export default {
  contacts: {
    ...
    deleteCategoryConfirm: "Êtes-vous sûr de vouloir supprimer la catégorie '{category}' ? Cela la retirera de tous les contacts. Aucun contact ne sera supprimé.",
    rename: 'Renommer',
    delete: 'Supprimer',
    create: 'Créer',
    add: 'Ajouter',
    ...
    sortZa: 'Trier Z-A',
    sortAz: 'Trier A-Z',
    filterStarred: 'Filtrer les favoris',
    ...
    selectContact: 'Sélectionnez un contact pour voir les détails',
