export default {
  contacts: {
    ...
    renameCategory: 'Preimenuj kategoriju',
    deleteCategory: 'Obriši kategoriju',
    deleteCategoryConfirm: "Da li ste sigurni da želite da obrišete kategoriju '{category}'? Ovo će je ukloniti iz svih kontakata. Kontakti neće biti obrisani.",
    rename: 'Preimenuj',
    delete: 'Obriši',
    create: 'Napravi',
    add: 'Dodaj',
    newCategory: 'Nova kategorija',
    refreshContacts: 'Osveži kontakte',
    sortZa: 'Sortiraj Z-A',
    sortAz: 'Sortiraj A-Z',
    filterStarred: 'Filtriraj omiljene',
    uncategorized: 'Nekategorizovano',
    addToCategory: 'Dodaj u kategoriju',
    deleteContact: 'Obriši kontakt',
    deleteContactConfirm: 'Da li ste sigurni da želite da obrišete ovaj kontakt?',
