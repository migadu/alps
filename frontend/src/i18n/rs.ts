export const rs = {
  settings: {
    ...
    categories: {
      ...
      accounts: 'Повезани налози',
      accountsDesc: 'Претходно ауторизовани налози за брзо пребацивање.',
  ...
  linkedAccounts: {
    description: 'Повежите други налог да бисте брзо прелазили између њих без одјављивања.',
    noAccounts: 'Нема повезаних налога.',
    remove: 'Уклони',
    addTitle: 'Повежи налог',
    linkAccount: 'Повежи налог',
    addedSuccess: 'Налог је успешно повезан.',
    addError: 'Додавање налога није успело. Проверите акредитиве.',
    removeConfirm: 'Да ли сте сигурни да желите да уклоните овај повезани налог?',
    removedSuccess: 'Налог је уклоњен.',
    removeError: 'Уклањање налога није успело.',
    switchError: 'Пребацивање налога није успело. Лозинка је можда промењена.'
  },
  print: {
  ...
  messageList: {
    ...
    emptyMailboxSelectionNote: {
      ...
      other: 'Укључено је и {count} порука које сте означили.'
    },
    emptyingMailbox: 'Празњење сандучета...',
    mailboxEmptied: 'Сандуче је успешно испражњено.',
    emptyMailboxFailed: 'Није могуће испразнити сандуче. Проверите да ли је Отпад или Непожељно.',
    mailboxAlreadyEmpty: '{folder} је већ био празан — ништа није обрисано.',
    emptyMailboxSlow: 'Пражњење фасцикле {folder} је још у току. Сервер и даље ради — проверите поново за тренутак.'
  },
  composer: {
  ...
  messageComposer: {
    ...
    moreFormatting: 'Више опција',
    undo: 'Опозови',
    redo: 'Понови',
    quote: 'Цитат',
    strikethrough: 'Прецртано',
    clearFormatting: 'Обриши форматирање',
    goToLink: 'Иди на везу:',
    change: 'Промени',
    remove: 'Уклони',
    text: 'Текст',
    link: 'Веза',
    apply: 'Примени',
    writeMessage: 'Напишите своју поруку...'
  },
  tags: {
    important: 'Важно',
    work: 'Посао',
  ...
  floatingComposer: {
    discardDraftTitle: 'Одбаци нацрт?',
    discardDraftMessage: 'Да ли сте сигурни да желите да одбаците овај нацрт? Ова акција се не може поништити.',
    discard: 'Одбаци',
    dropFiles: 'Превуците датотеке овде да бисте их приложили',
    ...
    insertEmoji: 'Уметни емоџи',
    send: 'Пошаљи',
    linkUrl: 'URL везе',
    linkUrlPlaceholder: 'https://example.com',
    displayText: 'Текст за приказ',
    displayTextPlaceholder: 'Мој вебсајт',
    apply: 'Примени',
    uploadFailed: 'Грешка при отпремању прилога: {error}',
  ...
  messageReader: {
    ...
    attachments: 'Прилози',
    downloadAllAttachments: 'Преузми све прилоге',
    unknownAttachment: 'Непознат прилог',
    archive: 'Архивирај',
    reportSpam: 'Пријави као Спем',
    notSpam: 'Није Спем',
    delete: 'Обриши',
    deleteThread: 'Обриши разговор',
  ...
  attachment: {
    ...
    zoomOut: 'Умањи',
    rotate: 'Ротирај',
    fitToScreen: 'Прилагоди екрану',
    previous: 'Претходно',
    next: 'Следеће',
    copyContent: 'Копирај садржај',
    copied: 'Копирано!',
    openInNewTab: 'Отвори у новој картици',
    cannotPreview: 'Преглед није доступан за овај тип датотеке',
    loadingPreview: 'Учитавање прегледа...',
    errorLoading: 'Грешка при учитавању прегледа',
    close: 'Затвори'
  },
  ...
  mailboxPage: {
    ...
    deletePermanently: 'Трајно обриши',
    undo: 'Опозови'
  },
  offline: {
  ...
  webauthn: {
    ...
    instruction: 'Користите свој безбедносни кључ да бисте довршили пријаву.',
    not_supported: 'WebAuthn није подржан у вашем прегледачу.',
    requesting: 'Захтевање аутентификације...',
    waiting_for_key: 'Чекање на безбедносни кључ...',
    verifying: 'Верификација...',
    success: 'Верификација је успела, преусмеравање...',
    verify_btn: 'Потврди идентитет',
    verifying_btn: 'Верификација...',
    back_to_login: 'Назад на пријаву',
    key_name_placeholder: 'Име уређаја (нпр. YubiKey)',
    name_key_title: 'Именуј безбедносни кључ',
    name_key_label: 'Име уређаја',
    add_key: 'Додај безбедносни кључ',
    trust_linked: 'Веруј повезаним налозима',
    trust_linked_desc: 'Ако је омогућено, можете да се пребаците на овај налог са повезаног налога без поновног уноса 2ФА акредитива.',
    trust_linked_checkbox: 'Дозволи пребацивање на овај налог без 2ФА',
    confirm_remove: 'Да ли сте сигурни да желите да уклоните овај безбедносни кључ?',
    errors: {
