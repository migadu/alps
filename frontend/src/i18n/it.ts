export const it = {
  ...
  messageList: {
    ...
    allOnPageSelected: 'Tutti i {count} messaggi di questa pagina sono selezionati',
    selectAllMatching: 'Seleziona tutti i {count} in {folder}',
    allMatchingSelected: 'Tutti i {count} messaggi in {folder} sono selezionati',
