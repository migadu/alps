...
>>>>>>>> main:frontend/dist/assets/index-CCMQIZxV.js
  ...
  `}_handleAnimationIteration(){this.dispatchEvent(new Event(`animationiteration`,{bubbles:!0,composed:!0}))}render(){return n`
      ...
      >
        ${this.icon?k(this.icon):n`<slot></slot>`}
      </button>
    `}};A([o({type:String})],mn.prototype,`icon`,void 0),A([o({type:String})],mn.prototype,`title`,void 0),A([o({type:Boolean})],mn.prototype,`disabled`,void 0),A([o({type:Boolean,reflect:!0})],mn.prototype,`active`,void 0),A([o({type:Boolean})],mn.prototype,`spinning`,void 0),mn=A([p(`alps-icon-btn`)],mn);var hn=g`
  .app-container {
    display: flex;
    flex: 1;
    overflow: hidden;
...
`,gn=class extends d{constructor(...e){super(...e),this.isMobile=!1,this.isOpen=!1,this.collapsed=!1,this.suppressHover=!1,this.isHovered=!1,this.width=250,this.hideFooterDivider=!1,this.showMobileBack=!1,this.isDragging=!1}static{this.styles=g`
    :host {
      display: block;
      position: relative;
      height: 100%;
  ...
  `}startResize(e){if(this.isMobile||this.collapsed)return;e.preventDefault(),this.isDragging=!0,this.dispatchEvent(new CustomEvent(`drag-start`));let t=e.clientX,n=this.width,r=e=>{let r=n+(e.clientX-t);this.dispatchEvent(new CustomEvent(`sidebar-resize`,{detail:{newWidth:r,clientX:e.clientX}}))},i=()=>{this.isDragging=!1,window.removeEventListener(`mousemove`,r),window.removeEventListener(`mouseup`,i),this.dispatchEvent(new CustomEvent(`drag-end`))};window.addEventListener(`mousemove`,r),window.addEventListener(`mouseup`,i)}render(){return n`
        ...
        <div class="sidebar-footer">
          ${this.isMobile&&this.showMobileBack?n`
            <button class="mobile-return-btn" @click=${()=>window.location.hash=``}>
              ${k(`arrowLeft`)} <span class="return-text">${this.i18nStore?.t(`messageReader.back`)||`Back`}</span>
            </button>
          `:this.isMobile?``:n`
            <alps-icon-btn 
              class="collapse-btn"
    ...
    `}};A([h({context:C})],gn.prototype,`i18nStore`,void 0),A([o({type:Boolean})],gn.prototype,`isMobile`,void 0),A([o({type:Boolean})],gn.prototype,`isOpen`,void 0),A([o({type:Boolean,reflect:!0})],gn.prototype,`collapsed`,void 0),A([o({type:Boolean,reflect:!0})],gn.prototype,`suppressHover`,void 0),A([o({type:Boolean,reflect:!0})],gn.prototype,`isHovered`,void 0),A([o({type:Number})],gn.prototype,`width`,void 0),A([o({type:Boolean})],gn.prototype,`hideFooterDivider`,void 0),A([o({type:Boolean})],gn.prototype,`showMobileBack`,void 0),A([a()],gn.prototype,`isDragging`,void 0),gn=A([p(`alps-sidebar`)],gn);var _n=class extends d{constructor(...e){super(...e),this.options=[],this.value=``}static{this.styles=g`
    :host {
      display: inline-flex;
      background-color: var(--bg-secondary, #f3f4f6);
      border-radius: 6px;
  ...
  `}render(){return n`
    ...
    `}};A([o({type:String,reflect:!0})],vn.prototype,`variant`,void 0),A([o({type:String})],vn.prototype,`icon`,void 0),A([o({type:Boolean,reflect:!0})],vn.prototype,`disabled`,void 0),A([o({type:Boolean,reflect:!0})],vn.prototype,`spinning`,void 0),A([o({type:String})],vn.prototype,`type`,void 0),A([o({type:String})],vn.prototype,`title`,void 0),A([o({type:Boolean,attribute:`full-width`,reflect:!0})],vn.prototype,`fullWidth`,void 0),vn=A([p(`alps-button`)],vn);var yn=class extends d{constructor(...e){super(...e),this.scrolled=!1}static{this.styles=g`
    :host {
      display: flex;
      align-items: center;
      height: 57px;
  ...
  `}render(){return n`<slot></slot>`}};A([o({type:Boolean,reflect:!0})],yn.prototype,`scrolled`,void 0),yn=A([p(`alps-toolbar`)],yn);var bn=class extends d{constructor(...e){super(...e),this.collapsed=!1,this.icon=`plus`,this.text=``,this.disabled=!1,this.title=``}static{this.styles=g`
    :host {
      display: block;
      width: 100%;
    }
  ...
  `}render(){return n`
    ...
    `}};A([o({type:Boolean})],bn.prototype,`collapsed`,void 0),A([o({type:String})],bn.prototype,`icon`,void 0),A([o({type:String})],bn.prototype,`text`,void 0),A([o({type:Boolean})],bn.prototype,`disabled`,void 0),A([o({type:String})],bn.prototype,`title`,void 0),bn=A([p(`alps-create-button`)],bn);var xn=g`
  .btn-cancel {
    background: transparent;
    border: none;
    color: var(--text-muted, #6b7280);
...
`,Sn=class extends d{constructor(...e){super(...e),this.title=``,this.isDanger=!1,this.dismissible=!1,this.width=`400px`,this._handleEscape=e=>{this.dismissible||e.preventDefault()},this._handleDialogClose=()=>{this.dispatchEvent(new CustomEvent(`cancel`,{bubbles:!0,composed:!0}))}}static{this.styles=g`
    .modal-dialog {
      position: fixed;
      inset: 0;
      margin: 0;
  ...
  `}firstUpdated(){let e=this.shadowRoot?.querySelector(`.modal-dialog`);e&&!e.open&&e.showModal()}_handleOverlayClick(e){this.dismissible?e.target===e.currentTarget&&(e.stopPropagation(),this.dispatchEvent(new CustomEvent(`cancel`,{bubbles:!0,composed:!0}))):e.stopPropagation()}render(){return n`
    ...
    `}};A([o({type:String})],Sn.prototype,`title`,void 0),A([o({type:Boolean})],Sn.prototype,`isDanger`,void 0),A([o({type:Boolean})],Sn.prototype,`dismissible`,void 0),A([o({type:String})],Sn.prototype,`width`,void 0),Sn=A([p(`ui-modal`)],Sn);var j=class extends d{constructor(...e){super(...e),this._handleI18nChange=()=>this.requestUpdate(),this.type=`text`,this.value=``,this.placeholder=``,this.required=!1,this.autocomplete=``,this.inputId=``,this.icon=``,this.clearable=!1,this.autofocus=!1,this.showPassword=!1}static{this.styles=g`
    :host {
      display: block;
      width: 100%;
      position: relative;
  ...
  `}handleInput(e){let t=e.target;this.value=t.value,this.dispatchEvent(new Event(`input`,{bubbles:!0,composed:!0})),this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))}togglePassword(){this.showPassword=!this.showPassword}handleClear(){this.value=``,this.dispatchEvent(new Event(`input`,{bubbles:!0,composed:!0})),this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0})),this.dispatchEvent(new Event(`clear`,{bubbles:!0,composed:!0}))}handleKeyDown(e){if(e.key===`Enter`){let t=this.closest(`form`);t&&(e.preventDefault(),t.requestSubmit())}}checkValidity(){let e=this.shadowRoot?.querySelector(`input`);return e?e.checkValidity():!0}reportValidity(){let e=this.shadowRoot?.querySelector(`input`);return e?e.reportValidity():!0}focus(){let e=this.shadowRoot?.querySelector(`input`);e&&e.focus()}connectedCallback(){super.connectedCallback(),this.i18nStore?.addEventListener(`change`,this._handleI18nChange)}disconnectedCallback(){super.disconnectedCallback(),this.i18nStore?.removeEventListener(`change`,this._handleI18nChange)}render(){let e=this.type===`password`,t=e&&this.showPassword?`text`:this.type,r=this.icon||(this.type===`email`?`at`:``);return n`
      <div class="input-wrapper ${r?`has-left-icon`:``} ${(e||this.clearable)&&this.value?`has-right-icon`:``}">
        ...
        ${e&&this.value?n`
          <button 
            ...
            tabindex="-1"
          >
            ${k(this.showPassword?`eyeSlash`:`eye`)}
          </button>
    ...
    `}};A([h({context:C})],j.prototype,`i18nStore`,void 0),A([o({type:String})],j.prototype,`type`,void 0),A([o({type:String})],j.prototype,`value`,void 0),A([o({type:String})],j.prototype,`placeholder`,void 0),A([o({type:Boolean})],j.prototype,`required`,void 0),A([o({type:String})],j.prototype,`autocomplete`,void 0),A([o({type:String})],j.prototype,`inputId`,void 0),A([o({type:String})],j.prototype,`icon`,void 0),A([o({type:Boolean})],j.prototype,`clearable`,void 0),A([o({type:Boolean})],j.prototype,`autofocus`,void 0),A([a()],j.prototype,`showPassword`,void 0),j=A([p(`alps-input`)],j);var Cn=class extends d{constructor(...e){super(...e),this.value=``,this.options=[]}static{this.styles=g`
		:host {
			display: block;
			position: relative;
		}
	...
	`}handleChange(e){let t=e.target;this.value=t.value,this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))}render(){return n`
		...
		`}};A([o({type:String})],Cn.prototype,`value`,void 0),A([o({type:Array})],Cn.prototype,`options`,void 0),Cn=A([p(`alps-select`)],Cn);var wn=new Set([``,`text`,`search`,`url`,`email`,`password`,`tel`,`number`]);function Tn(e){if(!e)return!1;if(e.isContentEditable)return!0;let t=e.tagName;if(t===`TEXTAREA`||t===`SELECT`)return!0;if(t===`INPUT`)return wn.has((e.type||``).toLowerCase());let n=e.getAttribute(`role`);return n===`textbox`||n===`searchbox`}function En(e){return e?e.tagName===`TEXTAREA`||e.isContentEditable:!1}var Dn=g`
  .dropdown-header {
...
`,On=class extends d{constructor(...e){super(...e),this.align=`right`,this.position=`bottom`,this.triggerOn=`click`,this.openState=!1,this._handleDialogClick=e=>{this.openState&&e.target===e.currentTarget&&(e.stopPropagation(),e.preventDefault(),this.close())},this._handleDialogClose=()=>{this.openState&&this.close()},this._handleDialogKeydown=e=>{if(this.openState){if(e.key===`ArrowDown`||e.key===`ArrowUp`){if(En(this._getActiveElement()))return;e.preventDefault();let t=this._getFocusableElements();if(t.length===0)return;let n=this._getActiveElement(),r=t.findIndex(e=>e===n);r=e.key===`ArrowDown`?r===-1?0:(r+1)%t.length:r===-1?t.length-1:(r-1+t.length)%t.length,t[r].focus()}else if(e.key===`Enter`||e.key===` `){let t=this._getActiveElement();if(e.key===` `?Tn(t):En(t))return;t&&typeof t.click==`function`&&(e.preventDefault(),t.click())}}},this._closeTimeout=null,this._handleMouseEnter=()=>{this.triggerOn===`hover`&&(this._closeTimeout&&=(clearTimeout(this._closeTimeout),null),this.open())},this._handleMouseLeave=()=>{this.triggerOn===`hover`&&(this._closeTimeout&&clearTimeout(this._closeTimeout),this._closeTimeout=setTimeout(()=>{this.close(),this._closeTimeout=null},300))},this._handleResize=()=>{this.openState&&this._updatePosition()}}static{this.styles=g`
    :host {
      display: inline-block;
      position: relative;
    }
  ...
  `]}render(){return n`
    ...
    `}};A([o({type:Array})],kn.prototype,`addresses`,void 0),A([o({type:Boolean})],kn.prototype,`disabled`,void 0),A([a()],kn.prototype,`inputText`,void 0),A([a()],kn.prototype,`suggestions`,void 0),A([a()],kn.prototype,`focusedSuggestionIndex`,void 0),kn=A([p(`alps-address-input`)],kn);var An=class extends d{constructor(...e){super(...e),this.title=`Confirm`,this.message=`Are you sure?`,this.confirmText=`Confirm`,this.cancelText=``,this.isDanger=!1,this.dismissible=!1}static{this.styles=[xn]}_handleCancel(e){e.stopPropagation(),this.dispatchEvent(new CustomEvent(`cancel`,{bubbles:!0,composed:!0}))}_handleSecondary(e){e.stopPropagation(),this.dispatchEvent(new CustomEvent(`secondary`,{bubbles:!0,composed:!0}))}_handleConfirm(e){e.stopPropagation(),this.dispatchEvent(new CustomEvent(`confirm`,{bubbles:!0,composed:!0}))}render(){return n`
      <ui-modal 
        .title=${this.title}
    ...
    `}};A([h({context:C})],An.prototype,`i18nStore`,void 0),A([o({type:String})],An.prototype,`title`,void 0),A([o({type:String})],An.prototype,`message`,void 0),A([o({type:String})],An.prototype,`confirmText`,void 0),A([o({type:String})],An.prototype,`cancelText`,void 0),A([o({type:String})],An.prototype,`secondaryText`,void 0),A([o({type:Boolean})],An.prototype,`isDanger`,void 0),A([o({type:Boolean})],An.prototype,`dismissible`,void 0),An=A([p(`ui-confirm`)],An);var M=class extends d{constructor(...e){super(...e),this.calendars=[],this.open=!1,this.scheduling=`email`,this.summary=``,this.location=``,this.calendarPath=``,this.description=``,this.startDate=``,this.startTime=``,this.endDate=``,this.endTime=``,this.isAllDay=!1,this.isSaving=!1,this.rruleFreq=``,this.originalRRule=``,this.attendees=[],this.askNotify=!1}static{this.styles=[xn,g`
            .form-group {
                margin-bottom: 16px;
            }
            .form-group label {
        ...
        `]}updated(e){if(e.has(`open`)&&this.open){let e=e=>e.toString().padStart(2,`0`);if(this.askNotify=!1,this.attendees=(this.event?.attendees??[]).map(Et),this.event){this.summary=this.event.summary||``,this.location=this.event.location||``,this.description=this.event.description||``,this.calendarPath=this.event.calendarPath||(this.calendars.length>0?this.calendars[0].path:``);let t=jt(this.event);if(this.isAllDay=t,this.event.rrule?(this.originalRRule=this.event.rrule,this.event.rrule===`FREQ=DAILY`?this.rruleFreq=`DAILY`:this.event.rrule===`FREQ=WEEKLY`?this.rruleFreq=`WEEKLY`:this.event.rrule===`FREQ=MONTHLY`?this.rruleFreq=`MONTHLY`:this.event.rrule===`FREQ=YEARLY`?this.rruleFreq=`YEARLY`:this.rruleFreq=`CUSTOM`):(this.originalRRule=``,this.rruleFreq=``),t){let t=new Date(this.event.start);this.startDate=`${t.getUTCFullYear()}-${e(t.getUTCMonth()+1)}-${e(t.getUTCDate())}`,this.startTime=`00:00`;let n=new Date(this.event.end);n.setUTCDate(n.getUTCDate()-1),this.endDate=`${n.getUTCFullYear()}-${e(n.getUTCMonth()+1)}-${e(n.getUTCDate())}`,this.endTime=`00:00`}else{let t=new Date(this.event.start);this.startDate=`${t.getFullYear()}-${e(t.getMonth()+1)}-${e(t.getDate())}`,this.startTime=`${e(t.getHours())}:${e(t.getMinutes())}`;let n=new Date(this.event.end);this.endDate=`${n.getFullYear()}-${e(n.getMonth()+1)}-${e(n.getDate())}`,this.endTime=`${e(n.getHours())}:${e(n.getMinutes())}`}}else{this.summary=``,this.location=``,this.description=``,this.originalRRule=``,this.rruleFreq=``,this.calendarPath=this.calendars.length>0?this.calendars[0].path:``;let t=this.initialDate?new Date(this.initialDate):new Date;if(this.initialAllDay===void 0?this.initialDate&&t.getHours()===0&&t.getMinutes()===0:this.initialAllDay)this.isAllDay=!0,this.startDate=`${t.getFullYear()}-${e(t.getMonth()+1)}-${e(t.getDate())}`,this.startTime=`00:00`,this.endDate=this.startDate,this.endTime=`00:00`;else{this.isAllDay=!1,this.initialDate||(t.setMinutes(0,0,0),t.setHours(t.getHours()+1)),this.startDate=`${t.getFullYear()}-${e(t.getMonth()+1)}-${e(t.getDate())}`,this.startTime=`${e(t.getHours())}:${e(t.getMinutes())}`;let n=new Date(t.getTime()+3600*1e3);this.endDate=`${n.getFullYear()}-${e(n.getMonth()+1)}-${e(n.getDate())}`,this.endTime=`${e(n.getHours())}:${e(n.getMinutes())}`}}}}handleCancel(){this.open=!1,this.dispatchEvent(new CustomEvent(`close`))}formTimes(){if(this.isAllDay){let e=new Date(`${this.endDate}T00:00:00.000Z`);return e.setUTCDate(e.getUTCDate()+1),{startISO:`${this.startDate}T00:00:00.000Z`,endISO:e.toISOString()}}return{startISO:new Date(`${this.startDate}T${this.startTime||`00:00`}`).toISOString(),endISO:new Date(`${this.endDate}T${this.endTime||`00:00`}`).toISOString()}}get invited(){return this.event?.role===`attendee`}async handleSave(){if(!this.summary.trim()||!this.startDate||!this.endDate)return;let e=!!this.event?.ended&&new Date(this.formTimes().endISO)<=new Date;if(this.event?.path&&!this.invited&&Ot({...this.event,ended:e},this.scheduling)){this.askNotify=!0;return}await this.save()}async save(e){this.askNotify=!1,this.isSaving=!0;try{let{startISO:t,endISO:n}=this.formTimes(),r;this.rruleFreq===`CUSTOM`?r=this.originalRRule:this.rruleFreq&&(r=`FREQ=${this.rruleFreq}`);let i={summary:this.summary,location:this.location,description:this.description,start:t,end:n,allDay:this.isAllDay,calendarPath:this.calendarPath,rrule:r,etag:this.event?.etag,attendees:this.invited?void 0:this.attendees.map(Tt).filter(e=>e!==null),notify:e,lang:this.i18nStore?.getLanguage?.()};(this.event&&this.event.path?await It.updateEvent(this.event.path,i):await It.createEvent(i))?.sendFailed&&window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:this.i18nStore?.t(`invitations.notTold`),duration:8e3}})),this.open=!1,this.dispatchEvent(new CustomEvent(`saved`))}catch(e){console.error(`Failed to save event`,e);let t=ot(e);t&&this.dispatchEvent(new CustomEvent(`conflict`)),window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:this.i18nStore?.t(t?`calendar.saveConflict`:`calendar.saveEventFailed`),duration:8e3}}))}finally{this.isSaving=!1}}render(){return this.open?n`
            <ui-modal 
            ...
            ${this.askNotify?n`
                ...
                ></ui-confirm>
            `:``}
        `:n``}};A([h({context:C})],M.prototype,`i18nStore`,void 0),A([o({type:Object})],M.prototype,`event`,void 0),A([o({type:Object})],M.prototype,`initialDate`,void 0),A([o({type:Boolean})],M.prototype,`initialAllDay`,void 0),A([o({type:Array})],M.prototype,`calendars`,void 0),A([o({type:Boolean})],M.prototype,`open`,void 0),A([o({type:String})],M.prototype,`scheduling`,void 0),A([a()],M.prototype,`summary`,void 0),A([a()],M.prototype,`location`,void 0),A([a()],M.prototype,`calendarPath`,void 0),A([a()],M.prototype,`description`,void 0),A([a()],M.prototype,`startDate`,void 0),A([a()],M.prototype,`startTime`,void 0),A([a()],M.prototype,`endDate`,void 0),A([a()],M.prototype,`endTime`,void 0),A([a()],M.prototype,`isAllDay`,void 0),A([a()],M.prototype,`isSaving`,void 0),A([a()],M.prototype,`rruleFreq`,void 0),A([a()],M.prototype,`originalRRule`,void 0),A([a()],M.prototype,`attendees`,void 0),A([a()],M.prototype,`askNotify`,void 0),M=A([p(`calendar-event-modal`)],M);function jn(e){if(!e||typeof e!=`object`)return!1;if(Array.isArray(e.Children))return e.Children.some(e=>jn(e));let t=`${e.Type||``}/${e.Subtype||``}`.toLowerCase();if(t===`text/calendar`||t===`application/ics`)return!0;let n=e.Extended?.Disposition?.Params?.filename||e.Params?.name||``;return typeof n==`string`&&n.toLowerCase().endsWith(`.ics`)}var Mn=new class{async fetchInvitation(e,t){let n=await E(`/calendar/invitation?${new URLSearchParams({mailbox:e,uid:t}).toString()}`);if(n.status===404)return null;if(!n.ok)throw new T(n.status,`Failed to read the invitation`);return n.json()}async respond(e){return this.post(`/calendar/invitation/respond`,e,`Failed to answer the invitation`)}async apply(e){return this.post(`/calendar/invitation/apply`,e,`Failed to update the calendar`)}async post(e,t,n){let r=await E(e,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)});if(!r.ok)throw new T(r.status,n);return r.json()}},Nn={accepted:`accepted`,tentative:`tentative`,declined:`declined`,"needs-action":`needsAction`,delegated:`delegated`,completed:`completed`,"in-process":`inProcess`};function Pn(e){return Nn[e??``]??`needsAction`}var Fn={update:`update`,outdated:`outdated`,organizer:`organizer`,"not-invited":`notInvited`,cancel:`cancel`,cancelled:`cancelled`,reply:`reply`,replied:`replied`,unknown:`unknown`,add:`add`,added:`added`,unsupported:`unsupported`},In=e=>e.name||e.email,Ln=class extends d{constructor(...e){super(...e),this.mailbox=``,this.uid=``,this.view=null,this.busy=!1,this.notice=null,this.calendarPath=``,this.loadSeq=0,this.autoApplied=new Set}static{this.styles=g`
        :host {
            display: block;
            margin: 12px 16px 0;
        }
    ...
    `}willUpdate(e){(e.has(`mailbox`)||e.has(`uid`))&&(this.view=null,this.notice=null,this.load())}t(e,t){return this.i18nStore?.t(e,t)??e}async load(){let e=++this.loadSeq,{mailbox:t,uid:n}=this;if(!t||!n)return;let r;try{r=await Mn.fetchInvitation(t,n)}catch(t){console.error(`Failed to read the invitation`,t),e===this.loadSeq&&(this.view=null);return}if(e!==this.loadSeq||(this.view=r,!r))return;r.calendars.some(e=>e.path===this.calendarPath)||(this.calendarPath=r.copy?.calendarPath||r.calendars[0]?.path||``);let i=JSON.stringify([t,n]);r.autoApply&&!this.autoApplied.has(i)&&(this.autoApplied.add(i),await this.apply())}async respond(e){let t=this.view;if(!(!t||this.busy)){this.busy=!0,this.notice=null;try{let n=await Mn.respond({mailbox:this.mailbox,uid:this.uid,status:e,calendarPath:t.copy?void 0:this.calendarPath,lang:this.i18nStore?.getLanguage?.()});this.notice=n.sendFailed?{key:`invitations.sendFailed`,tone:`error`}:{key:n.sent?`invitations.sent`:`invitations.saved`,tone:`info`}}catch(e){console.error(`Failed to answer the invitation`,e),this.notice={key:ot(e)?`invitations.changedElsewhere`:`invitations.answerFailed`,tone:`error`}}finally{this.busy=!1}await this.load()}}async apply(){let e=this.view;if(!(!e||this.busy)){this.busy=!0,this.notice=null;try{let t=(await Mn.apply({mailbox:this.mailbox,uid:this.uid,calendarPath:this.calendarPath})).removed?`invitations.removed`:e.state===`add`?`invitations.added`:`invitations.updated`;this.notice={key:t,tone:`info`}}catch(e){console.error(`Failed to update the calendar`,e),this.notice={key:ot(e)?`invitations.changedElsewhere`:`invitations.applyFailed`,tone:`error`}}finally{this.busy=!1}await this.load()}}kindKey(e){switch(e.method){case`cancel`:return`cancelled`;case`reply`:return`reply`;case`request`:return e.kind===`task`?`task`:e.state===`update`?`updated`:`invitation`}return e.kind===`task`?`task`:`event`}when(e){let t=this.i18nStore?.getIntlLanguage?.()||void 0,n=new Intl.DateTimeFormat(t,{weekday:`short`,year:`numeric`,month:`short`,day:`numeric`}),r=e=>new Date(`${e.slice(0,10)}T00:00:00`);if(e.kind===`task`&&!e.start){if(!e.end)return``;let i=e.allDay?n.format(r(e.end)):new Intl.DateTimeFormat(t,{dateStyle:`medium`,timeStyle:`short`}).format(new Date(e.end));return`${this.t(`tasks.due`)}: ${i}`}if(!e.start)return``;if(e.allDay){let t=r(e.start);if(!e.end)return n.format(t);let i=r(e.end);return i.setDate(i.getDate()-1),i>t?`${n.format(t)} - ${n.format(i)}`:n.format(t)}let i=new Date(e.start),a=e.end?new Date(e.end):i,o=new Intl.DateTimeFormat(t,{weekday:`short`,year:`numeric`,month:`short`,day:`numeric`,hour:`numeric`,minute:`2-digit`}),s=o.formatRange;return a>i&&s?s.call(o,i,a):o.format(i)}renderStateLine(e){if(e.ended)return n`
                <div class="muted state ended">${this.t(`invitations.states.ended`)}</div>
                ${e.status&&e.status!==`needs-action`?n`<div class="muted answer">${this.t(`invitations.yourAnswer`)}: ${this.t(`invitations.statuses.${Pn(e.status)}`)}</div>`:c}
            `;if(e.state===`answer`)return!e.status||e.status===`needs-action`?c:n`<div class="muted answer">${this.t(`invitations.yourAnswer`)}: ${this.t(`invitations.statuses.${Pn(e.status)}`)}</div>`;let t=Fn[e.state];return t?n`<div class="muted state">${this.t(`invitations.states.${t}`)}</div>`:c}renderClashes(e){if(e.ended||e.kind!==`event`||e.method!==`request`||e.state!==`answer`&&e.state!==`update`||e.status===`declined`)return c;if(!e.clashes.length)return n`<div class="muted clashes">${this.t(`invitations.noConflicts`)}</div>`;let t=e.clashes.map(e=>e.summary||this.t(`calendar.noTitle`)).join(`, `);return n`<div class="clash clashes">${this.t(`invitations.conflictsWith`,{names:t})}</div>`}renderSender(e){if(e.ended||e.senderVerified||!e.sender||![`answer`,`update`,`cancel`,`reply`].includes(e.state))return c;let t=e.method===`reply`?`invitations.unverifiedReply`:`invitations.unverified`;return n`<div class="warning sender">${this.t(t,{sender:e.sender})}</div>`}renderPicker(e){return e.copy||e.calendars.length<2?c:n`
            <alps-select
                .value=${this.calendarPath}
        ...
        `}renderActions(e){if(e.ended)return c;if(e.method===`request`&&[`answer`,`update`,`outdated`].includes(e.state)&&e.me){let t=(t,r)=>n`
            ...
            <div class="card" role="region" aria-label=${r}>
                <div class="icon">${k(e.kind===`task`?`checkCircle`:`calendar`)}</div>
                <div class="body">
                    ...
                    ${e.method===`reply`&&e.replier?n`<div class="replier">${this.t(`invitations.answered.${Pn(e.replier.status)}`,{name:In(e.replier)})}</div>`:e.organizer?n`<div class="muted organizer">${this.t(`invitations.organizer`)}: ${In(e.organizer)}</div>`:c}
        ...
        `}};A([h({context:C})],Ln.prototype,`i18nStore`,void 0),A([o()],Ln.prototype,`mailbox`,void 0),A([o()],Ln.prototype,`uid`,void 0),A([a()],Ln.prototype,`view`,void 0),A([a()],Ln.prototype,`busy`,void 0),A([a()],Ln.prototype,`notice`,void 0),A([a()],Ln.prototype,`calendarPath`,void 0),Ln=A([p(`calendar-invitation-banner`)],Ln);var Rn=[`DAILY`,`WEEKLY`,`MONTHLY`,`YEARLY`];function zn(e){return e?Rn.find(t=>e===`FREQ=${t}`)??`CUSTOM`:``}var Bn=e=>String(e).padStart(2,`0`),N=class extends d{constructor(...e){super(...e),this.open=!1,this.lists=[],this.defaultList=``,this.scheduling=`email`,this.title=``,this.description=``,this.dueDate=``,this.dueTime=``,this.allDay=!0,this.status=`needs-action`,this.priority=0,this.percent=0,this.repeat=``,this.calendarPath=``,this.saving=!1,this.attendees=[],this.askNotify=!1,this.originalRRule=``,this.openedDue={date:``,time:``,allDay:!0}}static{this.styles=[xn,g`
            .form-group {
                margin-bottom: 16px;
                flex: 1;
            }
        ...
        `]}willUpdate(e){e.has(`open`)&&this.open&&this.reset()}reset(){let e=this.task;this.title=e?.title??``,this.description=e?.description??``,this.status=e?.status??`needs-action`,this.priority=e?.priority??0,this.percent=e?.percentComplete??0,this.calendarPath=e?.calendarPath||this.defaultList||this.lists[0]?.path||``,this.originalRRule=e?.rrule??``,this.repeat=zn(this.originalRRule),this.dueDate=``,this.dueTime=``,this.allDay=e?.due?e.allDay:!0;let t=e?ft(e):null;t&&(this.dueDate=`${t.getFullYear()}-${Bn(t.getMonth()+1)}-${Bn(t.getDate())}`,this.allDay||(this.dueTime=`${Bn(t.getHours())}:${Bn(t.getMinutes())}`)),this.openedDue={date:this.dueDate,time:this.dueTime,allDay:this.allDay},this.attendees=(e?.attendees??[]).map(Et),this.askNotify=!1}get assignedToUser(){return this.task?.role===`attendee`}input(){let e=``,t=this.dueDate===this.openedDue.date&&this.dueTime===this.openedDue.time&&this.allDay===this.openedDue.allDay;this.task&&t?e=this.task.due??``:this.dueDate&&(e=this.allDay?`${this.dueDate}T00:00:00Z`:new Date(`${this.dueDate}T${this.dueTime||`09:00`}`).toISOString());let n=e?this.repeat===`CUSTOM`?this.originalRRule:this.repeat?`FREQ=${this.repeat}`:``:``;return{title:this.title.trim(),description:this.description,due:e,allDay:this.allDay,status:this.status,percentComplete:this.status===`completed`?100:this.percent,priority:this.priority,rrule:n,calendarPath:this.calendarPath,etag:this.task?.etag}}setStatus(e){this.status===`completed`&&e!==`completed`&&this.percent>=100&&(this.percent=0),this.status=e}close(){this.open=!1,this.dispatchEvent(new CustomEvent(`close`))}requestDelete(){this.dispatchEvent(new CustomEvent(`delete`,{detail:{task:this.task}}))}async handleSave(){if(!(this.saving||!this.title.trim()||!this.calendarPath)){if(this.task?.role===`organizer`&&Dt(this.task,this.scheduling)){this.askNotify=!0;return}await this.save()}}async save(e){this.askNotify=!1,this.saving=!0;try{let t=!this.task,n={...this.input(),attendees:this.assignedToUser?void 0:this.attendees.map(Tt).filter(e=>e!==null),notify:e,lang:this.i18nStore?.getLanguage?.()},r=this.task?await Ct.updateTask(this.task.path,n):await Ct.createTask(n);r?.sendFailed&&window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:this.i18nStore?.t(`invitations.notTold`),duration:8e3}})),this.open=!1,this.dispatchEvent(new CustomEvent(`saved`,{detail:{task:r,created:t}}))}catch(e){console.error(`Failed to save task`,e);let t=ot(e);t&&this.dispatchEvent(new CustomEvent(`conflict`)),window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:this.i18nStore?.t(t?`tasks.saveConflict`:`tasks.saveFailed`),duration:8e3}}))}finally{this.saving=!1}}priorityOptions(){let e=e=>this.i18nStore?.t(e)??e,t=[{value:`0`,label:e(`tasks.priorities.none`)},{value:`1`,label:e(`tasks.priorities.high`)},{value:`5`,label:e(`tasks.priorities.medium`)},{value:`9`,label:e(`tasks.priorities.low`)}];if(!t.some(e=>e.value===String(this.priority))){let n=this.priority<=4?`tasks.priorities.high`:this.priority===5?`tasks.priorities.medium`:`tasks.priorities.low`;t.push({value:String(this.priority),label:e(n)})}return t}render(){if(!this.open)return n``;let e=e=>this.i18nStore?.t(e)??e,t=!!this.dueDate,r=this.task;return n`
            <ui-modal
                ...
                `:n`
                    ...
                    ${r?.role===`organizer`&&r.attendees?.length?n`
                        <div class="assigned answers">
                            ${r.attendees.map(t=>n`<div>${t.name||t.email}: ${e(`invitations.statuses.${Pn(t.status)}`)}</div>`)}
                        </div>
                    `:``}
                `}
            ...
            `:``}
<<<<<<<< HEAD:frontend/dist/assets/index-BHV7B3Zq.js
        `}};A([h({context:C})],N.prototype,`i18nStore`,void 0),A([o({type:Boolean})],N.prototype,`open`,void 0),A([o({attribute:!1})],N.prototype,`task`,void 0),A([o({type:Array})],N.prototype,`lists`,void 0),A([o({type:String})],N.prototype,`defaultList`,void 0),A([o({type:String})],N.prototype,`scheduling`,void 0),A([a()],N.prototype,`title`,void 0),A([a()],N.prototype,`description`,void 0),A([a()],N.prototype,`dueDate`,void 0),A([a()],N.prototype,`dueTime`,void 0),A([a()],N.prototype,`allDay`,void 0),A([a()],N.prototype,`status`,void 0),A([a()],N.prototype,`priority`,void 0),A([a()],N.prototype,`percent`,void 0),A([a()],N.prototype,`repeat`,void 0),A([a()],N.prototype,`calendarPath`,void 0),A([a()],N.prototype,`saving`,void 0),A([a()],N.prototype,`attendees`,void 0),A([a()],N.prototype,`askNotify`,void 0),N=A([p(`task-modal`)],N);var Vn=class extends d{constructor(...e){super(...e),this.events=[],this.showTitle=!1,this._handleSettingsChange=()=>{this.requestUpdate()}}connectedCallback(){super.connectedCallback(),this.settingsStore?.addEventListener(`change`,this._handleSettingsChange)}disconnectedCallback(){super.disconnectedCallback(),this.settingsStore?.removeEventListener(`change`,this._handleSettingsChange)}getFirstDayOfWeek(){return this.weekStart===void 0?this.settingsStore?.getState()?.weekStart??1:this.weekStart}static{this.styles=g`
========
        `}};A([h({context:S})],N.prototype,`i18nStore`,void 0),A([o({type:Boolean})],N.prototype,`open`,void 0),A([o({attribute:!1})],N.prototype,`task`,void 0),A([o({type:Array})],N.prototype,`lists`,void 0),A([o({type:String})],N.prototype,`defaultList`,void 0),A([o({type:String})],N.prototype,`scheduling`,void 0),A([a()],N.prototype,`title`,void 0),A([a()],N.prototype,`description`,void 0),A([a()],N.prototype,`dueDate`,void 0),A([a()],N.prototype,`dueTime`,void 0),A([a()],N.prototype,`allDay`,void 0),A([a()],N.prototype,`status`,void 0),A([a()],N.prototype,`priority`,void 0),A([a()],N.prototype,`percent`,void 0),A([a()],N.prototype,`repeat`,void 0),A([a()],N.prototype,`calendarPath`,void 0),A([a()],N.prototype,`saving`,void 0),A([a()],N.prototype,`attendees`,void 0),A([a()],N.prototype,`askNotify`,void 0),N=A([p(`task-modal`)],N);var Bn=class extends d{constructor(...e){super(...e),this.events=[],this.showTitle=!1,this.weekStart=1}getFirstDayOfWeek(){return this.weekStart??1}static{this.styles=g`
>>>>>>>> main:frontend/dist/assets/index-CCMQIZxV.js
        :host {
            display: flex;
            flex-direction: column;
    ...
    `}getMonthGrid(){let e=this.getFirstDayOfWeek(),t=(new Date(this.year,this.month,1).getDay()-e+7)%7,n=1-t,r=new Date(this.year,this.month+1,0).getDate(),i=Math.ceil((r+t)/7)*7,a=[];for(let e=0;e<i;e++)a.push(new Date(this.year,this.month,n+e));return a}hasEventsForDate(e){if(!this.events||this.events.length===0)return!1;let t=new Date(e);t.setHours(0,0,0,0);let n=new Date(e);return n.setHours(23,59,59,999),this.events.some(e=>{if(jt(e)){let n=e.start.split(`T`)[0],r=e.end.split(`T`)[0],i=new Date(n+`T00:00:00`),a=new Date(r+`T00:00:00`);return i<=t&&a>t}else{let r=new Date(e.start),i=new Date(e.end);return i.getTime()===t.getTime()&&r.getTime()<i.getTime()?!1:r<=n&&i>=t}})}handleDateClick(e){this.dispatchEvent(new CustomEvent(`date-selected`,{detail:{date:e},bubbles:!0,composed:!0}))}render(){let e=this.getMonthGrid(),t=this.getFirstDayOfWeek(),r=Array.from({length:7},(e,n)=>{let r=(t+n)%7;return this.i18nStore?.t(`calendar.daysNarrow.${r}`)}),i=new Date;i.setHours(0,0,0,0);let a=this.i18nStore?.t(`calendar.months.${this.month}`);return n`
            ${this.showTitle?n`<div class="year-month-title">${a}</div>`:``}
            <div class="mini-grid">
                ${r.map(e=>n`<div class="mini-day-name">${e}</div>`)}
                ${e.map(e=>{let t=e.getMonth()!==this.month,r=e.getTime()===i.getTime(),a=this.hasEventsForDate(e),o=e.getDay()===0||e.getDay()===6;return n`
                        <div 
                            class="mini-day ${r?`today`:``} ${a?`has-event`:``} ${o?`weekend`:``}" 
                            style="${t?`opacity: 0.3`:``}"
...
<<<<<<<< HEAD:frontend/dist/assets/index-BHV7B3Zq.js
        `}};A([h({context:C})],Vn.prototype,`i18nStore`,void 0),A([h({context:w})],Vn.prototype,`settingsStore`,void 0),A([o({type:Number})],Vn.prototype,`year`,void 0),A([o({type:Number})],Vn.prototype,`month`,void 0),A([o({type:Array})],Vn.prototype,`events`,void 0),A([o({type:Boolean})],Vn.prototype,`showTitle`,void 0),A([o({type:Number})],Vn.prototype,`weekStart`,void 0),A([o({type:Object})],Vn.prototype,`currentDate`,void 0),Vn=A([p(`calendar-mini-month`)],Vn);var Hn=class extends d{static{this.styles=g`
========
        `}};A([h({context:S})],Bn.prototype,`i18nStore`,void 0),A([o({type:Number})],Bn.prototype,`year`,void 0),A([o({type:Number})],Bn.prototype,`month`,void 0),A([o({type:Array})],Bn.prototype,`events`,void 0),A([o({type:Boolean})],Bn.prototype,`showTitle`,void 0),A([o({type:Number})],Bn.prototype,`weekStart`,void 0),A([o({type:Object})],Bn.prototype,`currentDate`,void 0),Bn=A([p(`calendar-mini-month`)],Bn);var Vn=class extends d{static{this.styles=g`
>>>>>>>> main:frontend/dist/assets/index-CCMQIZxV.js
        :host {
            display: block;
            padding: 12px;
    ...
    `}formatEventDate(e){let t=e.start,n=jt(e),r;return r=n?new Date(t.split(`T`)[0]+`T00:00:00`):new Date(t),`${this.i18nStore?.t(`calendar.days.${r.getDay()}`)}, ${this.i18nStore?.t(`calendar.monthsShort.${r.getMonth()}`)} ${r.getDate()}, ${r.getFullYear()}`}formatEventTimeRange(e){let t=new Date(e.start),n=new Date(e.end);if(jt(e))return this.i18nStore?.t(`calendar.allDay`);let r={hour:`numeric`,minute:`2-digit`};return t.toDateString()===n.toDateString()?`${t.toLocaleTimeString(void 0,r)} - ${n.toLocaleTimeString(void 0,r)}`:`${t.toLocaleTimeString(void 0,r)} - ${this.i18nStore?.t(`calendar.monthsShort.${n.getMonth()}`)} ${n.getDate()} ${n.toLocaleTimeString(void 0,r)}`}handleEdit(e){e.stopPropagation();let t=this.closest(`alps-popup`);t&&t.close(),setTimeout(()=>{this.dispatchEvent(new CustomEvent(`edit-event`,{detail:{event:this.event},bubbles:!0,composed:!0}))},10)}handleDelete(e){e.stopPropagation();let t=this.closest(`alps-popup`);t&&t.close(),setTimeout(()=>{this.dispatchEvent(new CustomEvent(`delete-event`,{detail:{event:this.event},bubbles:!0,composed:!0}))},10)}handleComplete(e){e.stopPropagation();let t=this.closest(`alps-popup`);t&&t.close(),setTimeout(()=>{this.dispatchEvent(new CustomEvent(`complete-task`,{detail:{task:this.event.task},bubbles:!0,composed:!0}))},10)}handleRespond(e,t){e.stopPropagation();let n=this.closest(`alps-popup`);n&&n.close(),setTimeout(()=>{this.dispatchEvent(new CustomEvent(`respond-event`,{detail:{event:this.event,status:t},bubbles:!0,composed:!0}))},10)}answerable(e){return!e.ended&&new Date(e.end)>new Date}renderMeeting(e){if(!e.organizer&&!e.attendees?.length)return``;let t=e=>this.i18nStore?.t(e),r=e=>e.name||e.email,i=(r,i)=>n`
        ...
        `;return n`
            <div class="card meeting">
                ...
                ${e.attendees?.length?n`
                    ...
                    <ul class="people">
                        ${e.attendees.map(e=>n`<li><span>${r(e)}</span><span class="status">${t(`invitations.statuses.${Pn(e.status)}`)}</span></li>`)}
                    </ul>
                `:``}
                ${e.role===`attendee`?n`
                    ...
                    `:n`<div class="description-text answer-status">${t(`invitations.statuses.${Pn(e.status)}`)}</div>`}
                `:``}
            </div>
        `}renderTask(e){let t=this.event,r=ft(e);return n`
            <div class="header">
        ...
        `}};A([h({context:C})],Hn.prototype,`i18nStore`,void 0),A([o({type:Object})],Hn.prototype,`event`,void 0),Hn=A([p(`calendar-event-preview`)],Hn);var Un=class extends d{constructor(...e){super(...e),this.days=[],this.events=[],this.scrolled=!1,this.now=new Date}connectedCallback(){super.connectedCallback(),this.now=new Date,this.nowTimer=window.setInterval(()=>{this.now=new Date},6e4)}disconnectedCallback(){super.disconnectedCallback(),this.nowTimer!==void 0&&(clearInterval(this.nowTimer),this.nowTimer=void 0)}static{this.styles=g`
        :host {
            display: flex;
            flex-direction: column;
            height: 100%;
    ...
    `}getEventsForDate(e,t){return this.events?this.events.filter(n=>{let r=jt(n);if(t!==r)return!1;let i=new Date(e);i.setHours(0,0,0,0);let a=new Date(e);if(a.setHours(23,59,59,999),r){let e=n.start.split(`T`)[0],t=n.end.split(`T`)[0],r=new Date(e+`T00:00:00`),a=new Date(t+`T00:00:00`);return r<=i&&a>i}else{let e=new Date(n.start),t=new Date(n.end);return t.getTime()===i.getTime()&&e.getTime()<t.getTime()?!1:e<=a&&t>=i}}):[]}handleColumnClick(e,t){let n=e.currentTarget.getBoundingClientRect(),r=e.clientY-n.top,i=Math.floor(r/48),a=new Date(t);a.setHours(i,0,0,0),this.dispatchEvent(new CustomEvent(`create-event`,{detail:{date:a,allDay:!1},bubbles:!0,composed:!0}))}handleAllDayCellClick(e){let t=new Date(e);t.setHours(0,0,0,0),this.dispatchEvent(new CustomEvent(`create-event`,{detail:{date:t,allDay:!0},bubbles:!0,composed:!0}))}handleScroll(e){let t=e.target;this.scrolled=t.scrollTop>0}render(){let e=Array.from({length:24},(e,t)=>t),t=new Date(this.now);return t.setHours(0,0,0,0),n`
                                            ...
                                            ${this.getEventsForDate(e,!0).map(e=>n`
                                                <alps-popup align="left" position="bottom" style="width: 100%; display: block;" @click=${e=>e.stopPropagation()}>
                                                    <div slot="trigger"
                                                        ...
                                                        ${e.task?k(`checkCircle`):``}${e.summary||this.i18nStore?.t(`calendar.noTitle`)}
                                                    </div>
        ...
        `}};A([h({context:C})],Un.prototype,`i18nStore`,void 0),A([o({type:Array})],Un.prototype,`days`,void 0),A([o({type:Array})],Un.prototype,`events`,void 0),A([a()],Un.prototype,`scrolled`,void 0),A([a()],Un.prototype,`now`,void 0),Un=A([p(`calendar-time-grid`)],Un);var Wn=class extends d{constructor(...e){super(...e),this.events=[]}static{this.styles=g`
        :host {
            display: flex;
            height: 100%;
            width: 100%;
    ...
    `}render(){return n`
            ...
            ></calendar-time-grid>
<<<<<<<< HEAD:frontend/dist/assets/index-BHV7B3Zq.js
        `}};A([o({type:Object})],Wn.prototype,`date`,void 0),A([o({type:Array})],Wn.prototype,`events`,void 0),Wn=A([p(`calendar-day-view`)],Wn);var Gn=class extends d{constructor(...e){super(...e),this.events=[],this._handleSettingsChange=()=>{this.requestUpdate()}}connectedCallback(){super.connectedCallback(),this.settingsStore?.addEventListener(`change`,this._handleSettingsChange)}disconnectedCallback(){super.disconnectedCallback(),this.settingsStore?.removeEventListener(`change`,this._handleSettingsChange)}getFirstDayOfWeek(){return this.weekStart===void 0?this.settingsStore?.getState()?.weekStart??1:this.weekStart}static{this.styles=g`
========
        `}};A([o({type:Object})],Un.prototype,`date`,void 0),A([o({type:Array})],Un.prototype,`events`,void 0),Un=A([p(`calendar-day-view`)],Un);var Wn=class extends d{constructor(...e){super(...e),this.events=[],this.weekStart=1}getFirstDayOfWeek(){return this.weekStart??1}static{this.styles=g`
>>>>>>>> main:frontend/dist/assets/index-CCMQIZxV.js
        :host {
            display: flex;
            height: 100%;
    ...
    `}getWeekDays(){let e=[],t=this.getFirstDayOfWeek(),n=Ft(this.date,t);for(let t=0;t<7;t++)e.push(new Date(n)),n.setDate(n.getDate()+1);return e}render(){return n`
            <calendar-time-grid 
            ...
            ></calendar-time-grid>
<<<<<<<< HEAD:frontend/dist/assets/index-BHV7B3Zq.js
        `}};A([h({context:C})],Gn.prototype,`i18nStore`,void 0),A([h({context:w})],Gn.prototype,`settingsStore`,void 0),A([o({type:Object})],Gn.prototype,`date`,void 0),A([o({type:Array})],Gn.prototype,`events`,void 0),A([o({type:Number})],Gn.prototype,`weekStart`,void 0),Gn=A([p(`calendar-week-view`)],Gn);var Kn=class extends d{constructor(...e){super(...e),this.events=[],this._handleSettingsChange=()=>{this.requestUpdate()}}connectedCallback(){super.connectedCallback(),this.settingsStore?.addEventListener(`change`,this._handleSettingsChange)}disconnectedCallback(){super.disconnectedCallback(),this.settingsStore?.removeEventListener(`change`,this._handleSettingsChange)}getFirstDayOfWeek(){return this.weekStart===void 0?this.settingsStore?.getState()?.weekStart??1:this.weekStart}static{this.styles=g`
========
        `}};A([h({context:S}),o({attribute:!1})],Wn.prototype,`i18nStore`,void 0),A([o({type:Object})],Wn.prototype,`date`,void 0),A([o({type:Array})],Wn.prototype,`events`,void 0),A([o({type:Number})],Wn.prototype,`weekStart`,void 0),Wn=A([p(`calendar-week-view`)],Wn);var Gn=class extends d{constructor(...e){super(...e),this.events=[],this.weekStart=1}getFirstDayOfWeek(){return this.weekStart??1}static{this.styles=g`
>>>>>>>> main:frontend/dist/assets/index-CCMQIZxV.js
        :host {
            display: flex;
            flex-direction: column;
    ...
    `}getMonthGrid(){let e=this.date.getFullYear(),t=this.date.getMonth(),n=this.getFirstDayOfWeek(),r=(new Date(e,t,1).getDay()-n+7)%7,i=1-r,a=new Date(e,t+1,0).getDate(),o=Math.ceil((a+r)/7)*7,s=[];for(let n=0;n<o;n++)s.push(new Date(e,t,i+n));return s}getEventsForDate(e,t){return this.events?this.events.filter(n=>{let r=jt(n);if(t!==r)return!1;let i=new Date(e);i.setHours(0,0,0,0);let a=new Date(e);if(a.setHours(23,59,59,999),r){let e=n.start.split(`T`)[0],t=n.end.split(`T`)[0],r=new Date(e+`T00:00:00`),a=new Date(t+`T00:00:00`);return r<=i&&a>i}else{let e=new Date(n.start),t=new Date(n.end);return t.getTime()===i.getTime()&&e.getTime()<t.getTime()?!1:e<=a&&t>=i}}):[]}handleCellClick(e){this.dispatchEvent(new CustomEvent(`create-event`,{detail:{date:e,allDay:!0},bubbles:!0,composed:!0}))}render(){let e=this.getMonthGrid(),t=this.getFirstDayOfWeek(),r=Array.from({length:7},(e,n)=>{let r=(t+n)%7;return this.i18nStore?.t(`calendar.daysShort.${r}`)}),i=new Date;return i.setHours(0,0,0,0),n`
            <div class="month-view">
                <div class="month-header">
                    ${r.map(e=>n`<div class="month-header-cell">${e}</div>`)}
                </div>
                <div class="month-grid">
                    ${e.map(e=>{let t=e.getMonth()!==this.date.getMonth(),r=e.getTime()===i.getTime(),a=this.getEventsForDate(e,!0).concat(this.getEventsForDate(e,!1));return n`
                            <div class="month-cell ${t?`other-month`:``}" @click=${()=>this.handleCellClick(e)} style="cursor: pointer;">
                                ...
                                ${a.slice(0,4).map(e=>n`
                                    <alps-popup align="left" position="bottom" style="width: 100%; display: block;" @click=${e=>e.stopPropagation()}>
                                        <div slot="trigger"
                                            class="event-chip ${jt(e)?`all-day`:``} ${e.task?`task`:``} ${e.status===`declined`?`declined`:``}" 
                                            style=${e.task?`border-color: ${e.color}`:e.color?`background-color: ${e.color}`:``}
                                            title="${e.summary||this.i18nStore?.t(`calendar.noTitle`)}">
                                            ${e.task?k(`checkCircle`):``}${e.summary||this.i18nStore?.t(`calendar.noTitle`)}
                                        </div>
...
<<<<<<<< HEAD:frontend/dist/assets/index-BHV7B3Zq.js
        `}};A([h({context:C})],Kn.prototype,`i18nStore`,void 0),A([h({context:w})],Kn.prototype,`settingsStore`,void 0),A([o({type:Object})],Kn.prototype,`date`,void 0),A([o({type:Array})],Kn.prototype,`events`,void 0),A([o({type:Number})],Kn.prototype,`weekStart`,void 0),Kn=A([p(`calendar-month-view`)],Kn);var qn=class extends d{constructor(...e){super(...e),this.events=[]}static{this.styles=g`
========
        `}};A([h({context:S})],Gn.prototype,`i18nStore`,void 0),A([o({type:Object})],Gn.prototype,`date`,void 0),A([o({type:Array})],Gn.prototype,`events`,void 0),A([o({type:Number})],Gn.prototype,`weekStart`,void 0),Gn=A([p(`calendar-month-view`)],Gn);var Kn=class extends d{constructor(...e){super(...e),this.events=[]}static{this.styles=g`
>>>>>>>> main:frontend/dist/assets/index-CCMQIZxV.js
        :host {
            display: flex;
            height: 100%;
    ...
    `}render(){return n`
        ...
        `}};A([o({type:Number})],qn.prototype,`year`,void 0),A([o({type:Array})],qn.prototype,`events`,void 0),A([o({type:Number})],qn.prototype,`weekStart`,void 0),qn=A([p(`calendar-year-view`)],qn);var Jn=class extends d{constructor(...e){super(...e),this.events=[]}static{this.styles=g`
        :host {
            display: flex;
            flex-direction: column;
            width: 100%;
    ...
    `}render(){return this.events.length===0?n`
            ...
            `:n`
            <div class="list-container">
                ${[...this.events].sort((e,t)=>new Date(e.start).getTime()-new Date(t.start).getTime()).map(e=>{let t=jt(e),r=t?new Date(e.start.split(`T`)[0]+`T00:00:00`):new Date(e.start);return n`
                        <alps-popup align="left" position="bottom" style="width: 100%; display: block;" @click=${e=>e.stopPropagation()}>
        ...
        `}};A([h({context:C})],Jn.prototype,`i18nStore`,void 0),A([o({type:Array})],Jn.prototype,`events`,void 0),Jn=A([p(`calendar-list-view`)],Jn);var Yn=class extends d{constructor(...e){super(...e),this.selectedDate=new Date,this.events=[],this.viewDate=new Date}static{this.styles=g`
        :host {
            display: flex;
            flex-direction: column;
            width: 100%;
    ...
    `}updated(e){e.has(`selectedDate`)&&this.selectedDate&&(this.viewDate=new Date(this.selectedDate))}changeMonth(e){this.viewDate=new Date(this.viewDate.getFullYear(),this.viewDate.getMonth()+e,1)}render(){let e=this.viewDate.getFullYear(),t=this.viewDate.getMonth();return n`
        ...
        `}};A([h({context:C})],Yn.prototype,`i18nStore`,void 0),A([o({type:Object})],Yn.prototype,`selectedDate`,void 0),A([o({type:Array})],Yn.prototype,`events`,void 0),A([o({type:Number})],Yn.prototype,`weekStart`,void 0),A([a()],Yn.prototype,`viewDate`,void 0),Yn=A([p(`alps-sidebar-calendar`)],Yn);var Xn=class extends d{constructor(...e){super(...e),this._handleI18nChange=()=>this.requestUpdate(),this.label=`Today`}static{this.styles=g`
        :host {
            display: inline-flex;
        }
    ...
    `}handlePrevious(){this.dispatchEvent(new CustomEvent(`previous`,{bubbles:!0,composed:!0}))}handleNext(){this.dispatchEvent(new CustomEvent(`next`,{bubbles:!0,composed:!0}))}handleCenter(){this.dispatchEvent(new CustomEvent(`center`,{bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this.i18nStore?.addEventListener(`change`,this._handleI18nChange)}disconnectedCallback(){super.disconnectedCallback(),this.i18nStore?.removeEventListener(`change`,this._handleI18nChange)}render(){return n`
        ...
        `}};A([h({context:C})],Xn.prototype,`i18nStore`,void 0),A([o({type:String})],Xn.prototype,`label`,void 0),Xn=A([p(`alps-nav-buttons`)],Xn);var Zn=class extends d{constructor(...e){super(...e),this.title=`Prompt`,this.fields=[],this.confirmText=``,this.cancelText=``,this.busy=!1,this.values={},this.seededFrom=null,this.submitted=!1}static{this.styles=[xn,g`
      .field-group {
        margin-bottom: 16px;
      }
...
<<<<<<<< HEAD:frontend/dist/assets/index-BHV7B3Zq.js
    `}};A([h({context:C})],Zn.prototype,`i18nStore`,void 0),A([o({type:String})],Zn.prototype,`title`,void 0),A([o({type:Array})],Zn.prototype,`fields`,void 0),A([o({type:String})],Zn.prototype,`confirmText`,void 0),A([o({type:String})],Zn.prototype,`cancelText`,void 0),A([o({type:Boolean})],Zn.prototype,`busy`,void 0),A([a()],Zn.prototype,`values`,void 0),A([a()],Zn.prototype,`submitted`,void 0),Zn=A([p(`ui-prompt`)],Zn);var Qn=250,$n=150,er=500,tr=120,nr=`alps.calendar.showTasks`;function rr(){try{return localStorage.getItem(nr)!==`false`}catch{return!0}}function ir(e){try{localStorage.setItem(nr,String(e))}catch{}}var P=class extends d{constructor(...e){super(...e),this.calendars=[],this.events=[],this.currentDate=new Date,this.viewMode=`month`,this.loading=!0,this.isSpinning=!1,this.modalOpen=!1,this.activeCalendars=new Set,this.showTasks=rr(),this.taskModalOpen=!1,this.searchQuery=``,this.sidebarWidth=250,this.sidebarCollapsed=!1,this.isSidebarHovered=!1,this.isMobile=window.innerWidth<=768,this.mobileSidebarOpen=!1,this.promptOpen=!1,this.promptFields=[{id:`name`,label:`Calendar Name`,autofocus:!0}],this.syncIntervalTimer=null,this.promptMode=null,this.promptTarget=null,this.calendarToDelete=null,this.eventToDelete=null,this.scheduling=`email`,this.activeKebabMenu=null,this.hoverTimeout=null,this.suppressSidebarHover=!1,this.isSidebarDragging=!1,this._handleSettingsChange=()=>{if(this.settingsStore){let e=this.settingsStore.getState();if(this.sidebarCollapsed=e.sidebarCollapsed,this.syncIntervalTimer&&=(clearInterval(this.syncIntervalTimer),null),e.checkMailInterval&&e.checkMailInterval>0){let t=e.checkMailInterval*60*1e3;this.syncIntervalTimer=setInterval(()=>{this.fetchData()},t)}this.requestUpdate()}},this.handleHashChange=()=>{this.parseHash()&&this.fetchData()},this.handleResize=()=>{this.isMobile=window.innerWidth<=768},this.handleSpinIteration=()=>{this.loading||(this.isSpinning=!1)}}static{this.styles=[hn,Dn,g`
========
    `}};A([h({context:S})],Xn.prototype,`i18nStore`,void 0),A([o({type:String})],Xn.prototype,`title`,void 0),A([o({type:Array})],Xn.prototype,`fields`,void 0),A([o({type:String})],Xn.prototype,`confirmText`,void 0),A([o({type:String})],Xn.prototype,`cancelText`,void 0),A([o({type:Boolean})],Xn.prototype,`busy`,void 0),A([a()],Xn.prototype,`values`,void 0),A([a()],Xn.prototype,`submitted`,void 0),Xn=A([p(`ui-prompt`)],Xn);var Zn=250,Qn=150,$n=500,er=120,tr=`alps.calendar.showTasks`;function nr(){try{return localStorage.getItem(tr)!==`false`}catch{return!0}}function rr(e){try{localStorage.setItem(tr,String(e))}catch{}}var P=class extends d{constructor(...e){super(...e),this.calendars=[],this.events=[],this.currentDate=new Date,this.viewMode=`month`,this.loading=!0,this.isSpinning=!1,this.modalOpen=!1,this.activeCalendars=new Set,this.showTasks=nr(),this.taskModalOpen=!1,this.searchQuery=``,this.sidebarWidth=250,this.sidebarCollapsed=!1,this.isSidebarHovered=!1,this.isMobile=window.innerWidth<=768,this.mobileSidebarOpen=!1,this.promptOpen=!1,this.promptFields=[{id:`name`,label:`Calendar Name`,autofocus:!0}],this.syncIntervalTimer=null,this.promptMode=null,this.promptTarget=null,this.calendarToDelete=null,this.eventToDelete=null,this.scheduling=`email`,this.activeKebabMenu=null,this.hoverTimeout=null,this.suppressSidebarHover=!1,this.isSidebarDragging=!1,this._lastWeekStart=1,this._handleSettingsChange=()=>{if(this.settingsStore){let e=this.settingsStore.getState();this.sidebarCollapsed=e.sidebarCollapsed;let t=this.getFirstDayOfWeek(),n=t!==this._lastWeekStart;if(this._lastWeekStart=t,this.syncIntervalTimer&&=(clearInterval(this.syncIntervalTimer),null),e.checkMailInterval&&e.checkMailInterval>0){let t=e.checkMailInterval*60*1e3;this.syncIntervalTimer=setInterval(()=>{this.fetchData()},t)}n&&this.viewMode===`week`&&this.fetchData(),this.requestUpdate()}},this.handleHashChange=()=>{this.parseHash()&&this.fetchData()},this.handleResize=()=>{this.isMobile=window.innerWidth<=768},this.handleSpinIteration=()=>{this.loading||(this.isSpinning=!1)}}static{this.styles=[mn,En,g`
>>>>>>>> main:frontend/dist/assets/index-CCMQIZxV.js
        :host {
            display: flex;
            flex-direction: column;
...
>>>>>>>> main:frontend/dist/assets/index-CCMQIZxV.js
            ...
            <div class="app-container ${this.sidebarCollapsed&&!this.isMobile?`collapsed`:``} ${this.isSidebarDragging?`dragging`:``}" style="${!this.sidebarCollapsed&&!this.isMobile?`--sidebar-width: ${this.sidebarWidth}px;`:``}">
                <div class="layout">
                    <alps-sidebar 
                        ...
                        @sidebar-resize=${e=>{let t=e.detail.newWidth;t<tr?(this.sidebarCollapsed||(this.sidebarCollapsed=!0,this.settingsStore&&this.settingsStore.updateSettings({sidebarCollapsed:!0})),this.sidebarWidth=Qn):(this.sidebarCollapsed&&(this.sidebarCollapsed=!1,this.settingsStore&&this.settingsStore.updateSettings({sidebarCollapsed:!1})),this.sidebarWidth=Math.min(Math.max(t,$n),er))}}
                                    ...
                                    ${this.calendars.map(e=>n`
                                        <div class="calendar-item" @click=${()=>this.toggleCalendar(e.path)}>
                                            <div class="calendar-checkbox ${this.activeCalendars.has(e.path)?`checked`:``}" style="--cal-color: ${e.color}">
                                                ${this.activeCalendars.has(e.path)?k(`check`):``}
                                            </div>
                                            <span>${e.name}</span>
                                            ...
                                            <div class="calendar-actions ${this.activeKebabMenu===e.path?`popup-open`:``}" @click=${e=>e.stopPropagation()}>
                                                ...
                                                >
                                                    ...
                                                    <button class="dropdown-item" @click=${t=>{let n=t.target.closest(`alps-popup`);n&&n.close(),this.handleRenameCalendar(e)}}>
                                                        ${k(`pen`)} <span class="item-text">${this.i18nStore?.t(`calendar.rename`)}</span>
                                                    </button>
                                                    ${this.calendars.length>1&&!(e.path===`default`||e.path.endsWith(`/default`)||e.path.endsWith(`/default/`))?n`
                                                        <button class="dropdown-item text-danger" @click=${t=>{let n=t.target.closest(`alps-popup`);n&&n.close(),this.handleDeleteCalendar(e)}}>
                                                            ${k(`trash`)} <span class="item-text">${this.i18nStore?.t(`calendar.delete`)}</span>
                                                        </button>
                                                    `:``}
                                                </alps-popup>
                                            </div>
            ...
            ${this.eventToDelete&&(this.eventToDelete.task?Dt(this.eventToDelete.task,this.scheduling):Ot(this.eventToDelete,this.scheduling))?n`
                <ui-confirm
            ...
            `:this.eventToDelete?n`
                ...
                ></ui-confirm>
            `:``}
        `}};A([h({context:C})],P.prototype,`i18nStore`,void 0),A([h({context:w})],P.prototype,`settingsStore`,void 0),A([a()],P.prototype,`calendars`,void 0),A([a()],P.prototype,`events`,void 0),A([a()],P.prototype,`currentDate`,void 0),A([a()],P.prototype,`viewMode`,void 0),A([a()],P.prototype,`loading`,void 0),A([a()],P.prototype,`isSpinning`,void 0),A([a()],P.prototype,`modalOpen`,void 0),A([a()],P.prototype,`selectedEvent`,void 0),A([a()],P.prototype,`initialDate`,void 0),A([a()],P.prototype,`initialAllDay`,void 0),A([a()],P.prototype,`activeCalendars`,void 0),A([a()],P.prototype,`showTasks`,void 0),A([a()],P.prototype,`taskModalOpen`,void 0),A([a()],P.prototype,`editingTask`,void 0),A([a()],P.prototype,`searchQuery`,void 0),A([a()],P.prototype,`sidebarWidth`,void 0),A([a()],P.prototype,`sidebarCollapsed`,void 0),A([a()],P.prototype,`isSidebarHovered`,void 0),A([a()],P.prototype,`isMobile`,void 0),A([a()],P.prototype,`mobileSidebarOpen`,void 0),A([a()],P.prototype,`promptOpen`,void 0),A([a()],P.prototype,`promptFields`,void 0),A([a()],P.prototype,`promptMode`,void 0),A([a()],P.prototype,`promptTarget`,void 0),A([a()],P.prototype,`calendarToDelete`,void 0),A([a()],P.prototype,`eventToDelete`,void 0),A([a()],P.prototype,`scheduling`,void 0),A([a()],P.prototype,`activeKebabMenu`,void 0),A([a()],P.prototype,`suppressSidebarHover`,void 0),A([a()],P.prototype,`isSidebarDragging`,void 0),P=A([p(`calendar-page`)],P);var ar=class extends d{constructor(...e){super(...e),this.text=``,this.fullHeight=!1}static{this.styles=g`
    :host {
      display: inline-flex;
      align-items: center;
      justify-content: center;
  ...
  `}render(){return n`
      <div class="spinner">${k(`edelweiss`)}</div>
      ${this.text?n`<span>${this.text}</span>`:``}
    `}};A([o({type:String})],ar.prototype,`text`,void 0),A([o({type:Boolean,attribute:`full-height`})],ar.prototype,`fullHeight`,void 0),ar=A([p(`alps-loader`)],ar);var or={overdue:`tasks.groups.overdue`,today:`tasks.groups.today`,week:`tasks.groups.week`,undated:`tasks.groups.undated`,later:`tasks.groups.later`,completed:`tasks.groups.completed`},sr={high:`tasks.priorities.high`,medium:`tasks.priorities.medium`,low:`tasks.priorities.low`},cr={high:`!!!`,medium:`!!`,low:`!`},lr=class extends d{constructor(...e){super(...e),this.tasks=[],this.pendingPaths=new Set,this.settling=new Set,this.searching=!1,this.loading=!1,this.focusedIndex=-1}static{this.styles=g`
        :host {
            display: flex;
            flex-direction: column;
            flex: 1;
    ...
    `}groups(){let e=this.now??new Date,t=new Map;for(let n of this.tasks){let r=this.settling.has(n.path)?mt({...n,status:`needs-action`},e):mt(n,e),i=t.get(r);i?i.push(n):t.set(r,[n])}for(let[e,n]of t)n.sort(e===`completed`?_t:gt);return pt.filter(e=>t.has(e)).map(e=>[e,t.get(e)])}toggle(e){this.pendingPaths.has(e.path)||this.dispatchEvent(new CustomEvent(`toggle-complete`,{detail:{task:e,done:e.status!==`completed`}}))}open(e){this.dispatchEvent(new CustomEvent(`open-task`,{detail:{task:e}}))}handleKeyDown(e){if(e.target!==e.currentTarget)return;let t=this.groups().flatMap(([,e])=>e);if(t.length===0)return;let n=Math.min(this.focusedIndex,t.length-1);switch(e.key){case`ArrowDown`:this.focusedIndex=Math.min(t.length-1,n+1);break;case`ArrowUp`:this.focusedIndex=Math.max(0,n-1);break;case`Home`:this.focusedIndex=0;break;case`End`:this.focusedIndex=t.length-1;break;case`Enter`:if(n<0)return;e.preventDefault(),this.open(t[n]);return;case` `:if(n<0)return;e.preventDefault(),this.toggle(t[n]);return;default:return}e.preventDefault(),this.updateComplete.then(()=>{this.renderRoot.querySelector(`.row.focused`)?.scrollIntoView?.({block:`nearest`})})}renderRow(e,t,r){let i=e=>this.i18nStore?.t(e)??e,a=e.status===`completed`,o=e.status===`cancelled`,s=vt(e.priority),c=this.now??new Date;return n`
            ...
            >
                ...
                <div class="body">
                    ...
                    <div class="meta">
                        ...
                        ${e.due?n`<span class="due ${r===`overdue`?`overdue`:``}">${bt(e,c,i(`tasks.today`),yt(this.i18nStore?.getLanguage?.()))}</span>`:``}
                        ${e.rrule?n`<span class="repeats" role="img" aria-label=${i(`tasks.repeats`)} title=${i(`tasks.repeats`)}>${k(`arrowsClockwise`)}</span>`:``}
                        ...
                        ${s?n`<span class="priority ${s}" role="img" aria-label=${i(sr[s])} title=${i(sr[s])}>${cr[s]}</span>`:``}
                    </div>
                </div>
            </div>
        `}render(){if(this.loading&&this.tasks.length===0)return n`<div class="empty"><alps-loader></alps-loader></div>`;let e=this.groups();if(e.length===0)return n`<div class="empty">${this.i18nStore?.t(this.searching?`tasks.noResults`:`tasks.noTasks`)}</div>`;let t=-1;return n`
            <div class="scroll" tabindex="0" @keydown=${this.handleKeyDown}>
                ${e.map(([e,r])=>n`
                        <div class="group ${e}">${this.i18nStore?.t(or[e])}</div>
                        ${f(r,e=>e.path,n=>this.renderRow(n,++t,e))}
                    `)}
            </div>
        `}};A([h({context:C})],lr.prototype,`i18nStore`,void 0),A([o({type:Array})],lr.prototype,`tasks`,void 0),A([o({attribute:!1})],lr.prototype,`pendingPaths`,void 0),A([o({attribute:!1})],lr.prototype,`settling`,void 0),A([o({type:Boolean})],lr.prototype,`searching`,void 0),A([o({type:Boolean})],lr.prototype,`loading`,void 0),A([o({attribute:!1})],lr.prototype,`now`,void 0),A([a()],lr.prototype,`focusedIndex`,void 0),lr=A([p(`tasks-list`)],lr);var ur=250,dr=150,fr=500,pr=120,mr=[{id:`all`,icon:`listBullets`,label:`tasks.allTasks`},{id:`today`,icon:`calendarBlank`,label:`tasks.today`},{id:`upcoming`,icon:`calendar`,label:`tasks.upcoming`},{id:`undated`,icon:`tray`,label:`tasks.undated`},{id:`completed`,icon:`checkCircle`,label:`tasks.completed`}],F=class extends d{constructor(...e){super(...e),this.tasks=[],this.lists=[],this.selectedList=`all`,this.selectedCalendar=``,this.searchQuery=``,this.loading=!0,this.loadedScope=``,this.pendingPaths=new Set,this.settling=new Set,this.modalOpen=!1,this.taskToDelete=null,this.scheduling=`email`,this.isSpinning=!1,this.listPromptOpen=!1,this.sidebarWidth=ur,this.sidebarCollapsed=!1,this.isSidebarHovered=!1,this.suppressSidebarHover=!1,this.isSidebarDragging=!1,this.isMobile=window.innerWidth<=768,this.mobileSidebarOpen=!1,this.syncTimer=null,this.readEpoch=0,this.mutationEpoch=0,this.handleSettingsChange=()=>{if(!this.settingsStore)return;let e=this.settingsStore.getState();this.sidebarCollapsed=e.sidebarCollapsed,this.syncTimer&&=(clearInterval(this.syncTimer),null),e.checkMailInterval&&e.checkMailInterval>0&&(this.syncTimer=setInterval(()=>void this.fetchTasks(),e.checkMailInterval*60*1e3))},this.handleResize=()=>{this.isMobile=window.innerWidth<=768},this.handleHashChange=()=>{this.parseHash()&&this.fetchTasks()}}static{this.styles=[hn,g`
            :host {
                display: flex;
                flex-direction: column;
                width: 100%;
        ...
        `]}connectedCallback(){super.connectedCallback(),window.addEventListener(`resize`,this.handleResize),window.addEventListener(`hashchange`,this.handleHashChange),this.settingsStore&&(this.settingsStore.addEventListener(`change`,this.handleSettingsChange),this.handleSettingsChange()),this.parseHash(),this.fetchTasks()}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener(`resize`,this.handleResize),window.removeEventListener(`hashchange`,this.handleHashChange),this.settingsStore?.removeEventListener(`change`,this.handleSettingsChange),this.syncTimer&&=(clearInterval(this.syncTimer),null),clearTimeout(this.hoverTimeout)}get wantedScope(){return this.searchQuery?`all`:xt(this.selectedList)}parseHash(){let e=window.location.hash;if(!e.startsWith(`#/tasks`))return!1;let[t,n=``]=e.slice(1).split(`?`),r=t.split(`/`)[2]??``,i=new URLSearchParams(n),a=i.get(`list`)??``,o=i.get(`q`)??``;if(!mr.some(e=>e.id===r))return this.navigate(`all`,a,o),!1;let s=r;return(s!==this.selectedList||a!==this.selectedCalendar||o!==this.searchQuery)&&(this.settling=new Set),this.selectedList=s,this.selectedCalendar=a,this.searchQuery=o,this.wantedScope!==this.loadedScope}navigate(e,t=this.selectedCalendar,n=this.searchQuery){let r=new URLSearchParams;t&&r.set(`list`,t),n&&r.set(`q`,n);let i=r.toString(),a=`#/tasks/${e}${i?`?${i}`:``}`;window.location.hash!==a&&(window.location.hash=a)}async fetchTasks(){let e=++this.readEpoch,t=this.mutationEpoch,n=this.wantedScope;this.loading=!0,this.isSpinning=!0;try{let r=await Ct.fetchTasks(n===`all`?void 0:n);if(e!==this.readEpoch)return;if(t!==this.mutationEpoch){this.fetchTasks();return}this.lists=r.calendars.map(e=>({...e,color:At(e.path)})),this.tasks=r.tasks.map(e=>({...e,color:At(e.calendarPath)})),this.loadedScope=n,this.scheduling=r.scheduling===`server`?`server`:`email`,this.settling=new Set,r.failedCalendars>0&&this.toast(`tasks.someListsFailed`)}catch(t){if(e!==this.readEpoch)return;console.error(`Failed to load tasks`,t),this.failed(`tasks.loadFailed`,t)}finally{e===this.readEpoch&&(this.loading=!1)}}shows(e,t=new Date){if(this.selectedCalendar&&e.calendarPath!==this.selectedCalendar)return!1;let n=this.searchQuery.trim().toLowerCase();return n?e.title.toLowerCase().includes(n)||(e.description??``).toLowerCase().includes(n):St(e,this.selectedList,t)}get visibleTasks(){let e=new Date;return this.tasks.filter(t=>this.shows(t,e)||this.settling.has(t.path))}countFor(e){if(this.loadedScope!==`all`&&this.loadedScope!==xt(e))return null;let t=new Date;return this.tasks.filter(n=>(!this.selectedCalendar||n.calendarPath===this.selectedCalendar)&&St(n,e,t)).length}replaceTask(e,t){this.mutationEpoch++;let n={...t,color:At(t.calendarPath)};this.tasks=this.tasks.map(t=>t.path===e?n:t)}async handleToggleComplete(e,t){if(!this.pendingPaths.has(e.path)){this.pendingPaths=new Set(this.pendingPaths).add(e.path),this.settling=new Set(this.settling).add(e.path),this.replaceTask(e.path,{...e,status:t?`completed`:`needs-action`});try{let n=await Ct.completeTask(e.path,t,this.i18nStore?.getLanguage?.());this.replaceTask(e.path,n),n.sendFailed&&this.toast(`invitations.notTold`),t&&!dt(n)&&this.toast(`tasks.movedToNext`,{date:this.formatDue(n)})}catch(t){console.error(`Failed to update task`,t),this.replaceTask(e.path,e),this.failed(`tasks.completeFailed`,t)}finally{let t=new Set(this.pendingPaths);t.delete(e.path),this.pendingPaths=t}}}handleSaved(e){let{task:t,created:n}=e.detail;this.closeModal(),this.mutationEpoch++;let r={...t,color:At(t.calendarPath)};if(this.tasks=n?[r,...this.tasks]:this.tasks.map(e=>e.path===r.path?r:e),!this.shows(r))if(n){let e=this.selectedCalendar===r.calendarPath?this.selectedCalendar:``;this.navigate(dt(r)?`completed`:`all`,e,``)}else this.settling=new Set(this.settling).add(r.path)}async confirmDelete(e=!0){let t=this.taskToDelete;if(t){this.taskToDelete=null;try{(await Ct.deleteTask(t.path,{notify:e,lang:this.i18nStore?.getLanguage?.()}))?.sendFailed&&this.toast(`invitations.notTold`),this.mutationEpoch++,this.tasks=this.tasks.filter(e=>e.path!==t.path)}catch(e){console.error(`Failed to delete task`,e),this.failed(`tasks.deleteFailed`,e)}}}async handleListPromptSubmit(e){this.listPromptOpen=!1;let t=String(e.detail?.name??``).trim();if(t)try{await It.createCalendar(t),await this.fetchTasks()}catch(e){console.error(`Failed to create list`,e),this.failed(`tasks.createListFailed`,e)}}openCreate(){this.editingTask=void 0,this.modalOpen=!0,this.mobileSidebarOpen=!1}openEdit(e){this.editingTask=e,this.modalOpen=!0}closeModal(){this.modalOpen=!1,this.editingTask=void 0}selectList(e){this.mobileSidebarOpen=!1,this.navigate(e,this.selectedCalendar,``)}selectCalendar(e){this.mobileSidebarOpen=!1,this.navigate(this.selectedList,this.selectedCalendar===e?``:e,this.searchQuery)}formatDue(e){return bt(e,new Date,this.i18nStore?.t(`tasks.today`)??`Today`,yt(this.i18nStore?.getLanguage?.()))}failed(e,t){st(t)||this.toast(e)}toast(e,t){window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:this.i18nStore?.t(e,t),duration:5e3}}))}handleSidebarMouseEnter(){this.sidebarCollapsed&&!this.isSidebarDragging&&(clearTimeout(this.hoverTimeout),this.hoverTimeout=setTimeout(()=>{this.isSidebarHovered=!0,this.suppressSidebarHover=!1},300))}handleSidebarMouseLeave(){this.sidebarCollapsed&&(clearTimeout(this.hoverTimeout),this.isSidebarHovered=!1)}handleSidebarResize(e){let t=e.detail.newWidth,n=t<pr;n!==this.sidebarCollapsed&&(this.sidebarCollapsed=n,this.settingsStore?.updateSettings({sidebarCollapsed:n})),this.sidebarWidth=n?ur:Math.min(Math.max(t,dr),fr)}get username(){return this.settingsStore?.getState().loginUsername||``}render(){let e=e=>this.i18nStore?.t(e)??e,t=this.sidebarCollapsed&&(!this.isSidebarHovered||this.suppressSidebarHover)&&!this.isMobile,r=mr.find(e=>e.id===this.selectedList)??mr[0],i=this.lists.find(e=>e.path===this.selectedCalendar)?.name??``,a=this.selectedCalendar||this.lists[0]?.path||``;return n`
            <app-header
                currentTab="tasks"
                .username=${this.username}
                .isMobile=${this.isMobile}
                            ...
                            <div class="sidebar-content">
                                <div class="sidebar-scroll-content">
                                    <nav class="smart-lists">
                                        ${mr.map(t=>{let r=this.countFor(t.id);return n`
                                                <button
            ...
            ${this.taskToDelete&&Dt(this.taskToDelete,this.scheduling)?n`
                <ui-confirm
            ...
            `:``}
<<<<<<<< HEAD:frontend/dist/assets/index-BHV7B3Zq.js
        `}};A([h({context:C})],F.prototype,`i18nStore`,void 0),A([h({context:w})],F.prototype,`settingsStore`,void 0),A([a()],F.prototype,`tasks`,void 0),A([a()],F.prototype,`lists`,void 0),A([a()],F.prototype,`selectedList`,void 0),A([a()],F.prototype,`selectedCalendar`,void 0),A([a()],F.prototype,`searchQuery`,void 0),A([a()],F.prototype,`loading`,void 0),A([a()],F.prototype,`loadedScope`,void 0),A([a()],F.prototype,`pendingPaths`,void 0),A([a()],F.prototype,`settling`,void 0),A([a()],F.prototype,`modalOpen`,void 0),A([a()],F.prototype,`editingTask`,void 0),A([a()],F.prototype,`taskToDelete`,void 0),A([a()],F.prototype,`scheduling`,void 0),A([a()],F.prototype,`isSpinning`,void 0),A([a()],F.prototype,`listPromptOpen`,void 0),A([a()],F.prototype,`sidebarWidth`,void 0),A([a()],F.prototype,`sidebarCollapsed`,void 0),A([a()],F.prototype,`isSidebarHovered`,void 0),A([a()],F.prototype,`suppressSidebarHover`,void 0),A([a()],F.prototype,`isSidebarDragging`,void 0),A([a()],F.prototype,`isMobile`,void 0),A([a()],F.prototype,`mobileSidebarOpen`,void 0),F=A([p(`tasks-page`)],F);var hr=e({});v.registerRoute({path:`/calendar/*`,component:`calendar-page`,pluginId:`caldav`}),v.registerNavTab({id:`calendar`,pluginId:`caldav`,labelKey:`navigation.calendar`,icon:`calendar`,order:20}),v.registerRoute({path:`/tasks/*`,component:`tasks-page`,pluginId:`caldav`}),v.registerNavTab({id:`tasks`,pluginId:`caldav`,labelKey:`navigation.tasks`,icon:`checkCircle`,order:30}),v.registerHook(`reader:content`,e=>{let t=e?.message;if(!t||!jn(t.BodyStructure))return;let r=e.mailbox||t.Mailbox;!r||t.UID===void 0||(e.banners=e.banners||[],e.banners.push(n`<calendar-invitation-banner .mailbox=${r} .uid=${String(t.UID)}></calendar-invitation-banner>`))},`caldav`);function gr(e){let t=0;for(let n of e)n.status===`rejected`&&(t+=1,console.error(`Bulk contact operation failed for one item`,n.reason));return{total:e.length,done:e.length-t,failed:t}}var I=new class{async fetchContacts(e=``){let t=await E(e?`/contacts?query=${encodeURIComponent(e)}`:`/contacts`);if(!t.ok)throw Error(`Failed to fetch contacts: ${t.statusText}`);return t.json()}async fetchContact(e){let t=await E(`/contacts/${at(e)}`);if(!t.ok)throw Error(`Failed to fetch contact: ${t.statusText}`);return t.json()}async createContact(e){let t=await E(`/contacts/create`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)});if(!t.ok)throw new T(t.status,`Failed to create contact: ${t.statusText}`);return t.json()}async updateContact(e,t){let n=await E(`/contacts/${at(e)}/edit`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)});if(!n.ok)throw new T(n.status,`Failed to update contact: ${n.statusText}`);return n.json()}async updateCategories(e,t){let n=await E(`/contacts/${at(e)}/categories`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({categories:t})});if(!n.ok)throw new T(n.status,`Failed to update contact: ${n.statusText}`);return n.json()}async deleteContact(e){let t=await E(`/contacts/${at(e)}`,{method:`DELETE`});if(!t.ok)throw Error(`Failed to delete contact: ${t.statusText}`)}async bulkUpdateCategories(e){let t=e.filter(e=>e.path),n=await Promise.allSettled(t.map(e=>this.updateCategories(e.path,e.categories??[]))),r={};return n.forEach((e,n)=>{e.status===`fulfilled`&&e.value?.etag&&(r[t[n].path]=e.value.etag)}),{...gr(n),etags:r}}async bulkDeleteContacts(e){return gr(await Promise.allSettled(e.map(e=>this.deleteContact(e))))}},_r=`All Contacts`,vr=`Favorites`,yr=`alps_msg_`,br=1800*1e3,xr={get(e,t,n=`html`){try{let r=`${yr}${e}_${t}_${n}`,i=sessionStorage.getItem(r);if(!i)return null;let a=JSON.parse(i);return Date.now()-a.timestamp>br?(sessionStorage.removeItem(r),null):a}catch(e){return x.error(`Failed to read message cache`,e),null}},set(e,t,n,r){try{let i=`${yr}${e}_${t}_${n}`,a={...r,timestamp:Date.now()},o=JSON.stringify(a);if(o.length>2*1024*1024){console.warn(`Message ${t} is too large to cache (${Math.round(o.length/1024)}KB)`);return}sessionStorage.setItem(i,o)}catch(i){if(i instanceof DOMException&&(i.name===`QuotaExceededError`||i.code===22)){console.warn(`Session storage quota exceeded, clearing cache and retrying...`),this.clear();try{let i=`${yr}${e}_${t}_${n}`,a={...r,timestamp:Date.now()};sessionStorage.setItem(i,JSON.stringify(a))}catch(e){x.error(`Failed to write message cache even after clearing`,e)}}else x.error(`Failed to write message cache`,i)}},clear(){try{let e=[];for(let t=0;t<sessionStorage.length;t++){let n=sessionStorage.key(t);n&&n.startsWith(yr)&&e.push(n)}e.forEach(e=>sessionStorage.removeItem(e))}catch(e){x.error(`Failed to clear message cache`,e)}}},L=new class extends EventTarget{constructor(...e){super(...e),this.interval=null,this.currentMailbox=D,this.currentPage=0,this.currentQuery=``,this.listed=!1,this.currentFetchId=0,this.currentLabelsId=0}setContext(e,t,n=``){this.currentMailbox=e,this.currentPage=t,this.currentQuery=n}start(e=5){if(this.stop(),e<=0)return;let t=e*60*1e3;this.interval=setInterval(()=>void this.backgroundSync(),t)}stop(){this.interval&&=(clearInterval(this.interval),null)}mailboxRenamed(e,t){if(this.currentMailbox===e)this.currentMailbox=t;else if(this.currentMailbox.startsWith(e)){let n=this.currentMailbox.slice(e.length);/^[^A-Za-z0-9]/.test(n)&&(this.currentMailbox=t+n)}}mailboxDeleted(e){(this.currentMailbox===e||Zt(this.currentMailbox,e))&&(this.currentMailbox=D,this.currentPage=0,this.listed=!1)}sync(){this.fetch(this.currentMailbox,this.currentPage,this.currentQuery,!0,!0)}syncIfViewing(e){this.currentMailbox===e&&this.sync()}async syncLabels(){let e=++this.currentLabelsId;try{let t=await E(`/mailboxes`);if(this.currentLabelsId!==e)return;if(t.status===401){window.dispatchEvent(new CustomEvent(`auth-error`));return}if(!t.ok)throw Error(`HTTP ${t.status}`);let n=await t.json();if(this.currentLabelsId!==e||!n.Mailboxes)return;this.dispatchEvent(new CustomEvent(`labels-success`,{detail:{mailboxes:n.Mailboxes}}))}catch(e){x.error(`Failed to refresh folder list`,e)}}async fetch(e,t,n=``,r=!1,i=!1){this.setContext(e,t,n),this.listed=!1;let a=++this.currentFetchId;this.dispatchEvent(new CustomEvent(`sync-start`,{detail:{background:!1,quiet:i}}));let o=Date.now(),s=async()=>{if(i)return;let e=Date.now()-o;e<200&&await new Promise(t=>setTimeout(t,200-e))};try{let o=`/mailboxes/${O(e)}?page=${t}`;n&&(o+=`&query=${encodeURIComponent(n)}`),r&&(o+=`&refresh=true`);let c=await E(o);if(this.currentFetchId!==a)return;if(c.status===401){window.dispatchEvent(new CustomEvent(`auth-error`));return}if(c.status===404){this.dispatchEvent(new CustomEvent(`mailbox-not-found`));return}let l=await c.json();if(this.currentFetchId!==a||(await s(),this.currentFetchId!==a))return;this.listed=!0,this.dispatchEvent(new CustomEvent(`sync-success`,{detail:{data:l,background:!1,quiet:i}}))}catch(e){if(this.currentFetchId!==a||(x.error(`Failed to fetch mailbox data`,e),await s(),this.currentFetchId!==a))return;this.dispatchEvent(new CustomEvent(`sync-error`,{detail:{error:e,background:!1,quiet:i}}))}}async check(e,t,n=``){if(!(this.listed&&t===0&&this.currentPage===0&&e===this.currentMailbox&&n===this.currentQuery))return this.fetch(e,t,n,!0);this.dispatchEvent(new CustomEvent(`sync-start`,{detail:{background:!0}})),!await this.backgroundSync()&&this.dispatchEvent(new CustomEvent(`sync-error`,{detail:{error:null,background:!0}}))}async backgroundSync(){let e=++this.currentFetchId,t=this.currentMailbox,n=this.currentPage,r=this.currentQuery;try{if(t!==`INBOX`&&await E(`/mailboxes/${D}/status`).catch(()=>{}),this.currentFetchId!==e||(await E(`/mailboxes/${O(t)}/status`),this.currentFetchId!==e))return!0;let i=`/mailboxes/${O(t)}?page=${n}`;r&&(i+=`&query=${encodeURIComponent(r)}`);let a=await E(i);if(this.currentFetchId!==e)return!0;if(a.status===401)return window.dispatchEvent(new CustomEvent(`auth-error`)),!0;if(a.status===404)return this.dispatchEvent(new CustomEvent(`mailbox-not-found`)),!0;let o=await a.json();return this.currentFetchId===e&&this.dispatchEvent(new CustomEvent(`sync-success`,{detail:{data:o,background:!0}})),!0}catch(t){return this.currentFetchId===e?(x.error(`Background sync failed`,t),!1):!0}}},R=`\\Seen`,z=`\\Flagged`,Sr=`\\Answered`,Cr=`\\Deleted`,wr=`\\Draft`,Tr=`$Forwarded`,Er=`$MDNSent`,Dr=`Junk`,Or=`NonJunk`,kr=`NotJunk`,Ar=`$Junk`,jr=`$NotJunk`,Mr=`$Phishing`,Nr=`$SubmitPending`,Pr=`$Submitted`;function Fr(e,t){if(!e)return[];let n=new Set([R,z,Sr,Cr,wr,Tr,Er,Dr,Or,kr,Ar,jr,Mr,Nr,Pr].map(e=>e.toLowerCase())),r=[];for(let i of e)i.startsWith(`\\`)||n.has(i.toLowerCase())||r.push({id:i,name:Rr(i,t),color:zr(i)});return r.sort((e,t)=>{let n=e.id.toLowerCase().startsWith(`$label`),r=t.id.toLowerCase().startsWith(`$label`);return n&&!r?-1:!n&&r?1:e.id.localeCompare(t.id)})}var Ir=new Set([Tr,Er,Mr,Nr,Pr].map(e=>e.toLowerCase()));function Lr(e){return e?e.filter(e=>!e.startsWith(`\\`)&&!Ir.has(e.toLowerCase())):[]}function Rr(e,t){switch(e.toLowerCase()){case`$label1`:return t?.t(`tags.important`)||`Important`;case`$label2`:return t?.t(`tags.work`)||`Work`;case`$label3`:return t?.t(`tags.personal`)||`Personal`;case`$label4`:return t?.t(`tags.todo`)||`To Do`;case`$label5`:return t?.t(`tags.later`)||`Later`;default:return e}}function zr(e){switch(e.toLowerCase()){case`$label1`:return`#ef4444`;case`$label2`:return`#f97316`;case`$label3`:return`#22c55e`;case`$label4`:return`#3b82f6`;case`$label5`:return`#a855f7`;default:return Br(e)}}function Br(e){let t=0;for(let n=0;n<e.length;n++)t=e.charCodeAt(n)+((t<<5)-t);return`hsl(${Math.abs(t)%360}, 70%, 45%)`}function Vr(e){let t=[];for(let n=0;n<e.length;n+=500)t.push(e.slice(n,n+500));return t}async function Hr(e){try{return await e.json()??{}}catch{return{}}}var B=new class{isAuthError(e){return e.status===401?(window.dispatchEvent(new CustomEvent(`auth-error`)),!0):!1}async setFlag(e,t,n,r){if(!t||t.length===0)return{ok:!1,reason:`empty`};let i=0;try{for(let a of Vr(t)){let t=await E(`/mailboxes/${O(e)}/messages/flag`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify({uids:a,flags:n,action:r})});if(this.isAuthError(t))return{ok:!1,reason:`auth`,applied:i};if(!t.ok){let e=await Hr(t),n=e.error===`unsupported_flags`?`unsupported`:`failed`;return x.error(`Failed to set flag`,t.status,e),{ok:!1,reason:n,applied:i,rejected:e.rejected}}i+=a.length}return{ok:!0,applied:i}}catch(e){return x.error(`Failed to set flag`,e),{ok:!1,reason:`failed`,applied:i}}}matchingBody(e,t={}){return JSON.stringify({all:!0,query:e.query||``,except:e.except??[],...t})}countOf(e){return typeof e.count==`number`?e.count:0}async setFlagMatching(e,t,n,r){try{let i=await E(`/mailboxes/${O(e)}/messages/flag`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:this.matchingBody(t,{flags:n,action:r})});if(this.isAuthError(i))return{ok:!1,reason:`auth`};let a=await Hr(i);if(!i.ok){let e=a.error===`unsupported_flags`?`unsupported`:`failed`;return x.error(`Failed to set a flag on a folder`,i.status,a),{ok:!1,reason:e,rejected:a.rejected}}return L.sync(),{ok:!0,applied:this.countOf(a)}}catch(e){return x.error(`Failed to set a flag on a folder`,e),{ok:!1,reason:`failed`}}}async moveMatching(e,t,n){return this.fileMatching(`move`,e,t,n)}async copyMatching(e,t,n){return this.fileMatching(`copy`,e,t,n)}async fileMatching(e,t,n,r){try{let i=await E(`/mailboxes/${O(t)}/messages/${e}`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:this.matchingBody(n,{to:r})});if(this.isAuthError(i))return{success:!1,reason:`auth`};let a=await Hr(i);return i.ok?(L.sync(),{success:!0,uidMapping:a.uidMapping??{},count:this.countOf(a)}):(x.error(`Failed to ${e} a folder's messages`,i.status,a),{success:!1,reason:`failed`})}catch(t){return x.error(`Failed to ${e} a folder's messages`,t),{success:!1,reason:`failed`}}}async deleteMatchingResult(e,t){try{let n=await E(`/mailboxes/${O(e)}/messages`,{method:`DELETE`,headers:{"Content-Type":`application/json`},body:this.matchingBody(t)});if(this.isAuthError(n))return{ok:!1,reason:`auth`};let r=await Hr(n);return n.ok?(L.sync(),{ok:!0,count:this.countOf(r)}):(x.error(`Failed to delete a folder's messages`,n.status,r),{ok:!1,reason:`failed`})}catch(e){return x.error(`Failed to delete a folder's messages`,e),{ok:!1,reason:`failed`}}}async markAsRead(e,t){let n=t?.UID;if(!n||t.Flags?.includes(`\\Seen`))return t;let{ok:r}=await this.setFlag(e,[String(n)],[R],`add`);if(r){let e={...t};return e.Flags=[...e.Flags||[],R],e}return t}async deleteMessagesResult(e,t){if(!t||t.length===0)return{ok:!1,reason:`empty`};let n=0;try{for(let r of Vr(t)){let t=await E(`/mailboxes/${O(e)}/messages`,{method:`DELETE`,headers:{"Content-Type":`application/json`},body:JSON.stringify({uids:r})});if(this.isAuthError(t))return{ok:!1,reason:`auth`};if(!t.ok)return x.error(`Failed to delete messages`,t.status,await Hr(t)),n>0&&L.sync(),{ok:!1,reason:`failed`};n+=r.length}return L.sync(),{ok:!0}}catch(e){return x.error(`Failed to delete messages`,e),n>0&&L.sync(),{ok:!1,reason:`failed`}}}async deleteMessages(e,t){return(await this.deleteMessagesResult(e,t)).ok}async moveMessages(e,t,n){if(!t||t.length===0)return{success:!1,reason:`empty`};let r=0,i={};try{for(let a of Vr(t)){let t=await E(`/mailboxes/${O(e)}/messages/move`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify({uids:a,to:n})});if(this.isAuthError(t))return{success:!1,reason:`auth`};if(!t.ok)return x.error(`Failed to move messages`,t.status,await Hr(t)),r>0&&L.sync(),{success:!1,reason:`failed`};let o=await Hr(t);Object.assign(i,o.uidMapping??{}),r+=a.length}return L.sync(),{success:!0,uidMapping:i}}catch(e){return x.error(`Failed to move messages`,e),r>0&&L.sync(),{success:!1,reason:`failed`}}}async copyMessages(e,t,n){if(!t||t.length===0)return{success:!1,reason:`empty`};let r=0;try{for(let i of Vr(t)){let t=await E(`/mailboxes/${O(e)}/messages/copy`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify({uids:i,to:n})});if(this.isAuthError(t))return{success:!1,reason:`auth`};if(!t.ok)return x.error(`Failed to copy messages`,t.status,await Hr(t)),r>0&&L.sync(),{success:!1,reason:`failed`};r+=i.length}return L.sync(),{success:!0}}catch(e){return x.error(`Failed to copy messages`,e),r>0&&L.sync(),{success:!1,reason:`failed`}}}async markMessagesAsRead(e,t){if(!t||t.length===0)return!1;let{ok:n}=await this.setFlag(e,t,[R],`add`);return n}async markMessagesAsUnread(e,t){if(!t||t.length===0)return!1;let{ok:n}=await this.setFlag(e,t,[R],`remove`);return n}async saveDraft(e){try{let t=await E(`/messages`,{method:`POST`,body:e});if(t.status===401)return window.dispatchEvent(new CustomEvent(`auth-error`)),null;if(t.ok){let e=await t.json();return{uid:e.draft_uid,mailbox:e.draft_mailbox,size:e.draft_size,attachments:e.attachments}}return x.error(`Failed to save draft:`,t.status,await Hr(t)),null}catch(e){return x.error(`Failed to save draft:`,e),null}}async sendDraft(e){try{let t=await E(`/messages`,{method:`POST`,body:e});if(t.status===401)return window.dispatchEvent(new CustomEvent(`auth-error`)),!1;if(t.ok)return L.sync(),!0;let n=await Hr(t);throw Error(n.error||`Failed to send message (${t.status})`)}catch(e){throw x.error(`Failed to send message:`,e),e}}},Ur=`Attachments exceed the maximum allowed size.`,Wr=new Map;function Gr(){return globalThis.crypto?.randomUUID?.()??`${Date.now().toString(36)}-${Math.random().toString(36).slice(2)}`}function Kr(e){let t=Wr.get(e);t&&(t.abort(),Wr.delete(e))}function qr(e){for(let t of e)t.uploading&&t._tempId&&Kr(t._tempId)}async function Jr(e){try{await fetch(`/attachments/${e}`,{method:`DELETE`})}catch(e){x.error(`Failed to delete attachment from server:`,e)}}function Yr(e,t,n,r,i,a,o,s){let c=document.createElement(`input`);c.type=`file`,c.multiple=!0,c.onchange=c=>{let l=Array.from(c.target.files||[]);l.length!==0&&Xr(l,e,t,n,r,i,a,o,s)},c.click()}function Xr(e,t,n,r,i,a,o,s,c){let l=0;for(let t of e)l+=t.size;if(n>0&&r+l>n){window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:c||Ur,duration:5e3}}));return}for(let n of e){let e=Gr();i(e,n);let r=new FormData;r.append(`attachments`,n);let c=new XMLHttpRequest;Wr.set(e,c),c.open(`POST`,`/attachments?composer_id=${encodeURIComponent(t)}`,!0),c.upload.onprogress=t=>{t.lengthComputable&&a(e,Math.round(t.loaded/t.total*100))},c.onload=()=>{if(Wr.delete(e),c.status>=200&&c.status<300)try{let t=JSON.parse(c.responseText),n=Array.isArray(t)?t:t.uuids||[];n.length>0?o(e,n):s(e,Error(`No UUID returned from server`))}catch(t){s(e,t)}else try{let t=JSON.parse(c.responseText);s(e,Error(t.error||`Unknown error`))}catch{s(e,Error(`Upload failed with status `+c.status))}},c.onerror=()=>{Wr.delete(e),s(e,Error(`Network error during upload`))},c.onabort=()=>{Wr.delete(e)},c.send(r)}}function Zr(e){let t=[],n=(e,r)=>{if(e){if(e.ID){let n=Number(e.Size)||0;t.push({name:e.Extended?.Disposition?.Params?.filename||e.Params?.name||`image`,size:String(e.Encoding).toLowerCase()===`base64`?Math.floor(n*3/4):n,type:e.Type&&e.Subtype?`${e.Type}/${e.Subtype}`.toLowerCase():`application/octet-stream`,partPath:r||`1`,inline:!0})}Array.isArray(e.Children)&&e.Children.forEach((e,t)=>n(e,r?`${r}.${t+1}`:`${t+1}`))}};return n(e,``),t}function Qr(e,t){let n={},r=e?.Envelope?.MessageID||e?.Envelope?.MessageId;return r&&(n.inReplyTo=r,n.references=Array.isArray(e.References)?[...e.References]:[]),e?.UID!==void 0&&e?.UID!==null&&t&&(n.replyMailbox=t,n.replyUid=String(e.UID)),n}function $r(e,t){t.inReplyTo&&e.append(`in_reply_to`,t.inReplyTo),t.references?.length&&e.append(`references`,t.references.join(` `)),t.replyMailbox&&t.replyUid&&(e.append(`reply_mailbox`,t.replyMailbox),e.append(`reply_uid`,t.replyUid)),t.quoteSource?.mailbox&&t.quoteSource.uid&&(e.append(`source_mailbox`,t.quoteSource.mailbox),e.append(`source_uid`,t.quoteSource.uid))}var ei=e=>`alps_compose_drafts_${e}`,ti=`alps_compose_drafts`,ni=e=>{let t=e.trim();if(t.endsWith(`>`)){let e=t.lastIndexOf(`<`);e!==-1&&(t=t.substring(e+1,t.length-1))}return t.trim().toLowerCase()},ri=e=>{let t=ni(e);return t.startsWith(`noreply`)||t.startsWith(`no-reply`)||t.startsWith(`mailer-daemon`)},ii=e=>e&&e.filter(e=>!ri(e)),ai=class extends EventTarget{constructor(){super(),this.state={activeComposers:[]},this.saveTimeout=null,this.username=null,this.adoptSession=()=>{let e=Oe();if(e===this.username)return;let t=this.username===null?this.state.activeComposers:[];this.username=e;let n=e?this.loadDrafts(e):[];this.state.activeComposers=e?[...n,...t]:[],this.notify()},this.handleSessionCleared=e=>{this.saveTimeout!==null&&(window.clearTimeout(this.saveTimeout),this.saveTimeout=null);let t=e?.detail?.reason===`expired`;t&&this.saveDrafts();let n=this.username&&!t?ei(this.username):null;this.username=null;for(let e of this.state.activeComposers)qr(e.attachments||[]);if(this.state.activeComposers=[],this.notify(),n)try{localStorage.removeItem(n)}catch(e){x.error(`Failed to clear compose drafts`,e)}};try{localStorage.removeItem(ti)}catch{}window.addEventListener(`session-cleared`,this.handleSessionCleared),window.addEventListener(`user-logged-in`,this.adoptSession),window.addEventListener(`alps-active-user-changed`,this.adoptSession),this.adoptSession()}loadDrafts(e){try{let t=localStorage.getItem(ei(e));if(t)return JSON.parse(t).map(e=>{let t=e.isSending;return{...e,attachments:e.attachments?.filter(e=>!e.uploading&&e.uuid)||[],isSending:!1,minimized:t?!1:e.minimized}})}catch(e){x.error(`Failed to parse compose drafts from localStorage`,e)}return[]}saveDrafts(){if(this.username)try{localStorage.setItem(ei(this.username),JSON.stringify(this.state.activeComposers))}catch(e){x.error(`Failed to save compose drafts to localStorage`,e)}}debouncedSaveDrafts(){this.saveTimeout!==null&&window.clearTimeout(this.saveTimeout),this.saveTimeout=window.setTimeout(()=>{this.saveDrafts(),this.saveTimeout=null},500)}notify(){this.dispatchEvent(new CustomEvent(`change`))}get stateCopy(){return{...this.state}}getComposer(e){return this.state.activeComposers.find(t=>t.id===e)}getState(){return this.state}openComposer(e){if(e?.draftUid){let t=this.state.activeComposers.find(t=>t.draftUid===e.draftUid);if(t){this.bringComposerToFront(t.id),t.minimized&&this.updateComposer(t.id,{minimized:!1});return}}let t=window.innerWidth<=768;if(t&&this.state.activeComposers.length>=1){let e=this.state.activeComposers[0].id;this.bringComposerToFront(e);return}if(!t&&this.state.activeComposers.length>=3)return;let n=`composer_`+Date.now()+`_`+Math.random().toString(36).substr(2,5),r=`html`,i=``,a=ke();a.composeFormat===`text`&&(r=`text`),a.signature&&(i=a.signature);let o=e?.text||``,s=e?.html||``;if(i&&!e?.draftUid){let t=`-- \n${i}`,n=`<div class="alps-signature">-- <br>${i.replace(/\n/g,`<br>`)}</div>`;o=`\n\n${t}\n${o}`,s=s||e?.text?`<br><br>${n}${s}`:`<br><br>${n}`}let c={id:n,minimized:!1,expanded:!1,dirty:!1,subject:``,format:e?.format||r,attachments:[],zIndex:1e3+this.state.activeComposers.length,...e,to:ii(e?.to)||[],cc:ii(e?.cc)||[],bcc:ii(e?.bcc)||[],text:o,html:s,initialText:o,initialHtml:s};this.state={...this.state,activeComposers:[...this.state.activeComposers,c]},this.saveDrafts(),this.notify()}updateComposer(e,t){t.to&&=ii(t.to),t.cc&&=ii(t.cc),t.bcc&&=ii(t.bcc);let n=this.state.activeComposers.map(n=>{if(n.id!==e)return n;let r=!1;if(`subject`in t&&t.subject!==n.subject&&(r=!0),`to`in t&&JSON.stringify(t.to||[])!==JSON.stringify(n.to||[])&&(r=!0),`cc`in t&&JSON.stringify(t.cc||[])!==JSON.stringify(n.cc||[])&&(r=!0),`bcc`in t&&JSON.stringify(t.bcc||[])!==JSON.stringify(n.bcc||[])&&(r=!0),`attachments`in t&&t.attachments!==n.attachments&&(r=!0),!r&&!n.dirty){if(`text`in t||`html`in t){let e=`text`in t?t.text||``:n.text||``,i=n.initialText||``;e.trim()!==i.trim()&&(r=!0)}}else !r&&n.dirty;let i=`dirty`in t?t.dirty:r?!0:n.dirty;return{...n,...t,dirty:i}});this.state={...this.state,activeComposers:n},this.debouncedSaveDrafts(),this.notify()}closeComposer(e){this.state={...this.state,activeComposers:this.state.activeComposers.filter(t=>t.id!==e)},this.saveDrafts(),this.notify()}clearAllComposers(){this.state={...this.state,activeComposers:[]},this.notify()}async saveAllDirtyDrafts(){let e=0,t=this.state.activeComposers.filter(e=>e.dirty);if(t.length>0)for(let n of t){let t=(n.to?.length||0)>0||(n.cc?.length||0)>0||(n.bcc?.length||0)>0,r=n.text?.trim()!==n.initialText?.trim()||(n.subject?.trim().length||0)>0;if(!t&&!r&&!(n.attachments&&n.attachments.length>0))continue;let i=new FormData,a=[...n.bcc||[]],o=``;{let e=ke(),t=e.loginUsername;e.bccMyself&&t&&!a.some(e=>ni(e)===ni(t))&&a.push(t),e.replyTo&&(o=e.replyTo)}i.append(`to`,(n.to||[]).join(`, `)),i.append(`cc`,(n.cc||[]).join(`, `)),i.append(`bcc`,a.join(`, `)),o&&i.append(`reply_to`,o),i.append(`subject`,(n.subject||``).trim()),i.append(`text`,n.text||``),n.html&&n.format===`html`&&i.append(`html`,n.html),i.append(`save_as_draft`,`1`);let s=n.attachments||[],c=s.map(e=>e.uuid).filter(Boolean).join(`,`);c&&i.append(`attachment-uuids`,c);let l=s.map(e=>e.partPath).filter(Boolean).join(`,`);l&&i.append(`prev_attachments`,l),n.draftMailbox&&i.append(`draft_mailbox`,n.draftMailbox),n.draftUid&&i.append(`draft_uid`,n.draftUid),$r(i,n),await B.saveDraft(i)||e++}return this.state={...this.state,activeComposers:[]},this.saveDrafts(),this.notify(),{failed:e}}bringComposerToFront(e){let t=1e3;this.state.activeComposers.forEach(e=>{e.zIndex&&e.zIndex>t&&(t=e.zIndex)}),this.updateComposer(e,{zIndex:t+1})}},oi=u(`compose-store`),si=`alps-login-notice`;function ci(e){try{sessionStorage.setItem(si,e)}catch{}}function li(){try{let e=sessionStorage.getItem(si);return e&&sessionStorage.removeItem(si),e||null}catch{return null}}var ui=new class extends EventTarget{constructor(){super(),this.accounts=[],this.loading=!1,this.initialized=!1}getAccounts(){return this.accounts}isLoading(){return this.loading}isInitialized(){return this.initialized}async fetchAccounts(){this.loading=!0,this.dispatchEvent(new Event(`change`));try{let e=await fetch(`/accounts`);if(e.ok){let t=await e.json();this.accounts=t.accounts||[],this.initialized=!0}else x.error(`Failed to fetch linked accounts`)}catch(e){x.error(`Error fetching linked accounts:`,e)}finally{this.loading=!1,this.dispatchEvent(new Event(`change`))}}async addAccount(e,t,n=``){let r=new URLSearchParams;r.append(`username`,e),r.append(`password`,t),r.append(`display_name`,n);let i=await fetch(`/accounts`,{method:`POST`,headers:{"Content-Type":`application/x-www-form-urlencoded`},body:r.toString()});if(!i.ok){let e=await i.json().catch(()=>({}));throw Error(e.error||`Failed to add linked account`)}await this.fetchAccounts()}async removeAccount(e){let t=await fetch(`/accounts/${encodeURIComponent(e)}`,{method:`DELETE`});if(!t.ok){let e=await t.json().catch(()=>({}));throw Error(e.error||`Failed to remove linked account`)}await this.fetchAccounts()}async switchAccount(e){let t=new URLSearchParams;t.append(`username`,e);let n=await fetch(`/accounts/switch`,{method:`POST`,headers:{"Content-Type":`application/x-www-form-urlencoded`},body:t.toString()});if(!n.ok){let e=await n.json().catch(()=>({}));throw Error(e.error||`Failed to switch account`)}return await n.json()}},di=u(`alps-linked-accounts`),fi=class extends d{constructor(...e){super(...e),this.name=``,this.email=``,this.src=``,this.size=40,this.imageError=!1,this._handleStoreChange=()=>{this.requestUpdate()}}willUpdate(e){e.has(`src`)&&(this.imageError=!1)}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.settingsStore?.addEventListener(`change`,this._handleStoreChange)})}disconnectedCallback(){super.disconnectedCallback(),this.settingsStore?.removeEventListener(`change`,this._handleStoreChange)}static{this.styles=g`
========
        `}};A([h({context:S})],F.prototype,`i18nStore`,void 0),A([h({context:C})],F.prototype,`settingsStore`,void 0),A([a()],F.prototype,`tasks`,void 0),A([a()],F.prototype,`lists`,void 0),A([a()],F.prototype,`selectedList`,void 0),A([a()],F.prototype,`selectedCalendar`,void 0),A([a()],F.prototype,`searchQuery`,void 0),A([a()],F.prototype,`loading`,void 0),A([a()],F.prototype,`loadedScope`,void 0),A([a()],F.prototype,`pendingPaths`,void 0),A([a()],F.prototype,`settling`,void 0),A([a()],F.prototype,`modalOpen`,void 0),A([a()],F.prototype,`editingTask`,void 0),A([a()],F.prototype,`taskToDelete`,void 0),A([a()],F.prototype,`scheduling`,void 0),A([a()],F.prototype,`isSpinning`,void 0),A([a()],F.prototype,`listPromptOpen`,void 0),A([a()],F.prototype,`sidebarWidth`,void 0),A([a()],F.prototype,`sidebarCollapsed`,void 0),A([a()],F.prototype,`isSidebarHovered`,void 0),A([a()],F.prototype,`suppressSidebarHover`,void 0),A([a()],F.prototype,`isSidebarDragging`,void 0),A([a()],F.prototype,`isMobile`,void 0),A([a()],F.prototype,`mobileSidebarOpen`,void 0),F=A([p(`tasks-page`)],F);var mr=e({});v.registerRoute({path:`/calendar/*`,component:`calendar-page`,pluginId:`caldav`}),v.registerNavTab({id:`calendar`,pluginId:`caldav`,labelKey:`navigation.calendar`,icon:`calendar`,order:20}),v.registerRoute({path:`/tasks/*`,component:`tasks-page`,pluginId:`caldav`}),v.registerNavTab({id:`tasks`,pluginId:`caldav`,labelKey:`navigation.tasks`,icon:`checkCircle`,order:30}),v.registerHook(`reader:content`,e=>{let t=e?.message;if(!t||!An(t.BodyStructure))return;let r=e.mailbox||t.Mailbox;!r||t.UID===void 0||(e.banners=e.banners||[],e.banners.push(n`<calendar-invitation-banner .mailbox=${r} .uid=${String(t.UID)}></calendar-invitation-banner>`))},`caldav`);function hr(e){let t=0;for(let n of e)n.status===`rejected`&&(t+=1,console.error(`Bulk contact operation failed for one item`,n.reason));return{total:e.length,done:e.length-t,failed:t}}var I=new class{async fetchContacts(e=``){let t=await E(e?`/contacts?query=${encodeURIComponent(e)}`:`/contacts`);if(!t.ok)throw Error(`Failed to fetch contacts: ${t.statusText}`);return t.json()}async fetchContact(e){let t=await E(`/contacts/${w(e)}`);if(!t.ok)throw Error(`Failed to fetch contact: ${t.statusText}`);return t.json()}async createContact(e){let t=await E(`/contacts/create`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)});if(!t.ok)throw new T(t.status,`Failed to create contact: ${t.statusText}`);return t.json()}async updateContact(e,t){let n=await E(`/contacts/${w(e)}/edit`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)});if(!n.ok)throw new T(n.status,`Failed to update contact: ${n.statusText}`);return n.json()}async updateCategories(e,t){let n=await E(`/contacts/${w(e)}/categories`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({categories:t})});if(!n.ok)throw new T(n.status,`Failed to update contact: ${n.statusText}`);return n.json()}async deleteContact(e){let t=await E(`/contacts/${w(e)}`,{method:`DELETE`});if(!t.ok)throw Error(`Failed to delete contact: ${t.statusText}`)}async bulkUpdateCategories(e){let t=e.filter(e=>e.path),n=await Promise.allSettled(t.map(e=>this.updateCategories(e.path,e.categories??[]))),r={};return n.forEach((e,n)=>{e.status===`fulfilled`&&e.value?.etag&&(r[t[n].path]=e.value.etag)}),{...hr(n),etags:r}}async bulkDeleteContacts(e){return hr(await Promise.allSettled(e.map(e=>this.deleteContact(e))))}},gr=`All Contacts`,_r=`Favorites`,vr=`alps_msg_`,yr=1800*1e3,br={get(e,t,n=`html`){try{let r=`${vr}${e}_${t}_${n}`,i=sessionStorage.getItem(r);if(!i)return null;let a=JSON.parse(i);return Date.now()-a.timestamp>yr?(sessionStorage.removeItem(r),null):a}catch(e){return b.error(`Failed to read message cache`,e),null}},set(e,t,n,r){try{let i=`${vr}${e}_${t}_${n}`,a={...r,timestamp:Date.now()},o=JSON.stringify(a);if(o.length>2*1024*1024){console.warn(`Message ${t} is too large to cache (${Math.round(o.length/1024)}KB)`);return}sessionStorage.setItem(i,o)}catch(i){if(i instanceof DOMException&&(i.name===`QuotaExceededError`||i.code===22)){console.warn(`Session storage quota exceeded, clearing cache and retrying...`),this.clear();try{let i=`${vr}${e}_${t}_${n}`,a={...r,timestamp:Date.now()};sessionStorage.setItem(i,JSON.stringify(a))}catch(e){b.error(`Failed to write message cache even after clearing`,e)}}else b.error(`Failed to write message cache`,i)}},clear(){try{let e=[];for(let t=0;t<sessionStorage.length;t++){let n=sessionStorage.key(t);n&&n.startsWith(vr)&&e.push(n)}e.forEach(e=>sessionStorage.removeItem(e))}catch(e){b.error(`Failed to clear message cache`,e)}}},L=new class extends EventTarget{constructor(...e){super(...e),this.interval=null,this.currentMailbox=D,this.currentPage=0,this.currentQuery=``,this.listed=!1,this.currentFetchId=0,this.currentLabelsId=0}setContext(e,t,n=``){this.currentMailbox=e,this.currentPage=t,this.currentQuery=n}start(e=5){if(this.stop(),e<=0)return;let t=e*60*1e3;this.interval=setInterval(()=>void this.backgroundSync(),t)}stop(){this.interval&&=(clearInterval(this.interval),null)}mailboxRenamed(e,t){if(this.currentMailbox===e)this.currentMailbox=t;else if(this.currentMailbox.startsWith(e)){let n=this.currentMailbox.slice(e.length);/^[^A-Za-z0-9]/.test(n)&&(this.currentMailbox=t+n)}}mailboxDeleted(e){(this.currentMailbox===e||Xt(this.currentMailbox,e))&&(this.currentMailbox=D,this.currentPage=0,this.listed=!1)}sync(){this.fetch(this.currentMailbox,this.currentPage,this.currentQuery,!0,!0)}syncIfViewing(e){this.currentMailbox===e&&this.sync()}async syncLabels(){let e=++this.currentLabelsId;try{let t=await E(`/mailboxes`);if(this.currentLabelsId!==e)return;if(t.status===401){window.dispatchEvent(new CustomEvent(`auth-error`));return}if(!t.ok)throw Error(`HTTP ${t.status}`);let n=await t.json();if(this.currentLabelsId!==e||!n.Mailboxes)return;this.dispatchEvent(new CustomEvent(`labels-success`,{detail:{mailboxes:n.Mailboxes}}))}catch(e){b.error(`Failed to refresh folder list`,e)}}async fetch(e,t,n=``,r=!1,i=!1){this.setContext(e,t,n),this.listed=!1;let a=++this.currentFetchId;this.dispatchEvent(new CustomEvent(`sync-start`,{detail:{background:!1,quiet:i}}));let o=Date.now(),s=async()=>{if(i)return;let e=Date.now()-o;e<200&&await new Promise(t=>setTimeout(t,200-e))};try{let o=`/mailboxes/${O(e)}?page=${t}`;n&&(o+=`&query=${encodeURIComponent(n)}`),r&&(o+=`&refresh=true`);let c=await E(o);if(this.currentFetchId!==a)return;if(c.status===401){window.dispatchEvent(new CustomEvent(`auth-error`));return}if(c.status===404){this.dispatchEvent(new CustomEvent(`mailbox-not-found`));return}let l=await c.json();if(this.currentFetchId!==a||(await s(),this.currentFetchId!==a))return;this.listed=!0,this.dispatchEvent(new CustomEvent(`sync-success`,{detail:{data:l,background:!1,quiet:i}}))}catch(e){if(this.currentFetchId!==a||(b.error(`Failed to fetch mailbox data`,e),await s(),this.currentFetchId!==a))return;this.dispatchEvent(new CustomEvent(`sync-error`,{detail:{error:e,background:!1,quiet:i}}))}}async check(e,t,n=``){if(!(this.listed&&t===0&&this.currentPage===0&&e===this.currentMailbox&&n===this.currentQuery))return this.fetch(e,t,n,!0);this.dispatchEvent(new CustomEvent(`sync-start`,{detail:{background:!0}})),!await this.backgroundSync()&&this.dispatchEvent(new CustomEvent(`sync-error`,{detail:{error:null,background:!0}}))}async backgroundSync(){let e=++this.currentFetchId,t=this.currentMailbox,n=this.currentPage,r=this.currentQuery;try{if(t!==`INBOX`&&await E(`/mailboxes/${D}/status`).catch(()=>{}),this.currentFetchId!==e||(await E(`/mailboxes/${O(t)}/status`),this.currentFetchId!==e))return!0;let i=`/mailboxes/${O(t)}?page=${n}`;r&&(i+=`&query=${encodeURIComponent(r)}`);let a=await E(i);if(this.currentFetchId!==e)return!0;if(a.status===401)return window.dispatchEvent(new CustomEvent(`auth-error`)),!0;if(a.status===404)return this.dispatchEvent(new CustomEvent(`mailbox-not-found`)),!0;let o=await a.json();return this.currentFetchId===e&&this.dispatchEvent(new CustomEvent(`sync-success`,{detail:{data:o,background:!0}})),!0}catch(t){return this.currentFetchId===e?(b.error(`Background sync failed`,t),!1):!0}}},R=`\\Seen`,z=`\\Flagged`,xr=`\\Answered`,Sr=`\\Deleted`,Cr=`\\Draft`,wr=`$Forwarded`,Tr=`$MDNSent`,Er=`Junk`,Dr=`NonJunk`,Or=`NotJunk`,kr=`$Junk`,Ar=`$NotJunk`,jr=`$Phishing`,Mr=`$SubmitPending`,Nr=`$Submitted`;function Pr(e,t){if(!e)return[];let n=new Set([R,z,xr,Sr,Cr,wr,Tr,Er,Dr,Or,kr,Ar,jr,Mr,Nr].map(e=>e.toLowerCase())),r=[];for(let i of e)i.startsWith(`\\`)||n.has(i.toLowerCase())||r.push({id:i,name:Lr(i,t),color:Rr(i)});return r.sort((e,t)=>{let n=e.id.toLowerCase().startsWith(`$label`),r=t.id.toLowerCase().startsWith(`$label`);return n&&!r?-1:!n&&r?1:e.id.localeCompare(t.id)})}var Fr=new Set([wr,Tr,jr,Mr,Nr].map(e=>e.toLowerCase()));function Ir(e){return e?e.filter(e=>!e.startsWith(`\\`)&&!Fr.has(e.toLowerCase())):[]}function Lr(e,t){switch(e.toLowerCase()){case`$label1`:return t?.t(`tags.important`)||`Important`;case`$label2`:return t?.t(`tags.work`)||`Work`;case`$label3`:return t?.t(`tags.personal`)||`Personal`;case`$label4`:return t?.t(`tags.todo`)||`To Do`;case`$label5`:return t?.t(`tags.later`)||`Later`;default:return e}}function Rr(e){switch(e.toLowerCase()){case`$label1`:return`#ef4444`;case`$label2`:return`#f97316`;case`$label3`:return`#22c55e`;case`$label4`:return`#3b82f6`;case`$label5`:return`#a855f7`;default:return zr(e)}}function zr(e){let t=0;for(let n=0;n<e.length;n++)t=e.charCodeAt(n)+((t<<5)-t);return`hsl(${Math.abs(t)%360}, 70%, 45%)`}function Br(e){let t=[];for(let n=0;n<e.length;n+=500)t.push(e.slice(n,n+500));return t}async function Vr(e){try{return await e.json()??{}}catch{return{}}}var B=new class{isAuthError(e){return e.status===401?(window.dispatchEvent(new CustomEvent(`auth-error`)),!0):!1}async setFlag(e,t,n,r){if(!t||t.length===0)return{ok:!1,reason:`empty`};let i=0;try{for(let a of Br(t)){let t=await E(`/mailboxes/${O(e)}/messages/flag`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify({uids:a,flags:n,action:r})});if(this.isAuthError(t))return{ok:!1,reason:`auth`,applied:i};if(!t.ok){let e=await Vr(t),n=e.error===`unsupported_flags`?`unsupported`:`failed`;return b.error(`Failed to set flag`,t.status,e),{ok:!1,reason:n,applied:i,rejected:e.rejected}}i+=a.length}return{ok:!0,applied:i}}catch(e){return b.error(`Failed to set flag`,e),{ok:!1,reason:`failed`,applied:i}}}matchingBody(e,t={}){return JSON.stringify({all:!0,query:e.query||``,except:e.except??[],...t})}countOf(e){return typeof e.count==`number`?e.count:0}async setFlagMatching(e,t,n,r){try{let i=await E(`/mailboxes/${O(e)}/messages/flag`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:this.matchingBody(t,{flags:n,action:r})});if(this.isAuthError(i))return{ok:!1,reason:`auth`};let a=await Vr(i);if(!i.ok){let e=a.error===`unsupported_flags`?`unsupported`:`failed`;return b.error(`Failed to set a flag on a folder`,i.status,a),{ok:!1,reason:e,rejected:a.rejected}}return L.sync(),{ok:!0,applied:this.countOf(a)}}catch(e){return b.error(`Failed to set a flag on a folder`,e),{ok:!1,reason:`failed`}}}async moveMatching(e,t,n){return this.fileMatching(`move`,e,t,n)}async copyMatching(e,t,n){return this.fileMatching(`copy`,e,t,n)}async fileMatching(e,t,n,r){try{let i=await E(`/mailboxes/${O(t)}/messages/${e}`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:this.matchingBody(n,{to:r})});if(this.isAuthError(i))return{success:!1,reason:`auth`};let a=await Vr(i);return i.ok?(L.sync(),{success:!0,uidMapping:a.uidMapping??{},count:this.countOf(a)}):(b.error(`Failed to ${e} a folder's messages`,i.status,a),{success:!1,reason:`failed`})}catch(t){return b.error(`Failed to ${e} a folder's messages`,t),{success:!1,reason:`failed`}}}async deleteMatchingResult(e,t){try{let n=await E(`/mailboxes/${O(e)}/messages`,{method:`DELETE`,headers:{"Content-Type":`application/json`},body:this.matchingBody(t)});if(this.isAuthError(n))return{ok:!1,reason:`auth`};let r=await Vr(n);return n.ok?(L.sync(),{ok:!0,count:this.countOf(r)}):(b.error(`Failed to delete a folder's messages`,n.status,r),{ok:!1,reason:`failed`})}catch(e){return b.error(`Failed to delete a folder's messages`,e),{ok:!1,reason:`failed`}}}async markAsRead(e,t){let n=t?.UID;if(!n||t.Flags?.includes(`\\Seen`))return t;let{ok:r}=await this.setFlag(e,[String(n)],[R],`add`);if(r){let e={...t};return e.Flags=[...e.Flags||[],R],e}return t}async deleteMessagesResult(e,t){if(!t||t.length===0)return{ok:!1,reason:`empty`};let n=0;try{for(let r of Br(t)){let t=await E(`/mailboxes/${O(e)}/messages`,{method:`DELETE`,headers:{"Content-Type":`application/json`},body:JSON.stringify({uids:r})});if(this.isAuthError(t))return{ok:!1,reason:`auth`};if(!t.ok)return b.error(`Failed to delete messages`,t.status,await Vr(t)),n>0&&L.sync(),{ok:!1,reason:`failed`};n+=r.length}return L.sync(),{ok:!0}}catch(e){return b.error(`Failed to delete messages`,e),n>0&&L.sync(),{ok:!1,reason:`failed`}}}async deleteMessages(e,t){return(await this.deleteMessagesResult(e,t)).ok}async moveMessages(e,t,n){if(!t||t.length===0)return{success:!1,reason:`empty`};let r=0,i={};try{for(let a of Br(t)){let t=await E(`/mailboxes/${O(e)}/messages/move`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify({uids:a,to:n})});if(this.isAuthError(t))return{success:!1,reason:`auth`};if(!t.ok)return b.error(`Failed to move messages`,t.status,await Vr(t)),r>0&&L.sync(),{success:!1,reason:`failed`};let o=await Vr(t);Object.assign(i,o.uidMapping??{}),r+=a.length}return L.sync(),{success:!0,uidMapping:i}}catch(e){return b.error(`Failed to move messages`,e),r>0&&L.sync(),{success:!1,reason:`failed`}}}async copyMessages(e,t,n){if(!t||t.length===0)return{success:!1,reason:`empty`};let r=0;try{for(let i of Br(t)){let t=await E(`/mailboxes/${O(e)}/messages/copy`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify({uids:i,to:n})});if(this.isAuthError(t))return{success:!1,reason:`auth`};if(!t.ok)return b.error(`Failed to copy messages`,t.status,await Vr(t)),r>0&&L.sync(),{success:!1,reason:`failed`};r+=i.length}return L.sync(),{success:!0}}catch(e){return b.error(`Failed to copy messages`,e),r>0&&L.sync(),{success:!1,reason:`failed`}}}async markMessagesAsRead(e,t){if(!t||t.length===0)return!1;let{ok:n}=await this.setFlag(e,t,[R],`add`);return n}async markMessagesAsUnread(e,t){if(!t||t.length===0)return!1;let{ok:n}=await this.setFlag(e,t,[R],`remove`);return n}async saveDraft(e){try{let t=await E(`/messages`,{method:`POST`,body:e});if(t.status===401)return window.dispatchEvent(new CustomEvent(`auth-error`)),null;if(t.ok){let e=await t.json();return{uid:e.draft_uid,mailbox:e.draft_mailbox,size:e.draft_size,attachments:e.attachments}}return b.error(`Failed to save draft:`,t.status,await Vr(t)),null}catch(e){return b.error(`Failed to save draft:`,e),null}}async sendDraft(e){try{let t=await E(`/messages`,{method:`POST`,body:e});if(t.status===401)return window.dispatchEvent(new CustomEvent(`auth-error`)),!1;if(t.ok)return L.sync(),!0;let n=await Vr(t);throw Error(n.error||`Failed to send message (${t.status})`)}catch(e){throw b.error(`Failed to send message:`,e),e}}},Hr=`Attachments exceed the maximum allowed size.`,Ur=new Map;function Wr(){return globalThis.crypto?.randomUUID?.()??`${Date.now().toString(36)}-${Math.random().toString(36).slice(2)}`}function Gr(e){let t=Ur.get(e);t&&(t.abort(),Ur.delete(e))}function Kr(e){for(let t of e)t.uploading&&t._tempId&&Gr(t._tempId)}async function qr(e){try{await fetch(`/attachments/${e}`,{method:`DELETE`})}catch(e){b.error(`Failed to delete attachment from server:`,e)}}function Jr(e,t,n,r,i,a,o,s){let c=document.createElement(`input`);c.type=`file`,c.multiple=!0,c.onchange=c=>{let l=Array.from(c.target.files||[]);l.length!==0&&Yr(l,e,t,n,r,i,a,o,s)},c.click()}function Yr(e,t,n,r,i,a,o,s,c){let l=0;for(let t of e)l+=t.size;if(n>0&&r+l>n){window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:c||Hr,duration:5e3}}));return}for(let n of e){let e=Wr();i(e,n);let r=new FormData;r.append(`attachments`,n);let c=new XMLHttpRequest;Ur.set(e,c),c.open(`POST`,`/attachments?composer_id=${encodeURIComponent(t)}`,!0),c.upload.onprogress=t=>{t.lengthComputable&&a(e,Math.round(t.loaded/t.total*100))},c.onload=()=>{if(Ur.delete(e),c.status>=200&&c.status<300)try{let t=JSON.parse(c.responseText),n=Array.isArray(t)?t:t.uuids||[];n.length>0?o(e,n):s(e,Error(`No UUID returned from server`))}catch(t){s(e,t)}else try{let t=JSON.parse(c.responseText);s(e,Error(t.error||`Unknown error`))}catch{s(e,Error(`Upload failed with status `+c.status))}},c.onerror=()=>{Ur.delete(e),s(e,Error(`Network error during upload`))},c.onabort=()=>{Ur.delete(e)},c.send(r)}}function Xr(e){let t=[],n=(e,r)=>{if(e){if(e.ID){let n=Number(e.Size)||0;t.push({name:e.Extended?.Disposition?.Params?.filename||e.Params?.name||`image`,size:String(e.Encoding).toLowerCase()===`base64`?Math.floor(n*3/4):n,type:e.Type&&e.Subtype?`${e.Type}/${e.Subtype}`.toLowerCase():`application/octet-stream`,partPath:r||`1`,inline:!0})}Array.isArray(e.Children)&&e.Children.forEach((e,t)=>n(e,r?`${r}.${t+1}`:`${t+1}`))}};return n(e,``),t}function Zr(e,t){let n={},r=e?.Envelope?.MessageID||e?.Envelope?.MessageId;return r&&(n.inReplyTo=r,n.references=Array.isArray(e.References)?[...e.References]:[]),e?.UID!==void 0&&e?.UID!==null&&t&&(n.replyMailbox=t,n.replyUid=String(e.UID)),n}function Qr(e,t){t.inReplyTo&&e.append(`in_reply_to`,t.inReplyTo),t.references?.length&&e.append(`references`,t.references.join(` `)),t.replyMailbox&&t.replyUid&&(e.append(`reply_mailbox`,t.replyMailbox),e.append(`reply_uid`,t.replyUid)),t.quoteSource?.mailbox&&t.quoteSource.uid&&(e.append(`source_mailbox`,t.quoteSource.mailbox),e.append(`source_uid`,t.quoteSource.uid))}var $r=e=>`alps_compose_drafts_${e}`,ei=`alps_compose_drafts`,ti=e=>{let t=e.trim();if(t.endsWith(`>`)){let e=t.lastIndexOf(`<`);e!==-1&&(t=t.substring(e+1,t.length-1))}return t.trim().toLowerCase()},ni=e=>{let t=ti(e);return t.startsWith(`noreply`)||t.startsWith(`no-reply`)||t.startsWith(`mailer-daemon`)},ri=e=>e&&e.filter(e=>!ni(e)),ii=class extends EventTarget{constructor(){super(),this.state={activeComposers:[]},this.saveTimeout=null,this.username=null,this.adoptSession=()=>{let e=ke();if(e===this.username)return;let t=this.username===null?this.state.activeComposers:[];this.username=e;let n=e?this.loadDrafts(e):[];this.state.activeComposers=e?[...n,...t]:[],this.notify()},this.handleSessionCleared=e=>{this.saveTimeout!==null&&(window.clearTimeout(this.saveTimeout),this.saveTimeout=null);let t=e?.detail?.reason===`expired`;t&&this.saveDrafts();let n=this.username&&!t?$r(this.username):null;this.username=null;for(let e of this.state.activeComposers)Kr(e.attachments||[]);if(this.state.activeComposers=[],this.notify(),n)try{localStorage.removeItem(n)}catch(e){b.error(`Failed to clear compose drafts`,e)}};try{localStorage.removeItem(ei)}catch{}window.addEventListener(`session-cleared`,this.handleSessionCleared),window.addEventListener(`user-logged-in`,this.adoptSession),window.addEventListener(`alps-active-user-changed`,this.adoptSession),this.adoptSession()}loadDrafts(e){try{let t=localStorage.getItem($r(e));if(t)return JSON.parse(t).map(e=>{let t=e.isSending;return{...e,attachments:e.attachments?.filter(e=>!e.uploading&&e.uuid)||[],isSending:!1,minimized:t?!1:e.minimized}})}catch(e){b.error(`Failed to parse compose drafts from localStorage`,e)}return[]}saveDrafts(){if(this.username)try{localStorage.setItem($r(this.username),JSON.stringify(this.state.activeComposers))}catch(e){b.error(`Failed to save compose drafts to localStorage`,e)}}debouncedSaveDrafts(){this.saveTimeout!==null&&window.clearTimeout(this.saveTimeout),this.saveTimeout=window.setTimeout(()=>{this.saveDrafts(),this.saveTimeout=null},500)}notify(){this.dispatchEvent(new CustomEvent(`change`))}get stateCopy(){return{...this.state}}getComposer(e){return this.state.activeComposers.find(t=>t.id===e)}getState(){return this.state}openComposer(e){if(e?.draftUid){let t=this.state.activeComposers.find(t=>t.draftUid===e.draftUid);if(t){this.bringComposerToFront(t.id),t.minimized&&this.updateComposer(t.id,{minimized:!1});return}}let t=window.innerWidth<=768;if(t&&this.state.activeComposers.length>=1){let e=this.state.activeComposers[0].id;this.bringComposerToFront(e);return}if(!t&&this.state.activeComposers.length>=3)return;let n=`composer_`+Date.now()+`_`+Math.random().toString(36).substr(2,5),r=`html`,i=``,a=Ae();a.composeFormat===`text`&&(r=`text`),a.signature&&(i=a.signature);let o=e?.text||``,s=e?.html||``;if(i&&!e?.draftUid){let t=`-- \n${i}`,n=`<div class="alps-signature">-- <br>${i.replace(/\n/g,`<br>`)}</div>`;o=`\n\n${t}\n${o}`,s=s||e?.text?`<br><br>${n}${s}`:`<br><br>${n}`}let c={id:n,minimized:!1,expanded:!1,dirty:!1,subject:``,format:e?.format||r,attachments:[],zIndex:1e3+this.state.activeComposers.length,...e,to:ri(e?.to)||[],cc:ri(e?.cc)||[],bcc:ri(e?.bcc)||[],text:o,html:s,initialText:o,initialHtml:s};this.state={...this.state,activeComposers:[...this.state.activeComposers,c]},this.saveDrafts(),this.notify()}updateComposer(e,t){t.to&&=ri(t.to),t.cc&&=ri(t.cc),t.bcc&&=ri(t.bcc);let n=this.state.activeComposers.map(n=>{if(n.id!==e)return n;let r=!1;if(`subject`in t&&t.subject!==n.subject&&(r=!0),`to`in t&&JSON.stringify(t.to||[])!==JSON.stringify(n.to||[])&&(r=!0),`cc`in t&&JSON.stringify(t.cc||[])!==JSON.stringify(n.cc||[])&&(r=!0),`bcc`in t&&JSON.stringify(t.bcc||[])!==JSON.stringify(n.bcc||[])&&(r=!0),`attachments`in t&&t.attachments!==n.attachments&&(r=!0),!r&&!n.dirty){if(`text`in t||`html`in t){let e=`text`in t?t.text||``:n.text||``,i=n.initialText||``;e.trim()!==i.trim()&&(r=!0)}}else !r&&n.dirty;let i=`dirty`in t?t.dirty:r?!0:n.dirty;return{...n,...t,dirty:i}});this.state={...this.state,activeComposers:n},this.debouncedSaveDrafts(),this.notify()}closeComposer(e){this.state={...this.state,activeComposers:this.state.activeComposers.filter(t=>t.id!==e)},this.saveDrafts(),this.notify()}clearAllComposers(){this.state={...this.state,activeComposers:[]},this.notify()}async saveAllDirtyDrafts(){let e=0,t=this.state.activeComposers.filter(e=>e.dirty);if(t.length>0)for(let n of t){let t=(n.to?.length||0)>0||(n.cc?.length||0)>0||(n.bcc?.length||0)>0,r=n.text?.trim()!==n.initialText?.trim()||(n.subject?.trim().length||0)>0;if(!t&&!r&&!(n.attachments&&n.attachments.length>0))continue;let i=new FormData,a=[...n.bcc||[]],o=``;{let e=Ae(),t=e.loginUsername;e.bccMyself&&t&&!a.some(e=>ti(e)===ti(t))&&a.push(t),e.replyTo&&(o=e.replyTo)}i.append(`to`,(n.to||[]).join(`, `)),i.append(`cc`,(n.cc||[]).join(`, `)),i.append(`bcc`,a.join(`, `)),o&&i.append(`reply_to`,o),i.append(`subject`,(n.subject||``).trim()),i.append(`text`,n.text||``),n.html&&n.format===`html`&&i.append(`html`,n.html),i.append(`save_as_draft`,`1`);let s=n.attachments||[],c=s.map(e=>e.uuid).filter(Boolean).join(`,`);c&&i.append(`attachment-uuids`,c);let l=s.map(e=>e.partPath).filter(Boolean).join(`,`);l&&i.append(`prev_attachments`,l),n.draftMailbox&&i.append(`draft_mailbox`,n.draftMailbox),n.draftUid&&i.append(`draft_uid`,n.draftUid),Qr(i,n),await B.saveDraft(i)||e++}return this.state={...this.state,activeComposers:[]},this.saveDrafts(),this.notify(),{failed:e}}bringComposerToFront(e){let t=1e3;this.state.activeComposers.forEach(e=>{e.zIndex&&e.zIndex>t&&(t=e.zIndex)}),this.updateComposer(e,{zIndex:t+1})}},ai=u(`compose-store`),oi=`alps-login-notice`;function si(e){try{sessionStorage.setItem(oi,e)}catch{}}function ci(){try{let e=sessionStorage.getItem(oi);return e&&sessionStorage.removeItem(oi),e||null}catch{return null}}var li=new class extends EventTarget{constructor(){super(),this.accounts=[],this.loading=!1,this.initialized=!1}getAccounts(){return this.accounts}isLoading(){return this.loading}isInitialized(){return this.initialized}async fetchAccounts(){this.loading=!0,this.dispatchEvent(new Event(`change`));try{let e=await fetch(`/accounts`);if(e.ok){let t=await e.json();this.accounts=t.accounts||[],this.initialized=!0}else b.error(`Failed to fetch linked accounts`)}catch(e){b.error(`Error fetching linked accounts:`,e)}finally{this.loading=!1,this.dispatchEvent(new Event(`change`))}}async addAccount(e,t,n=``){let r=new URLSearchParams;r.append(`username`,e),r.append(`password`,t),r.append(`display_name`,n);let i=await fetch(`/accounts`,{method:`POST`,headers:{"Content-Type":`application/x-www-form-urlencoded`},body:r.toString()});if(!i.ok){let e=await i.json().catch(()=>({}));throw Error(e.error||`Failed to add linked account`)}await this.fetchAccounts()}async removeAccount(e){let t=await fetch(`/accounts/${encodeURIComponent(e)}`,{method:`DELETE`});if(!t.ok){let e=await t.json().catch(()=>({}));throw Error(e.error||`Failed to remove linked account`)}await this.fetchAccounts()}async switchAccount(e){let t=new URLSearchParams;t.append(`username`,e);let n=await fetch(`/accounts/switch`,{method:`POST`,headers:{"Content-Type":`application/x-www-form-urlencoded`},body:t.toString()});if(!n.ok){let e=await n.json().catch(()=>({}));throw Error(e.error||`Failed to switch account`)}return await n.json()}},ui=u(`alps-linked-accounts`),di=class extends d{constructor(...e){super(...e),this.name=``,this.email=``,this.src=``,this.size=40,this.imageError=!1,this._handleStoreChange=()=>{this.requestUpdate()}}willUpdate(e){e.has(`src`)&&(this.imageError=!1)}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.isConnected&&this.settingsStore?.addEventListener(`change`,this._handleStoreChange)})}disconnectedCallback(){super.disconnectedCallback(),this.settingsStore?.removeEventListener(`change`,this._handleStoreChange)}static{this.styles=g`
>>>>>>>> main:frontend/dist/assets/index-CCMQIZxV.js
    :host {
      display: inline-block;
      flex-shrink: 0;
  ...
  `}getInitials(e){if(!e)return`U`;let t=e.trim().split(/[\s.@]+/);return t.length>=2?(t[0][0]+t[1][0]).toUpperCase():e.substring(0,2).toUpperCase()}render(){let e=this.settingsStore?.getState()?.loginUsername||``,t=this.settingsStore?.getState()?.name||``,i=!1;(e&&this.email&&this.email.toLowerCase()===e.toLowerCase()||t&&this.name&&this.name.toLowerCase()===t.toLowerCase()||e&&this.name&&this.name.toLowerCase()===e.toLowerCase())&&(i=!0);let a=i?t||e:this.email||this.name,o=i&&(t||e)||this.name,s=Math.round(this.size/2.3);return n`
    ...
    `}};A([h({context:w})],fi.prototype,`settingsStore`,void 0),A([o({type:String})],fi.prototype,`name`,void 0),A([o({type:String})],fi.prototype,`email`,void 0),A([o({type:String})],fi.prototype,`src`,void 0),A([o({type:Number})],fi.prototype,`size`,void 0),A([a()],fi.prototype,`imageError`,void 0),fi=A([p(`alps-avatar`)],fi);var pi=class extends d{constructor(...e){super(...e),this.username=``,this.isMobile=!1,this.currentTab=`messages`,this._handleStoreChange=()=>{this.requestUpdate()}}static{this.styles=[Dn,g`
    :host {
      display: block;
      position: relative;
    }
      ...
      <div class="user-profile">
        ...
        <alps-popup align="right">
          ...
          <button class="dropdown-item ${this.currentTab===`messages`?`active`:``}" @click="${()=>this._handleTabChange(`messages`)}">
            ${k(`envelopeSimple`)} <span class="item-text">${this.i18nStore?.t(`navigation.messages`)}</span>
          </button>
          ${v.getNavTabs().map(e=>n`
            <button class="dropdown-item ${this.currentTab===e.id?`active`:``}" @click="${()=>this._handleTabChange(e.id)}">
              ${k(e.icon||`star`)} <span class="item-text">${this.i18nStore?.t(e.labelKey)}</span>
            </button>
          `)}
          <div class="dropdown-divider"></div>
          <button class="dropdown-item ${this.currentTab===`settings`?`active`:``}" @click="${this._handleSettings}">
            ${k(`gear`)} <span class="item-text">${this.i18nStore?.t(`userMenu.settings`)}</span>
          </button>
          <div class="dropdown-divider"></div>
          <button class="dropdown-item" @click="${this._handleSignOut}">
            ${k(`signOut`)} <span class="item-text">${this.i18nStore?.t(`userMenu.signOut`)}</span>
          </button>
        </alps-popup>
      </div>
<<<<<<<< HEAD:frontend/dist/assets/index-BHV7B3Zq.js
    `}};A([o({type:String})],pi.prototype,`username`,void 0),A([o({type:Boolean})],pi.prototype,`isMobile`,void 0),A([o({type:String})],pi.prototype,`currentTab`,void 0),A([h({context:C})],pi.prototype,`i18nStore`,void 0),A([h({context:w})],pi.prototype,`settingsStore`,void 0),A([h({context:di})],pi.prototype,`linkedAccountsStore`,void 0),pi=A([p(`user-profile-menu`)],pi);var mi=class extends d{constructor(...e){super(...e),this.username=``,this.currentTab=``,this.isMobile=!1,this.scrolled=!1,this._handleStoreChange=()=>{this.requestUpdate()}}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.i18nStore?.addEventListener(`change`,this._handleStoreChange)})}disconnectedCallback(){super.disconnectedCallback(),this.i18nStore?.removeEventListener(`change`,this._handleStoreChange)}static{this.styles=g`
========
    `}};A([o({type:String})],fi.prototype,`username`,void 0),A([o({type:Boolean})],fi.prototype,`isMobile`,void 0),A([o({type:String})],fi.prototype,`currentTab`,void 0),A([h({context:S})],fi.prototype,`i18nStore`,void 0),A([h({context:C})],fi.prototype,`settingsStore`,void 0),A([h({context:ui})],fi.prototype,`linkedAccountsStore`,void 0),fi=A([p(`user-profile-menu`)],fi);var pi=class extends d{constructor(...e){super(...e),this.username=``,this.currentTab=``,this.isMobile=!1,this.scrolled=!1,this._handleStoreChange=()=>{this.requestUpdate()}}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.isConnected&&this.i18nStore?.addEventListener(`change`,this._handleStoreChange)})}disconnectedCallback(){super.disconnectedCallback(),this.i18nStore?.removeEventListener(`change`,this._handleStoreChange)}static{this.styles=g`
>>>>>>>> main:frontend/dist/assets/index-CCMQIZxV.js
    :host {
      display: block;
      position: relative;
  ...
  `}handleSettings(){window.location.hash=`/settings`}async handleSignOut(){let e=0;try{this.composeStore&&(e=(await this.composeStore.saveAllDirtyDrafts()).failed)}catch(e){x.error(`Could not save drafts before signing out`,e)}ci(e>0?`signedOutDraftsLost`:`signedOut`);try{await fetch(`/session`,{method:`DELETE`})}catch(e){x.error(`Sign-out request failed; ending the session locally anyway`,e)}xr.clear(),Ae(),window.dispatchEvent(new CustomEvent(`session-cleared`)),window.location.hash=`#/login`}render(){return n`
...
<<<<<<<< HEAD:frontend/dist/assets/index-BHV7B3Zq.js
    `}};A([o({type:String})],mi.prototype,`username`,void 0),A([o({type:String})],mi.prototype,`currentTab`,void 0),A([o({type:Boolean,reflect:!0})],mi.prototype,`isMobile`,void 0),A([o({type:Boolean,reflect:!0})],mi.prototype,`scrolled`,void 0),A([h({context:C})],mi.prototype,`i18nStore`,void 0),A([h({context:oi})],mi.prototype,`composeStore`,void 0),mi=A([p(`alps-header`)],mi);var hi=class extends d{constructor(...e){super(...e),this.username=``,this.currentTab=`messages`,this.isMobile=!1,this.currentMailbox=``,this.currentMailboxDelimiter=``,this.searchQuery=``,this.scrolled=!1,this._handleStoreChange=()=>{this.requestUpdate()},this._handleHashChange=()=>{let e=window.location.hash;if(e.startsWith(`#/contacts`))this.currentTab=`contacts`;else if(e.startsWith(`#/settings`))this.currentTab=`settings`;else{let t=v.getNavTabs().find(t=>e.startsWith(`#/${t.id}`));t?this.currentTab=t.id:this.currentTab=`messages`}}}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.i18nStore?.addEventListener(`change`,this._handleStoreChange)}),window.addEventListener(`hashchange`,this._handleHashChange),window.addEventListener(`plugins-updated`,this._handleStoreChange),this._handleHashChange()}disconnectedCallback(){super.disconnectedCallback(),this.i18nStore?.removeEventListener(`change`,this._handleStoreChange),window.removeEventListener(`hashchange`,this._handleHashChange),window.removeEventListener(`plugins-updated`,this._handleStoreChange)}static{this.styles=g`
========
    `}};A([o({type:String})],pi.prototype,`username`,void 0),A([o({type:String})],pi.prototype,`currentTab`,void 0),A([o({type:Boolean,reflect:!0})],pi.prototype,`isMobile`,void 0),A([o({type:Boolean,reflect:!0})],pi.prototype,`scrolled`,void 0),A([h({context:S})],pi.prototype,`i18nStore`,void 0),A([h({context:ai})],pi.prototype,`composeStore`,void 0),pi=A([p(`alps-header`)],pi);var mi=class extends d{constructor(...e){super(...e),this.username=``,this.currentTab=`messages`,this.isMobile=!1,this.currentMailbox=``,this.currentMailboxDelimiter=``,this.searchQuery=``,this.scrolled=!1,this._handleStoreChange=()=>{this.requestUpdate()},this._handleHashChange=()=>{let e=window.location.hash;if(e.startsWith(`#/contacts`))this.currentTab=`contacts`;else if(e.startsWith(`#/settings`))this.currentTab=`settings`;else{let t=v.getNavTabs().find(t=>e.startsWith(`#/${t.id}`));t?this.currentTab=t.id:this.currentTab=`messages`}}}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.isConnected&&this.i18nStore?.addEventListener(`change`,this._handleStoreChange)}),window.addEventListener(`hashchange`,this._handleHashChange),window.addEventListener(`plugins-updated`,this._handleStoreChange),this._handleHashChange()}disconnectedCallback(){super.disconnectedCallback(),this.i18nStore?.removeEventListener(`change`,this._handleStoreChange),window.removeEventListener(`hashchange`,this._handleHashChange),window.removeEventListener(`plugins-updated`,this._handleStoreChange)}static{this.styles=g`
>>>>>>>> main:frontend/dist/assets/index-CCMQIZxV.js
    :host {
      display: block;
      width: 100%;
  ...
  `}handleTabClick(e){this.currentTab=e,this.dispatchEvent(new CustomEvent(`change-tab`,{detail:{tab:e}})),e===`messages`?window.location.hash.startsWith(`#/mailbox/`)||(window.location.hash=`#/`):window.location.hash=`#/`+e}render(){return n`
    ...
    `}};A([o({type:String})],hi.prototype,`username`,void 0),A([o({type:String})],hi.prototype,`currentTab`,void 0),A([o({type:Boolean})],hi.prototype,`isMobile`,void 0),A([o({type:String})],hi.prototype,`currentMailbox`,void 0),A([o({type:String})],hi.prototype,`currentMailboxDelimiter`,void 0),A([o({type:String})],hi.prototype,`searchQuery`,void 0),A([o({type:Boolean})],hi.prototype,`scrolled`,void 0),A([h({context:C})],hi.prototype,`i18nStore`,void 0),hi=A([p(`app-header`)],hi);var gi=class extends d{constructor(...e){super(...e),this.hidden=!1}static{this.styles=g`
    :host {
      position: absolute;
      inset: 0;
      background: var(--bg-primary, #ffffff);
  ...
  `}render(){return n`<alps-loader></alps-loader>`}};A([o({type:Boolean,reflect:!0})],gi.prototype,`hidden`,void 0),gi=A([p(`alps-initial-loader`)],gi);var V=class extends d{constructor(...e){super(...e),this.contacts=[],this.uniqueCategories=[],this.selectedCategory=``,this.filterQuery=``,this.sidebarCollapsed=!1,this.isSidebarHovered=!1,this.suppressSidebarHover=!1,this.isMobile=!1,this.activeKebabMenu=null,this.sidebarScrolled=!1}static{this.styles=[Dn,hn,g`
    :host {
      display: flex;
      flex-direction: column;
      flex: 1;
  ...
  `]}handleSidebarScroll(e){let t=e.target.scrollTop>0;this.sidebarScrolled!==t&&(this.sidebarScrolled=t)}render(){return n`
      <div class="sidebar-wrapper ${this.sidebarCollapsed&&!this.isMobile&&(!this.isSidebarHovered||this.suppressSidebarHover)?`collapsed`:``}">
        ...
        <div class="sidebar-content" @scroll=${this.handleSidebarScroll}>
          <div class="sidebar-scroll-content">
            ${[_r,vr,...this.uniqueCategories.filter(e=>e!==vr)].map(e=>{let t=e===`All Contacts`?this.contacts.length:this.contacts.filter(t=>t.categories&&t.categories.includes(e)).length,r=e===`All Contacts`||e===`Favorites`;return n`
                    ...
                    <div class="category-actions ${this.activeKebabMenu===e?`popup-open`:``}" @click=${e=>e.stopPropagation()}>
                      ...
                      >
                        ...
                        <button class="dropdown-item" @click=${t=>{let n=t.target.closest(`alps-popup`);n&&n.close(),this.dispatchEvent(new CustomEvent(`rename-category`,{detail:{category:e}}))}}>
                          ${k(`pen`)} <span class="item-text">${this.i18nStore?.t(`contacts.rename`)}</span>
                        </button>
                        <button class="dropdown-item text-danger" @click=${t=>{let n=t.target.closest(`alps-popup`);n&&n.close(),this.dispatchEvent(new CustomEvent(`delete-category`,{detail:{category:e}}))}}>
                          ${k(`trash`)} <span class="item-text">${this.i18nStore?.t(`contacts.delete`)}</span>
                        </button>
                      </alps-popup>
                    </div>
                  `}
    ...
    `}};A([h({context:C})],V.prototype,`i18nStore`,void 0),A([o({type:Array})],V.prototype,`contacts`,void 0),A([o({type:Array})],V.prototype,`uniqueCategories`,void 0),A([o({type:String})],V.prototype,`selectedCategory`,void 0),A([o({type:String})],V.prototype,`filterQuery`,void 0),A([o({type:Boolean})],V.prototype,`sidebarCollapsed`,void 0),A([o({type:Boolean})],V.prototype,`isSidebarHovered`,void 0),A([o({type:Boolean})],V.prototype,`suppressSidebarHover`,void 0),A([o({type:Boolean})],V.prototype,`isMobile`,void 0),A([a()],V.prototype,`activeKebabMenu`,void 0),A([a()],V.prototype,`sidebarScrolled`,void 0),V=A([p(`alps-contacts-categories`)],V);var _i=600*1e3,vi=new class{async classify(e,t){return e.status===401?(window.dispatchEvent(new CustomEvent(`auth-error`)),`failed`):e.ok?`ok`:e.status===409?`exists`:(x.error(`Failed to ${t}`,e.status),`failed`)}async createMailbox(e){try{let t=new URLSearchParams;t.append(`name`,e);let n=await E(`/mailboxes`,{method:`POST`,headers:{"Content-Type":`application/x-www-form-urlencoded`},body:t.toString()}),r=await this.classify(n,`create mailbox`);return r===`ok`&&L.syncLabels(),r}catch(e){return x.error(`Failed to create mailbox`,e),`failed`}}async renameMailbox(e,t){try{let n=await E(`/mailboxes/${O(e)}/rename`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify({new_name:t})}),r=await this.classify(n,`rename mailbox`);return r===`ok`&&(L.mailboxRenamed(e,t),L.syncLabels()),r}catch(e){return x.error(`Failed to rename mailbox`,e),`failed`}}async deleteMailbox(e){try{let t=await E(`/mailboxes/${O(e)}`,{method:`DELETE`}),n=await this.classify(t,`delete mailbox`);return n===`ok`&&(L.mailboxDeleted(e),L.sync()),n===`ok`}catch(e){return x.error(`Failed to delete mailbox`,e),!1}}async emptyMailbox(e){try{let t=await E(`/mailboxes/${O(e)}/empty`,{method:`POST`},_i);if(t.status===401)return{ok:!1,reason:`auth`};if(t.ok){let e;try{let n=await t.json();typeof n?.discarded==`number`&&(e=n.discarded)}catch{}return L.sync(),{ok:!0,discarded:e}}return x.error(`Failed to empty mailbox`,t.status),{ok:!1,reason:t.status===403?`not_discardable`:`failed`}}catch(e){return x.error(`Failed to empty mailbox`,e),e?.name===`AbortError`?(L.sync(),{ok:!1,reason:`timeout`}):{ok:!1,reason:`failed`}}}async setSubscribed(e,t){let n=t?`subscribe`:`unsubscribe`;try{let t=await E(`/mailboxes/${O(e)}/${n}`,{method:`PUT`});return t.status===401?(window.dispatchEvent(new CustomEvent(`auth-error`)),{ok:!1,reason:`auth`}):t.ok?(L.syncLabels(),{ok:!0}):(x.error(`Failed to ${n} mailbox`,t.status),{ok:!1,reason:`failed`})}catch(e){return x.error(`Failed to ${n} mailbox`,e),{ok:!1,reason:`failed`}}}};async function yi(e,t){let n=new Map,r=null;for(let i=0;i<t.length;i+=200){let a=t.slice(i,i+200).map(encodeURIComponent).join(`,`),o=await E(`/mailboxes/${O(e)}/verdicts?uids=${a}`);if(!o.ok)throw Error(`verdicts request failed: ${o.status}`);let s=await o.json(),c=typeof s?.Scope==`string`?s.Scope:``;if(r!==null&&c!==r)throw Error(`verdicts were answered under different scopes`);r=c;for(let[e,t]of Object.entries(s?.Verdicts??{})){let r=t??{};n.set(e,{HasBimiPotential:r.HasBimiPotential===!0,HasBimiFailed:r.HasBimiFailed===!0})}}return{verdicts:n,scope:r??``}}function H(e,t){return`${e??``} ${String(t)}`}function bi(e){let t=e.indexOf(`\0`);return t===-1?{mailbox:``,uid:e}:{mailbox:e.slice(0,t),uid:e.slice(t+1)}}function xi(e){let t=new Map;for(let n of e){let{mailbox:e,uid:r}=bi(n),i=t.get(e);i?i.push(r):t.set(e,[r])}return t}function Si(e,t){return typeof e?.Mailbox==`string`&&e.Mailbox?e.Mailbox:t}var Ci=class extends d{constructor(...e){super(...e),this.name=``,this.color=``}static{this.styles=g`
    :host {
      display: inline-flex;
    }
...
<<<<<<<< HEAD:frontend/dist/assets/index-BHV7B3Zq.js
    `}};A([o({type:String})],Ci.prototype,`name`,void 0),A([o({type:String})],Ci.prototype,`color`,void 0),Ci=A([p(`alps-tag`)],Ci);var wi=class extends d{constructor(...e){super(...e),this.currentPage=0,this.totalItems=0,this.itemsPerPage=50,this.currentCount=0,this.isSearch=!1,this._handleStoreChange=()=>{this.requestUpdate()}}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.i18nStore?.addEventListener(`change`,this._handleStoreChange)})}disconnectedCallback(){super.disconnectedCallback(),this.i18nStore?.removeEventListener(`change`,this._handleStoreChange)}static{this.styles=g`
========
    `}};A([o({type:String})],Si.prototype,`name`,void 0),A([o({type:String})],Si.prototype,`color`,void 0),Si=A([p(`alps-tag`)],Si);var Ci=class extends d{constructor(...e){super(...e),this.currentPage=0,this.totalItems=0,this.itemsPerPage=50,this.currentCount=0,this.isSearch=!1,this._handleStoreChange=()=>{this.requestUpdate()}}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.isConnected&&this.i18nStore?.addEventListener(`change`,this._handleStoreChange)})}disconnectedCallback(){super.disconnectedCallback(),this.i18nStore?.removeEventListener(`change`,this._handleStoreChange)}static{this.styles=g`
>>>>>>>> main:frontend/dist/assets/index-CCMQIZxV.js
  ...
  `}changePage(e){let t=this.currentPage+e;t>=0&&t<Math.ceil(this.totalItems/this.itemsPerPage)&&this.dispatchEvent(new CustomEvent(`change-page`,{detail:{page:t},bubbles:!0,composed:!0}))}get knownTotal(){return this.totalItems>0?this.totalItems:void 0}get hasPrev(){return this.currentPage>0}get hasNext(){let e=this.knownTotal;return e===void 0?!1:(this.currentPage+1)*this.itemsPerPage<e}get rangeText(){let e=this.currentCount>0?this.currentCount:0;if(e===0)return this.i18nStore?.t(`pagination.zeroMessages`)||`0 messages`;if(!this.hasPrev&&!this.hasNext){let t=this.isSearch?e:this.knownTotal??e,n=this.isSearch?`pagination.searchResults`:`pagination.totalCount`,r=this.isSearch?`{total} results`:`{total} total`;return(this.i18nStore?.t(n)||r).replace(`{total}`,String(t))}let t=this.currentPage*this.itemsPerPage+1,n=t+e-1,r=this.knownTotal;return r===void 0?`${t}\u2013${n}`:(this.i18nStore?.t(`pagination.rangeOfTotal`)||`{start}–{end} of {total}`).replace(`{start}`,String(t)).replace(`{end}`,String(n)).replace(`{total}`,String(r))}render(){let e=this.rangeText;return n`
    ...
    `}};A([o({type:Number})],wi.prototype,`currentPage`,void 0),A([o({type:Number})],wi.prototype,`totalItems`,void 0),A([o({type:Number})],wi.prototype,`itemsPerPage`,void 0),A([o({type:Number})],wi.prototype,`currentCount`,void 0),A([o({type:Boolean})],wi.prototype,`isSearch`,void 0),A([h({context:C})],wi.prototype,`i18nStore`,void 0),wi=A([p(`alps-pagination`)],wi);var Ti=class extends d{constructor(...e){super(...e),this.variant=`info`}static{this.styles=g`
    :host {
      display: block;
      position: sticky;
      top: 0;
...
>>>>>>>> main:frontend/dist/assets/index-CCMQIZxV.js
        ...
        <div @click=${t=>this.toggleStar(t,e)} class="star-btn ${se?`starred`:``} star-btn-wrapper-ultra">
          ${k(se?`starFourFill`:`starFour`)}
        </div>
        ${ce||le?n`
          <div class="indicators-wrapper-ultra">
            ${ce?n`<div class="indicator-icon" title=${this.i18nStore?.t(`messageList.replied`)}>${k(`arrowBendUpLeft`)}</div>`:``}
            ${le?n`<div class="indicator-icon" title=${this.i18nStore?.t(`messageList.forwarded`)}>${k(`arrowBendUpRight`)}</div>`:``}
          </div>
        `:``}
        ${ue.length>0?n`
          <div class="tag-pills">
        ...
        <div class="message-indicators">
          <div class="attachment-col">
            ${e.HasAttachments?n`<div class="indicator-icon" title=${this.i18nStore?.t(`messageList.hasAttachments`)}>${k(`paperclipHorizontal`)}</div>`:``}
          </div>
        ...
        <div class="avatar-stack">
          ${m.map((t,r)=>{let i=t.Mailbox&&t.Host?`${t.Mailbox}@${t.Host}`:``,a=t.Name||i||this.i18nStore?.t(d)||this.i18nStore?.t(`messageList.unknown`),o=fn(this.withVerdict(e),t);return n`
              <div class="avatar-wrapper" style="z-index: ${ee-r};">
                <alps-avatar .name=${a} .email=${i} .size=${de} .src=${o}></alps-avatar>
              </div>
            `})}
          ${h>0?n`
            <div class="avatar-wrapper extra-count" style="width: ${de}px; height: ${de}px; z-index: 0;">
              +${h}
            </div>
          `:``}
        </div>
      ...
      <div class="message-details">
        <div class="message-header-row">
          <div class="message-header-inner">
            <div class="message-sender">${f}</div>
            <div @click=${t=>this.toggleStar(t,e)} class="star-btn ${se?`starred`:``}">
              ${k(se?`starFourFill`:`starFour`)}
            </div>
          </div>
          <div class="message-indicators">
    ...
    `}toggleStar(e,t){e.stopPropagation(),this.dispatchEvent(new CustomEvent(`toggle-star-message`,{detail:{message:t,messages:this.rowMessages(t)}}))}get isTextSearch(){return this.filterQuery!==``&&!Ei.has(this.filterQuery)}render(){return n`
      ${this.isMobile?``:n`
      ...
      ${this.showEmptyConfirm?n`
        ...
        ></ui-confirm>
      `:``}
    `}};A([h({context:w})],U.prototype,`settingsStore`,void 0),A([h({context:C})],U.prototype,`i18nStore`,void 0),A([o({type:Array})],U.prototype,`messages`,void 0),A([o({type:String})],U.prototype,`currentMailbox`,void 0),A([o({type:String})],U.prototype,`currentMailboxDelimiter`,void 0),A([o({type:String})],U.prototype,`currentMailboxRole`,void 0),A([o({type:Boolean})],U.prototype,`loading`,void 0),A([o({type:Object})],U.prototype,`selectedMessage`,void 0),A([o({type:String})],U.prototype,`layoutMode`,void 0),A([o({type:Boolean})],U.prototype,`isMobile`,void 0),A([o({type:Boolean})],U.prototype,`sidebarCollapsed`,void 0),A([o({type:Number})],U.prototype,`currentPage`,void 0),A([o({type:Number})],U.prototype,`listedPage`,void 0),A([o({type:Number})],U.prototype,`totalMessages`,void 0),A([o({type:Number})],U.prototype,`messagesPerPage`,void 0),A([o({type:String})],U.prototype,`filterQuery`,void 0),A([o({type:String})],U.prototype,`sortOrder`,void 0),A([o({type:String})],U.prototype,`densityMode`,void 0),A([o({type:Boolean})],U.prototype,`showSenderAvatars`,void 0),A([o({type:Object})],U.prototype,`selectedMessages`,void 0),A([o({type:Boolean})],U.prototype,`selectAllMatching`,void 0),A([o({type:Number})],U.prototype,`matchingCount`,void 0),A([o({type:Boolean})],U.prototype,`syncing`,void 0),A([o({type:Boolean})],U.prototype,`loadFailed`,void 0),A([a()],U.prototype,`isSpinning`,void 0),A([a()],U.prototype,`isScrolled`,void 0),A([a()],U.prototype,`isAtBottom`,void 0),A([a()],U.prototype,`focusedIndex`,void 0),A([a()],U.prototype,`showEmptyConfirm`,void 0),A([a()],U.prototype,`emptying`,void 0),A([a()],U.prototype,`expandedThreads`,void 0),A([a()],U.prototype,`verdicts`,void 0),U=A([p(`alps-message-list`)],U);var W=class extends d{constructor(...e){super(...e),this.contacts=[],this.selectedCategory=``,this.filterQuery=``,this.sortOrder=`asc`,this.showOnlyStarred=!1,this.isMobile=!1,this.densityMode=`compact`,this.selectedContacts=new Set,this.selectedContact=null,this.isSpinning=!1,this.loading=!1,this.listScrolled=!1,this.focusedIndex=-1}getFilteredContacts(){let e=this.contacts.filter(e=>{if(this.selectedCategory&&(!e.categories||!e.categories.includes(this.selectedCategory))||this.showOnlyStarred&&(!e.categories||!e.categories.includes(`Favorites`)))return!1;if(this.filterQuery){let t=this.filterQuery.toLowerCase(),n=(e.email||``).toLowerCase().includes(t)||e.emails&&e.emails.some(e=>(e.value||``).toLowerCase().includes(t)),r=(e.phone||``).toLowerCase().includes(t)||e.phones&&e.phones.some(e=>(e.value||``).toLowerCase().includes(t));if(!(e.name||``).toLowerCase().includes(t)&&!n&&!r&&!(e.nickname||``).toLowerCase().includes(t)&&!(e.organization||``).toLowerCase().includes(t))return!1}return!0});return e.sort((e,t)=>{let n=(e.name||e.email||``).toLowerCase(),r=(t.name||t.email||``).toLowerCase();return n<r?this.sortOrder===`asc`?-1:1:n>r?this.sortOrder===`asc`?1:-1:0}),e}willUpdate(e){if(super.willUpdate(e),e.has(`selectedContact`)||e.has(`contacts`)||e.has(`selectedCategory`)||e.has(`filterQuery`)||e.has(`sortOrder`)||e.has(`showOnlyStarred`)){let e=this.getFilteredContacts();if(this.selectedContact&&e.length>0){let t=e.findIndex(e=>e.path===this.selectedContact.path);t===-1?this.focusedIndex=-1:this.focusedIndex=t}else this.focusedIndex=-1}}updated(e){super.updated(e),e.has(`densityMode`)&&(this.classList.remove(`density-loose`,`density-normal`,`density-compact`,`density-ultra-compact`),this.classList.add(`density-${this.densityMode}`))}static{this.styles=[U.styles,g`
    :host {
      display: flex;
      flex-direction: column;
      flex: 1;
                      ...
                      <div class="contact-header-row">
                        <div class="contact-header-inner">
                          ...
                          <div @click=${t=>{t.stopPropagation(),this.dispatchEvent(new CustomEvent(`toggle-star`,{detail:{contact:e}}))}} class="star-btn ${e.categories?.includes(`Favorites`)?`starred`:``}" style="${e.isTemporary?`opacity: 0.5; pointer-events: none;`:``}">
                            ${k(e.categories?.includes(`Favorites`)?`starFourFill`:`starFour`)}
                          </div>
                        </div>
...
<<<<<<<< HEAD:frontend/dist/assets/index-BHV7B3Zq.js
    `}};A([h({context:C})],W.prototype,`i18nStore`,void 0),A([h({context:w})],W.prototype,`settingsStore`,void 0),A([o({type:Array})],W.prototype,`contacts`,void 0),A([o({type:String})],W.prototype,`selectedCategory`,void 0),A([o({type:String})],W.prototype,`filterQuery`,void 0),A([o({type:String})],W.prototype,`sortOrder`,void 0),A([o({type:Boolean})],W.prototype,`showOnlyStarred`,void 0),A([o({type:Boolean})],W.prototype,`isMobile`,void 0),A([o({type:String})],W.prototype,`densityMode`,void 0),A([o({type:Object})],W.prototype,`selectedContacts`,void 0),A([o({type:Object})],W.prototype,`selectedContact`,void 0),A([o({type:Boolean})],W.prototype,`isSpinning`,void 0),A([o({type:Boolean})],W.prototype,`loading`,void 0),A([o({type:Boolean})],W.prototype,`listScrolled`,void 0),A([a()],W.prototype,`focusedIndex`,void 0),W=A([p(`alps-contacts-list`)],W);var G=class extends d{constructor(...e){super(...e),this.mailboxes=[],this.currentMailbox=``,this.expandedFolders=new Set,this.layoutMode=`vertical`,this.syncing=!1,this.collapsed=!1,this.isScrolled=!1,this.showCreatePrompt=!1,this.promptBusy=!1,this.showRenamePrompt=!1,this.mailboxToRename=``,this.showDeleteConfirm=!1,this.showMoveToTrashConfirm=!1,this.mailboxToDelete=``,this.parentForNewFolder=``,this.activeKebabMenu=null,this.primaryFullNames=new Set,this._handleStoreChange=()=>{this.requestUpdate()},this.handleScroll=e=>{let t=e.target;this.isScrolled=t.scrollTop>0}}willUpdate(e){super.willUpdate(e)}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.composeStore&&this.composeStore.addEventListener(`change`,this._handleStoreChange),this.i18nStore&&this.i18nStore.addEventListener(`change`,this._handleStoreChange),this.settingsStore&&this.settingsStore.addEventListener(`change`,this._handleStoreChange)})}disconnectedCallback(){super.disconnectedCallback(),this.composeStore&&this.composeStore.removeEventListener(`change`,this._handleStoreChange),this.i18nStore?.removeEventListener(`change`,this._handleStoreChange),this.settingsStore?.removeEventListener(`change`,this._handleStoreChange)}static{this.styles=[Dn,hn,g`
========
    `}};A([h({context:S})],W.prototype,`i18nStore`,void 0),A([h({context:C})],W.prototype,`settingsStore`,void 0),A([o({type:Array})],W.prototype,`contacts`,void 0),A([o({type:String})],W.prototype,`selectedCategory`,void 0),A([o({type:String})],W.prototype,`filterQuery`,void 0),A([o({type:String})],W.prototype,`sortOrder`,void 0),A([o({type:Boolean})],W.prototype,`showOnlyStarred`,void 0),A([o({type:Boolean})],W.prototype,`isMobile`,void 0),A([o({type:String})],W.prototype,`densityMode`,void 0),A([o({type:Object})],W.prototype,`selectedContacts`,void 0),A([o({type:Object})],W.prototype,`selectedContact`,void 0),A([o({type:Boolean})],W.prototype,`isSpinning`,void 0),A([o({type:Boolean})],W.prototype,`loading`,void 0),A([o({type:Boolean})],W.prototype,`listScrolled`,void 0),A([a()],W.prototype,`focusedIndex`,void 0),W=A([p(`alps-contacts-list`)],W);var G=class extends d{constructor(...e){super(...e),this.mailboxes=[],this.currentMailbox=``,this.expandedFolders=new Set,this.layoutMode=`vertical`,this.syncing=!1,this.collapsed=!1,this.isScrolled=!1,this.showCreatePrompt=!1,this.promptBusy=!1,this.showRenamePrompt=!1,this.mailboxToRename=``,this.showDeleteConfirm=!1,this.showMoveToTrashConfirm=!1,this.mailboxToDelete=``,this.parentForNewFolder=``,this.activeKebabMenu=null,this.primaryFullNames=new Set,this._handleStoreChange=()=>{this.requestUpdate()},this.handleScroll=e=>{let t=e.target;this.isScrolled=t.scrollTop>0}}willUpdate(e){super.willUpdate(e)}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.isConnected&&(this.composeStore&&this.composeStore.addEventListener(`change`,this._handleStoreChange),this.i18nStore&&this.i18nStore.addEventListener(`change`,this._handleStoreChange),this.settingsStore&&this.settingsStore.addEventListener(`change`,this._handleStoreChange))})}disconnectedCallback(){super.disconnectedCallback(),this.composeStore&&this.composeStore.removeEventListener(`change`,this._handleStoreChange),this.i18nStore?.removeEventListener(`change`,this._handleStoreChange),this.settingsStore?.removeEventListener(`change`,this._handleStoreChange)}static{this.styles=[En,mn,g`
>>>>>>>> main:frontend/dist/assets/index-CCMQIZxV.js
    :host {
      display: flex;
      flex-direction: column;
  ...
  `]}toggleFolder(e,t){e&&e.stopPropagation(),this.dispatchEvent(new CustomEvent(`toggle-folder`,{detail:{folderName:t}}))}selectMailbox(e){this.dispatchEvent(new CustomEvent(`select-mailbox`,{detail:{name:e}}))}triggerCreateFolder(){this.parentForNewFolder=``,this.showCreatePrompt=!0}async handleCreateSubmit(e){let t=e.detail.name;this.promptBusy=!0;try{if(t){if(this.parentForNewFolder){let e=en(this.mailboxes.find(e=>(e.Name||e.Mailbox)===this.parentForNewFolder))||`.`;t=`${this.parentForNewFolder}${e}${t}`,this.dispatchEvent(new CustomEvent(`expand-folder`,{detail:{folderName:this.parentForNewFolder}}))}let e=await vi.createMailbox(t);e===`exists`?this.toast(this.i18nStore?.t(`toast.folderExists`),`A folder with that name already exists`,{type:`error`}):e===`failed`&&this.toast(this.i18nStore?.t(`toast.folderCreateFailed`),`Could not create the folder`,{type:`error`})}}finally{this.promptBusy=!1,this.showCreatePrompt=!1,this.parentForNewFolder=``}}toast(e,t,n={}){this.dispatchEvent(new CustomEvent(`toast`,{detail:{message:e||t,duration:4e3,...n},bubbles:!0,composed:!0}))}async handleRenameSubmit(e){let t=e.detail.name;if(t&&this.mailboxToRename){let e=this.mailboxToRename;this.showRenamePrompt=!1,this.mailboxToRename=``;let n=await vi.renameMailbox(e,t);n===`exists`?this.toast(this.i18nStore?.t(`toast.folderExists`),`A folder with that name already exists`,{type:`error`}):n===`failed`?this.toast(this.i18nStore?.t(`toast.folderRenameFailed`),`Could not rename the folder`,{type:`error`}):(Qt(this.currentMailbox,e)&&this.selectMailbox(t+this.currentMailbox.slice(e.length)),this.dispatchEvent(new CustomEvent(`toast`,{detail:{message:this.i18nStore?.t(`toast.folderRenamed`),actionLabel:this.i18nStore?.t(`toast.undo`),actionFn:async()=>{if(await vi.renameMailbox(t,e)!==`ok`){this.toast(this.i18nStore?.t(`toast.folderUndoFailed`),`Could not undo that`,{type:`error`});return}Qt(this.currentMailbox,t)&&this.selectMailbox(e+this.currentMailbox.slice(t.length))},duration:5e3},bubbles:!0,composed:!0})))}else this.showRenamePrompt=!1,this.mailboxToRename=``}async handleDeleteConfirm(){this.mailboxToDelete&&(await vi.deleteMailbox(this.mailboxToDelete)?(Qt(this.currentMailbox,this.mailboxToDelete)&&this.selectMailbox(D),this.dispatchEvent(new CustomEvent(`toast`,{detail:{message:this.i18nStore?.t(`toast.folderPermanentlyDeleted`),duration:3e3},bubbles:!0,composed:!0}))):this.toast(this.i18nStore?.t(`toast.folderDeleteFailed`),`Could not delete the folder`,{type:`error`})),this.showDeleteConfirm=!1,this.mailboxToDelete=``}async handleMoveToTrashConfirm(){if(this.mailboxToDelete){let e=this.mailboxes.find(e=>(e.Name||e.Mailbox)===this.mailboxToDelete),t=tn(this.mailboxToDelete,en(e,`.`)),n=t[t.length-1],r=en(e,`.`)||`.`,i=Jt(`trash`,this.mailboxToDelete,this.mailboxes,`Trash`),a=`${i}${r}${n}`,o=1;for(;this.mailboxes.some(e=>(e.Name||e.Mailbox)===a);)a=`${i}${r}${n} (${o})`,o++;let s=a;if(await vi.renameMailbox(this.mailboxToDelete,s)!==`ok`)this.toast(this.i18nStore?.t(`toast.folderRenameFailed`),`Could not rename the folder`,{type:`error`});else{Qt(this.currentMailbox,this.mailboxToDelete,r)&&this.selectMailbox(D);let e=this.mailboxToDelete;this.dispatchEvent(new CustomEvent(`toast`,{detail:{message:this.i18nStore?.t(`toast.folderMovedToTrash`),actionLabel:this.i18nStore?.t(`toast.undo`),actionFn:async()=>{await vi.renameMailbox(s,e)!==`ok`&&this.toast(this.i18nStore?.t(`toast.folderUndoFailed`),`Could not undo that`,{type:`error`})},duration:5e3},bubbles:!0,composed:!0}))}}this.showMoveToTrashConfirm=!1,this.mailboxToDelete=``}moveFolder(e,t){console.log(`[moveFolder] Start:`,{folderName:e,direction:t});let n=en(this.mailboxes.find(t=>(t.Name||t.Mailbox)===e),`.`),r=tn(e,n),i=r.slice(0,-1).join(n),a=this.mailboxes.map(e=>e.Name||e.Mailbox||``).filter(e=>{if(this.primaryFullNames.has(e))return!1;let t=tn(e,n);return t.slice(0,-1).join(n)===i&&t.length===r.length});console.log(`[moveFolder] Sibling custom folders found:`,a);let o=[...this.settingsStore?.getState()?.customMailboxOrder||[]];a.sort((e,t)=>{let n=o.indexOf(e),r=o.indexOf(t);return n!==-1&&r!==-1?n-r:n===-1?r===-1?e.localeCompare(t):1:-1}),console.log(`[moveFolder] Sorted siblings:`,a);let s=a.indexOf(e);if(s===-1){console.error(`[moveFolder] Folder not found in siblings!`);return}let c=s;switch(t){case`top`:c=0;break;case`up`:c=Math.max(0,s-1);break;case`down`:c=Math.min(a.length-1,s+1);break;case`bottom`:c=a.length-1;break}if(console.log(`[moveFolder] Shifting indexes:`,{currentIndex:s,newIndex:c}),c===s){console.log(`[moveFolder] No index change needed.`);return}a.splice(s,1),a.splice(c,0,e),console.log(`[moveFolder] New siblings order:`,a);let l=o.filter(e=>!a.includes(e));l.push(...a),console.log(`[moveFolder] Final updated customMailboxOrder settings state:`,l),this.settingsStore?.updateSettings({customMailboxOrder:l})}render(){let e=[{attr:`\\inbox`,names:[D],display:{icon:`tray`,colorClass:`icon-inbox`,label:this.i18nStore?.t(`folderList.inbox`)}},{attr:`\\drafts`,names:[Lt],display:{icon:`fileText`,colorClass:`icon-drafts`,label:this.i18nStore?.t(`folderList.drafts`)}},{attr:`\\sent`,names:[Rt],display:{icon:`paperPlaneTilt`,colorClass:`icon-sent`,label:this.i18nStore?.t(`folderList.sent`)}},{attr:`\\archive`,names:[zt,Bt],display:{icon:`archiveBox`,colorClass:`icon-archive`,label:this.i18nStore?.t(`folderList.archive`)}},{attr:`\\junk`,names:[Ht,Vt],display:{icon:`warningDiamond`,colorClass:`icon-spam`,label:this.i18nStore?.t(`folderList.junk`)}},{attr:`\\trash`,names:[Ut],display:{icon:`trash`,colorClass:`icon-trash`,label:this.i18nStore?.t(`folderList.trash`)}}],t={[D]:{icon:`tray`,colorClass:`icon-inbox`,label:this.i18nStore?.t(`folderList.inbox`)},[Lt]:{icon:`fileText`,colorClass:`icon-drafts`,label:this.i18nStore?.t(`folderList.drafts`)},[Rt]:{icon:`paperPlaneTilt`,colorClass:`icon-sent`,label:this.i18nStore?.t(`folderList.sent`)},[zt]:{icon:`archiveBox`,colorClass:`icon-archive`,label:this.i18nStore?.t(`folderList.archive`)},[Bt]:{icon:`archiveBox`,colorClass:`icon-archive`,label:this.i18nStore?.t(`folderList.archive`)},[Vt]:{icon:`warningDiamond`,colorClass:`icon-spam`,label:this.i18nStore?.t(`folderList.spam`)},[Ht]:{icon:`warningDiamond`,colorClass:`icon-spam`,label:this.i18nStore?.t(`folderList.junk`)},[Ut]:{icon:`trash`,colorClass:`icon-trash`,label:this.i18nStore?.t(`folderList.trash`)}},r=e=>({name:e,standardBySlot:new Map}),i=new Map,a=e=>{let t=i.get(e);return t||(t=r(e),i.set(e,t)),t},o=r(`@default`),s={};this.mailboxes.forEach(e=>{let t=e.Name||e.Mailbox||``,n=en(e,`.`),r=tn(t,n),i=s,c=``,l=o;r[0].startsWith(`@`)&&(l=a(r[0]));for(let t=0;t<r.length;t++){let a=r[t];c=t===0?a:c+n+a,i[a]||(i[a]={account:l,name:a,fullName:c,children:{}}),t===r.length-1&&(i[a].mb=e),i=i[a].children}});let c=e=>(e.mb?.Attrs||[]).map(e=>typeof e==`string`?e.toLowerCase():``),l=(e,t)=>{let n=c(e);return n.includes(t)||n.includes(`\\`+t)},u=t=>{let n=c(t);for(let t=0;t<e.length;t++){let r=e[t];if(n.includes(r.attr)||n.includes(`\\`+r.attr))return t}if(t.mb&&!n.includes(`\\noselect`)&&!n.includes(`\\nonexistent`)){for(let n=0;n<e.length;n++)if(e[n].names.includes(t.name))return n}return-1},d=[],f=t=>n=>{if(n.name==n.account.name){d.push(n),Object.values(n.children).forEach(f(!1));return}let r=u(n);if(r<0){t&&d.push(n);return}let i=n.account.standardBySlot,a=i.get(r);if(!a){i.set(r,n);return}let o=e[r],s=l(n,o.attr),c=l(a,o.attr),p=o.names.indexOf(n.name),m=o.names.indexOf(a.name);s&&!c||s===c&&p!==-1&&(m===-1||p<m)?(i.set(r,n),t&&d.push(a)):t&&d.push(n)};Object.values(s).forEach(f(!0));let p=[];for(let n=0;n<e.length;n++){let r=o.standardBySlot.get(n);r&&(r.primary=t[r.name]||e[n].display,p.push(r))}this.primaryFullNames=new Set(p.map(e=>e.fullName)),i.forEach(n=>{n.standardBySlot.forEach((n,r)=>{n.primary=t[n.name]||e[r].display})});let m=this.settingsStore?.getState()?.customMailboxOrder||[];d.sort((e,t)=>{let n=m.indexOf(e.fullName),r=m.indexOf(t.fullName);return n!==-1&&r!==-1?n-r:n===-1?r===-1?e.name.localeCompare(t.name):1:-1});let h=(e,t=0)=>e.map(e=>{let r=Object.keys(e.children).length>0,i=this.expandedFolders.has(e.fullName),a=this.currentMailbox===e.fullName,o=t>0&&!e.primary,s=!1,c=!1;if(t>0){let t=en(e.mb,`.`),n=tn(e.fullName,t),r=n.slice(0,-1).join(t),i=this.mailboxes.map(e=>e.Name||e.Mailbox||``).filter(e=>{if(this.primaryFullNames.has(e))return!1;let i=tn(e,t);return i.slice(0,-1).join(t)===r&&i.length===n.length}),a=this.settingsStore?.getState()?.customMailboxOrder||[];i.sort((e,t)=>{let n=a.indexOf(e),r=a.indexOf(t);return n!==-1&&r!==-1?n-r:n===-1?r===-1?e.localeCompare(t):1:-1});let o=i.indexOf(e.fullName);s=o<=0,c=o===-1||o===i.length-1}let l=k(`folder`),u=`icon-default`,d=e.name;e.primary&&(l=k(e.primary.icon),u=e.primary.colorClass,d=e.primary.label);let f=e.mb?.Unseen||0,p=(e.mb?.Attrs||[]).some(e=>typeof e==`string`&&e.toLowerCase()===`\\noselect`),ee=t=>{p?r&&this.toggleFolder(t,e.fullName):this.selectMailbox(e.fullName)},g=e.primary,te=e.name.startsWith(`@`),ne=!g,re=!g&&!te,_=!g&&!te,v=!g,y=!te&&!g,b=[];return ne&&b.push(n`
            <button class="dropdown-item" @click=${t=>{let n=t.target.closest(`alps-popup`);n&&n.close(),this.parentForNewFolder=e.fullName,this.showCreatePrompt=!0}}>
              ${k(`folderPlus`)} <span class="item-text">${this.i18nStore?.t(`folderList.createSubfolder`)}</span>
            </button>
          `),re&&b.push(n`
            <button class="dropdown-item" @click=${t=>{let n=t.target.closest(`alps-popup`);n&&n.close(),this.mailboxToRename=e.fullName,this.showRenamePrompt=!0}}>
              ${k(`pen`)} <span class="item-text">${this.i18nStore?.t(`folderList.rename`)}</span>
            </button>
          `),_&&b.push(n`
            <button class="dropdown-item" @click=${t=>{let n=t.target.closest(`alps-popup`);n&&n.close();let r=!e.mb?.Subscribed;vi.setSubscribed(e.fullName,r).then(e=>{e.ok||e.reason===`auth`||(r?this.toast(this.i18nStore?.t(`toast.subscribeFailed`),`Could not subscribe`):this.toast(this.i18nStore?.t(`toast.unsubscribeFailed`),`Could not unsubscribe`))})}}>
              ${k(e.mb?.Subscribed?`eyeSlash`:`eye`)} <span class="item-text">${e.mb?.Subscribed?this.i18nStore?.t(`folderList.unsubscribe`):this.i18nStore?.t(`folderList.subscribe`)}</span>
            </button>
          `),v&&(b.length>0&&b.push(n`<div class="dropdown-divider"></div>`),b.push(n`
            ...
            >
              <button slot="trigger" class="dropdown-item submenu-trigger">
                <div class="trigger-label">
                  ${k(`sortAscending`)} <span class="item-text">${this.i18nStore?.t(`folderList.order`)}</span>
                </div>
                <div class="caret-icon">${k(`caretRight`)}</div>
              </button>
              <button class="dropdown-item" ?disabled=${s} @click=${t=>{let n=t.target.closest(`alps-popup`);n&&n.close();let r=t.target.closest(`.folder-actions`)?.querySelector(`alps-popup`);r&&r.close(),this.moveFolder(e.fullName,`top`)}}>
                ${k(`caretDoubleUp`)} <span class="item-text">${this.i18nStore?.t(`folderList.moveToTop`)}</span>
              </button>
              <button class="dropdown-item" ?disabled=${s} @click=${t=>{let n=t.target.closest(`alps-popup`);n&&n.close();let r=t.target.closest(`.folder-actions`)?.querySelector(`alps-popup`);r&&r.close(),this.moveFolder(e.fullName,`up`)}}>
                ${k(`caretUp`)} <span class="item-text">${this.i18nStore?.t(`folderList.moveUp`)}</span>
              </button>
              <button class="dropdown-item" ?disabled=${c} @click=${t=>{let n=t.target.closest(`alps-popup`);n&&n.close();let r=t.target.closest(`.folder-actions`)?.querySelector(`alps-popup`);r&&r.close(),this.moveFolder(e.fullName,`down`)}}>
                ${k(`caretDown`)} <span class="item-text">${this.i18nStore?.t(`folderList.moveDown`)}</span>
              </button>
              <button class="dropdown-item" ?disabled=${c} @click=${t=>{let n=t.target.closest(`alps-popup`);n&&n.close();let r=t.target.closest(`.folder-actions`)?.querySelector(`alps-popup`);r&&r.close(),this.moveFolder(e.fullName,`bottom`)}}>
                ${k(`caretDoubleDown`)} <span class="item-text">${this.i18nStore?.t(`folderList.moveToBottom`)}</span>
              </button>
            </alps-popup>
          `)),y&&(b.length>0&&b.push(n`<div class="dropdown-divider"></div>`),b.push(n`
            <button class="dropdown-item" @click=${t=>{let n=t.target.closest(`alps-popup`);n&&n.close(),this.mailboxToDelete=e.fullName;let r=Jt(`trash`,this.mailboxToDelete,this.mailboxes,Ut);qt(e.fullName,this.mailboxes)===`trash`||Qt(e.fullName,r,en(e.mb))?this.showDeleteConfirm=!0:this.showMoveToTrashConfirm=!0}}>
              ${k(`trash`)} <span class="item-text">${this.i18nStore?.t(`folderList.delete`)}</span>
            </button>
          `)),n`
          <div 
            class="folder-item ${a?`active`:``} ${p?`no-select`:``} ${o?`has-actions`:``}"
            title=${d}
            @click=${ee}
          >
            <alps-icon-btn 
            ...
            ${f>0?n`<div class="folder-badge">${f}</div>`:``}
          </div>

          ${r&&i?n`
            <div class="folder-children">
              ${h(Object.values(e.children).sort((e,t)=>{let n=m.indexOf(e.fullName),r=m.indexOf(t.fullName);return n!==-1&&r!==-1?n-r:n===-1?r===-1?e.name.localeCompare(t.name):1:-1}),t+1)}
            </div>
          `:``}
        `});return n`
      ...
      ${this.showDeleteConfirm?n`
        ...
        ></ui-confirm>
      `:``}
    `}};A([h({context:oi})],G.prototype,`composeStore`,void 0),A([h({context:C})],G.prototype,`i18nStore`,void 0),A([h({context:w})],G.prototype,`settingsStore`,void 0),A([o({type:Array})],G.prototype,`mailboxes`,void 0),A([o({type:String})],G.prototype,`currentMailbox`,void 0),A([o({type:Object})],G.prototype,`expandedFolders`,void 0),A([o({type:String})],G.prototype,`layoutMode`,void 0),A([o({type:Boolean})],G.prototype,`syncing`,void 0),A([o({type:Boolean,reflect:!0})],G.prototype,`collapsed`,void 0),A([a()],G.prototype,`isScrolled`,void 0),A([a()],G.prototype,`showCreatePrompt`,void 0),A([a()],G.prototype,`promptBusy`,void 0),A([a()],G.prototype,`showRenamePrompt`,void 0),A([a()],G.prototype,`mailboxToRename`,void 0),A([a()],G.prototype,`showDeleteConfirm`,void 0),A([a()],G.prototype,`showMoveToTrashConfirm`,void 0),A([a()],G.prototype,`mailboxToDelete`,void 0),A([a()],G.prototype,`parentForNewFolder`,void 0),A([a()],G.prototype,`activeKebabMenu`,void 0),G=A([p(`alps-folder-list`)],G);var Di=class extends d{constructor(...e){super(...e),this.name=``,this.address=``}static{this.styles=g`
    :host {
      display: inline;
    }
  ...
  `}handleClick(){this.composeStore.openComposer({to:[this.address]})}render(){let e=this.name;return e===this.address&&(e=``),e?n`
      ...
      `}};A([h({context:oi})],Di.prototype,`composeStore`,void 0),A([o({type:String})],Di.prototype,`name`,void 0),A([o({type:String})],Di.prototype,`address`,void 0),Di=A([p(`alps-recipient-pill`)],Di);function Oi(e,t,n){if(!e||t===void 0||t===``||!n)return``;let r=Array.isArray(n.Path)?n.Path.join(`.`):String(n.Path??``);return r?`/mailboxes/${O(e)}/messages/${t}/raw?part=${r}`:``}var ki=new Set([`png`,`jpg`,`jpeg`,`gif`,`webp`,`svg`,`avif`,`bmp`,`ico`,`tiff`,`tif`,`heic`,`heif`]),Ai=new Set([`pdf`]),ji=new Set([`doc`,`docx`,`odt`,`rtf`,`pages`,`dotx`,`docm`]),Mi=new Set([`xls`,`xlsx`,`csv`,`tsv`,`ods`,`numbers`,`xlsm`]),Ni=new Set([`ppt`,`pptx`,`odp`,`key`,`potx`,`ppsx`]),Pi=new Set([`zip`,`tar`,`gz`,`rar`,`7z`,`bz2`,`xz`,`tgz`,`iso`,`dmg`,`pkg`,`deb`,`rpm`]),Fi=new Set(`js.mjs.cjs.ts.mts.cts.jsx.tsx.json.json5.html.htm.css.scss.sass.less.py.go.rs.c.cpp.h.hpp.java.kt.sh.bash.zsh.yml.yaml.sql.xml.md.markdown.toml.ini.env.diff.patch.php.rb.swift.graphql.gql.proto.vue.svelte.rust`.split(`.`)),Ii=new Set([`txt`,`text`,`log`,`nfo`,`sub`,`srt`]),Li=new Set([`mp3`,`wav`,`ogg`,`m4a`,`flac`,`aac`,`wma`,`aiff`,`opus`,`mid`,`midi`]),Ri=new Set([`mp4`,`webm`,`mov`,`mkv`,`avi`,`wmv`,`flv`,`m4v`,`3gp`,`ogv`]),zi=new Set([`ics`,`ical`,`ifb`]),Bi=new Set([`vcf`,`vcard`]);function Vi(e){if(!e)return``;let t=e.lastIndexOf(`.`);return t===-1||t===e.length-1?``:e.slice(t+1).toLowerCase()}function Hi(e,t){let n=(e||``).toLowerCase().trim(),r=Vi(t);if(n===`application/pdf`||Ai.has(r))return{category:`pdf`,icon:`filePdf`,themeClass:`type-pdf`,color:`#ef4444`,previewKind:`pdf`,isImage:!1,isPdf:!0,isAudio:!1,isVideo:!1,isPreviewable:!0};if(n.startsWith(`image/`)||ki.has(r))return{category:`image`,icon:`image`,themeClass:`type-image`,color:`#10b981`,previewKind:`image`,isImage:!0,isPdf:!1,isAudio:!1,isVideo:!1,isPreviewable:!0};if(n.startsWith(`audio/`)||Li.has(r))return{category:`audio`,icon:`fileAudio`,themeClass:`type-audio`,color:`#f59e0b`,previewKind:`audio`,isImage:!1,isPdf:!1,isAudio:!0,isVideo:!1,isPreviewable:!0};if(n.startsWith(`video/`)||Ri.has(r))return{category:`video`,icon:`fileVideo`,themeClass:`type-video`,color:`#f43f5e`,previewKind:`video`,isImage:!1,isPdf:!1,isAudio:!1,isVideo:!0,isPreviewable:!0};if(Fi.has(r)||n===`application/json`||n===`application/ld+json`||n===`application/xml`||n===`application/javascript`||n===`text/javascript`||n===`text/css`||n===`text/html`||n===`text/markdown`||n===`text/x-python`||n===`text/x-shellscript`)return{category:`code`,icon:`fileCode`,themeClass:`type-code`,color:`#8b5cf6`,previewKind:`text`,isImage:!1,isPdf:!1,isAudio:!1,isVideo:!1,isPreviewable:!0};if(Mi.has(r)||n.includes(`spreadsheet`)||n.includes(`excel`)||n===`text/csv`||n===`text/tab-separated-values`){let e=r===`csv`||r===`tsv`||n===`text/csv`||n===`text/tab-separated-values`;return{category:`spreadsheet`,icon:`fileXls`,themeClass:`type-spreadsheet`,color:`#059669`,previewKind:e?`text`:`none`,isImage:!1,isPdf:!1,isAudio:!1,isVideo:!1,isPreviewable:e}}return ji.has(r)||n.includes(`word`)||n.includes(`officedocument.wordprocessingml`)||n===`application/rtf`?{category:`document`,icon:`fileDoc`,themeClass:`type-document`,color:`#3b82f6`,previewKind:`none`,isImage:!1,isPdf:!1,isAudio:!1,isVideo:!1,isPreviewable:!1}:Ni.has(r)||n.includes(`presentation`)||n.includes(`powerpoint`)?{category:`presentation`,icon:`filePpt`,themeClass:`type-presentation`,color:`#f59e0b`,previewKind:`none`,isImage:!1,isPdf:!1,isAudio:!1,isVideo:!1,isPreviewable:!1}:Pi.has(r)||n.includes(`zip`)||n.includes(`tar`)||n.includes(`compressed`)||n.includes(`archive`)?{category:`archive`,icon:`fileArchive`,themeClass:`type-archive`,color:`#64748b`,previewKind:`none`,isImage:!1,isPdf:!1,isAudio:!1,isVideo:!1,isPreviewable:!1}:zi.has(r)||n===`text/calendar`?{category:`calendar`,icon:`calendarBlank`,themeClass:`type-calendar`,color:`#0ea5e9`,previewKind:`text`,isImage:!1,isPdf:!1,isAudio:!1,isVideo:!1,isPreviewable:!0}:Bi.has(r)||n===`text/vcard`||n===`text/x-vcard`?{category:`contact`,icon:`user`,themeClass:`type-contact`,color:`#14b8a6`,previewKind:`text`,isImage:!1,isPdf:!1,isAudio:!1,isVideo:!1,isPreviewable:!0}:Ii.has(r)||n.startsWith(`text/`)?{category:`text`,icon:`fileText`,themeClass:`type-text`,color:`#6b7280`,previewKind:`text`,isImage:!1,isPdf:!1,isAudio:!1,isVideo:!1,isPreviewable:!0}:{category:`generic`,icon:`file`,themeClass:`type-generic`,color:``,previewKind:`none`,isImage:!1,isPdf:!1,isAudio:!1,isVideo:!1,isPreviewable:!1}}var Ui=class extends d{constructor(...e){super(...e),this.attachment=null,this.downloadUrl=``,this.fallbackName=`Unknown attachment`,this.removable=!1,this.compact=!1,this.imgError=!1}willUpdate(e){e.has(`attachment`)&&(this.imgError=!1)}static{this.styles=g`
    .attachment-chip {
      display: inline-flex;
      align-items: center;
      width: 100%;
...
<<<<<<<< HEAD:frontend/dist/assets/index-BHV7B3Zq.js
      `}};A([h({context:C})],Ui.prototype,`i18nStore`,void 0),A([o({type:Object})],Ui.prototype,`attachment`,void 0),A([o({type:String})],Ui.prototype,`downloadUrl`,void 0),A([o({type:String})],Ui.prototype,`fallbackName`,void 0),A([o({type:Boolean})],Ui.prototype,`removable`,void 0),A([o({type:Boolean,reflect:!0})],Ui.prototype,`compact`,void 0),A([a()],Ui.prototype,`imgError`,void 0),Ui=A([p(`alps-attachment-pill`)],Ui);var Wi=class extends d{constructor(...e){super(...e),this.attachments=[],this.mailbox=D,this.messageUid=``,this.removable=!1,this.composerMode=!1,this.attachmentsExpanded=!0,this._handleStoreChange=()=>{this.requestUpdate()}}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.i18nStore?.addEventListener(`change`,this._handleStoreChange)})}disconnectedCallback(){super.disconnectedCallback(),this.i18nStore?.removeEventListener(`change`,this._handleStoreChange)}get resolvedMailbox(){if(this.mailbox)return this.mailbox;let e=window.location.hash.match(/^#\/mailbox\/([^/]+)/);return e?decodeURIComponent(e[1]):D}_openPreview(e){window.dispatchEvent(new CustomEvent(`open-attachment-preview`,{detail:{attachments:this.attachments,mailbox:this.resolvedMailbox,messageUid:this.messageUid,index:e}}))}toggleAttachments(){this.attachmentsExpanded=!this.attachmentsExpanded}_downloadAll(e){if(e.stopPropagation(),!this.attachments||this.attachments.length===0||!this.messageUid)return;let t=this.resolvedMailbox;this.attachments.forEach((e,n)=>{let r=Oi(t,this.messageUid,e);r&&setTimeout(()=>{let t=document.createElement(`a`);t.href=r,t.download=e.Filename||this.i18nStore?.t(`messageReader.unknownAttachment`)||`attachment`,document.body.appendChild(t),t.click(),document.body.removeChild(t)},n*200)})}static{this.styles=g`
========
      `}};A([h({context:S})],Hi.prototype,`i18nStore`,void 0),A([o({type:Object})],Hi.prototype,`attachment`,void 0),A([o({type:String})],Hi.prototype,`downloadUrl`,void 0),A([o({type:String})],Hi.prototype,`fallbackName`,void 0),A([o({type:Boolean})],Hi.prototype,`removable`,void 0),A([o({type:Boolean,reflect:!0})],Hi.prototype,`compact`,void 0),A([a()],Hi.prototype,`imgError`,void 0),Hi=A([p(`alps-attachment-pill`)],Hi);var Ui=class extends d{constructor(...e){super(...e),this.attachments=[],this.mailbox=D,this.messageUid=``,this.removable=!1,this.composerMode=!1,this.attachmentsExpanded=!0,this._handleStoreChange=()=>{this.requestUpdate()}}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.isConnected&&this.i18nStore?.addEventListener(`change`,this._handleStoreChange)})}disconnectedCallback(){super.disconnectedCallback(),this.i18nStore?.removeEventListener(`change`,this._handleStoreChange)}get resolvedMailbox(){if(this.mailbox)return this.mailbox;let e=window.location.hash.match(/^#\/mailbox\/([^/]+)/);return e?decodeURIComponent(e[1]):D}_openPreview(e){window.dispatchEvent(new CustomEvent(`open-attachment-preview`,{detail:{attachments:this.attachments,mailbox:this.resolvedMailbox,messageUid:this.messageUid,index:e}}))}toggleAttachments(){this.attachmentsExpanded=!this.attachmentsExpanded}_downloadAll(e){if(e.stopPropagation(),!this.attachments||this.attachments.length===0||!this.messageUid)return;let t=this.resolvedMailbox;this.attachments.forEach((e,n)=>{let r=Di(t,this.messageUid,e);r&&setTimeout(()=>{let t=document.createElement(`a`);t.href=r,t.download=e.Filename||this.i18nStore?.t(`messageReader.unknownAttachment`)||`attachment`,document.body.appendChild(t),t.click(),document.body.removeChild(t)},n*200)})}static{this.styles=g`
>>>>>>>> main:frontend/dist/assets/index-CCMQIZxV.js
    :host {
      display: block;
      width: 100%;
  ...
  `}render(){return!this.attachments||this.attachments.length===0?n``:n`
          ...
          <div class="attachments-list">
            ${this.attachments.map((e,t)=>n`
                <alps-attachment-pill
                  .attachment=${e}
                  .downloadUrl=${this.messageUid?Oi(this.resolvedMailbox,this.messageUid,e):``}
    ...
    `}};A([h({context:C})],Wi.prototype,`i18nStore`,void 0),A([o({type:Array})],Wi.prototype,`attachments`,void 0),A([o({type:String})],Wi.prototype,`mailbox`,void 0),A([o({type:String})],Wi.prototype,`messageUid`,void 0),A([o({type:Boolean})],Wi.prototype,`removable`,void 0),A([o({type:Boolean,reflect:!0})],Wi.prototype,`composerMode`,void 0),A([a()],Wi.prototype,`attachmentsExpanded`,void 0),Wi=A([p(`alps-attachment-list`)],Wi);var Gi=class extends d{constructor(...e){super(...e),this.mailboxes=[],this.currentMailbox=``,this.noActionBox=!1,this.noSearchBox=!1,this.filterQuery=``,this.isMove=!0}static{this.styles=g`
    :host {
      display: inline-block;
    }
  ...
  `}_handleFilter(e){let t=e.target;this.filterQuery=t.value.toLowerCase()}_handleSelect(e){this.popup&&this.popup.close(),this.dispatchEvent(new CustomEvent(`folder-selected`,{detail:{folderName:e,isMove:this.isMove},bubbles:!0,composed:!0}))}_handlePopupToggle(){this.filterQuery=``,setTimeout(()=>{this.filterInput&&this.filterInput.focus()},50)}render(){let e=this.mailboxes.map(e=>e.Name||e.Mailbox||``).filter(e=>e!==``&&e!==this.currentMailbox).filter(e=>e.toLowerCase().includes(this.filterQuery));return n`
    ...
    `}};A([h({context:C})],Gi.prototype,`i18nStore`,void 0),A([o({type:Array})],Gi.prototype,`mailboxes`,void 0),A([o({type:String})],Gi.prototype,`currentMailbox`,void 0),A([o({type:Boolean})],Gi.prototype,`noActionBox`,void 0),A([o({type:Boolean})],Gi.prototype,`noSearchBox`,void 0),A([a()],Gi.prototype,`filterQuery`,void 0),A([a()],Gi.prototype,`isMove`,void 0),A([ee(`alps-popup`)],Gi.prototype,`popup`,void 0),A([ee(`input`)],Gi.prototype,`filterInput`,void 0),Gi=A([p(`alps-folder-selector-popup`)],Gi);var Ki=class extends d{constructor(...e){super(...e),this.verified=!1,this.failed=!1}static{this.styles=g`
    :host {
      display: inline-flex;
      flex-shrink: 0;
  ...
  `}render(){let e=this.verified?`verified`:this.failed?`failed`:``;if(!e)return c;let t=e===`verified`?this.i18nStore?.t(`messageReader.verifiedSender`)||`Verified Sender`:this.i18nStore?.t(`messageReader.unverifiedSender`)||`Unverified Sender`;return n`
      <span class="badge ${e}" role="img" aria-label=${t} title=${t}>
        ${k(e===`verified`?`verifiedBadge`:`authFailedBadge`)}
      </span>
    `}};A([h({context:C})],Ki.prototype,`i18nStore`,void 0),A([o({type:Boolean})],Ki.prototype,`verified`,void 0),A([o({type:Boolean})],Ki.prototype,`failed`,void 0),Ki=A([p(`alps-sender-auth-badge`)],Ki);var qi=t(te(),1),Ji=`data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7`;function Yi(e){let t=e.trim().toLowerCase();return t.startsWith(`http://`)||t.startsWith(`https://`)||t.startsWith(`//`)}function Xi(e){return e.toLowerCase().replace(/[^\x21-\x7e]/g,``)}function Zi(e){return Xi(e).startsWith(`cid:`)}function Qi(e){return e.replace(/[^\x21-\x7e]/g,``).substring(4)}var $i=()=>/url\(\s*(['"]?)((?:https?:)?\/\/[^'"\)]+)\1\s*\)/gi,ea=()=>/@import\s+(?:url\(\s*)?(['"]?)((?:https?:)?\/\/[^'"\)]+)\1\s*\)?\s*;?/gi;function ta(e){return`/proxy?url=${encodeURIComponent(e.trim())}`}function na(e,t){return Yi(e)?(t.onRemoteResourceBlocked&&t.onRemoteResourceBlocked(),t.allowRemoteResources?ta(e):Ji):null}function ra(e,t){let n=e.split(`,`).map(e=>e.trim()).filter(Boolean);if(n.length===0)return null;let r=!1,i=n.map(e=>{let n=e.search(/\s/),i=n===-1?e:e.slice(0,n),a=n===-1?``:e.slice(n);return Yi(i)?(r=!0,t.allowRemoteResources?`${ta(i)}${a}`:Ji):e});return r?(t.onRemoteResourceBlocked&&t.onRemoteResourceBlocked(),t.allowRemoteResources?i.join(`, `):Ji):null}function ia(e,t,n=``){if(!e)return null;let r=t.replace(/^<|>$/g,``);if(e.ID&&e.ID.replace(/^<|>$/g,``)===r)return n||`1`;if(e.Children&&Array.isArray(e.Children))for(let r=0;r<e.Children.length;r++){let i=n?`${n}.${r+1}`:`${r+1}`,a=ia(e.Children[r],t,i);if(a)return a}return null}function aa(e,t){if(!e)return e;try{let n=qi.parse(e,{silent:!0});if(n&&n.stylesheet&&n.stylesheet.rules){let e=$i(),r=n=>n.replace(e,(e,n,r)=>{if(t.onRemoteResourceBlocked&&t.onRemoteResourceBlocked(),t.allowRemoteResources){let e=n||`"`;return`url(${e}${ta(r)}${e})`}else return`url(${Ji})`}),i=n=>{for(let a=n.length-1;a>=0;a--){let o=n[a];if([`rule`,`font-face`,`page`,`keyframe`].includes(o.type)&&!o.declarations&&(o.declarations=[]),[`rule`,`page`].includes(o.type)&&!o.selectors&&(o.selectors=[]),o.type===`keyframe`&&!o.values&&(o.values=[]),o.type===`import`){let e=o;if(e.import&&e.import.match(/(?:https?:)?\/\//i)){t.onRemoteResourceBlocked&&t.onRemoteResourceBlocked(),n.splice(a,1);continue}}else if(o.type===`font-face`){let r=o;if(r.declarations){let i=!1;for(let n of r.declarations)n.type===`declaration`&&n.value?.match(e)&&(t.onRemoteResourceBlocked&&t.onRemoteResourceBlocked(),i=!0);if(i&&!t.allowRemoteResources){n.splice(a,1);continue}}}if(o.declarations)for(let t of o.declarations)t.type===`declaration`&&t.value&&t.value.match(e)&&(t.value=r(t.value));o.rules&&i(o.rules)}};return i(n.stylesheet.rules),qi.stringify(n)}}catch(e){console.warn(`AST CSS parsing failed, falling back to regex sanitizer`,e)}let n=e,r=ea(),i=$i();return(n.match(r)||n.match(i))&&(t.onRemoteResourceBlocked&&t.onRemoteResourceBlocked(),n=n.replace(r,``),t.allowRemoteResources?n=n.replace(i,(e,t,n)=>`url(${t}${ta(n)}${t})`):(n=n.replace(/@font-face\s*\{[^{}]*\}/gi,e=>/url\(\s*['"]?(?:https?:)?\/\//i.test(e)?``:e),n=n.replace(i,`url(${Ji})`))),n}function oa(e,t){let n=new DOMParser().parseFromString(e,`text/html`);n.querySelectorAll(`iframe, object, embed, frame, frameset, applet, meta[http-equiv]`).forEach(e=>e.remove()),n.querySelectorAll(`link`).forEach(e=>{(e.getAttribute(`rel`)||``).toLowerCase()!==`stylesheet`&&e.remove()});let r=n.createElement(`base`);r.target=`_blank`,n.head.prepend(r);let i=n.createElement(`meta`);i.httpEquiv=`Content-Security-Policy`,i.content=`default-src 'none'; img-src ${window.location.origin} data: blob: cid:; media-src ${window.location.origin} data: blob: cid:; style-src 'unsafe-inline'; font-src ${window.location.origin} data:; script-src 'none'; object-src 'none'; frame-src 'none'; child-src 'none'; form-action 'none'; base-uri 'none';`,n.head.prepend(i);let a=n.createElement(`style`);a.textContent=`
  ...
  `,n.head.prepend(a),n.querySelectorAll(`img`).forEach(e=>{let n=e.getAttribute(`src`);if(n)if(Zi(n)){let r=Qi(n);if(t.messageStructure){let n=ia(t.messageStructure,r);n&&(e.src=`/mailboxes/${O(t.mailbox)}/messages/${t.messageUid}/raw?part=${n}`)}}else Yi(n)&&(t.onRemoteResourceBlocked&&t.onRemoteResourceBlocked(),t.allowRemoteResources?e.src=ta(n):(e.setAttribute(`data-original-src`,n),e.src=Ji,e.style.height=`0`,e.style.width=`0`))});for(let e of Array.from(n.querySelectorAll(`img[srcset], source[srcset], video[poster], source[src]`)))for(let n of[`srcset`,`poster`,`src`]){let r=e.getAttribute(n);if(!r||n===`src`&&e.tagName.toLowerCase()===`img`)continue;let i=n===`srcset`?ra(r,t):na(r,t);i!==null&&e.setAttribute(n,i)}n.querySelectorAll(`link[rel="stylesheet"]`).forEach(e=>{let n=e.getAttribute(`href`);n&&Yi(n)&&(t.onRemoteResourceBlocked&&t.onRemoteResourceBlocked(),e.remove())}),n.querySelectorAll(`a[href]`).forEach(e=>{e.setAttribute(`rel`,`noopener noreferrer`)}),n.querySelectorAll(`style`).forEach(e=>{e.textContent&&=aa(e.textContent,t)});let o=$i();return n.querySelectorAll(`[style]`).forEach(e=>{let n=e.getAttribute(`style`);n&&n.match(o)&&(t.onRemoteResourceBlocked&&t.onRemoteResourceBlocked(),n=t.allowRemoteResources?n.replace(o,(e,t,n)=>{let r=t||`"`;return`url(${r}${ta(n)}${r})`}):n.replace(o,`url(${Ji})`),e.setAttribute(`style`,n))}),n.documentElement.outerHTML}function sa(e){if(!e)return``;let t=new DOMParser().parseFromString(e,`text/html`);t.querySelectorAll(`script, style, link, iframe, object, embed, form, meta, base`).forEach(e=>e.remove());for(let e of Array.from(t.querySelectorAll(`*`))){for(let t of Array.from(e.attributes)){let n=t.name.toLowerCase();if(n.startsWith(`on`)){e.removeAttribute(t.name);continue}if(n===`href`||n===`src`||n===`srcset`||n===`action`){let n=Xi(t.value);(n.startsWith(`javascript:`)||n.startsWith(`vbscript:`)||n.startsWith(`data:text/html`))&&e.removeAttribute(t.name)}}let t=e.getAttribute(`style`);t&&/url\s*\(/i.test(t)&&e.setAttribute(`style`,t.replace(/url\s*\([^)]*\)/gi,``))}return t.body.innerHTML}function ca(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}var la=`data-alps-quote`;function ua(e){return e?e.map(e=>e.Name?`${e.Name} <${e.Mailbox}@${e.Host}>`:`${e.Mailbox}@${e.Host}`):[]}var da=e=>`${e?.Mailbox??``}@${e?.Host??``}`.toLowerCase(),fa=e=>{let t=e.trim(),n=t.lastIndexOf(`<`);return(t.endsWith(`>`)&&n!==-1?t.slice(n+1,-1):t).trim().toLowerCase()};function pa(e,t,n,r,i,a=`YYYY-MM-DD`,o=`12`,s=[]){let c=t?.Envelope?.Subject||``,l=c;l=e===`forward`?l.toLowerCase().startsWith(`fwd:`)?l:`Fwd: ${l}`:l.toLowerCase().startsWith(`re:`)?l:`Re: ${l}`;let u=[],d=[];if(e===`reply`||e===`replyAll`){let n=t?.Envelope??{},r=new Set(s.filter(Boolean).map(fa)),i=new Set,a=e=>(e||[]).filter(e=>{let t=da(e);return r.has(t)||i.has(t)?!1:(i.add(t),!0)}),o=n.ReplyTo?.length>0?n.ReplyTo:n.From,c=a(o);(e===`replyAll`||c.length===0)&&(c=[...c,...a(n.To)]);let l=e===`replyAll`?a(n.Cc):[];c.length===0&&([c,l]=[l,[]]),u=c.length>0?ua(c):ua(o),d=ua(l)}let f=t?.Envelope?.Date?an(t.Envelope.Date,a,o):``,p=t?.Envelope?.From?.[0],m=p?.Mailbox&&p?.Host?`${p.Mailbox}@${p.Host}`:``,h=p?.Name||m||`Unknown Sender`,ee=`On ${f}, ${h} wrote:`;e===`forward`&&(ee=`---------- Forwarded message ---------\nFrom: ${h} <${m}>\nDate: ${f}\nSubject: ${c}\nTo: ${ua(t?.Envelope?.To).join(`, `)}\n`);let g=`\n\n${ee}\n`+n.split(`
`).map(e=>`> ${e}`).join(`
`),te=ca(h),ne=ca(m),re=ca(c),_=ca(f),v=i&&r?sa(r):``,y=``;return y=v?e===`forward`?`<br><br><div class="gmail_quote" ${la}><div dir="ltr" class="gmail_attr">---------- Forwarded message ---------<br>From: ${te} &lt;${ne}&gt;<br>Date: ${_}<br>Subject: ${re}<br>To: ${ca(ua(t?.Envelope?.To).join(`, `))}<br></div><br>${v}</div>`:`<br><br><div class="gmail_quote" ${la}><div dir="ltr" class="gmail_attr">On ${_}, ${te} wrote:<br></div><blockquote class="gmail_quote" style="margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);padding-left:1ex">${v}</blockquote></div>`:`<br><br><div class="gmail_quote"><div dir="ltr" class="gmail_attr">${ca(ee).replace(/\n/g,`<br>`)}<br></div><blockquote class="gmail_quote" style="margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);padding-left:1ex">${ca(n).replace(/\n/g,`<br>`)}</blockquote></div>`,{subject:l,to:u,cc:d,quotedText:g,quotedHtml:y}}var ma=`alps_last_active`,ha=3e3;function ga(e){try{return window.localStorage.getItem(e)}catch{return null}}function _a(e,t){try{window.localStorage.setItem(e,t)}catch{}}function va(e){try{window.localStorage.removeItem(e)}catch{}}var ya=new class{constructor(){this.events=[`mousedown`,`mousemove`,`keydown`,`scroll`,`touchstart`,`wheel`,`pointerdown`,`pointermove`,`click`,`input`,`focusin`],this.logoutMinutes=0,this.lastActivity=Date.now(),this.lastSync=0,this.lastPing=Date.now(),this.checkInterval=null,this.recordActivity=()=>{let e=Date.now();this.lastActivity=e,!(window.location.hash===`#/login`||window.location.hash===``)&&e-this.lastSync>=ha&&(this.lastSync=e,_a(ma,String(e)))},this.handleActivity=()=>{this.recordActivity()},this.handleStorage=e=>{if(e.key===ma&&e.newValue){let t=Number(e.newValue);Number.isFinite(t)&&t>this.lastActivity&&(this.lastActivity=t)}}}setLogoutTime(e){let t=this.logoutMinutes>0;this.logoutMinutes=e;let n=this.logoutMinutes>0;n&&!t?(this.attachEvents(),this.startInterval()):!n&&t?(this.detachEvents(),this.clearInterval()):n&&t&&this.recordActivity()}attachEvents(){this.lastSync=0,this.events.forEach(e=>{document.addEventListener(e,this.handleActivity,{capture:!0,passive:!0})}),window.addEventListener(`storage`,this.handleStorage),this.recordActivity()}detachEvents(){this.lastSync=0,this.events.forEach(e=>{document.removeEventListener(e,this.handleActivity,{capture:!0})}),window.removeEventListener(`storage`,this.handleStorage)}trackIframe(e){try{let t=e.contentDocument;if(!t)return;this.events.forEach(e=>{t.addEventListener(e,this.handleActivity,{capture:!0,passive:!0})})}catch{}}startInterval(){this.clearInterval(),this.checkInterval=setInterval(()=>this.checkTimeout(),3e4)}clearInterval(){this.checkInterval&&=(clearInterval(this.checkInterval),null)}checkTimeout(){if(this.logoutMinutes<=0)return;if(window.location.hash===`#/login`||window.location.hash===``){this.recordActivity();return}let e=this.lastActivity,t=Number(ga(ma));Number.isFinite(t)&&t>e&&(e=t,this.lastActivity=t);let n=Date.now()-e;n>=this.logoutMinutes*60*1e3?this.logout():n<300*1e3&&Date.now()-this.lastPing>300*1e3&&this.pingBackend()}async pingBackend(){this.lastPing=Date.now();try{await fetch(`/session`)}catch{}}rearm(){this.lastActivity=Date.now(),this.lastPing=Date.now(),this.lastSync=0,this.logoutMinutes>0&&(this.attachEvents(),this.startInterval())}async logout(){this.clearInterval(),this.detachEvents();let e=0;if(this.onBeforeLogout)try{e=(await this.onBeforeLogout())?.failed??0}catch(e){x.error(`Failed to run onBeforeLogout hook`,e)}try{va(ma),ci(e>0?`inactivitySignedOutDraftsLost`:`inactivitySignedOut`);try{await fetch(`/session`,{method:`DELETE`})}catch(e){x.error(`Sign-out request failed; ending the session locally anyway`,e)}xr.clear(),Ae(),window.dispatchEvent(new CustomEvent(`session-cleared`)),window.location.hash=`#/login`}catch(e){x.error(`Failed to auto sign out`,e)}finally{this.rearm()}}};function ba(e,t){if(!e.contentDocument||!e.contentDocument.body)return;let n=e.contentDocument.getElementById(`dark-mode-override`);if(n&&n.remove(),t&&document.body.classList.contains(`theme-dark`)){let t=window.getComputedStyle(document.documentElement).getPropertyValue(`--bg-primary`).trim()||`#1f2937`,n=window.getComputedStyle(document.documentElement).getPropertyValue(`--text-primary`).trim()||`#f9fafb`,r=window.getComputedStyle(document.documentElement).getPropertyValue(`--accent-color`).trim()||`#3b82f6`,i=window.getComputedStyle(document.documentElement).getPropertyValue(`--border-color`).trim()||`#374151`,a=e.contentDocument.createElement(`style`);a.id=`dark-mode-override`,a.textContent=`
      html {
    ...
    `,e.contentDocument.head.appendChild(a)}}function xa(e,t){if(!e.contentDocument||!e.contentDocument.body)return;e.style.width=`100%`,e.contentDocument.addEventListener(`dragover`,e=>e.preventDefault()),e.contentDocument.addEventListener(`drop`,e=>e.preventDefault()),ya.trackIframe(e),ba(e,t),e._ro&&e._ro.disconnect();let n=e.contentDocument,r=()=>{if(!e.contentDocument)return;let t=e.contentDocument.documentElement,n=e.contentDocument.body,r=Math.max(t?.scrollHeight||0,n?.scrollHeight||0);if(r>0){let t=parseFloat(e.style.height)||0;Math.abs(t-r)>2&&(e.style.height=`${Math.ceil(r)}px`)}};r();let i=new ResizeObserver(()=>r());i.observe(n.body),i.observe(n.documentElement),e._ro=i}function Sa(e){if(!e)return``;let t=new DOMParser().parseFromString(e,`text/html`);t.querySelectorAll(`script, style, noscript, head, template`).forEach(e=>e.remove());let n=new Set([`p`,`div`,`br`,`tr`,`li`,`h1`,`h2`,`h3`,`h4`,`h5`,`h6`,`blockquote`,`section`,`article`,`header`,`footer`,`pre`,`table`,`ul`,`ol`]),r=``,i=e=>{for(let t of Array.from(e.childNodes))if(t.nodeType===Node.TEXT_NODE)r+=t.textContent||``;else if(t.nodeType===Node.ELEMENT_NODE){let e=t,a=e.tagName.toLowerCase();if(a===`br`){r+=`
`;continue}i(e),n.has(a)&&(r+=`
`)}};return t.body&&i(t.body),r.replace(/\n{3,}/g,`

`).trim()}function Ca(e,t,n,r){if(!e)return n||r;let i=e;if(t?.toLowerCase()===`text/html`||e.trim().startsWith(`<`)||/<\/[a-zA-Z]+>/.test(e)||/<[a-zA-Z]+[^>]*>/.test(e))try{let t=new DOMParser().parseFromString(e,`text/html`);t.querySelectorAll(`style, script, head`).forEach(e=>e.remove());let n=e=>{if(e.nodeType===Node.TEXT_NODE)return e.textContent||``;if(e.nodeType===Node.ELEMENT_NODE){let t=e,r=t.tagName.toLowerCase();if(r===`br`)return` `;let i=``;for(let e=0;e<t.childNodes.length;e++)i+=n(t.childNodes[e]);return[`p`,`div`,`td`,`tr`,`th`,`li`,`h1`,`h2`,`h3`,`h4`,`h5`,`h6`,`section`,`article`,`blockquote`,`ol`,`ul`,`header`,`footer`].includes(r)?` `+i+` `:i}return``};i=n(t.body||t)}catch{i=e.replace(/<[^>]*>/g,` `)}else i=e.replace(/[\r\n\t]+/g,` `);let a=i.replace(/\s+/g,` `).trim();if(a){let e=a.substring(0,100);return a.length>100?e+`...`:e}else if(n)return n.replace(/[\r\n\t\s]+/g,` `).trim();else return r}var wa=class extends d{constructor(...e){super(...e),this.showSenderAvatars=!0,this.canToggleRead=!1}static{this.styles=g`
    :host {
      display: block;
            ...
            ${this.item.expanded?n`
              ...
              <alps-popup align="right" class="card-more-menu" @click=${e=>e.stopPropagation()}>
                ...
                <button class="dropdown-item" @click=${()=>this.handleActionForItem(`reply`)}>
                  ${k(`arrowBendUpLeft`)} <span class="item-text">${this.i18nStore?.t(`messageReader.reply`)}</span>
                </button>
                <button class="dropdown-item" @click=${()=>this.handleActionForItem(`replyAll`)}>
                  ${k(`arrowBendDoubleUpLeft`)} <span class="item-text">${this.i18nStore?.t(`messageReader.replyAll`)}</span>
                </button>
                <button class="dropdown-item" @click=${()=>this.handleActionForItem(`forward`)}>
                  ${k(`arrowBendUpRight`)} <span class="item-text">${this.i18nStore?.t(`messageReader.forward`)}</span>
                </button>
                <div class="dropdown-divider"></div>
                ...
                <button class="dropdown-item" @click=${()=>this.handleActionForItem(f?`markRead`:`markUnread`)}>
                  ${k(f?`envelopeOpen`:`envelopeUnread`)} <span class="item-text">${this.i18nStore?.t(f?`messageReader.markRead`:`messageReader.markUnread`)}</span>
                </button>
                `:``}
                <button class="dropdown-item" @click=${()=>this.handleActionForItem(`print`)}>
                  ${k(`printer`)} <span class="item-text">${this.i18nStore?.t(`messageReader.print`)}</span>
                </button>
                <button class="dropdown-item" @click=${()=>this.handleActionForItem(`downloadMessage`)}>
                  ${k(`downloadSimple`)} <span class="item-text">${this.i18nStore?.t(`messageReader.downloadMessage`)}</span>
                </button>
                <button class="dropdown-item" @click=${()=>this.handleActionForItem(`showOriginal`)}>
                  ${k(`codeBlock`)} <span class="item-text">${this.i18nStore?.t(`messageReader.showOriginal`)}</span>
                </button>
                <div class="dropdown-divider"></div>
                <button class="dropdown-item" @click=${()=>this.handleDeleteItem()}>
                  ${k(`trash`)} <span class="item-text">${this.i18nStore?.t(`messageReader.delete`)}</span>
                </button>
              </alps-popup>
            `:``}
...
>>>>>>>> main:frontend/dist/assets/index-CCMQIZxV.js
  ...
  `]}updated(e){if(!e.has(`message`))return;if(!this.message){this.scrolledToKey=null;return}let t=this.keyOf(this.message);t!==this.scrolledToKey&&(this.scrolledToKey=t,this.scrollToCard(t))}scrollToCard(e){this.scrollTimer&&clearTimeout(this.scrollTimer),this.scrollTimer=setTimeout(()=>{this.scrollTimer=null;let t=this.threadItems.find(t=>this.itemKey(t)===e),n=t?this.shadowRoot?.getElementById(this.cardId(t)):null;n&&n.scrollIntoView({behavior:`smooth`,block:`start`})},50)}willUpdate(e){let t=e.has(`message`),n=e.has(`mailbox`),r=e.has(`messages`);if(t||n){let t=e.get(`message`),n=e.has(`mailbox`)?e.get(`mailbox`):this.mailbox;this.message?!t||this.keyOf(t)!==this.keyOf(this.message)||n!==this.mailbox?(this.localPreferredView=null,this.fetchMessageBody(this.message,this.message._isAutosaveUpdate)):(t&&(t.HasBimiPotential&&!this.message.HasBimiPotential&&(this.message={...this.message,HasBimiPotential:!0}),t.HasBimiFailed&&!this.message.HasBimiFailed&&(this.message={...this.message,HasBimiFailed:!0})),this.resolveThread(this.message),this.message._isAutosaveUpdate&&t&&this.message!==t&&this.fetchMessageBody(this.message,!0)):(this.localPreferredView=null,this.content=``,this.mimeType=``,this.rawMessageHtml=``,this.loading=!1,this.allowRemoteResources=!1,this.hasRemoteResources=!1,this.hasHtml=!1,this.hasText=!1,this.activeBanners=[],this.threadItems=[])}else r&&this.message&&this.resolveThread(this.message);this.syncReadTimers()}syncReadTimers(){let e=this.settingsStore?.getState()?.markReadTimeout??0,t=this.selectedCount>0,n=new Set;if(e>=0&&this.threadItems.length>1&&!t)for(let e of this.threadItems)!e.message||!e.expanded||this.isOpenItem(e)||e.message.Flags?.includes(`\\Seen`)||Ta(e.message)||n.add(this.itemKey(e));let r=!1;for(let e of[...this.readDueAt.keys()])n.has(e)||(r=this.readDueAt.delete(e)||r);for(let t of n)this.readDueAt.has(t)||(this.readDueAt.set(t,Date.now()+e*1e3),r=!0);r&&this.armReadTimer()}armReadTimer(){if(this.readTimer&&clearTimeout(this.readTimer),this.readTimer=null,this.readDueAt.size===0)return;let e=Math.max(0,Math.min(...this.readDueAt.values())-Date.now());this.readTimer=setTimeout(()=>this.flushReadDue(),e)}flushReadDue(){this.readTimer=null;let e=Date.now(),t=[...this.readDueAt].filter(([,t])=>t<=e).map(([e])=>e);for(let e of t)this.readDueAt.delete(e);let n=t.filter(e=>{let t=this.threadItems.find(t=>this.itemKey(t)===e);return!!t&&t.expanded&&!t.message?.Flags?.includes(`\\Seen`)});n.length>0&&this.markMembersRead(n),this.armReadTimer()}patchMemberFlag(e,t,n){let r=e=>{let r=e?.Flags||[],i=r.includes(t);return n===`add`===i?e:{...e,Flags:n===`add`?[...r,t]:r.filter(e=>e!==t)}},i=this.threadItems.findIndex(t=>this.itemKey(t)===e);if(i!==-1){let e=this.threadItems[i],t=r(e.message);t!==e.message&&(this.threadItems[i]={...e,message:t},this.threadItems=[...this.threadItems])}this._conversation&&={...this._conversation,messages:this._conversation.messages.map(t=>this.keyOf(t)===e?r(t):t)},this.message&&this.keyOf(this.message)===e&&(this.message.Flags=r(this.message).Flags,this.requestUpdate())}async markMembersRead(e){let t=new Set(e),n=new Map;for(let e of this.threadItems){if(!e.message||!t.has(this.itemKey(e)))continue;let r=n.get(e.mailbox)??[];r.push(String(e.message.UID)),n.set(e.mailbox,r)}let r=this.listedKeys(),i=(e,t,n)=>{for(let i of t){let t=H(e,i);r.has(t)&&this.isConnected&&this.dispatchEvent(new CustomEvent(`message-flags-changed`,{detail:{uid:i,mailbox:e,flag:R,action:n},bubbles:!0,composed:!0})),this.patchMemberFlag(t,R,n)}};await Promise.all([...n].map(async([e,t])=>{i(e,t,`add`);let n=!1;try{n=(await B.setFlag(e,t,[R],`add`)).ok}catch(e){x.error(`Failed to mark conversation messages read`,e)}n||i(e,t,`remove`)}))}expandUnreadOnOpen(){if(this.openIsUnsent)return;let e=this.threadItems.filter(e=>e.message&&!e.message.Flags?.includes(`\\Seen`)&&!Ta(e.message)),t=!1;for(let n of e.slice(0,Ea))n.expanded||(n.expanded=!0,t=!0,!n.content&&!n.loading&&(n.loading=!0,this.queueItemBody(n)));return t&&(this.threadItems=[...this.threadItems]),e[0]?this.itemKey(e[0]):void 0}settleOpenedConversation(){if(!this.message||this.threadItems.length<2)return;let e=this.expandUnreadOnOpen();e&&e!==this.keyOf(this.message)&&this.scrollToCard(e)}loadRemoteResources(){if(this.allowRemoteResources=!0,this.message&&this.rawMessageHtml){this.hasRemoteResources=!1,this.content=oa(this.rawMessageHtml,{mailbox:this.mailboxOfMessage(this.message),messageUid:this.message.UID,allowRemoteResources:this.allowRemoteResources,messageStructure:this.message.BodyStructure,onRemoteResourceBlocked:()=>{this.hasRemoteResources=!0}});let e=this.threadItems.find(e=>this.isOpenItem(e));e&&(e.allowRemoteResources=!0,e.content=this.content,e.hasRemoteResources=this.hasRemoteResources,this.updateThreadItemReference(e))}}resolveThread(e){if(!e)return;let t=this.settingsStore?.getState()?.enableThreading??!0,n=[],r=null;if(t&&this.messages&&this.messages.length>0){let t=this.messages.find(t=>this.keyOf(t)===this.keyOf(e));if(t)r=t;else for(let t of this.messages)if(t.SubMessages&&t.SubMessages.find(t=>this.keyOf(t)===this.keyOf(e))){r=t;break}}if(r?(n=[r,...r.SubMessages||[]],n.sort((e,t)=>(e.Envelope?.Date?new Date(e.Envelope.Date).getTime():0)-(t.Envelope?.Date?new Date(t.Envelope.Date).getTime():0))):n=(t&&this.threadItems.length>1&&this.threadItems.some(t=>this.itemKey(t)===this.keyOf(e))?this.threadItems.map(e=>({...e.message,Mailbox:e.mailbox})):null)??[e],t&&this._conversation?.key===this.keyOf(e)){let e=new Set(n.map(e=>this.keyOf(e))),t=this._conversation.messages.filter(t=>!e.has(this.keyOf(t)));t.length>0&&(n=[...n,...t],n.sort((e,t)=>(e.Envelope?.Date?new Date(e.Envelope.Date).getTime():0)-(t.Envelope?.Date?new Date(t.Envelope.Date).getTime():0)))}this._isThread=t&&n.length>1;let i=this.getSentMailboxName(),a=this.threadItems||[];this.threadItems=n.map(t=>{let n=this.keyOf(t)===this.keyOf(e),r=a.find(e=>this.itemKey(e)===this.keyOf(t));if(r){let e={...t,Flags:t.Flags||r.message.Flags||[]};return r.message.HasBimiPotential&&(e.HasBimiPotential=!0),r.message.HasBimiFailed&&(e.HasBimiFailed=!0),{...r,message:e}}return{message:t,content:``,mimeType:``,loading:!1,attachments:[],rawMessageHtml:``,hasHtml:!1,hasText:!1,activeBanners:[],allowRemoteResources:this.allowRemoteResources,hasRemoteResources:!1,isSent:(this.mailbox||``).toLowerCase()===i.toLowerCase()||(t.Mailbox||``).toLowerCase()===i.toLowerCase(),mailbox:t.Mailbox||this.mailbox,expanded:n}})}async fetchMessageBody(e,t=!1){e&&(e._isAutosaveUpdate=!1),this.message&&(this.message._isAutosaveUpdate=!1),t||(this.content=``,this.mimeType=``,this.rawMessageHtml=``,this.loading=!0,this.activeBanners=[],this.allowRemoteResources=this.settingsStore?.getState().showRemoteContent===`always`,this.hasRemoteResources=!1,this.threadItems=[],this._conversation=null),this.resolveThread(e),this.prefetchQueue=[];let n=this.threadItems.find(t=>this.itemKey(t)===this.keyOf(e))||this.threadItems[0];if(n){n.loading=!t,n.expanded=!0,this._deferPropertySync=!1;let r=this.fetchItemBody(n);r.then(()=>{this.isConnected&&(!this.message||this.keyOf(this.message)!==this.keyOf(e)||this.requestUpdate())}),t||r.catch(()=>{}).then(()=>this.loadConversation(e));return}t||this.loadConversation(e)}queueItemBody(e){this.isConnected&&(this.prefetchQueue.push(e),this.drainPrefetch())}async drainPrefetch(){if(!this.prefetching){this.prefetching=!0;try{for(;this.prefetchQueue.length>0;){let e=this.prefetchQueue.shift();e.content||await this.fetchItemBody(e)}}finally{this.prefetching=!1}}}async loadConversation(e,t=!0){if(!(this.settingsStore?.getState()?.enableThreading??!0)||!e?.UID)return;let n=this.keyOf(e),r=e.Mailbox||this.mailbox;try{let t=await E(`/mailboxes/${O(r)}/messages/${e.UID}/thread`);if(t.ok){let e=await t.json(),r=Array.isArray(e?.Messages)?e.Messages:[];if(!this.isConnected||!this.message||this.keyOf(this.message)!==n)return;this._conversation={key:n,messages:r},r.length>1&&(this.resolveThread(this.message),this.requestUpdate())}}catch(e){x.error(`Failed to load the conversation`,e)}t&&this.message&&this.keyOf(this.message)===n&&this.settleOpenedConversation()}updateThreadItemReference(e){if(!e.message||!this.isConnected)return;let t=this.threadItems.findIndex(t=>this.itemKey(t)===this.itemKey(e));t!==-1&&(this.threadItems[t]={...e},this.threadItems=[...this.threadItems])}async fetchItemBody(e){if(!e.message)return;let t=e.message,n=e.mailbox,r=this.localPreferredView||this.settingsStore?.getState()?.preferredView||`html`;try{let i=xr.get(n,t.UID.toString(),r);if(i){if(e.attachments=i.Attachments||[],e.hasHtml=i.HasHTML||!1,e.hasText=i.HasText||!1,i.Message&&(e.message={...t,...i.Message}),i.Part)if(e.mimeType=i.Part.MIMEType||i.Part.MimeType||`text/plain`,i.RawHtml===void 0){if(i.RawText!==void 0){e.content=i.RawText;let t={content:e.content,isHtml:!1,message:e.message,mailbox:n,banners:[],i18nStore:this.i18nStore},r=await v.invokeHookAsync(`reader:content`,t);for(let t of r)t&&typeof t==`string`&&(e.content=t);e.activeBanners=t.banners||[],t.isHtml&&(e.mimeType=`text/html`,e.hasHtml=!0,e.content=oa(e.content,{mailbox:n,messageUid:e.message?.UID,allowRemoteResources:e.allowRemoteResources,messageStructure:e.message?.BodyStructure,onRemoteResourceBlocked:()=>{e.hasRemoteResources=!0,this.isOpenItem(e)&&(this.hasRemoteResources=!0)}}))}}else{e.rawMessageHtml=i.RawHtml;let t={content:e.rawMessageHtml,isHtml:!0,message:e.message,mailbox:n,banners:[],i18nStore:this.i18nStore},r=await v.invokeHookAsync(`reader:content`,t);for(let t of r)t&&typeof t==`string`&&(e.rawMessageHtml=t);e.activeBanners=t.banners||[],e.content=oa(e.rawMessageHtml,{mailbox:n,messageUid:e.message?.UID,allowRemoteResources:e.allowRemoteResources,messageStructure:e.message?.BodyStructure,onRemoteResourceBlocked:()=>{e.hasRemoteResources=!0,this.isOpenItem(e)&&(this.hasRemoteResources=!0)}})}e.loading=!1,this.isConnected&&!this._deferPropertySync&&this.isOpenItem(e)&&(this.content=e.content,this.mimeType=e.mimeType,this.rawMessageHtml=e.rawMessageHtml,this.attachments=e.attachments,this.hasHtml=e.hasHtml,this.hasText=e.hasText,this.activeBanners=e.activeBanners,this.allowRemoteResources=e.allowRemoteResources,this.hasRemoteResources=e.hasRemoteResources,this.loading=!1,this.message={...this.message,...e.message}),this.updateThreadItemReference(e);return}let a=await E(`/mailboxes/${O(n)}/messages/${t.UID}?view=${r}`);if(a.status===401){window.location.hash=`/login`;return}if(!a.ok)throw Error(`Failed to fetch metadata`);let o=await a.json();e.attachments=o.Attachments||[],e.hasHtml=!!o.HasHTML,e.hasText=!!o.HasText,o.Message&&(e.message={...e.message,...o.Message});let s,c,l=o.Part;if(l){e.mimeType=l.MIMEType||l.MimeType||`text/plain`;let r=Array.isArray(l.Path)?l.Path.join(`.`):l.Path,i=await E(`/mailboxes/${O(n)}/messages/${t.UID}/raw?part=${r}`);if(i.status===401){window.location.hash=`/login`;return}if(i.ok)if(e.mimeType.toLowerCase()===`text/html`){s=await i.text(),e.rawMessageHtml=s;let t={content:e.rawMessageHtml,isHtml:!0,message:e.message,mailbox:n,banners:[],i18nStore:this.i18nStore},r=await v.invokeHookAsync(`reader:content`,t);for(let t of r)t&&typeof t==`string`&&(e.rawMessageHtml=t);e.activeBanners=t.banners||[],e.content=oa(e.rawMessageHtml,{mailbox:n,messageUid:e.message?.UID,allowRemoteResources:e.allowRemoteResources,messageStructure:e.message?.BodyStructure,onRemoteResourceBlocked:()=>{e.hasRemoteResources=!0,this.isOpenItem(e)&&(this.hasRemoteResources=!0)}})}else{c=await i.text(),e.content=c;let t={content:e.content,isHtml:!1,message:e.message,mailbox:n,banners:[],i18nStore:this.i18nStore},r=await v.invokeHookAsync(`reader:content`,t);for(let t of r)t&&typeof t==`string`&&(e.content=t);e.activeBanners=t.banners||[],t.isHtml&&(e.mimeType=`text/html`,e.hasHtml=!0,e.content=oa(e.content,{mailbox:n,messageUid:e.message?.UID,allowRemoteResources:e.allowRemoteResources,messageStructure:e.message?.BodyStructure,onRemoteResourceBlocked:()=>{e.hasRemoteResources=!0,this.isOpenItem(e)&&(this.hasRemoteResources=!0)}}))}}xr.set(n,t.UID.toString(),r,{Message:o.Message,Part:o.Part,Attachments:o.Attachments,RawHtml:s,RawText:c,HasHTML:e.hasHtml,HasText:e.hasText})}catch(t){x.error(`Failed to fetch message:`,t),e.content=`Error loading message.`}finally{e.loading=!1,this.isConnected&&!this._deferPropertySync&&this.isOpenItem(e)&&(this.content=e.content,this.mimeType=e.mimeType,this.rawMessageHtml=e.rawMessageHtml,this.attachments=e.attachments,this.hasHtml=e.hasHtml,this.hasText=e.hasText,this.activeBanners=e.activeBanners,this.allowRemoteResources=e.allowRemoteResources,this.hasRemoteResources=e.hasRemoteResources,this.loading=!1,this.message={...this.message,...e.message}),this.updateThreadItemReference(e)}}getSentMailboxName(){if(this.mailboxes&&Array.isArray(this.mailboxes)){for(let e of this.mailboxes){let t=e.Name||e.Mailbox;if(t&&(e.Attrs||[]).some(e=>typeof e==`string`&&(e.toLowerCase()===`\\sent`||e.toLowerCase()===`\\\\sent`)))return t}let e=[`sent`,`sent messages`,`sent items`,`sent-mail`];for(let t of this.mailboxes){let n=t.Name||t.Mailbox;if(n&&e.includes(n.toLowerCase()))return n}}return Rt}async toggleItemExpansion(e){e.expanded=!e.expanded,this.updateThreadItemReference(e),e.expanded&&!e.content&&!e.loading&&(e.loading=!0,this.updateThreadItemReference(e),await this.fetchItemBody(e))}loadRemoteResourcesForItem(e){e.allowRemoteResources=!0,e.message&&e.rawMessageHtml&&(e.hasRemoteResources=!1,e.content=oa(e.rawMessageHtml,{mailbox:e.mailbox,messageUid:e.message.UID,allowRemoteResources:e.allowRemoteResources,messageStructure:e.message.BodyStructure,onRemoteResourceBlocked:()=>{e.hasRemoteResources=!0}}),this.isOpenItem(e)&&(this.content=e.content,this.allowRemoteResources=!0,this.hasRemoteResources=e.hasRemoteResources),this.updateThreadItemReference(e))}async toggleItemStar(e){if(!e.message)return;let t=e.message.Flags?.includes(z),n=t?`remove`:`add`;t?e.message.Flags=e.message.Flags.filter(e=>e!==z):e.message.Flags=[...e.message.Flags||[],z],this.updateThreadItemReference(e);let r=this.listedKeys().has(this.itemKey(e)),i=t=>{r&&this.dispatchEvent(new CustomEvent(`message-flags-changed`,{detail:{uid:String(e.message.UID),mailbox:e.mailbox,flag:z,action:t},bubbles:!0,composed:!0}))};i(n);try{let{ok:r}=await B.setFlag(e.mailbox,[String(e.message.UID)],[z],n);r?this.isOpenItem(e)&&(this.message.Flags=e.message.Flags,this.requestUpdate()):(t?e.message.Flags=[...e.message.Flags||[],z]:e.message.Flags=e.message.Flags.filter(e=>e!==z),this.updateThreadItemReference(e),i(t?`add`:`remove`))}catch(n){x.error(`Failed to toggle star for thread item`,n),t?e.message.Flags=[...e.message.Flags||[],z]:e.message.Flags=e.message.Flags.filter(e=>e!==z),this.updateThreadItemReference(e),i(t?`add`:`remove`)}}deleteItem(e){if(!e.message)return;let t=this.itemKey(e),n=this.isOpenItem(e)?[...this.conversationItems].reverse().find(e=>this.itemKey(e)!==t):void 0;this.dispatchEvent(new CustomEvent(`action`,{detail:{action:`delete`,uid:String(e.message.UID),mailbox:e.mailbox,nextUid:n?String(n.message.UID):void 0,done:e=>{e&&this.dropCard(t)}}}))}dropCard(e){if(this.threadItems=this.threadItems.filter(t=>this.itemKey(t)!==e),this._conversation&&={...this._conversation,messages:this._conversation.messages.filter(t=>this.keyOf(t)!==e)},this.threadItems.length===1&&!this.threadItems[0].expanded){let e=this.threadItems[0];e.expanded=!0,!e.content&&!e.loading&&(e.loading=!0,this.fetchItemBody(e))}this._isThread=this.threadItems.length>1,this.requestUpdate()}reloadConversation(){this.message&&this.loadConversation(this.message,!1)}async _handleActionForItem(e,t){if(e===`reply`||e===`replyAll`||e===`forward`){let n=``;if(t.mimeType===`text/plain`)n=t.content;else{try{let e=await E(`/mailboxes/${O(t.mailbox)}/messages/${t.message.UID}?view=text`);if(e.ok){let t=await e.json();t.Part&&t.RawText&&(n=t.RawText)}}catch(e){x.error(`Failed to fetch text body for quote`,e)}!n&&t.rawMessageHtml&&(n=Sa(t.rawMessageHtml))}let r=this.settingsStore?.getState()?.dateFormat||`YYYY-MM-DD`,i=String(this.settingsStore?.getState()?.hourFormat||`12`),{subject:a,to:o,cc:s,quotedText:c,quotedHtml:l}=pa(e,t.message,n,t.rawMessageHtml,t.hasHtml,r,i,this.ownAddresses()),u=e===`forward`?t.attachments.map(e=>({name:e.Filename||`attachment`,size:e.Size||0,type:e.MIMEType||`application/octet-stream`,partPath:e.Path?e.Path.join(`.`):void 0})):[],d=[...u,...Zr(t.message.BodyStructure).filter(e=>!u.some(t=>t.partPath===e.partPath))],f=e===`reply`||e===`replyAll`?Qr(t.message,t.mailbox):{};this.composeStore.openComposer({subject:a,to:o,cc:s,text:c,html:l,format:this.settingsStore?.getState()?.composeFormat||`html`,attachments:d,quoteSource:{mailbox:t.mailbox,uid:String(t.message.UID),structure:t.message.BodyStructure},...f});return}if(e===`markRead`)return void this.markMembersRead([this.itemKey(t)]);if(e===`markUnread`||e===`downloadMessage`||e===`showOriginal`){this.dispatchEvent(new CustomEvent(`action`,{detail:{action:e,uid:String(t.message.UID),mailbox:t.mailbox}}));return}if(e===`showPlaintext`){this.localPreferredView=`text`,this.fetchItemBody(t);return}if(e===`showHtml`){this.localPreferredView=`html`,this.fetchItemBody(t);return}if(e===`print`){let e=t.allowRemoteResources?`&remote=1`:``;window.open(`#/print?mailbox=`+encodeURIComponent(t.mailbox)+`&uid=`+t.message.UID+e,`_blank`);return}}applyThemeToIframe(e){ba(e,this.settingsStore?.getState()?.themeIframeContent??!1)}applyThemeToAllIframes(){let e=this.shadowRoot?.querySelectorAll(`iframe.reader-iframe`);e&&e.forEach(e=>this.applyThemeToIframe(e))}onIframeLoad(e){let t=e.target;xa(t,this.settingsStore?.getState()?.themeIframeContent??!1)}async _handleEditDraft(e){let t=e&&!(e instanceof Event),n=t?e.message:this.message,r=t?e.mailbox:this.mailboxOfMessage(n);if(!n)return;t&&e&&!e.content&&!e.loading&&(e.loading=!0,this.updateThreadItemReference(e),await this.fetchItemBody(e));let i=t&&e?e.content:this.content,a=t&&e?e.mimeType:this.mimeType,o=t&&e?e.rawMessageHtml:this.rawMessageHtml,s=t&&e?e.attachments:this.attachments,c=``;if(a===`text/plain`)c=i;else{try{let e=await E(`/mailboxes/${O(r)}/messages/${n.UID}?view=text`);if(e.ok){let t=await e.json();t.Part&&t.RawText&&(c=t.RawText)}}catch(e){x.error(`Failed to fetch text body for draft`,e)}c||=Sa(o)}let l=(s||[]).map(e=>({name:e.Filename||`attachment`,size:e.Size||0,type:e.MIMEType||`application/octet-stream`,partPath:e.Path?e.Path.join(`.`):void 0})),u=e=>e?e.map(e=>e.Name?`${e.Name} <${e.Mailbox}@${e.Host}>`:`${e.Mailbox}@${e.Host}`):[];this.composeStore.openComposer({draftUid:n.UID.toString(),draftMailbox:r,subject:n.Envelope?.Subject||``,to:u(n.Envelope?.To),cc:u(n.Envelope?.Cc),bcc:u(n.Envelope?.Bcc),text:c,html:o,format:this.settingsStore?.getState()?.composeFormat||`html`,attachments:l,quoteSource:{mailbox:r,uid:n.UID.toString(),structure:n.BodyStructure},inReplyTo:n.Envelope?.InReplyTo||void 0,references:Array.isArray(n.References)&&n.References.length?n.References:void 0})}get showSenderAvatars(){return this.settingsStore?.getState()?.showSenderAvatars??!0}canToggleReadFor(e){return!e.message||e.isSent||Ta(e.message)||qt(this.mailbox||``,this.mailboxes)===`trash`?!1:(this.mailbox||``).toLowerCase()!==this.getSentMailboxName().toLowerCase()}get newestAnswerable(){return[...this.threadItems].reverse().find(e=>e.message&&!Ta(e.message))}async answerNewest(e){let t=this.newestAnswerable;if(!t)return;let n=this.itemKey(t);!t.content&&!t.loading&&await this.fetchItemBody(t);let r=this.threadItems.find(e=>this.itemKey(e)===n)??t;await this._handleActionForItem(e,r)}renderConversationReply(){return!this.toolbarIsConversation||!this.newestAnswerable?``:n`
    ...
    `}render(){let e=this.selectedCount>0,t=this.settingsStore?.getState()?.enableThreading??!0;if(!this.message&&!e)return n`
      ...
      `;let r=this.localPreferredView||this.settingsStore?.getState()?.preferredView||`html`,i=this.message||{},a=Fr(i.Flags,this.i18nStore),o=new Set([`$label1`,`$label2`,`$label3`,`$label4`,`$label5`]),s=e||!this.message?[]:Lr(i.Flags).filter(e=>!o.has(e.toLowerCase())),c=i.Envelope?.From?.[0]||{},u=c.Mailbox&&c.Host?`${c.Mailbox}@${c.Host}`:``,d=c.Name||u||this.i18nStore?.t(`messageList.unknownSender`),f=this.settingsStore?.getState()?.dateFormat||`YYYY-MM-DD`,p=String(this.settingsStore?.getState()?.hourFormat||`12`),m=i.Envelope?.Date?an(i.Envelope.Date,f,p):``,h=fn(i,c),ee=(this.mailbox||``).toLowerCase(),g=qt(this.mailbox||``,this.mailboxes),te=g===`archive`,ne=g===`junk`,re=g===`trash`,_=g===`drafts`,v=ee===this.getSentMailboxName().toLowerCase(),y=this.toolbarIsConversation,b=this.readToggleMarksRead,ie=y?this.i18nStore?.t(`messageReader.deleteThread`):this.message?.Flags?.includes(`\\Draft`)||_?this.i18nStore?.t(`messageReader.discardDraft`):this.i18nStore?.t(`messageReader.delete`);return n`
      <alps-toolbar class="toolbar" ?scrolled=${this.isScrolled}>
        ...
        `:``}
        <alps-icon-btn title=${ie} @click=${()=>this._handleAction(`delete`)} icon="trash"></alps-icon-btn>
        ...
        ${!re&&!v?n`
        <alps-icon-btn title=${b?this.i18nStore?.t(`messageReader.markRead`):this.i18nStore?.t(`messageReader.markUnread`)} @click=${()=>this._handleAction(`markUnread`)} icon=${b?`envelopeOpen`:`envelopeUnread`}></alps-icon-btn>
        `:``}
        ${y?``:n`
        ...
        <alps-popup align="left" class="tags-popup">
          ...
          ${[`$label1`,`$label2`,`$label3`,`$label4`,`$label5`].map(e=>n`
              <button class="dropdown-item ${this.hasTag(e)?`active`:``}" @click=${()=>this._handleTag(e)}>
                <span style="display:inline-block;width:12px;height:12px;border-radius:50%;background:${zr(e)};margin-right:12px;opacity:0.9;"></span>
                <span class="item-text">${Rr(e,this.i18nStore)}</span>
              </button>
            `)}
          ${s.length?n`
            <div class="dropdown-divider"></div>
        ...
        <div class="toolbar-separator mobile-only"></div>
          ...
          ${e?``:n`
            ...
            <button class="dropdown-item" @click=${()=>this._handleAction(`archive`)}>
              ${k(`archiveBox`)} <span class="item-text">${this.i18nStore?.t(`messageReader.archive`)}</span>
            </button>
            `:``}
            ${!ne&&!re&&!_&&!v?n`
            <button class="dropdown-item" @click=${()=>this._handleAction(`reportSpam`)}>
              ${k(`warningDiamond`)} <span class="item-text">${this.i18nStore?.t(`messageReader.reportSpam`)}</span>
            </button>
            `:``}
            ${ne?n`
            <button class="dropdown-item" @click=${()=>this._handleAction(`notSpam`)}>
              ${k(`notSpam`)} <span class="item-text">${this.i18nStore?.t(`messageReader.notSpam`)}</span>
            </button>
            `:``}
            <button class="dropdown-item" @click=${()=>this._handleAction(`delete`)}>
              ${k(`trash`)} <span class="item-text">${ie}</span>
            </button>
            <alps-folder-selector-popup
            ...
            >
              <button slot="trigger" class="dropdown-item">
                ${k(`folderOpen`)} <span class="item-text">${this.i18nStore?.t(`messageReader.moveTo`)}</span>
              </button>
            </alps-folder-selector-popup>
            ${!re&&!v||!y?n`
            <div class="dropdown-divider"></div>
            ...
            <button class="dropdown-item" @click=${()=>this._handleAction(`markUnread`)}>
              ${k(b?`envelopeOpen`:`envelopeUnread`)} <span class="item-text">${b?this.i18nStore?.t(`messageReader.markRead`):this.i18nStore?.t(`messageReader.markUnread`)}</span>
            </button>
            `:``}
            ${y?``:n`
            <button class="dropdown-item" @click=${()=>this._handleAction(`star`)}>
              ${this.message?.Flags?.includes(`\\Flagged`)?k(`starFourFill`):k(`starFour`)} <span class="item-text">${this.i18nStore?.t(`messageReader.star`)}</span>
            </button>
            `}
            `:``}
            ${y?``:n`
      ...
      `}
<<<<<<<< HEAD:frontend/dist/assets/index-BHV7B3Zq.js
    `}};A([h({context:w})],K.prototype,`settingsStore`,void 0),A([h({context:C})],K.prototype,`i18nStore`,void 0),A([h({context:oi})],K.prototype,`composeStore`,void 0),A([a()],K.prototype,`localPreferredView`,void 0),A([a()],K.prototype,`hasHtml`,void 0),A([a()],K.prototype,`hasText`,void 0),A([o({type:String})],K.prototype,`mailbox`,void 0),A([o({type:Object})],K.prototype,`message`,void 0),A([o({type:Array})],K.prototype,`messages`,void 0),A([o({type:Object})],K.prototype,`selectedKeys`,void 0),A([o({type:Number})],K.prototype,`selectedCount`,void 0),A([o({type:Boolean})],K.prototype,`allSelectedStarred`,void 0),A([o({type:Boolean})],K.prototype,`allSelectedUnread`,void 0),A([o({type:Array})],K.prototype,`commonTags`,void 0),A([o({type:Boolean})],K.prototype,`bulkProcessing`,void 0),A([o({type:String})],K.prototype,`layoutMode`,void 0),A([o({type:Array})],K.prototype,`mailboxes`,void 0),A([a()],K.prototype,`content`,void 0),A([a()],K.prototype,`mimeType`,void 0),A([a()],K.prototype,`loading`,void 0),A([a()],K.prototype,`activeBanners`,void 0),A([a()],K.prototype,`attachments`,void 0),A([a()],K.prototype,`allowRemoteResources`,void 0),A([a()],K.prototype,`hasRemoteResources`,void 0),A([a()],K.prototype,`rawMessageHtml`,void 0),A([a()],K.prototype,`isScrolled`,void 0),A([a()],K.prototype,`threadItems`,void 0),A([a()],K.prototype,`_isThread`,void 0),K=A([p(`alps-message-reader`)],K);var Da=1e4,Oa=e=>!!e?.Flags?.includes(z),ka=(e,t)=>(e?.length??0)===(t?.length??0)&&(e??[]).every((e,n)=>e===t[n]);function Aa(e,t){return e===t?!0:!e||e.length!==t.length?!1:JSON.stringify(e)===JSON.stringify(t)}var ja=250,Ma=150,Na=500,Pa=64,Fa=120,Ia=380,La=300,Ra=57,za=150,Ba=250,q=class extends d{constructor(...e){super(...e),this.showDeleteConfirm=!1,this.listLoadFailed=!1,this.pendingDeleteDetails=null,this.markReadTimer=null,this.notificationSound=null,this.audioUnlocked=!1,this.unlockAudio=()=>{if(this.audioUnlocked||!this.settingsStore.getState().soundNotifications)return;let e=this.chime();e.muted=!0,e.play().then(()=>{e.pause(),e.currentTime=0,this.audioUnlocked=!0}).catch(()=>{}).finally(()=>{e.muted=!1}),document.removeEventListener(`click`,this.unlockAudio),document.removeEventListener(`keydown`,this.unlockAudio)},this.mailboxes=[],this.messages=[],this.currentMailbox=D,this.loadingMessages=!0,this.showInitialLoader=!window.alpsAppLoaded,this.selectedMessage=null,this.selectedKeys=new Set,this.selectAllMatching=!1,this.excludedKeys=new Set,this.layoutMode=`vertical`,this.filterQuery=``,this.expandedFolders=new Set([D]),this.username=``,this.currentPage=0,this.listedPage=0,this.totalMessages=0,this.messagesPerPage=50,this.resizerPositionX=ja+Math.max(Ia,(window.innerWidth-ja)*.4),this.listHeight=Math.max(Ba,(window.innerHeight-Ra)*.4),this.isSidebarDragging=!1,this.isPaneDragging=!1,this.sidebarWidth=ja,this.isSidebarHovered=!1,this.hoverTimeout=null,this.densityMode=`compact`,this.showSenderAvatars=!0,this.isSyncing=!1,this.sidebarCollapsed=!1,this.suppressSidebarHover=!1,this.sortOrder=`desc`,this.listScrolled=!1,this.targetUid=null,this.targetMailbox=null,this.isMobile=window.innerWidth<=768,this.mobileSidebarOpen=!1,this.bulkProcessing=!1,this.computedMinListWidth=Ia,this._mql=window.matchMedia(`(max-width: 768px)`),this._relayToast=e=>{this.showGlobalToast(e.detail.message,e.detail.actionLabel,e.detail.actionFn,e.detail.duration)},this._handleMediaQuery=e=>{this.isMobile=e.matches,this.isMobile||(this.mobileSidebarOpen=!1)},this.handleDraftAutosaved=e=>{let{oldUid:t,oldMailbox:n,newUid:r,mailbox:i,subject:a,hasAttachments:o,size:s}=e.detail;if(!this.messages)return;let c=String(r),l=!1,u=t?H(n||i,t):null,d=e=>({...e,UID:c,...e.Mailbox?{Mailbox:i}:{},Size:s||e.Size,RFC822Size:s||e.RFC822Size,HasAttachments:o,_isAutosaveUpdate:!0,Envelope:{...e.Envelope,Subject:a||e.Envelope?.Subject||`(No subject)`}});if(u){let e=this.messages.findIndex(e=>this.keyOf(e)===u);if(e!==-1){let t=[...this.messages];t[e]=d(t[e]),this.messages=t,l=!0,this.selectedMessage&&this.keyOf(this.selectedMessage)===u&&this.followAutosavedSelection(t[e])}else for(let e=0;e<this.messages.length;e++){let t=this.messages[e];if(t.SubMessages){let n=t.SubMessages.findIndex(e=>this.keyOf(e)===u);if(n!==-1){let r=[...t.SubMessages];r[n]=d(r[n]);let i=[...this.messages];i[e]={...t,SubMessages:r},this.messages=i,l=!0,this.selectedMessage&&this.keyOf(this.selectedMessage)===u&&this.followAutosavedSelection(r[n]);break}}}!l&&this.selectedMessage&&this.keyOf(this.selectedMessage)===u&&this.followAutosavedSelection(d(this.selectedMessage))}if(!l&&this.currentMailbox===i){let e=this.settingsStore?.getState().name||this.username,n=(this.username||``).split(`@`),i=n[0]||``,l=n[1]||``,u={UID:c,Size:s||0,RFC822Size:s||0,HasAttachments:o,Flags:[R,wr],_isAutosaveUpdate:!0,Envelope:{Subject:a||`(No subject)`,Date:new Date().toISOString(),From:[{Name:e,Mailbox:i,Host:l}]}},d=this.messages.filter(e=>String(e.UID)!==String(t)&&String(e.UID)!==String(r));this.messages=[u,...d]}},this._handleSettingsChange=()=>{this._syncSettings()},this._handleI18nChange=()=>{this.requestUpdate()},this.handleLabelsSuccess=e=>{let{mailboxes:t}=e.detail;this.mailboxes=t},this.handleSyncStart=e=>{let t=e.detail;this.isSyncing=!0,!t.background&&!t.quiet&&(this.loadingMessages=!0,this.listLoadFailed=!1)},this.handleSyncSuccess=e=>{this.isSyncing=!1,this.listLoadFailed=!1;let{data:t,background:n}=e.detail;t.Username&&(this.username=t.Username,this.settingsStore.getState().loginUsername!==t.Username&&this.settingsStore.updateSettings({loginUsername:t.Username}));let r=this.mailboxes.length===0,i=!1,a=!1,o=0;if(t.Mailboxes){for(let e of t.Mailboxes){let t=e.Name||e.Mailbox,s=this.mailboxes.find(e=>(e.Name||e.Mailbox)===t);if(s&&!r&&n&&e.Total!==void 0&&s.Total!==void 0&&e.Unseen!==void 0&&s.Unseen!==void 0){let n=Math.min(e.Total-s.Total,e.Unseen-s.Unseen);n>0&&(i=!0,t.toUpperCase()===`INBOX`&&(a=!0,o+=n))}}this.mailboxes=t.Mailboxes}if(i&&this.settingsStore.getState().soundNotifications){let e=this.chime();e.currentTime=0,e.play().catch(e=>{e.name!==`NotAllowedError`&&x.error(`Failed to play sound notification:`,e)})}if(a&&this.settingsStore.getState().desktopNotifications&&`Notification`in window&&Notification.permission===`granted`){let e=this.i18nStore?.t(`mailboxPage.newMessages`),t=o===1?this.i18nStore?.t(`mailboxPage.newMessagesSingleBody`):this.i18nStore?.t(`mailboxPage.newMessagesMultiBody`,{count:o});try{let n=new Notification(e,{body:t,icon:`/apple-touch-icon.png`,tag:`alps-new-message`});n.onclick=()=>{window.focus(),n.close(),this.currentMailbox===`INBOX`?(this.currentPage=0,L.fetch(this.currentMailbox,0,this.filterQuery,!1)):this.updateUrl(`INBOX`,0,null,``)}}catch(e){x.error(`Failed to show desktop notification:`,e)}}if(a&&this.currentMailbox!==`INBOX`&&this.showGlobalToast(this.i18nStore?.t(`mailboxPage.newMessagesInInbox`),this.i18nStore?.t(`mailboxPage.open`),()=>{this.updateUrl(`INBOX`,0,null,``)},5e3),n&&this.currentPage>0)t.Total!==void 0&&t.Total!==this.totalMessages&&this.showGlobalToast(this.i18nStore?.t(`mailboxPage.newMessagesAvailable`),this.i18nStore?.t(`mailboxPage.refresh`),()=>{this.currentPage=0,L.fetch(this.currentMailbox,this.currentPage,this.filterQuery,!1)});else if(t.Page!==void 0&&(this.currentPage=t.Page),this.listedPage=t.Page===void 0?this.currentPage:t.Page,t.Total!==void 0&&(this.totalMessages=t.Total),t.MessagesPerPage!==void 0&&(this.messagesPerPage=t.MessagesPerPage),t.Messages){if(Aa(this.messages,t.Messages)||(this.messages=t.Messages,this.selectAllMatching&&(this.selectedKeys=new Set(this.listedKeys().filter(e=>!this.excludedKeys.has(e))))),this.selectedMessage){let e=this.messages.find(e=>this.isOpen(e));e&&e.Flags&&!ka(this.selectedMessage.Flags,e.Flags)&&(this.selectedMessage={...this.selectedMessage,Flags:e.Flags})}}else this.messages=[];n||(this.loadingMessages=!1,this.applyTargetUid(),this.showInitialLoader&&setTimeout(()=>{this.showInitialLoader=!1,window.alpsAppLoaded=!0},100))},this.handleSyncError=e=>{this.isSyncing=!1;let{background:t}=e.detail;t||(this.loadingMessages=!1,this.listLoadFailed=!0)},this.handleMailboxNotFound=()=>{this.showGlobalToast(this.i18nStore.t(`mailboxPage.mailboxNotFound`),``,void 0,3e3),this.updateUrl(D,0,null,null)},this.handleHashChange=()=>{let e=this.currentMailbox,t=this.currentPage,n=this.targetUid,r=this.targetMailbox,i=this.filterQuery;this.extractMailboxFromHash(),e!==this.currentMailbox||t!==this.currentPage||i!==this.filterQuery?(e===this.currentMailbox?i!==this.filterQuery&&(this.loadingMessages=!0,this.currentPage=0,this.clearSelection()):(this.selectedMessage=null,this.currentPage=0,this.clearSelection(),this.loadingMessages=!0),L.fetch(this.currentMailbox,this.currentPage,this.filterQuery,!1)):(n!==this.targetUid||r!==this.targetMailbox)&&this.applyTargetUid()},this.startResize=e=>{e.preventDefault(),this.isPaneDragging=!0,this.updateComputedMinWidth();let t=e=>{if(this.layoutMode===`vertical`){let t=this.sidebarCollapsed?Pa:this.sidebarWidth,n=Math.max(t+this.computedMinListWidth,Math.min(e.clientX,window.innerWidth-La));this.resizerPositionX=n}else this.layoutMode===`horizontal`&&(this.listHeight=Math.max(za,Math.min(e.clientY-Ra,window.innerHeight-za)))},n=()=>{this.isPaneDragging=!1,window.removeEventListener(`mousemove`,t),window.removeEventListener(`mouseup`,n)};window.addEventListener(`mousemove`,t),window.addEventListener(`mouseup`,n)},this.rowsAfterTakeOut=null}chime(){return this.notificationSound??=new Audio(`/assets/notify.wav`)}static{this.styles=g`
========
    `}};A([h({context:C})],K.prototype,`settingsStore`,void 0),A([h({context:S})],K.prototype,`i18nStore`,void 0),A([h({context:ai})],K.prototype,`composeStore`,void 0),A([a()],K.prototype,`localPreferredView`,void 0),A([a()],K.prototype,`hasHtml`,void 0),A([a()],K.prototype,`hasText`,void 0),A([o({type:String})],K.prototype,`mailbox`,void 0),A([o({type:Object})],K.prototype,`message`,void 0),A([o({type:Array})],K.prototype,`messages`,void 0),A([o({type:Object})],K.prototype,`selectedKeys`,void 0),A([o({type:Number})],K.prototype,`selectedCount`,void 0),A([o({type:Boolean})],K.prototype,`allSelectedStarred`,void 0),A([o({type:Boolean})],K.prototype,`allSelectedUnread`,void 0),A([o({type:Array})],K.prototype,`commonTags`,void 0),A([o({type:Boolean})],K.prototype,`bulkProcessing`,void 0),A([o({type:String})],K.prototype,`layoutMode`,void 0),A([o({type:Array})],K.prototype,`mailboxes`,void 0),A([a()],K.prototype,`content`,void 0),A([a()],K.prototype,`mimeType`,void 0),A([a()],K.prototype,`loading`,void 0),A([a()],K.prototype,`activeBanners`,void 0),A([a()],K.prototype,`attachments`,void 0),A([a()],K.prototype,`allowRemoteResources`,void 0),A([a()],K.prototype,`hasRemoteResources`,void 0),A([a()],K.prototype,`rawMessageHtml`,void 0),A([a()],K.prototype,`isScrolled`,void 0),A([a()],K.prototype,`threadItems`,void 0),A([a()],K.prototype,`_isThread`,void 0),K=A([p(`alps-message-reader`)],K);var Ea=1e4,Da=e=>!!e?.Flags?.includes(z),Oa=(e,t)=>(e?.length??0)===(t?.length??0)&&(e??[]).every((e,n)=>e===t[n]);function ka(e,t){return e===t?!0:!e||e.length!==t.length?!1:JSON.stringify(e)===JSON.stringify(t)}var Aa=250,ja=150,Ma=500,Na=64,Pa=120,Fa=380,Ia=300,La=57,Ra=150,za=250,q=class extends d{constructor(...e){super(...e),this.showDeleteConfirm=!1,this.listLoadFailed=!1,this.pendingDeleteDetails=null,this.markReadTimer=null,this.notificationSound=null,this.audioUnlocked=!1,this.unlockAudio=()=>{if(this.audioUnlocked||!this.settingsStore.getState().soundNotifications)return;let e=this.chime();e.muted=!0,e.play().then(()=>{e.pause(),e.currentTime=0,this.audioUnlocked=!0}).catch(()=>{}).finally(()=>{e.muted=!1}),document.removeEventListener(`click`,this.unlockAudio),document.removeEventListener(`keydown`,this.unlockAudio)},this.mailboxes=[],this.messages=[],this.currentMailbox=D,this.loadingMessages=!0,this.showInitialLoader=!window.alpsAppLoaded,this.selectedMessage=null,this.selectedKeys=new Set,this.selectAllMatching=!1,this.excludedKeys=new Set,this.layoutMode=`vertical`,this.filterQuery=``,this.expandedFolders=new Set([D]),this.username=``,this.currentPage=0,this.listedPage=0,this.totalMessages=0,this.messagesPerPage=50,this.resizerPositionX=Aa+Math.max(Fa,(window.innerWidth-Aa)*.4),this.listHeight=Math.max(za,(window.innerHeight-La)*.4),this.isSidebarDragging=!1,this.isPaneDragging=!1,this.sidebarWidth=Aa,this.isSidebarHovered=!1,this.hoverTimeout=null,this.densityMode=`compact`,this.showSenderAvatars=!0,this.isSyncing=!1,this.sidebarCollapsed=!1,this.suppressSidebarHover=!1,this.sortOrder=`desc`,this.listScrolled=!1,this.targetUid=null,this.targetMailbox=null,this.isMobile=window.innerWidth<=768,this.mobileSidebarOpen=!1,this.bulkProcessing=!1,this.computedMinListWidth=Fa,this._mql=window.matchMedia(`(max-width: 768px)`),this._relayToast=e=>{this.showGlobalToast(e.detail.message,e.detail.actionLabel,e.detail.actionFn,e.detail.duration)},this._handleMediaQuery=e=>{this.isMobile=e.matches,this.isMobile||(this.mobileSidebarOpen=!1)},this.hasConnected=!1,this.handleDraftAutosaved=e=>{let{oldUid:t,oldMailbox:n,newUid:r,mailbox:i,subject:a,hasAttachments:o,size:s}=e.detail;if(!this.messages)return;let c=String(r),l=!1,u=t?H(n||i,t):null,d=e=>({...e,UID:c,...e.Mailbox?{Mailbox:i}:{},Size:s||e.Size,RFC822Size:s||e.RFC822Size,HasAttachments:o,_isAutosaveUpdate:!0,Envelope:{...e.Envelope,Subject:a||e.Envelope?.Subject||`(No subject)`}});if(u){let e=this.messages.findIndex(e=>this.keyOf(e)===u);if(e!==-1){let t=[...this.messages];t[e]=d(t[e]),this.messages=t,l=!0,this.selectedMessage&&this.keyOf(this.selectedMessage)===u&&this.followAutosavedSelection(t[e])}else for(let e=0;e<this.messages.length;e++){let t=this.messages[e];if(t.SubMessages){let n=t.SubMessages.findIndex(e=>this.keyOf(e)===u);if(n!==-1){let r=[...t.SubMessages];r[n]=d(r[n]);let i=[...this.messages];i[e]={...t,SubMessages:r},this.messages=i,l=!0,this.selectedMessage&&this.keyOf(this.selectedMessage)===u&&this.followAutosavedSelection(r[n]);break}}}!l&&this.selectedMessage&&this.keyOf(this.selectedMessage)===u&&this.followAutosavedSelection(d(this.selectedMessage))}if(!l&&this.currentMailbox===i){let e=this.settingsStore?.getState().name||this.username,n=(this.username||``).split(`@`),i=n[0]||``,l=n[1]||``,u={UID:c,Size:s||0,RFC822Size:s||0,HasAttachments:o,Flags:[R,Cr],_isAutosaveUpdate:!0,Envelope:{Subject:a||`(No subject)`,Date:new Date().toISOString(),From:[{Name:e,Mailbox:i,Host:l}]}},d=this.messages.filter(e=>String(e.UID)!==String(t)&&String(e.UID)!==String(r));this.messages=[u,...d]}},this._handleSettingsChange=()=>{this._syncSettings()},this._handleI18nChange=()=>{this.requestUpdate()},this.handleLabelsSuccess=e=>{let{mailboxes:t}=e.detail;this.mailboxes=t},this.handleSyncStart=e=>{let t=e.detail;this.isSyncing=!0,!t.background&&!t.quiet&&(this.loadingMessages=!0,this.listLoadFailed=!1)},this.handleSyncSuccess=e=>{this.isSyncing=!1,this.listLoadFailed=!1;let{data:t,background:n}=e.detail;t.Username&&(this.username=t.Username,this.settingsStore.getState().loginUsername!==t.Username&&this.settingsStore.updateSettings({loginUsername:t.Username}));let r=this.mailboxes.length===0,i=!1,a=!1,o=0;if(t.Mailboxes){for(let e of t.Mailboxes){let t=e.Name||e.Mailbox,s=this.mailboxes.find(e=>(e.Name||e.Mailbox)===t);if(s&&!r&&n&&e.Total!==void 0&&s.Total!==void 0&&e.Unseen!==void 0&&s.Unseen!==void 0){let n=Math.min(e.Total-s.Total,e.Unseen-s.Unseen);n>0&&(i=!0,t.toUpperCase()===`INBOX`&&(a=!0,o+=n))}}this.mailboxes=t.Mailboxes}if(i&&this.settingsStore.getState().soundNotifications){let e=this.chime();e.currentTime=0,e.play().catch(e=>{e.name!==`NotAllowedError`&&b.error(`Failed to play sound notification:`,e)})}if(a&&this.settingsStore.getState().desktopNotifications&&`Notification`in window&&Notification.permission===`granted`){let e=this.i18nStore?.t(`mailboxPage.newMessages`),t=o===1?this.i18nStore?.t(`mailboxPage.newMessagesSingleBody`):this.i18nStore?.t(`mailboxPage.newMessagesMultiBody`,{count:o});try{let n=new Notification(e,{body:t,icon:`/apple-touch-icon.png`,tag:`alps-new-message`});n.onclick=()=>{window.focus(),n.close(),this.currentMailbox===`INBOX`?(this.currentPage=0,L.fetch(this.currentMailbox,0,this.filterQuery,!1)):this.updateUrl(`INBOX`,0,null,``)}}catch(e){b.error(`Failed to show desktop notification:`,e)}}if(a&&this.currentMailbox!==`INBOX`&&this.showGlobalToast(this.i18nStore?.t(`mailboxPage.newMessagesInInbox`),this.i18nStore?.t(`mailboxPage.open`),()=>{this.updateUrl(`INBOX`,0,null,``)},5e3),n&&this.currentPage>0)t.Total!==void 0&&t.Total!==this.totalMessages&&this.showGlobalToast(this.i18nStore?.t(`mailboxPage.newMessagesAvailable`),this.i18nStore?.t(`mailboxPage.refresh`),()=>{this.currentPage=0,L.fetch(this.currentMailbox,this.currentPage,this.filterQuery,!1)});else if(t.Page!==void 0&&(this.currentPage=t.Page),this.listedPage=t.Page===void 0?this.currentPage:t.Page,t.Total!==void 0&&(this.totalMessages=t.Total),t.MessagesPerPage!==void 0&&(this.messagesPerPage=t.MessagesPerPage),t.Messages){if(ka(this.messages,t.Messages)||(this.messages=t.Messages,this.selectAllMatching&&(this.selectedKeys=new Set(this.listedKeys().filter(e=>!this.excludedKeys.has(e))))),this.selectedMessage){let e=this.messages.find(e=>this.isOpen(e));e&&e.Flags&&!Oa(this.selectedMessage.Flags,e.Flags)&&(this.selectedMessage={...this.selectedMessage,Flags:e.Flags})}}else this.messages=[];n||(this.loadingMessages=!1,this.applyTargetUid(),this.showInitialLoader&&setTimeout(()=>{this.showInitialLoader=!1,window.alpsAppLoaded=!0},100))},this.handleSyncError=e=>{this.isSyncing=!1;let{background:t}=e.detail;t||(this.loadingMessages=!1,this.listLoadFailed=!0)},this.handleMailboxNotFound=()=>{this.showGlobalToast(this.i18nStore.t(`mailboxPage.mailboxNotFound`),``,void 0,3e3),this.updateUrl(D,0,null,null)},this.handleHashChange=()=>{let e=this.currentMailbox,t=this.currentPage,n=this.targetUid,r=this.targetMailbox,i=this.filterQuery;this.extractMailboxFromHash(),e!==this.currentMailbox||t!==this.currentPage||i!==this.filterQuery?(e===this.currentMailbox?i!==this.filterQuery&&(this.loadingMessages=!0,this.currentPage=0,this.clearSelection()):(this.selectedMessage=null,this.currentPage=0,this.clearSelection(),this.loadingMessages=!0),L.fetch(this.currentMailbox,this.currentPage,this.filterQuery,!1)):(n!==this.targetUid||r!==this.targetMailbox)&&this.applyTargetUid()},this.startResize=e=>{e.preventDefault(),this.isPaneDragging=!0,this.updateComputedMinWidth();let t=e=>{if(this.layoutMode===`vertical`){let t=this.sidebarCollapsed?Na:this.sidebarWidth,n=Math.max(t+this.computedMinListWidth,Math.min(e.clientX,window.innerWidth-Ia));this.resizerPositionX=n}else this.layoutMode===`horizontal`&&(this.listHeight=Math.max(Ra,Math.min(e.clientY-La,window.innerHeight-Ra)))},n=()=>{this.isPaneDragging=!1,window.removeEventListener(`mousemove`,t),window.removeEventListener(`mouseup`,n)};window.addEventListener(`mousemove`,t),window.addEventListener(`mouseup`,n)},this.rowsAfterTakeOut=null}chime(){return this.notificationSound??=new Audio(`/assets/notify.wav`)}static{this.styles=g`
>>>>>>>> main:frontend/dist/assets/index-CCMQIZxV.js
    :host {
      display: flex;
      flex-direction: column;
    ...
    .layout-vertical alps-sidebar.desktop-sidebar { width: var(--sidebar-width, ${ja}px); flex-shrink: 0; }
    .layout-vertical .main-view { flex: 1; display: flex; flex-direction: row; min-width: 0; }
    .layout-vertical .message-list-pane { width: ${Ia}px; flex-shrink: 0; border-right: 1px solid var(--border-color); }
    .layout-vertical .message-reader-pane { flex: 1; min-width: 0; }

    /* Horizontal: Sidebar (250px) | [ Message List (50%) / Reader (50%) ] */
    .layout-horizontal alps-sidebar.desktop-sidebar { width: var(--sidebar-width, ${ja}px); flex-shrink: 0; }
    ...
    .layout-full alps-sidebar.desktop-sidebar { width: var(--sidebar-width, ${ja}px); flex-shrink: 0; }
...
>>>>>>>> main:frontend/dist/assets/index-CCMQIZxV.js
      ...
      <div class="app-container layout-${e} ${t?`reading`:``} ${this.isPaneDragging||this.isSidebarDragging?`dragging`:``} ${this.sidebarCollapsed&&!this.isMobile?`collapsed`:``} ${this.isMobile?`mobile-view`:``} ${this.suppressSidebarHover?`suppress-sidebar-hover`:``}" style="${!this.sidebarCollapsed&&!this.isMobile?`--sidebar-width: ${this.sidebarWidth}px;`:``}">
        <alps-sidebar 
          ...
          .collapsed=${this.sidebarCollapsed&&!this.isMobile}
          .width=${this.sidebarWidth}
          @sidebar-resize=${e=>{let t=e.detail.newWidth;t<Fa?(this.sidebarCollapsed||this.settingsStore.updateSettings({sidebarCollapsed:!0}),this.sidebarWidth=ja):(this.sidebarCollapsed&&this.settingsStore.updateSettings({sidebarCollapsed:!1}),this.sidebarWidth=Math.min(Math.max(t,Ma),Na),this.resizerPositionX=Math.max(this.resizerPositionX,this.sidebarWidth+Ia))}}
          @drag-start=${()=>this.isSidebarDragging=!0}
          @drag-end=${()=>this.isSidebarDragging=!1}
        ...
        <div class="main-view">
          <div class="pane message-list-pane" style="position: relative; ${e===`vertical`?`width: ${this.effectiveListWidth}px; flex: none; ${this.isPaneDragging||this.isSidebarDragging?``:`transition: width 0.2s;`}`:e===`horizontal`?`height: ${this.listHeight}px; flex: none;`:``}">
            ...
            <alps-message-list
              ...
              .currentMailbox=${this.currentMailbox}
              .currentMailboxRole=${qt(this.currentMailbox,this.mailboxes)||``}
              .currentMailboxDelimiter=${$t(this.currentMailbox,this.mailboxes)}
              ...
              @clear-search=${()=>{let e=this.currentMailbox===`*`?D:this.currentMailbox;this.updateUrl(e,0,null,``)}}
              @search-submit=${e=>{let t=e.detail.value,n=e.detail.global?`*`:this.currentMailbox;this.updateUrl(n,0,null,t)}}
      ...
      ${this.showDeleteConfirm?n`
        ...
        ></ui-confirm>
      `:``}
    `}};A([h({context:oi})],q.prototype,`composeStore`,void 0),A([h({context:w})],q.prototype,`settingsStore`,void 0),A([h({context:C})],q.prototype,`i18nStore`,void 0),A([a()],q.prototype,`showDeleteConfirm`,void 0),A([a()],q.prototype,`listLoadFailed`,void 0),A([a()],q.prototype,`pendingDeleteDetails`,void 0),A([a()],q.prototype,`mailboxes`,void 0),A([a()],q.prototype,`messages`,void 0),A([a()],q.prototype,`currentMailbox`,void 0),A([a()],q.prototype,`loadingMessages`,void 0),A([a()],q.prototype,`showInitialLoader`,void 0),A([a()],q.prototype,`selectedMessage`,void 0),A([a()],q.prototype,`selectedKeys`,void 0),A([a()],q.prototype,`selectAllMatching`,void 0),A([a()],q.prototype,`excludedKeys`,void 0),A([a()],q.prototype,`layoutMode`,void 0),A([a()],q.prototype,`filterQuery`,void 0),A([a()],q.prototype,`expandedFolders`,void 0),A([a()],q.prototype,`username`,void 0),A([a()],q.prototype,`currentPage`,void 0),A([a()],q.prototype,`listedPage`,void 0),A([a()],q.prototype,`totalMessages`,void 0),A([a()],q.prototype,`messagesPerPage`,void 0),A([a()],q.prototype,`resizerPositionX`,void 0),A([a()],q.prototype,`listHeight`,void 0),A([a()],q.prototype,`isSidebarDragging`,void 0),A([a()],q.prototype,`isPaneDragging`,void 0),A([a()],q.prototype,`sidebarWidth`,void 0),A([a()],q.prototype,`isSidebarHovered`,void 0),A([a()],q.prototype,`densityMode`,void 0),A([a()],q.prototype,`showSenderAvatars`,void 0),A([a()],q.prototype,`isSyncing`,void 0),A([a()],q.prototype,`sidebarCollapsed`,void 0),A([a()],q.prototype,`suppressSidebarHover`,void 0),A([a()],q.prototype,`sortOrder`,void 0),A([a()],q.prototype,`listScrolled`,void 0),A([a()],q.prototype,`targetUid`,void 0),A([a()],q.prototype,`targetMailbox`,void 0),A([a()],q.prototype,`isMobile`,void 0),A([a()],q.prototype,`mobileSidebarOpen`,void 0),A([a()],q.prototype,`bulkProcessing`,void 0),A([a()],q.prototype,`computedMinListWidth`,void 0),q=A([p(`mailbox-page`)],q);var Va=e=>`alps_contacts_categories_${e}`,Ha=`contacts_categories_cache`,J=class extends d{constructor(...e){super(...e),this.contacts=[],this.sortOrder=`asc`,this.showOnlyStarred=!1,this.loading=!0,this.isSpinning=!1,this.showInitialLoader=!window.alpsAppLoaded,this.selectedContact=null,this.filterQuery=``,this.isEditing=!1,this.saving=!1,this.selectedCategory=``,this.showCreatePrompt=!1,this.showDeleteConfirm=!1,this.addedCategories=[],this.sidebarWidth=250,this.listWidth=380,this.sidebarCollapsed=!1,this.isSidebarHovered=!1,this.isMobile=window.innerWidth<=768,this.mobileSidebarOpen=!1,this.hoverTimeout=null,this.suppressSidebarHover=!1,this.isSidebarDragging=!1,this.isPaneDragging=!1,this.densityMode=`compact`,this.selectedContacts=new Set,this.listScrolled=!1,this.categoryToRename=null,this.categoryToDelete=null,this.syncIntervalTimer=null,this._handleSettingsChange=()=>{if(this.settingsStore){let e=this.settingsStore.getState();if(this.sidebarCollapsed=e.sidebarCollapsed,this.densityMode=e.densityMode||`compact`,this.syncIntervalTimer&&=(clearInterval(this.syncIntervalTimer),null),e.checkMailInterval&&e.checkMailInterval>0){let t=e.checkMailInterval*60*1e3;this.syncIntervalTimer=setInterval(()=>{this.fetchContacts()},t)}}},this._handleWindowResize=()=>{this.isMobile=window.innerWidth<=768},this.loadAddedCategories=()=>{try{localStorage.removeItem(Ha);let e=Oe(),t=e?JSON.parse(localStorage.getItem(Va(e))||`[]`):[];this.addedCategories=Array.isArray(t)?t:[]}catch{this.addedCategories=[]}},this._handleHashChange=()=>{this.contacts=this.contacts.filter(e=>!e.isTemporary);let e=window.location.hash.match(/^#\/contacts\/?([^\/]*)\/?(.*)$/);if(e){let t=e[1]?decodeURIComponent(e[1]):``,n=e[2]?decodeURIComponent(e[2]):``,r=t===`all`||!t?``:t;if(this.selectedCategory!==r&&(this.selectedCategory=r,this.selectedContacts=new Set,this.isMobile&&(this.mobileSidebarOpen=!1)),n){if((this.selectedContact?.uid?.replace(/^urn:uuid:/,``)||this.selectedContact?.path)!==n){if(this.contacts.length===0)return;let e=this.contacts.find(e=>(e.uid?.replace(/^urn:uuid:/,``)||e.path)===n);e&&this.selectContact(e,!1)}}else this.selectedContact=null,this.isEditing=!1}else this.selectedContact=null,this.isEditing=!1},this.queuedSave=null,this.saveRunning=!1,this.conflictedPath=null,this.startResize=e=>{e.preventDefault(),this.isPaneDragging=!0;let t=e.clientX,n=this.listWidth,r=e=>{let r=e.clientX-t;this.listWidth=Math.max(250,Math.min(800,n+r))},i=()=>{this.isPaneDragging=!1,window.removeEventListener(`mousemove`,r),window.removeEventListener(`mouseup`,i)};window.addEventListener(`mousemove`,r),window.addEventListener(`mouseup`,i)}}static{this.styles=[q.styles,U.styles,Dn,g`
    :host {
      display: flex;
      flex-direction: column;
      height: 100vh;
  ...
  `]}updated(e){if(super.updated(e),e.has(`densityMode`)){let e=this.settingsStore?.getState().densityMode||`normal`;this.dataset.density=e;let t=this.shadowRoot?.querySelector(`.contact-list-pane`);t&&(t.classList.remove(`density-loose`,`density-normal`,`density-compact`,`density-ultra-compact`),t.classList.add(`density-${e}`))}e.has(`loading`)&&this.loading&&(this.isSpinning=!0)}handleSpinIteration(){this.loading||(this.isSpinning=!1)}connectedCallback(){super.connectedCallback(),this.showInitialLoader=!window.alpsAppLoaded,this.classList.add(`density-compact`),this.loadAddedCategories(),window.addEventListener(`alps-active-user-changed`,this.loadAddedCategories),this.fetchContacts(),window.addEventListener(`resize`,this._handleWindowResize),window.addEventListener(`hashchange`,this._handleHashChange),this.settingsStore&&(this.settingsStore.addEventListener(`change`,this._handleSettingsChange),this._handleSettingsChange()),setTimeout(()=>this._handleHashChange(),0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener(`resize`,this._handleWindowResize),window.removeEventListener(`hashchange`,this._handleHashChange),window.removeEventListener(`alps-active-user-changed`,this.loadAddedCategories),this.settingsStore&&this.settingsStore.removeEventListener(`change`,this._handleSettingsChange),this.syncIntervalTimer&&=(clearInterval(this.syncIntervalTimer),null)}saveAddedCategories(){let e=Oe();if(e)try{localStorage.setItem(Va(e),JSON.stringify(this.addedCategories))}catch{}}get uniqueCategories(){let e=new Set(this.addedCategories);for(let t of this.contacts)if(t.categories)for(let n of t.categories)e.add(n);return Array.from(e).sort((e,t)=>e.localeCompare(t))}get username(){return this.settingsStore?.getState().loginUsername||``}async fetchContacts(){this.loading=!0;try{let e=await I.fetchContacts(this.filterQuery);this.contacts=e.contacts||[],this._handleHashChange()}catch(e){console.error(`Failed to fetch contacts`,e)}finally{this.loading=!1,this.showInitialLoader&&setTimeout(()=>{this.showInitialLoader=!1,window.alpsAppLoaded=!0},100)}}async selectContact(e,t=!0){if(e.isTemporary){this.selectedContact=e,this.isEditing=!0;return}if(t){let t=this.selectedCategory?encodeURIComponent(this.selectedCategory):`all`,n=e.uid?.replace(/^urn:uuid:/,``)||e.path;window.location.hash=`/contacts/${t}/${encodeURIComponent(n)}`;return}if(this.selectedContacts.size>0&&(this.selectedContacts=new Set),this.selectedContact?.path!==e.path){this.selectedContact={...e},this.isEditing=!1,this.conflictedPath=null;try{let t=await I.fetchContact(e.path);this.selectedContact?.path===t.path&&(this.selectedContact=t)}catch(e){console.error(`Failed to fetch contact details`,e)}}}get gestureTargets(){return this.selectedContacts.size>0?Array.from(this.selectedContacts):[this.selectedContact?.path].filter(Boolean)}get allSelectedStarred(){if(this.selectedContacts.size===0)return!1;for(let e of this.selectedContacts){let t=this.contacts.find(t=>t.path===e);if(!t||!t.categories?.includes(`Favorites`))return!1}return!0}async handleToggleStar(e,t){if(e.stopPropagation(),t.isTemporary)return;let n=t.categories?[...t.categories]:[];n.includes(`Favorites`)?n=n.filter(e=>e!==vr):n.push(vr),this.contacts=this.contacts.map(e=>e.path===t.path?{...e,categories:n}:e);try{let e=await I.updateCategories(t.path,n);this.applyETags(e.etag?{[t.path]:e.etag}:void 0),this.selectedContact?.path===t.path&&(this.selectedContact={...this.selectedContact,categories:n})}catch(e){console.error(`Failed to toggle star:`,e),this.reportFailure(`contacts.starFailed`);let n=t.categories;this.contacts=this.contacts.map(e=>e.path===t.path?{...e,categories:n}:e)}}handleSelectAll(e){let t=e;if(t.detail?t.detail.checked:e.target.checked){let e=this.contacts.filter(e=>!(this.selectedCategory&&(!e.categories||!e.categories.includes(this.selectedCategory))));this.selectedContacts=new Set(e.map(e=>e.path))}else this.selectedContacts=new Set}handleSelectContact(e,t){e.stopPropagation();let n=new Set(this.selectedContacts);n.has(t)?n.delete(t):n.add(t),this.selectedContacts=n}handleCreateCategorySubmit(e){let t=e.detail.name?.trim();t&&(this.addedCategories.includes(t)||(this.addedCategories=[...this.addedCategories,t],this.saveAddedCategories())),this.showCreatePrompt=!1}handleCreateNew(){this.selectedContacts=new Set;let e={name:this.i18nStore?.t(`contacts.unnamedContact`),categories:this.selectedCategory?[this.selectedCategory]:[],isTemporary:!0};this.contacts=this.contacts.filter(e=>!e.isTemporary),this.contacts=[e,...this.contacts],this.selectedContact=e,this.isEditing=!0}async cardsCarrying(e){return(this.filterQuery?(await I.fetchContacts()).contacts||[]:this.contacts).filter(t=>t.categories?.includes(e))}async handleRenameCategorySubmit(e){let t=e.detail.name?.trim();if(!t||!this.categoryToRename||t===this.categoryToRename){this.categoryToRename=null;return}let n=this.categoryToRename;this.categoryToRename=null,this.addedCategories.includes(n)&&(this.addedCategories=this.addedCategories.map(e=>e===n?t:e),this.saveAddedCategories()),this.selectedCategory===n&&(this.selectedCategory=t,window.location.hash=`/contacts/${encodeURIComponent(t)}`);let r;try{r=await this.cardsCarrying(n)}catch(e){console.error(`Could not read the address book for a category change`,e),this.reportFailure(`contacts.categoryRenameFailed`,{failed:1,total:1});return}if(r.length>0){this.saving=!0;try{let e=r.map(e=>{let r=e.categories.map(e=>e===n?t:e);return{...e,categories:r}}),{total:i,failed:a,etags:o}=await I.bulkUpdateCategories(e);this.applyETags(o),this.fetchContacts(),a>0&&this.reportFailure(`contacts.categoryRenameFailed`,{failed:a,total:i})}catch(e){console.error(`Error renaming category`,e),this.fetchContacts(),this.reportFailure(`contacts.categoryRenameFailed`,{failed:1,total:1})}finally{this.saving=!1}}}async handleDeleteCategorySubmit(){if(!this.categoryToDelete)return;let e=this.categoryToDelete;this.categoryToDelete=null,this.addedCategories.includes(e)&&(this.addedCategories=this.addedCategories.filter(t=>t!==e),this.saveAddedCategories()),this.selectedCategory===e&&(this.selectedCategory=``,window.location.hash=`/contacts/all`);let t;try{t=await this.cardsCarrying(e)}catch(e){console.error(`Could not read the address book for a category change`,e),this.reportFailure(`contacts.categoryDeleteFailed`,{failed:1,total:1});return}if(t.length>0){this.saving=!0;try{let n=t.map(t=>{let n=t.categories.filter(t=>t!==e);return{...t,categories:n}}),{total:r,failed:i,etags:a}=await I.bulkUpdateCategories(n);this.applyETags(a),this.fetchContacts(),i>0&&this.reportFailure(`contacts.categoryDeleteFailed`,{failed:i,total:r})}catch(e){console.error(`Error deleting category`,e),this.fetchContacts(),this.reportFailure(`contacts.categoryDeleteFailed`,{failed:1,total:1})}finally{this.saving=!1}}}handleEdit(){this.isEditing=!0}handleCancelEdit(){this.isEditing=!1,this.selectedContact?.isTemporary?(this.selectedContact=null,this.contacts=this.contacts.filter(e=>!e.isTemporary),this.selectedCategory||(window.location.hash=`/contacts/all`)):this.selectedContact?.path&&this.selectedContact.path===this.conflictedPath&&(this.conflictedPath=null,this.rereadOpenContact())}async rereadOpenContact(){let e=this.selectedContact?.path;if(e){try{let t=await I.fetchContact(e);this.selectedContact?.path===e&&!this.isEditing&&(this.selectedContact=t)}catch(e){console.error(`Failed to re-read the contact`,e)}this.fetchContacts()}}applyETags(e){if(!e||Object.keys(e).length===0)return;this.contacts=this.contacts.map(t=>e[t.path]?{...t,etag:e[t.path]}:t);let t=this.selectedContact?.path;t&&e[t]&&(this.selectedContact={...this.selectedContact,etag:e[t]})}async handleSave(e){if(this.queuedSave=e,!this.saveRunning){this.saveRunning=!0;try{for(;this.queuedSave;){let e=this.queuedSave;this.queuedSave=null,await this.saveOnce(e)}}finally{this.saveRunning=!1}}}async saveOnce(e){let t=!!this.selectedContact&&!this.selectedContact.isTemporary;if(!(t&&this.conflictedPath===this.selectedContact.path)){this.saving=!0;try{e.categories&&typeof e.categories==`string`?e.categories=e.categories.split(`,`).map(e=>e.trim()).filter(e=>e):e.categories=[];let n;n=t?await I.updateContact(this.selectedContact.path,{...e,etag:this.selectedContact.etag}):await I.createContact(e);let r={...e,path:n.path||(t?this.selectedContact.path:``),etag:n.etag},i=this.contacts.findIndex(e=>this.selectedContact&&(e.path===this.selectedContact.path||e.isTemporary&&this.selectedContact.isTemporary));i>-1?(this.contacts[i]={...this.contacts[i],...r},delete this.contacts[i].isTemporary,this.contacts=[...this.contacts]):this.contacts=[r,...this.contacts],this.selectedContact={...this.selectedContact,...r},delete this.selectedContact.isTemporary}catch(e){console.error(`Error saving contact`,e),t&&ot(e)?(this.conflictedPath=this.selectedContact.path,this.reportFailure(`contacts.saveConflict`)):this.reportFailure(`contacts.saveFailed`)}finally{this.saving=!1}}}handleSaveEvent(e){this.handleSave(e.detail)}async handleToggleStarEvent(){let e=this.gestureTargets;if(e.length===0)return;let t=e.length>1?this.allSelectedStarred:this.contacts.find(t=>t.path===e[0])?.categories?.includes(`Favorites`)||!1;this.saving=!0;let n=this.contacts.map(e=>({...e})),r=this.selectedContact?{...this.selectedContact}:null;try{let i=e.map(e=>{let n=this.contacts.findIndex(t=>t.path===e);if(n===-1)return;let r=this.contacts[n],i=r.categories?[...r.categories]:[];return t?i=i.filter(e=>e!==vr):i.includes(`Favorites`)||i.push(vr),this.contacts[n]={...r,categories:i},this.selectedContact?.path===e&&(this.selectedContact={...this.selectedContact,categories:i}),{...r,categories:i}}).filter(Boolean);this.contacts=[...this.contacts];let{total:a,done:o,failed:s,etags:c}=await I.bulkUpdateCategories(i);this.applyETags(c),s>0&&(o===0?(this.contacts=n,this.selectedContact=r):this.fetchContacts(),this.reportFailure(`contacts.starFailed`,{failed:s,total:a}))}catch(e){console.error(`Error toggling star`,e),this.reportFailure(`contacts.starFailed`)}finally{this.saving=!1}}reportFailure(e,t){window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:this.i18nStore?.t(e,t),duration:5e3}}))}handleDelete(){this.showDeleteConfirm=!0}async confirmDelete(){this.showDeleteConfirm=!1,this.saving=!0;try{let e=this.gestureTargets,{total:t,done:n,failed:r}=await I.bulkDeleteContacts(e);n>0&&(this.selectedContact=null,this.selectedContacts.size>0&&(this.selectedContacts=new Set),this.isEditing=!1,this.fetchContacts()),r>0&&this.reportFailure(`contacts.deleteFailed`,{failed:r,total:t})}catch(e){console.error(`Error deleting contacts`,e),this.fetchContacts(),this.reportFailure(`contacts.deleteFailed`,{failed:1,total:1})}finally{this.saving=!1}}async handleUpdateCategories(e){let t=e.detail.category;typeof t==`string`&&(t=t.trim()),t&&!this.addedCategories.includes(t)&&(this.addedCategories=[...this.addedCategories,t],this.saveAddedCategories());let n=this.gestureTargets;if(n.length!==0){this.saving=!0;try{let e=n.map(e=>{let n=this.contacts.findIndex(t=>t.path===e);if(n===-1)return;let r=this.contacts[n],i=r.categories?[...r.categories]:[];return t===``?i=[]:i.includes(t)?i=i.filter(e=>e!==t):i.push(t),this.contacts[n]={...r,categories:i},this.selectedContact?.path===e&&(this.selectedContact={...this.selectedContact,categories:i}),{...r,categories:i}}).filter(Boolean),{total:r,failed:i,etags:a}=await I.bulkUpdateCategories(e);if(this.contacts=[...this.contacts],this.applyETags(a),i>0&&(this.fetchContacts(),this.reportFailure(`contacts.categoryUpdateFailed`,{failed:i,total:r})),this.selectedContact&&this.selectedContacts.size<=1&&this.selectedCategory!==``&&!this.selectedContact.categories?.includes(this.selectedCategory)){let e=this.selectedContact.uid?.replace(/^urn:uuid:/,``)||this.selectedContact.path;e&&(window.location.hash=`#/contacts/all/${encodeURIComponent(e)}`)}this.selectedCategory!==``&&this.selectedCategory!==`All Contacts`&&this.fetchContacts()}catch(e){console.error(`Error updating categories`,e),this.reportFailure(`contacts.categoryUpdateFailed`)}finally{this.saving=!1}}}render(){return n`
      ...
      ${this.categoryToDelete===null?``:n`
        ...
        ></ui-confirm>
      `}
    `}};A([h({context:C})],J.prototype,`i18nStore`,void 0),A([h({context:w})],J.prototype,`settingsStore`,void 0),A([a()],J.prototype,`contacts`,void 0),A([a()],J.prototype,`sortOrder`,void 0),A([a()],J.prototype,`showOnlyStarred`,void 0),A([a()],J.prototype,`loading`,void 0),A([a()],J.prototype,`isSpinning`,void 0),A([a()],J.prototype,`showInitialLoader`,void 0),A([a()],J.prototype,`selectedContact`,void 0),A([a()],J.prototype,`filterQuery`,void 0),A([a()],J.prototype,`isEditing`,void 0),A([a()],J.prototype,`saving`,void 0),A([a()],J.prototype,`selectedCategory`,void 0),A([a()],J.prototype,`showCreatePrompt`,void 0),A([a()],J.prototype,`showDeleteConfirm`,void 0),A([a()],J.prototype,`addedCategories`,void 0),A([a()],J.prototype,`sidebarWidth`,void 0),A([a()],J.prototype,`listWidth`,void 0),A([a()],J.prototype,`sidebarCollapsed`,void 0),A([a()],J.prototype,`isSidebarHovered`,void 0),A([a()],J.prototype,`isMobile`,void 0),A([a()],J.prototype,`mobileSidebarOpen`,void 0),A([a()],J.prototype,`suppressSidebarHover`,void 0),A([a()],J.prototype,`isSidebarDragging`,void 0),A([a()],J.prototype,`isPaneDragging`,void 0),A([a()],J.prototype,`densityMode`,void 0),A([a()],J.prototype,`selectedContacts`,void 0),A([a()],J.prototype,`listScrolled`,void 0),A([a()],J.prototype,`categoryToRename`,void 0),A([a()],J.prototype,`categoryToDelete`,void 0),J=A([p(`contacts-page`)],J);var Y=class extends d{constructor(...e){super(...e),this.contact=null,this.isEditing=!1,this.saving=!1,this.uniqueCategories=[],this.isMobile=!1,this.selectedCount=0,this.allSelectedStarred=!1,this.scrolled=!1,this.editForm={},this.isDirty=!1,this.newCategoryName=``,this.saveTimeout=null}handleAddCategory(){let e=this.newCategoryName.trim();if(e){this.dispatchEvent(new CustomEvent(`update-categories`,{detail:{category:e},bubbles:!0,composed:!0})),this.newCategoryName=``;let t=this.shadowRoot?.querySelector(`alps-popup`);t&&t.close()}}static{this.styles=[Dn,g`
    :host {
      display: flex;
      flex-direction: column;
      height: 100%;
  ...
  `]}updated(e){if(e.has(`contact`)||e.has(`isEditing`)){let t=e.has(`isEditing`)&&this.isEditing;this.contact&&this.isEditing&&(t||!this.editForm||this.editForm.path!==this.contact.path)&&(this.editForm={...this.contact},this.isDirty=!1,Array.isArray(this.editForm.categories)&&(this.editForm.categories=this.editForm.categories.join(`, `)),Array.isArray(this.editForm.emails)&&this.editForm.emails.length>0?this.editForm.emails=this.editForm.emails.map(e=>({...e})):this.editForm.email?this.editForm.emails=[{value:this.editForm.email,type:``}]:this.editForm.emails=[{value:``,type:``}],Array.isArray(this.editForm.phones)&&this.editForm.phones.length>0?this.editForm.phones=this.editForm.phones.map(e=>({...e})):this.editForm.phone?this.editForm.phones=[{value:this.editForm.phone,type:``}]:this.editForm.phones=[{value:``,type:``}])}}debouncedSave(){this.saveTimeout&&clearTimeout(this.saveTimeout),this.saveTimeout=setTimeout(()=>{this.handleSave()},500)}handleInput(e,t){this.editForm={...this.editForm,[e]:t},this.isDirty=!0,this.debouncedSave()}handleMultiInput(e,t,n,r){let i=[...this.editForm[e]||[]];i[t]&&(i[t]={...i[t],[n]:r},this.editForm={...this.editForm,[e]:i,...e===`emails`?{email:i[0]?.value||``}:{phone:i[0]?.value||``}},this.isDirty=!0,this.debouncedSave())}addMultiField(e){let t=[...this.editForm[e]||[]];t.push({value:``,type:``}),this.editForm={...this.editForm,[e]:t},this.requestUpdate()}removeMultiField(e,t){let n=[...this.editForm[e]||[]];n.splice(t,1),this.editForm={...this.editForm,[e]:n,...e===`emails`?{email:n[0]?.value||``}:{phone:n[0]?.value||``}},this.isDirty=!0,this.debouncedSave()}formatTypeLabel(e,t){if(!e)return t;let n=e.toLowerCase();return`${{home:this.i18nStore?.t(`contacts.typeHome`)||`Home`,work:this.i18nStore?.t(`contacts.typeWork`)||`Work`,other:this.i18nStore?.t(`contacts.typeOther`)||`Other`,cell:this.i18nStore?.t(`contacts.typeMobile`)||`Mobile`,mobile:this.i18nStore?.t(`contacts.typeMobile`)||`Mobile`}[n]||e.charAt(0).toUpperCase()+e.slice(1).toLowerCase()} ${t}`}handleSave(){this.dispatchEvent(new CustomEvent(`save`,{detail:this.editForm,bubbles:!0,composed:!0}))}renderDetailRow(e,t,r=!1,i=!1){if(!t)return``;let a=n`${t}`;return r||e===`Email Address`||e===`Email`||e.endsWith(`Email`)||e.endsWith(this.i18nStore?.t(`contacts.email`)||`Email`)?a=n`<a href="mailto:${t}" @click=${e=>{e.preventDefault();let n=this.contact?.name?`"${this.contact.name}" <${t}>`:t;this.composeStore?.openComposer({to:[n]})}}>${t}</a>`:i||e===`Phone`||e.endsWith(`Phone`)||e.endsWith(this.i18nStore?.t(`contacts.phone`)||`Phone`)?a=n`<a href="tel:${t}">${t}</a>`:e===`URL`&&(a=n`<a href=${t.startsWith(`http`)?t:`https://${t}`} target="_blank" rel="noopener noreferrer">${t}</a>`),n`
      <div class="detail-group">
        <div class="group-label">${e}</div>
        <div class="group-value">${a}</div>
      </div>
        ...
        <alps-popup align="right" @popup-close=${()=>{}}>
          ...
          ${this.uniqueCategories.map(e=>{let t=this.contact?.categories?.includes(e);return n`
              <button class="dropdown-item ${t?`active`:``}" @click=${t=>{t.stopPropagation(),this.dispatchEvent(new CustomEvent(`update-categories`,{detail:{category:e},bubbles:!0,composed:!0}))}}>
                ${t?k(`check`):n`<div style="width: 16px;"></div>`}
      ...
      <div class="content" @scroll=${e=>{let t=e.target.scrollTop>0;this.scrolled!==t&&(this.scrolled=t)}}>
        ...
        ${this.isEditing?n`
          <div class="edit-form">
            ...
            ${(this.editForm.emails||[]).map((e,t)=>n`
              <div class="multi-field-row">
                <alps-input 
                  placeholder="${this.i18nStore?.t(`contacts.email`)}" 
                  type="email"
                  .value=${e.value||``} 
                  @input=${e=>this.handleMultiInput(`emails`,t,`value`,e.target.value)}>
                </alps-input>
                <select class="multi-field-type" .value=${e.type||``} @change=${e=>this.handleMultiInput(`emails`,t,`type`,e.target.value)}>
                  <option value="" ?selected=${!e.type}>${this.i18nStore?.t(`contacts.typeDefault`)||`Default`}</option>
                  <option value="home" ?selected=${e.type?.toLowerCase()===`home`}>${this.i18nStore?.t(`contacts.typeHome`)||`Home`}</option>
                  <option value="work" ?selected=${e.type?.toLowerCase()===`work`}>${this.i18nStore?.t(`contacts.typeWork`)||`Work`}</option>
                  <option value="other" ?selected=${e.type?.toLowerCase()===`other`}>${this.i18nStore?.t(`contacts.typeOther`)||`Other`}</option>
                </select>
                ${(this.editForm.emails||[]).length>1?n`
                  <alps-icon-btn icon="trash" @click=${()=>this.removeMultiField(`emails`,t)} title="${this.i18nStore?.t(`contacts.delete`)}"></alps-icon-btn>
                `:``}
              </div>
            `)}
            ...
            ${(this.editForm.phones||[]).map((e,t)=>n`
              <div class="multi-field-row">
                <alps-input 
                  placeholder="${this.i18nStore?.t(`contacts.phone`)}" 
                  .value=${e.value||``} 
                  @input=${e=>this.handleMultiInput(`phones`,t,`value`,e.target.value)}>
                </alps-input>
                <select class="multi-field-type" .value=${e.type||``} @change=${e=>this.handleMultiInput(`phones`,t,`type`,e.target.value)}>
                  <option value="" ?selected=${!e.type}>${this.i18nStore?.t(`contacts.typeDefault`)||`Default`}</option>
                  <option value="cell" ?selected=${e.type?.toLowerCase()===`cell`||e.type?.toLowerCase()===`mobile`}>${this.i18nStore?.t(`contacts.typeMobile`)||`Mobile`}</option>
                  <option value="home" ?selected=${e.type?.toLowerCase()===`home`}>${this.i18nStore?.t(`contacts.typeHome`)||`Home`}</option>
                  <option value="work" ?selected=${e.type?.toLowerCase()===`work`}>${this.i18nStore?.t(`contacts.typeWork`)||`Work`}</option>
                  <option value="other" ?selected=${e.type?.toLowerCase()===`other`}>${this.i18nStore?.t(`contacts.typeOther`)||`Other`}</option>
                </select>
                ${(this.editForm.phones||[]).length>1?n`
                  <alps-icon-btn icon="trash" @click=${()=>this.removeMultiField(`phones`,t)} title="${this.i18nStore?.t(`contacts.delete`)}"></alps-icon-btn>
                `:``}
              </div>
            `)}
        ...
        `:n`
          ...
          <div class="view-details">
            ${this.contact.emails&&this.contact.emails.length>0?this.contact.emails.map(e=>this.renderDetailRow(this.formatTypeLabel(e.type,this.i18nStore?.t(`contacts.email`)||`Email`),e.value,!0)):this.renderDetailRow(this.i18nStore?.t(`contacts.email`)||`Email`,this.contact.email,!0)}
            ${this.contact.phones&&this.contact.phones.length>0?this.contact.phones.map(e=>this.renderDetailRow(this.formatTypeLabel(e.type,this.i18nStore?.t(`contacts.phone`)||`Phone`),e.value,!1,!0)):this.renderDetailRow(this.i18nStore?.t(`contacts.phone`)||`Phone`,this.contact.phone,!1,!0)}
    ...
    `}};A([o({type:Object})],Y.prototype,`contact`,void 0),A([o({type:Boolean})],Y.prototype,`isEditing`,void 0),A([o({type:Boolean})],Y.prototype,`saving`,void 0),A([o({type:Array})],Y.prototype,`uniqueCategories`,void 0),A([o({type:Boolean})],Y.prototype,`isMobile`,void 0),A([o({type:Number})],Y.prototype,`selectedCount`,void 0),A([o({type:Boolean})],Y.prototype,`allSelectedStarred`,void 0),A([a()],Y.prototype,`scrolled`,void 0),A([h({context:C})],Y.prototype,`i18nStore`,void 0),A([h({context:oi})],Y.prototype,`composeStore`,void 0),A([h({context:w,subscribe:!0})],Y.prototype,`settingsStore`,void 0),A([a()],Y.prototype,`editForm`,void 0),A([a()],Y.prototype,`isDirty`,void 0),A([a()],Y.prototype,`newCategoryName`,void 0),Y=A([p(`alps-contact-view`)],Y);var Ua=e({});v.registerRoute({path:`/contacts/*`,component:`contacts-page`,pluginId:`carddav`}),v.registerNavTab({id:`contacts`,pluginId:`carddav`,labelKey:`navigation.contacts`,icon:`users`,order:10}),v.registerHook(`composer:send`,async({recipients:e})=>{if(!(!e||!Array.isArray(e)))for(let t of e){let e=t,n=``,r=t.match(/^(.*?)\s*<([^>]+)>$/);r&&r[2]?(n=r[1].replace(/^["']|["']$/g,``).trim(),e=r[2]):e=e.trim();try{await I.createContact({name:n,email:e})}catch(e){console.error(`Failed to auto-save contact`,e)}}},`carddav`),v.registerHook(`composer:suggest`,async({query:e})=>{try{let t=(await I.fetchContacts(e)).contacts||[],n=[],r=new Set;for(let e of t){let t=e.name||``,i=e.emails&&e.emails.length>0?e.emails:e.email?[{value:e.email}]:[];for(let e of i){let i=e.value?.trim();i&&!r.has(i.toLowerCase())&&(r.add(i.toLowerCase()),n.push({name:t,address:i}))}}return n}catch(e){return console.error(`Failed to fetch contact suggestions`,e),[]}},`carddav`);var Wa=class extends d{constructor(...e){super(...e),this.label=``,this.description=``}static{this.styles=g`
    :host {
      display: block;
      width: 100%;
      max-width: 600px;
  ...
  `}render(){return n`
    ...
    `}};A([o({type:String})],Wa.prototype,`label`,void 0),A([o({type:String})],Wa.prototype,`description`,void 0),Wa=A([p(`alps-setting-group`)],Wa);function Ga(e,t){return new Promise(n=>{let r=document.createElement(`ui-prompt`);r.title=t?.t(`gpg.passphraseRequired`),r.confirmText=t?.t(`gpg.unlock`),r.cancelText=t?.t(`general.cancel`);let i=t?.t(`gpg.passphrasePrompt`);e&&(i+=` (Error: ${e})`),r.fields=[{id:`passphrase`,label:i,type:`password`,placeholder:t?.t(`gpg.passphrase`),autofocus:!0}];let a=()=>{r.parentNode&&r.parentNode.removeChild(r)};r.addEventListener(`submit`,e=>{n(e.detail.passphrase),a()}),r.addEventListener(`cancel`,()=>{n(null),a()}),document.body.appendChild(r)})}var Ka=null;function qa(){Ka=null;try{sessionStorage.removeItem(`gpg_private_key`)}catch{}}async function Ja(e,t){if(Ka)return Ka;let n=await E(`/gpg/keys`);if(!n.ok)throw Error(`Failed to fetch GPG keyring.`);let r=await n.json();if(!r.encrypted_private_key)throw Error(`No private key found on server. Please generate one in Settings.`);let i=await e.readPrivateKey({armoredKey:r.encrypted_private_key});if(i.isDecrypted())return Ka=i,Ka;{let n,r=await Ga(n,t);for(;r!==null;)try{return Ka=await e.decryptKey({privateKey:i,passphrase:r}),Ka}catch(e){n=`Incorrect passphrase: `+e.message,r=await Ga(n,t)}throw Error(`Passphrase prompt cancelled.`)}}async function Ya(e){let{instance:t,formData:n,composer:r}=e;if(!t.encryptGpg)return n;if(n.get(`attachment-uuids`)||n.get(`prev_attachments`)){let e=r?.i18nStore?.t(`gpg.attachmentsNotEncryptable`);return alert(e||`Attachments cannot be encrypted with inline PGP and would be sent unencrypted. Remove the attachments, or turn off encryption to send them.`),!1}try{let e=await S(()=>import(`./openpgp-BXFLORuu.js`).then(e=>e.t),__vite__mapDeps([0,1])),i=t.to||[],a=t.cc||[],o=t.bcc||[],s=[...i,...a,...o];if(s.length===0)return n;let c=[],l=[],u=[],d=ke();d.loginUsername&&u.push(d.loginUsername);for(let t of s){let n=t.includes(`<`)?t.split(`<`)[1].split(`>`)[0].trim():t.trim();if(u.includes(n))continue;let r=(await I.fetchContacts(n)).contacts||[],i=!1;for(let t of r)if(t.public_key){let n=await e.readKey({armoredKey:t.public_key});c.push(n),i=!0;break}i||l.push(t)}if(l.length>0){let e=r.i18nStore?.t(`gpg.missingPublicKeys`),t=l.join(`
`);return alert(e?e.replace(`{keys}`,t):`Cannot encrypt: Missing public keys for:\n${t}`),!1}let f=await Ja(e,r.i18nStore),p=f.toPublic();c.push(p);let m=n.get(`text`)||``,h=n.get(`html`)||``,ee=``;ee=t.format===`html`&&h?h:m;let g=await e.createMessage({text:ee}),te=await e.encrypt({message:g,encryptionKeys:c,signingKeys:f,format:`armored`});return n.set(`text`,te),n.set(`html`,``),n}catch(e){return alert(`GPG Encryption failed: `+e.message),!1}}async function Xa(e){if(typeof e.content==`string`&&e.content.includes(`-----BEGIN PGP MESSAGE-----`))try{let t=await S(()=>import(`./openpgp-BXFLORuu.js`).then(e=>e.t),__vite__mapDeps([0,1])),r=e.content.indexOf(`-----BEGIN PGP MESSAGE-----`),i=e.content.indexOf(`-----END PGP MESSAGE-----`)+25;if(r===-1||i<=r)return e.content;let a=e.content.substring(r,i),o=await Ja(t,e.i18nStore),s=await t.readMessage({armoredMessage:a}),{data:c}=await t.decrypt({message:s,decryptionKeys:o,format:`utf8`}),l=String(c);l.includes(`<html`)||l.includes(`<body`)||l.includes(`<p>`)||l.includes(`<div`)||l.includes(`<br`)||(l=l.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/\n/g,`<br/>`));let u=e.content.substring(0,r)+l+e.content.substring(i);return e.banners=e.banners||[],e.banners.push(n`
              <alps-banner variant="info">
                <span style="display: flex; align-items: center; gap: 8px;">
                  <span style="display: flex; width: 16px; height: 16px;">${k(`lock`)}</span>
    ...
    `}async connectedCallback(){super.connectedCallback(),await this.fetchKeys()}async fetchKeys(){this.loading=!0;try{let e=await E(`/gpg/keys`);if(e.ok){let t=await e.json();t.public_key?this.keyring=t:this.keyring=null}}catch(e){console.error(e)}finally{this.loading=!1}}promptForPassphrase(e=`lock`){return this.passphrasePromptMode=e,this.showPassphrasePrompt=!0,new Promise(e=>{this.resolvePassphrase=e})}showErrorDialog(e){return this.importError=e,new Promise(e=>{this.resolveError=e})}clearError(){this.importError=``,this.resolveError&&=(this.resolveError(),null)}async getConfirmedPassphrase(){for(;;){let e=await this.promptForPassphrase(`lock`);if(!e)return null;let t=await this.promptForPassphrase(`confirm`);if(!t)return null;if(e===t)return e;await this.showErrorDialog(this.i18nStore?.t(`gpg.passphraseMismatch`))}}handlePassphraseSubmit(e){this.resolvePassphrase&&=(this.resolvePassphrase(e),null),this.showPassphrasePrompt=!1}handlePassphraseCancel(){this.resolvePassphrase&&=(this.resolvePassphrase(null),null),this.showPassphrasePrompt=!1}async generateKeys(){let e=await this.getConfirmedPassphrase();if(e){this.generating=!0;try{let{privateKey:t,publicKey:n}=await(await S(()=>import(`./openpgp-BXFLORuu.js`).then(e=>e.t),__vite__mapDeps([0,1]))).generateKey({type:`ecc`,curve:`curve25519`,userIDs:[{name:`ALPS User`,email:``}],passphrase:e});await E(`/gpg/keys`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({public_key:n,encrypted_private_key:t})}),await this.fetchKeys()}catch(e){alert(this.i18nStore?.t(`gpg.generateFailed`,{error:e.message}))}finally{this.generating=!1}}}async importKeys(){if(!this.pubKeyInput||!this.privKeyInput){this.importError=this.i18nStore?.t(`gpg.importMissing`);return}this.importing=!0;let e,t;try{e=await S(()=>import(`./openpgp-BXFLORuu.js`).then(e=>e.t),__vite__mapDeps([0,1])),await e.readKey({armoredKey:this.pubKeyInput}),t=await e.readPrivateKey({armoredKey:this.privKeyInput})}catch(e){this.importing=!1,this.importError=this.i18nStore?.t(`gpg.importFailed`,{error:e.message});return}if(this.importing=!1,!t.isDecrypted()){let n=await this.promptForPassphrase(`unlock`);for(;n!==null;)try{t=await e.decryptKey({privateKey:t,passphrase:n});break}catch{await this.showErrorDialog(this.i18nStore?.t(`gpg.importIncorrectPassphrase`)),n=await this.promptForPassphrase(`unlock`)}if(!t.isDecrypted())return}let n=await this.getConfirmedPassphrase();if(n){this.importing=!0;try{let r=await e.encryptKey({privateKey:t,passphrase:n});await E(`/gpg/keys`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({public_key:this.pubKeyInput,encrypted_private_key:r})}),this.pubKeyInput=``,this.privKeyInput=``,this.viewState=`default`,await this.fetchKeys()}catch(e){this.importError=this.i18nStore?.t(`gpg.importFailed`,{error:e.message})}finally{this.importing=!1}}}async purgeKeys(){this.loading=!0,this.showPurgeConfirm=!1,await E(`/gpg/keys`,{method:`DELETE`}),this.keyring=null,qa(),this.loading=!1}render(){return this.loading||this.generating?n`<alps-loader full-height .text=${this.generating?`Generating keypair...`:`Loading...`}></alps-loader>`:n`
            ...
            ${this.showPurgeConfirm?n`
                ...
                ></ui-confirm>
            `:``}
        `}};A([h({context:C,subscribe:!0})],X.prototype,`i18nStore`,void 0),A([a()],X.prototype,`loading`,void 0),A([a()],X.prototype,`generating`,void 0),A([a()],X.prototype,`importing`,void 0),A([a()],X.prototype,`importError`,void 0),A([a()],X.prototype,`keyring`,void 0),A([a()],X.prototype,`pubKeyInput`,void 0),A([a()],X.prototype,`privKeyInput`,void 0),A([a()],X.prototype,`viewState`,void 0),A([a()],X.prototype,`showPassphrasePrompt`,void 0),A([a()],X.prototype,`passphrasePromptMode`,void 0),A([a()],X.prototype,`showPurgeConfirm`,void 0),X=A([p(`alps-gpg-settings`)],X);var Za=e({});v.registerSettingsTab({id:`gpg`,labelKey:`settings.gpg`,icon:`key`,component:`alps-gpg-settings`}),v.registerHook(`composer:toolbar`,e=>{let t=e.instance,r=e.composer,i=t.encryptGpg||!1;return n`
        <alps-icon-btn 
    ...
    `},`gpg`),v.registerHook(`composer:presend`,Ya,`gpg`),v.registerHook(`reader:content`,Xa,`gpg`);function Qa(e){return`"`+String(e??``).replace(/[\u0000-\u001f\u007f]/g,``).replace(/\\/g,`\\\\`).replace(/"/g,`\\"`)+`"`}function $a(e){let t=new TextEncoder().encode(JSON.stringify(e)),n=``;for(let e of t)n+=String.fromCharCode(e);return btoa(n)}function eo(e){let t=atob(e),n=Uint8Array.from(t,e=>e.charCodeAt(0));try{return new TextDecoder(`utf-8`,{fatal:!0}).decode(n)}catch{return t}}var to=class{static extractVisualState(e){let t=e.match(/^# ALPS_VISUAL_STATE: (.*)$/m);if(!t)return null;try{return JSON.parse(eo(t[1]))}catch{return null}}static compile(e){if(e.rules.length===0)return``;let t=new Set;for(let n of e.rules){for(let e of n.actions)e.type===`fileinto`&&(t.add(`fileinto`),t.add(`mailbox`));for(let e of n.conditions)e.field.toLowerCase()===`body`&&t.add(`body`)}let n=``;t.size>0&&(n+=`require [${Array.from(t).map(e=>`"${e}"`).join(`, `)}];\n\n`),n+=`# ALPS_VISUAL_STATE: ${$a(e)}\n\n`;for(let t of e.rules){if(t.conditions.length===0||t.actions.length===0)continue;let e=t.conditions.map(e=>this.compileCondition(e)),r=``;r=e.length===1?`if ${e[0]}`:t.matchType===`all`?`if allof (${e.join(`, `)})`:`if anyof (${e.join(`, `)})`,n+=`${r} {\n`;for(let e of t.actions)n+=`  ${this.compileAction(e)}\n`;n+=`}

`}return n}static compileCondition(e){let t=e.field.toLowerCase();if(t===`size`){let t=String(e.value??``).trim();return/^\d+[KMG]?$/i.test(t)?`size :${e.operator} ${t}`:`size :${e.operator} 0`}if(t===`body`)return`${e.operator===`not_contains`||e.operator===`not_is`?`not `:``}body :text ${e.operator===`is`||e.operator===`not_is`?`:is`:`:contains`} ${Qa(e.value)}`;let n=``,r=``;return e.operator===`contains`?(n=``,r=`:contains`):e.operator===`not_contains`?(n=`not `,r=`:contains`):e.operator===`is`?(n=``,r=`:is`):e.operator===`not_is`&&(n=`not `,r=`:is`),`${n}header ${r} ${Qa(e.field)} ${Qa(e.value)}`}static compileAction(e){switch(e.type){case`fileinto`:return`fileinto :create ${Qa(e.value??``)};`;case`discard`:return`discard;`;case`redirect`:return`redirect ${Qa(e.value??``)};`;case`stop`:return`stop;`}return``}},no=new class{async fetchScript(){let e=await E(`/managesieve/script`);if(!e.ok)throw Error(`Failed to fetch script: ${e.statusText}`);return e.json()}async saveScript(e,t=`PUT`){let n=await E(`/managesieve/script`,{method:t,headers:{"Content-Type":`application/json`},body:JSON.stringify({content:e})});if(!n.ok){let e=await n.json().catch(()=>({}));throw Error(e.error||`Failed to save script`)}return n.json()}async validateScript(e){let t=await E(`/managesieve/validate`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({content:e})});if(!t.ok){let e=await t.json().catch(()=>({}));throw Error(e.error||`Validation failed`)}return t.json()}async fetchFolders(){let e=await E(`/mailboxes/INBOX`);if(!e.ok)throw Error(`Failed to fetch mailboxes: ${e.statusText}`);return e.json()}},ro=class extends d{constructor(...e){super(...e),this.isDirty=!1,this.script=``,this.stored=``,this.isValidating=!1,this.isSaving=!1}static{this.styles=g`
		.editor-container {
			display: flex;
			flex-direction: column;
			gap: 16px;
...
`)&&(t+=` `),m(t)}handleScroll(e){let t=e.target,n=this.shadowRoot?.querySelector(`.highlight-layer`);n&&(n.scrollTop=t.scrollTop,n.scrollLeft=t.scrollLeft)}handleInput(e){let t=e.target;this.script=t.value,this.dispatchEvent(new CustomEvent(`script-changed`,{detail:{script:this.script}}))}async validate(){this.isValidating=!0;let e=this.script;try{if(await no.validateScript(e),this.script!==e)return;window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:this.i18nStore.t(`managesieve.toast.valid`),timeout:3e3}}))}catch(t){if(this.script!==e)return;window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:t.message||this.i18nStore.t(`managesieve.toast.networkError`),timeout:5e3,type:`error`}}))}finally{this.isValidating=!1}}async save(){this.isSaving=!0;let e=this.script;try{await no.saveScript(e,`PUT`),this.stored=e,this.dispatchEvent(new CustomEvent(`script-saved`,{detail:{script:e}}));let t=e.trim()===``?`managesieve.toast.deactivated`:`managesieve.toast.saved`;window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:this.i18nStore.t(t),timeout:3e3}}))}catch(e){window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:e.message||this.i18nStore.t(`managesieve.toast.networkError`),timeout:5e3,type:`error`}}))}finally{this.isSaving=!1}}render(){return n`
		...
		`}};A([a()],ro.prototype,`isDirty`,void 0),A([h({context:C})],ro.prototype,`i18nStore`,void 0),A([o({type:String})],ro.prototype,`script`,void 0),A([o({type:String})],ro.prototype,`stored`,void 0),A([a()],ro.prototype,`isValidating`,void 0),A([a()],ro.prototype,`isSaving`,void 0),ro=A([p(`alps-raw-editor`)],ro);var io=class extends d{constructor(...e){super(...e),this.isSaving=!1,this.initialSnapshot=``,this.state={rules:[]},this.folders=[]}willUpdate(e){e.has(`state`)&&this.initialSnapshot===``&&(this.initialSnapshot=JSON.stringify(this.state))}get isDirty(){return this.initialSnapshot!==``&&this.initialSnapshot!==JSON.stringify(this.state)}markClean(e=JSON.stringify(this.state)){this.initialSnapshot=e,this.requestUpdate()}static{this.styles=g`
		.editor-container {
			display: flex;
			flex-direction: column;
			gap: 24px;
	...
	`}addRule(){this.state={...this.state,rules:[...this.state.rules,{id:Math.random().toString(36).substring(7),matchType:`all`,conditions:[{field:`Subject`,operator:`contains`,value:``}],actions:[{type:`fileinto`,value:this.folders[0]||`INBOX`}]}]},this.notifyChange()}deleteRule(e){let t=[...this.state.rules];t.splice(e,1),this.state={...this.state,rules:t},this.notifyChange()}updateRule(e,t){let n=[...this.state.rules];n[e]={...n[e],...t},this.state={...this.state,rules:n},this.notifyChange()}addCondition(e,t){let n=this.state.rules[e],r={field:`Subject`,operator:`contains`,value:``},i=[...n.conditions];t===void 0?i.push(r):i.splice(t,0,r),this.updateRule(e,{conditions:i})}deleteCondition(e,t){let n=[...this.state.rules[e].conditions];n.splice(t,1),this.updateRule(e,{conditions:n})}updateCondition(e,t,n){let r=[...this.state.rules[e].conditions],i=r[t];n.field&&n.field!==i.field&&(n.field===`Size`?i.operator!==`over`&&i.operator!==`under`&&(n.operator=`over`):(i.operator===`over`||i.operator===`under`)&&(n.operator=`contains`)),r[t]={...i,...n},this.updateRule(e,{conditions:r})}addAction(e,t){let n=this.state.rules[e],r={type:`fileinto`,value:this.folders[0]||`INBOX`},i=[...n.actions];t===void 0?i.push(r):i.splice(t,0,r),this.updateRule(e,{actions:i})}deleteAction(e,t){let n=[...this.state.rules[e].actions];n.splice(t,1),this.updateRule(e,{actions:n})}updateAction(e,t,n){let r=[...this.state.rules[e].actions];r[t]={...r[t],...n},this.updateRule(e,{actions:r})}notifyChange(){this.dispatchEvent(new CustomEvent(`state-changed`,{detail:{state:this.state}}))}save(){this.dispatchEvent(new CustomEvent(`save-requested`))}render(){return n`
		...
		`}};A([o({type:Boolean})],io.prototype,`isSaving`,void 0),A([a()],io.prototype,`initialSnapshot`,void 0),A([h({context:C,subscribe:!0})],io.prototype,`i18nStore`,void 0),A([o({type:Object})],io.prototype,`state`,void 0),A([o({type:Array})],io.prototype,`folders`,void 0),io=A([p(`alps-visual-editor`)],io);var ao=class extends d{constructor(...e){super(...e),this.mode=`visual`,this.script=``,this.storedScript=``,this.visualState={rules:[]},this.folders=[],this.isLoading=!0,this.isSaving=!1,this.showSwitchRawConfirm=!1}static{this.styles=g`
		.container {
			display: flex;
			flex-direction: column;
			gap: 20px;
	...
	`}connectedCallback(){super.connectedCallback(),this.fetchScript(),this.fetchFolders()}async fetchScript(){try{let e=await no.fetchScript();if(this.script=e.content||``,this.storedScript=this.script,this.script.trim()===``)this.mode=`visual`,this.visualState={rules:[]};else{let e=to.extractVisualState(this.script);e?(this.visualState=e,this.mode=`visual`):this.mode=`raw`}}catch(e){console.error(`Failed to fetch Sieve script`,e),this.visualState={rules:[]},this.mode=`visual`}finally{this.isLoading=!1}}async fetchFolders(){try{let e=await no.fetchFolders();e&&e.Mailboxes&&(this.folders=e.Mailboxes.map(e=>e.Name||e.Mailbox).filter(Boolean))}catch(e){console.error(`Failed to fetch folders`,e)}}handleVisualStateChange(e){this.visualState=e.detail.state}handleRawScriptChange(e){this.script=e.detail.script}switchToRaw(){this.showSwitchRawConfirm=!0}confirmSwitchToRaw(){this.script=to.compile(this.visualState),this.mode=`raw`,this.showSwitchRawConfirm=!1}async saveVisual(){this.isSaving=!0;try{let e=to.compile(this.visualState);this.script=e;let t=JSON.stringify(this.visualState);await no.saveScript(e,`PUT`),this.storedScript=e;let n=e.trim()===``?`managesieve.toast.deactivated`:`managesieve.toast.saved`;window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:this.i18nStore.t(n),timeout:3e3}}));let r=this.shadowRoot?.querySelector(`alps-visual-editor`);r&&r.markClean&&r.markClean(t)}catch(e){window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:e.message||this.i18nStore.t(`managesieve.toast.networkError`),timeout:5e3,type:`error`}}))}finally{this.isSaving=!1}}render(){return n`
			...
			${this.showSwitchRawConfirm?n`
				...
				></ui-confirm>
			`:``}
		`}};A([h({context:C,subscribe:!0})],ao.prototype,`i18nStore`,void 0),A([a()],ao.prototype,`mode`,void 0),A([a()],ao.prototype,`script`,void 0),A([a()],ao.prototype,`storedScript`,void 0),A([a()],ao.prototype,`visualState`,void 0),A([a()],ao.prototype,`folders`,void 0),A([a()],ao.prototype,`isLoading`,void 0),A([a()],ao.prototype,`isSaving`,void 0),A([a()],ao.prototype,`showSwitchRawConfirm`,void 0),ao=A([p(`alps-managesieve-page`)],ao);var oo=e({});v.registerSettingsTab({id:`managesieve`,labelKey:`settings.categories.filters`,icon:`sieve`,component:`alps-managesieve-page`});var so=class extends d{constructor(...e){super(...e),this.passwordForm={old:``,new:``,confirm:``},this.isSubmitting=!1}static{this.styles=g`
		input[type="password"] {
			width: 100%;
			box-sizing: border-box;
	...
	`}};A([h({context:C})],so.prototype,`i18nStore`,void 0),A([a()],so.prototype,`passwordForm`,void 0),A([a()],so.prototype,`isSubmitting`,void 0),so=A([p(`alps-password-settings`)],so);var co=e({});v.registerSettingsTab({id:`password`,labelKey:`settings.categories.password`,icon:`password`,component:`alps-password-settings`});var lo=class{get currentPath(){return this.getHashPath()}constructor(e,t,n){this.routes=e,this.fallback=t,window.addEventListener(`hashchange`,()=>n())}getHashPath(){let e=window.location.hash;return!e||e===`#`?`/`:e.substring(1).split(`?`)[0]}navigate(e){window.location.hash=e}render(){if(this.routes[this.currentPath])return this.routes[this.currentPath]();for(let e in this.routes)if(e.endsWith(`/*`)&&this.currentPath.startsWith(e.replace(`/*`,``)))return this.routes[e]();return this.fallback()}},uo=class extends d{constructor(...e){super(...e),this.icon=``,this.title=``,this.subtitle=``}static{this.styles=g`
    :host {
      display: flex;
      justify-content: center;
      align-items: center;
  ...
  `}render(){return n`
    ...
    `}};A([o({type:String})],uo.prototype,`icon`,void 0),A([o({type:String})],uo.prototype,`title`,void 0),A([o({type:String})],uo.prototype,`subtitle`,void 0),uo=A([p(`alps-auth-card`)],uo);var fo=class extends d{constructor(...e){super(...e),this.notice=null,this.username=``,this.password=``,this.rememberMe=!1,this.error=``,this.isSubmitting=!1,this.retryAfter=0,this.isRateLimited=!1,this._handleI18nChange=()=>{this.requestUpdate()}}static{this.styles=g`
    .form-group {
      margin-bottom: 16px;
      position: relative;
    }
  ...
  `}connectedCallback(){super.connectedCallback(),this.notice=li(),this.updateComplete.then(()=>{this.i18nStore?.addEventListener(`change`,this._handleI18nChange)}),this.composeStore&&this.composeStore.clearAllComposers()}disconnectedCallback(){super.disconnectedCallback(),this.i18nStore?.removeEventListener(`change`,this._handleI18nChange),this.retryCountdownInterval&&clearInterval(this.retryCountdownInterval)}firstUpdated(){this.renderRoot.querySelector(`#username`)?.focus()}startRetryCountdown(e){this.retryAfter=e,this.isRateLimited=!0,this.retryCountdownInterval&&clearInterval(this.retryCountdownInterval),this.retryCountdownInterval=setInterval(()=>{this.retryAfter--,this.retryAfter<=0&&(this.isRateLimited=!1,this.retryCountdownInterval&&=(clearInterval(this.retryCountdownInterval),void 0))},1e3)}formatRetryTime(e){if(e<60)return`${e} second${e===1?``:`s`}`;let t=Math.ceil(e/60);return`${t} minute${t===1?``:`s`}`}async handleSubmit(e){if(e.preventDefault(),this.isSubmitting)return;let t=this.shadowRoot?.querySelector(`form`);if(t&&!t.checkValidity()){t.reportValidity();return}this.error=``,this.isSubmitting=!0;try{await new Promise(e=>setTimeout(e,600));let e={username:this.username,password:this.password,"remember-me":this.rememberMe?`on`:``},t=await fetch(`/session`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n={};try{n=await t.json()??{}}catch{n={}}if(t.ok)if(n.requires_2fa){try{sessionStorage.setItem(`pending_2fa_username`,this.username)}catch{}window.location.hash=`/login/webauthn`,this.isSubmitting=!1}else window.dispatchEvent(new CustomEvent(`user-logged-in`,{detail:{username:this.username}})),window.location.hash=`/mailbox/INBOX`;else{if(t.status===429){this.error=n.error||this.i18nStore?.t(`login.tooManyAttempts`);let e=Number(n.retry_after)||Number(t.headers.get(`Retry-After`))||60;this.startRetryCountdown(e)}else this.error=n.error||this.i18nStore?.t(`login.loginFailed`),this.isRateLimited=!1;this.isSubmitting=!1}}catch{this.error=this.i18nStore?.t(`login.networkError`),this.isSubmitting=!1,this.isRateLimited=!1}}render(){return n`
        ...
        <form @submit=${this.handleSubmit}>
          <div class="form-group">
            <div class="input-wrapper has-left-icon">
              <span class="icon-left">${k(`at`)}</span>
              <input 
                type="text" 
                id="username" 
                name="username"
          ...
          <div class="form-group">
            <div class="input-wrapper has-left-icon">
              <span class="icon-left">${k(`key`)}</span>
              <input 
                type="password" 
                id="password" 
                name="password"
    ...
    `}};A([h({context:C})],fo.prototype,`i18nStore`,void 0),A([a()],fo.prototype,`notice`,void 0),A([a()],fo.prototype,`username`,void 0),A([a()],fo.prototype,`password`,void 0),A([a()],fo.prototype,`rememberMe`,void 0),A([a()],fo.prototype,`error`,void 0),A([a()],fo.prototype,`isSubmitting`,void 0),A([a()],fo.prototype,`retryAfter`,void 0),A([a()],fo.prototype,`isRateLimited`,void 0),A([h({context:oi,subscribe:!0})],fo.prototype,`composeStore`,void 0),fo=A([p(`login-page`)],fo);var po=class extends d{constructor(...e){super(...e),this.active=!1,this.icon=``}static{this.styles=g`
    :host {
      display: flex;
      align-items: center;
      padding: 8px 16px;
  ...
  `}render(){return n`
      ${this.icon?n`
        <span class="category-icon">${k(this.icon)}</span>
      `:``}
      <span class="label"><slot></slot></span>
    `}};A([o({type:Boolean,reflect:!0})],po.prototype,`active`,void 0),A([o({type:String})],po.prototype,`icon`,void 0),po=A([p(`alps-category-item`)],po);var mo=class extends d{constructor(...e){super(...e),this.newUsername=``,this.newPassword=``,this.newDisplayName=``,this.isSubmitting=!1,this.error=``,this.showAddForm=!1,this._handleStoreChange=()=>{this.requestUpdate()}}static{this.styles=g`
        :host {
            display: block;
        }
    ...
    `}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.isConnected&&(this.i18nStore?.addEventListener(`change`,this._handleStoreChange),this.linkedAccountsStore?.addEventListener(`change`,this._handleStoreChange),this.linkedAccountsStore&&!this.linkedAccountsStore.isInitialized()&&this.linkedAccountsStore.fetchAccounts())})}disconnectedCallback(){super.disconnectedCallback(),this.i18nStore?.removeEventListener(`change`,this._handleStoreChange),this.linkedAccountsStore?.removeEventListener(`change`,this._handleStoreChange)}async handleAdd(e){if(e.preventDefault(),!(!this.newUsername||!this.newPassword)){this.isSubmitting=!0,this.error=``;try{await this.linkedAccountsStore.addAccount(this.newUsername,this.newPassword,this.newDisplayName),this.newUsername=``,this.newPassword=``,this.newDisplayName=``,this.showAddForm=!1,window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:this.i18nStore?.t(`linkedAccounts.addedSuccess`)}}))}catch(e){this.error=e.message||this.i18nStore?.t(`linkedAccounts.addError`)}finally{this.isSubmitting=!1}}}async handleRemove(e){if(confirm(this.i18nStore?.t(`linkedAccounts.removeConfirm`)))try{await this.linkedAccountsStore.removeAccount(e),window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:this.i18nStore?.t(`linkedAccounts.removedSuccess`)}}))}catch(e){window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:e.message||this.i18nStore?.t(`linkedAccounts.removeError`)}}))}}render(){let e=this.linkedAccountsStore?.getAccounts()||[],t=this.linkedAccountsStore?.isLoading();return n`
            ...
            `:``}
        `}};A([h({context:C})],mo.prototype,`i18nStore`,void 0),A([h({context:di})],mo.prototype,`linkedAccountsStore`,void 0),A([a()],mo.prototype,`newUsername`,void 0),A([a()],mo.prototype,`newPassword`,void 0),A([a()],mo.prototype,`newDisplayName`,void 0),A([a()],mo.prototype,`isSubmitting`,void 0),A([a()],mo.prototype,`error`,void 0),A([a()],mo.prototype,`showAddForm`,void 0),mo=A([p(`settings-accounts`)],mo);function ho(e){if(!e)throw Error(`base64url is null or undefined`);let t=e.replace(/-/g,`+`).replace(/_/g,`/`),n=atob(t),r=new Uint8Array(n.length);for(let e=0;e<n.length;e++)r[e]=n.charCodeAt(e);return r.buffer}function go(e){let t=new Uint8Array(e),n=``;for(let e=0;e<t.byteLength;e++)n+=String.fromCharCode(t[e]);return btoa(n).replace(/\+/g,`-`).replace(/\//g,`_`).replace(/=/g,``)}async function _o(e){e.publicKey.challenge=ho(e.publicKey.challenge),e.publicKey.user.id=ho(e.publicKey.user.id),e.publicKey.excludeCredentials&&(e.publicKey.excludeCredentials=e.publicKey.excludeCredentials.map(e=>({...e,id:ho(e.id)})));let t=await navigator.credentials.create(e);if(!t)throw Error(`Credential creation failed or was cancelled.`);let n=t.response,r=n.getTransports?n.getTransports():[];return{id:t.id,rawId:go(t.rawId),type:t.type,response:{attestationObject:go(n.attestationObject),clientDataJSON:go(n.clientDataJSON)},transports:r}}async function vo(e){e.publicKey.challenge=ho(e.publicKey.challenge),e.publicKey.allowCredentials&&(e.publicKey.allowCredentials=e.publicKey.allowCredentials.map(e=>({...e,id:ho(e.id)})));let t=await navigator.credentials.get(e);if(!t)throw Error(`Assertion failed or was cancelled.`);let n=t.response;return{id:t.id,rawId:go(t.rawId),type:t.type,response:{authenticatorData:go(n.authenticatorData),clientDataJSON:go(n.clientDataJSON),signature:go(n.signature),userHandle:n.userHandle?go(n.userHandle):null}}}function yo(){return window.PublicKeyCredential!==void 0&&navigator.credentials!==void 0}var bo=class extends d{constructor(...e){super(...e),this.data=null,this.error=``,this.loading=!0,this.adding=!1,this.showNamePrompt=!1,this.pendingCredential=null,this.pendingDeleteId=null}static{this.styles=g`
        :host { display: block; }
        .setting-row {
            display: flex;
            justify-content: space-between;
    ...
    `}connectedCallback(){super.connectedCallback(),this.fetchData()}async fetchData(){try{this.loading=!0;let e=await fetch(`/settings/2fa`);if(!e.ok)throw Error(`Failed to fetch settings`);this.data=await e.json()}catch(e){this.error=e.message}finally{this.loading=!1}}async handleTrustToggle(e){let t=e.target;await fetch(`/settings/2fa/trust-linked-accounts`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({trust:t.checked})}),this.fetchData()}async addCredential(){this.adding=!0,this.error=``;try{let e=await fetch(`/settings/2fa/begin`,{method:`POST`});if(!e.ok)throw Error(await e.text());let t=await _o(await e.json());this.pendingCredential=t,this.showNamePrompt=!0,this.adding=!1}catch(e){e.name===`NotAllowedError`||e.message&&e.message.includes(`not allowed`)?this.error=``:this.error=this.i18nStore?.t(`webauthn.errors.register_failed`)||`There was an error registering your security key. Please try again.`,this.adding=!1}}async _handlePromptSubmit(e){let t=e.detail.keyName||`Security Key`;this.showNamePrompt=!1;let n={...this.pendingCredential,name:t};this.adding=!0,this.error=``;try{let e=await fetch(`/settings/2fa/finish`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(n)});if(!e.ok)throw Error(await e.text());this.fetchData()}catch{this.error=this.i18nStore?.t(`webauthn.errors.register_failed`)||`There was an error registering your security key. Please try again.`}finally{this.adding=!1,this.pendingCredential=null}}_handlePromptCancel(){this.showNamePrompt=!1,this.pendingCredential=null}removeCredential(e){this.pendingDeleteId=e}async executeRemoveCredential(){if(!this.pendingDeleteId)return;let e=this.pendingDeleteId;this.pendingDeleteId=null;try{this.error=``;let t=await fetch(`/settings/2fa/credential/${encodeURIComponent(e)}/delete`,{method:`POST`});if(!t.ok)throw Error(await t.text());this.fetchData()}catch(e){this.error=e.message||this.i18nStore?.t(`webauthn.errors.remove_failed`)}}render(){return this.loading?n`<div>${this.i18nStore?.t(`settings.loading`)}</div>`:n`
                ...
                <div class="cred-list" style="margin-top: 0;">
                    ${this.data?.credentialCount&&this.data.credentialCount>0?n`
                        ${this.data?.credentials.map(e=>n`
                            <div class="setting-row">
                                <div style="display: flex; align-items: center; gap: 8px;">
                                    <div class="icon-container">${k(`fingerprint`)}</div>
            ...
            `:``}
        `}};A([h({context:C})],bo.prototype,`i18nStore`,void 0),A([a()],bo.prototype,`data`,void 0),A([a()],bo.prototype,`error`,void 0),A([a()],bo.prototype,`loading`,void 0),A([a()],bo.prototype,`adding`,void 0),A([a()],bo.prototype,`showNamePrompt`,void 0),A([a()],bo.prototype,`pendingCredential`,void 0),A([a()],bo.prototype,`pendingDeleteId`,void 0),bo=A([p(`alps-webauthn-settings`)],bo);var Z=class extends d{constructor(...e){super(...e),this.category=`general`,this.isMobile=window.innerWidth<=768,this.mobileSidebarOpen=!1,this.username=``,this.isScrolled=!1,this.sidebarWidth=250,this.sidebarCollapsed=!1,this.isSidebarDragging=!1,this.isSidebarHovered=!1,this.hoverTimeout=null,this.suppressSidebarHover=!1,this._handleResize=()=>{this.isMobile=window.innerWidth<=768,this.isMobile||(this.mobileSidebarOpen=!1)},this._handleScroll=e=>{let t=e.target;this.isScrolled=t.scrollTop>0},this._handleSettingsChange=()=>{this._syncState()},this._handleI18nChange=()=>{this.requestUpdate()}}static{this.styles=[hn,g`
    :host {
      display: flex;
      flex-direction: column;
      height: 100vh;
        ...
        <div slot="left" class="header-left">
          ${this.isMobile?``:n`
            <button class="header-icon-btn back-btn" @click=${()=>window.location.hash=``} title=${this.i18nStore?.t(`messageReader.back`)}>
              ${k(`arrowLeft`)} ${this.i18nStore?.t(`messageReader.back`)}
            </button>
          `}
        </div>
  ...
  `}connectedCallback(){super.connectedCallback(),this.extractParams(),this.mailbox&&this.uid?this.fetchOriginal():(this.error=this.i18nStore?.t(`originalMessage.errorMissingParams`),this.loading=!1),this.updateComplete.then(()=>{this.i18nStore?.addEventListener(`change`,this._handleStoreChange)})}disconnectedCallback(){super.disconnectedCallback(),this.i18nStore?.removeEventListener(`change`,this._handleStoreChange)}extractParams(){let e=window.location.hash,t=e.indexOf(`?`);if(t!==-1){let n=new URLSearchParams(e.substring(t+1));this.mailbox=n.get(`mailbox`)||``,this.uid=n.get(`uid`)||``}}async fetchOriginal(){try{this.loading=!0;let e=await E(`/mailboxes/${O(this.mailbox)}/messages/${this.uid}/raw?limit=${this.MAX_DISPLAY_SIZE}`);if(!e.ok){if(e.status===401){window.location.hash=`#/login`;return}throw Error(this.i18nStore?.t(`originalMessage.errorFailedToFetch`))}this.rawText=await e.text(),this.rawText.length>=this.MAX_DISPLAY_SIZE&&(this.isTruncated=!0),this.parsedHeaders=await xo(this.rawText)}catch(e){this.error=e.message}finally{this.loading=!1}}copyToClipboard(){navigator.clipboard.writeText(this.rawText).then(()=>{alert(this.isTruncated?this.i18nStore?.t(`originalMessage.copiedTruncated`):this.i18nStore?.t(`originalMessage.copied`))}).catch(e=>{x.error(`Failed to copy: `,e),alert(this.i18nStore?.t(`originalMessage.copyFailed`))})}renderAuthStatus(e,t){e=e.toLowerCase();let r=n`<span class="auth-none">${this.i18nStore?.t(`originalMessage.none`)}</span>`;return e===`pass`?r=n`<span class="auth-pass">${this.i18nStore?.t(`originalMessage.pass`)}</span>`:e===`fail`&&(r=n`<span class="auth-fail">${this.i18nStore?.t(`originalMessage.fail`)}</span>`),n`
    ...
    `}render(){if(this.loading)return n`
      ...
      `;let e=`/mailboxes/${O(this.mailbox)}/messages/${this.uid}/raw`;return n`
      <div class="container">
    ...
    `}};A([a()],So.prototype,`rawText`,void 0),A([a()],So.prototype,`parsedHeaders`,void 0),A([a()],So.prototype,`loading`,void 0),A([a()],So.prototype,`error`,void 0),A([a()],So.prototype,`mailbox`,void 0),A([a()],So.prototype,`uid`,void 0),A([a()],So.prototype,`isTruncated`,void 0),A([h({context:C})],So.prototype,`i18nStore`,void 0),So=A([p(`original-message-page`)],So);var Q=class extends d{constructor(...e){super(...e),this.loading=!0,this.error=``,this.mailbox=``,this.uid=``,this.message=null,this.content=``,this.rawMessageHtml=``,this.mimeType=`text/plain`,this.hasRemoteResources=!1,this.allowRemoteResources=!1,this.printTriggered=!1}static{this.styles=g`
    :host {
      display: block;
      min-height: 100vh;
      background: #fff;
  ...
  `}connectedCallback(){super.connectedCallback(),this.allowRemoteResources=this.settingsStore.getState().showRemoteContent===`always`,this.extractParams(),this.mailbox&&this.uid?this.fetchMessage():(this.error=`Missing mailbox or uid parameters`,this.loading=!1)}extractParams(){let e=window.location.hash,t=e.indexOf(`?`);if(t!==-1){let n=new URLSearchParams(e.substring(t+1));this.mailbox=n.get(`mailbox`)||``,this.uid=n.get(`uid`)||``,n.get(`remote`)===`1`&&(this.allowRemoteResources=!0)}}async fetchMessage(){try{this.loading=!0;let e=xr.get(this.mailbox,this.uid);if(e&&e.Part){this.message=e.Message,this.mimeType=e.Part.MIMEType||e.Part.MimeType||`text/plain`,e.RawHtml===void 0?e.RawText!==void 0&&(this.content=e.RawText):(this.rawMessageHtml=e.RawHtml,this.hasRemoteResources=!1,this.content=oa(this.rawMessageHtml,{mailbox:this.mailbox,messageUid:this.uid,allowRemoteResources:this.allowRemoteResources,messageStructure:this.message.BodyStructure,onRemoteResourceBlocked:()=>{this.hasRemoteResources=!0}})),this.loading=!1;return}let t=await E(`/mailboxes/${O(this.mailbox)}/messages/${this.uid}`);if(!t.ok){if(t.status===401){window.location.hash=`#/login`;return}throw Error(`Failed to fetch message metadata`)}this.message=await t.json(),await this.fetchMessageBody()}catch(e){this.error=e.message}finally{this.loading=!1}}findDisplayPart(e,t){if(!e)return null;if(e.MIMEType&&e.MIMEType.toLowerCase().startsWith(`multipart/`)){if(e.MIMEType.toLowerCase()===`multipart/alternative`){let n=null,r=null;for(let t of e.Children||[])t.MIMEType?.toLowerCase()===`text/plain`&&(n=t),t.MIMEType?.toLowerCase()===`text/html`&&(r=t);return t===`html`?r||n||e.Children[0]:n||r||e.Children[0]}for(let n of e.Children||[]){let e=this.findDisplayPart(n,t);if(e)return e}}return e.MIMEType?.toLowerCase()===`text/html`||e.MIMEType?.toLowerCase()===`text/plain`?e:null}findPartPath(e,t,n=``){if(!e)return null;if(e===t)return n||`1`;if(e.Children&&Array.isArray(e.Children))for(let r=0;r<e.Children.length;r++){let i=n?`${n}.${r+1}`:`${r+1}`,a=this.findPartPath(e.Children[r],t,i);if(a)return a}return null}async fetchMessageBody(){if(!this.message||!this.message.BodyStructure)return;let e=`1`,t=this.findDisplayPart(this.message.BodyStructure,`html`);if(t?(e=this.findPartPath(this.message.BodyStructure,t)||`1`,this.mimeType=t.MIMEType||`text/plain`):(this.mimeType=this.message.BodyStructure.MIMEType||`text/plain`,this.mimeType.toLowerCase()===`text/plain`||this.mimeType.toLowerCase()===`text/html`?e=`1`:this.mimeType=`multipart/mixed`),this.mimeType.toLowerCase().startsWith(`multipart/`)){this.content=``;return}let n=await E(`/mailboxes/${O(this.mailbox)}/messages/${this.uid}/raw?part=${e}`);if(!n.ok)throw Error(`Failed to fetch message body`);this.mimeType.toLowerCase()===`text/html`?(this.rawMessageHtml=await n.text(),this.hasRemoteResources=!1,this.content=oa(this.rawMessageHtml,{mailbox:this.mailbox,messageUid:this.uid,allowRemoteResources:this.allowRemoteResources,messageStructure:this.message.BodyStructure,onRemoteResourceBlocked:()=>{this.hasRemoteResources=!0}})):this.content=await n.text()}loadRemoteResources(){this.allowRemoteResources=!0,this.printTriggered=!1,this.rawMessageHtml&&(this.content=oa(this.rawMessageHtml,{mailbox:this.mailbox,messageUid:this.uid,allowRemoteResources:this.allowRemoteResources,messageStructure:this.message?.BodyStructure,onRemoteResourceBlocked:()=>{this.hasRemoteResources=!0}}))}updated(e){this.loading||this.error||!this.message||this.mimeType?.toLowerCase()!==`text/html`&&(this.printTriggered||(this.printTriggered=!0,setTimeout(()=>{this.isConnected&&window.print()},500)))}onPrintIframeLoad(e){let t=e.target;try{let e=t.contentDocument;e&&e.body&&(t.style.height=`${e.body.scrollHeight}px`)}catch{}this.printTriggered||(this.printTriggered=!0,setTimeout(()=>{this.isConnected&&window.print()},300))}render(){if(this.loading)return n`
        <div class="loading-state">
          <alps-loader></alps-loader>
    ...
    `}};A([h({context:w})],Q.prototype,`settingsStore`,void 0),A([h({context:C})],Q.prototype,`i18nStore`,void 0),A([a()],Q.prototype,`loading`,void 0),A([a()],Q.prototype,`error`,void 0),A([a()],Q.prototype,`mailbox`,void 0),A([a()],Q.prototype,`uid`,void 0),A([a()],Q.prototype,`message`,void 0),A([a()],Q.prototype,`content`,void 0),A([a()],Q.prototype,`rawMessageHtml`,void 0),A([a()],Q.prototype,`mimeType`,void 0),A([a()],Q.prototype,`hasRemoteResources`,void 0),A([a()],Q.prototype,`allowRemoteResources`,void 0),Q=A([p(`print-page`)],Q);var Co=class extends d{constructor(...e){super(...e),this.statusMessage=``,this.statusType=`info`,this.isLoading=!1,this.isSuccess=!1,this._handleI18nChange=()=>{this.requestUpdate()}}static{this.styles=g`
    .status {
      margin-bottom: 24px;
      padding: 8px 12px;
      border-radius: var(--radius-md, 6px);
  ...
  `}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.i18nStore?.addEventListener(`change`,this._handleI18nChange)}),yo()?setTimeout(()=>{this._handleVerify()},300):(this.statusMessage=this.i18nStore?.t(`webauthn.not_supported`),this.statusType=`error`)}disconnectedCallback(){super.disconnectedCallback(),this.i18nStore?.removeEventListener(`change`,this._handleI18nChange)}async _handleVerify(){this.isLoading=!0,this.statusMessage=this.i18nStore?.t(`webauthn.requesting`),this.statusType=`info`;try{let e=await fetch(`/webauthn/verify/begin`,{method:`POST`});if(!e.ok)throw Error(this.i18nStore?.t(`webauthn.errors.begin_failed`));let t=await e.json();if(!t||!t.publicKey)throw Error(this.i18nStore?.t(`webauthn.errors.invalid_options`));this.statusMessage=this.i18nStore?.t(`webauthn.waiting_for_key`);let n=await vo(t);this.statusMessage=this.i18nStore?.t(`webauthn.verifying`);let r=await(await fetch(`/webauthn/verify/finish`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(n)})).json();if(r.success){this.statusMessage=this.i18nStore?.t(`webauthn.success`),this.statusType=`success`,this.isSuccess=!0;let e=!1;try{e=sessionStorage.getItem(`pending_2fa_is_switch`)===`1`,sessionStorage.removeItem(`pending_2fa_is_switch`)}catch{}let t=r.username;if(t)try{sessionStorage.removeItem(`pending_2fa_username`)}catch{}else try{t=sessionStorage.getItem(`pending_2fa_username`)||``,sessionStorage.removeItem(`pending_2fa_username`)}catch{}setTimeout(()=>{if(window.dispatchEvent(new CustomEvent(`user-logged-in`,{detail:{username:t}})),window.location.hash=`/mailbox/INBOX`,e&&typeof window.location.reload==`function`)try{window.location.reload()}catch{}},500)}else throw Error(this.i18nStore?.t(`webauthn.errors.verification_failed`))}catch(e){this.statusMessage=e.message||this.i18nStore?.t(`webauthn.errors.general`),this.statusType=`error`}finally{this.isLoading=!1}}render(){return n`
      <alps-auth-card
        icon="fingerprint"
      ...
      >
        ...
        <alps-button 
          ...
          ?disabled=${this.isLoading||this.isSuccess||!yo()}
    ...
    `}};A([h({context:C})],Co.prototype,`i18nStore`,void 0),A([a()],Co.prototype,`statusMessage`,void 0),A([a()],Co.prototype,`statusType`,void 0),A([a()],Co.prototype,`isLoading`,void 0),A([a()],Co.prototype,`isSuccess`,void 0),Co=A([p(`login-webauthn-page`)],Co);var wo=class extends d{constructor(...e){super(...e),this.show=!1,this.message=``,this.actionLabel=``,this.timeout=0,this._timer=null}updated(e){e.has(`show`)&&(this.show&&this.timeout>0?(this._timer&&clearTimeout(this._timer),this._timer=setTimeout(()=>{this.dismiss()},this.timeout)):!this.show&&this._timer&&(clearTimeout(this._timer),this._timer=null))}dismiss(){this.onDismiss&&this.onDismiss(),this.close()}close(){this.show=!1,this.dispatchEvent(new CustomEvent(`dismiss`)),this.onAction=void 0,this.onDismiss=void 0}handleAction(){this.onAction?this.onAction():this.dispatchEvent(new CustomEvent(`action`)),this.close()}static{this.styles=g`
    :host {
      display: block;
      ...
      <div class="backdrop" @click=${c}>
        <div class="preview-header">
          ...
          <div class="actions-bar">
            ${a.isImage?n`
              <button class="action-btn icon-only zoom-out" @click=${this.zoomOut} title="${t(`attachment.zoomOut`)}">${k(`magnifyingGlassMinus`)}</button>
              <button class="action-btn icon-only fit" @click=${this.resetZoom} title="${t(`attachment.fitToScreen`)}">${k(`arrowsInSimple`)}</button>
              <button class="action-btn icon-only zoom-in" @click=${this.zoomIn} title="${t(`attachment.zoomIn`)}">${k(`magnifyingGlassPlus`)}</button>
              <button class="action-btn icon-only rotate" @click=${this.rotate} title="${t(`attachment.rotate`)}">${k(`arrowCounterClockwise`)}</button>
            `:``}
            ...
            ${a.isPdf&&this.pdfUrl?n`
              <button class="action-btn icon-only new-tab" @click=${this.openPdfInNewTab} title="${t(`attachment.openInNewTab`)}">${k(`arrowsOutSimple`)}</button>
            `:``}
            ${o?n`
              <button class="action-btn icon-only download" @click=${this.download} title="${t(`attachment.download`)}">${k(`downloadSimple`)}</button>
            `:``}
            <button class="close-btn" @click=${this.close} title="${t(`attachment.close`)}">${k(`x`)}</button>
          </div>
        </div>

        <div class="preview-body" @click=${c}>
          ${s>1?n`
            <button class="nav-arrow prev" @click=${this.prev} title="${t(`attachment.previous`)}">${k(`caretLeft`)}</button>
            <button class="nav-arrow next" @click=${this.next} title="${t(`attachment.next`)}">${k(`caretRight`)}</button>
          `:``}
...
`).map((e,t)=>n`
      ...
      <div class="fallback-card">
        <div class="card-icon">${k(e.icon)}</div>
        <div class="card-title">${r}</div>
...
<<<<<<<< HEAD:frontend/dist/assets/index-BHV7B3Zq.js
    `}};A([h({context:C,subscribe:!0})],$.prototype,`i18nStore`,void 0),A([o({type:Array})],$.prototype,`attachments`,void 0),A([o({type:String})],$.prototype,`mailbox`,void 0),A([o({type:String})],$.prototype,`messageUid`,void 0),A([o({type:Number})],$.prototype,`activeIndex`,void 0),A([a()],$.prototype,`zoom`,void 0),A([a()],$.prototype,`rotation`,void 0),A([a()],$.prototype,`loadedText`,void 0),A([a()],$.prototype,`textLoading`,void 0),A([a()],$.prototype,`textError`,void 0),A([a()],$.prototype,`copied`,void 0),A([a()],$.prototype,`pdfUrl`,void 0),A([a()],$.prototype,`pdfLoading`,void 0),A([a()],$.prototype,`pdfError`,void 0),$=A([p(`alps-attachment-preview`)],$);var Eo=3e3,Do=15e3,Oo=3e3,ko=1500,Ao=class extends d{constructor(...e){super(...e),this.composeStore=new ai,this.settingsStore=new De,this.i18nStore=new be,this.linkedAccountsStore=ui,this.activeComposers=[],this.composerReady=!1,this.toasts=[],this.attachmentPreview=null,this.toastIdCounter=0,this.isOffline=!navigator.onLine,this.offlineCountdown=0,this.offlineInterval=null,this._handleOpenAttachmentPreview=e=>{let{attachments:t,mailbox:n,messageUid:r,index:i}=e.detail??{};!Array.isArray(t)||t.length===0||(this.attachmentPreview={attachments:t,mailbox:n,messageUid:r,index:i??0})},this._handlePluginsUpdated=()=>{this.requestUpdate()},this._handleGlobalDragOver=e=>{e.preventDefault()},this._handleGlobalDrop=e=>{e.preventDefault(),window.dispatchEvent(new CustomEvent(`alps-composer-drop`))},this._handleAuthError=()=>{sessionStorage.clear(),Ae(),window.dispatchEvent(new CustomEvent(`session-cleared`,{detail:{reason:`expired`}})),ci(`sessionExpired`),window.location.hash=`#/login`},this._verifyConnectivity=async()=>{if(!navigator.onLine)return!1;try{let e=await fetch(`/site.webmanifest`,{method:`HEAD`,cache:`no-store`});return!(e.status===502||e.status===503||e.status===504)}catch{return!1}},this._handleOnlineEvent=async()=>{await this._verifyConnectivity()?(this.isOffline=!1,this._stopOfflineCountdown()):this._handleOfflineEvent()},this._verifyingNetworkError=!1,this._handleNetworkError=async()=>{if(!(this.isOffline||this._verifyingNetworkError)){this._verifyingNetworkError=!0;try{await this._verifyConnectivity()||this._handleOfflineEvent()}finally{this._verifyingNetworkError=!1}}},this._handleOfflineEvent=()=>{this.isOffline||(this.isOffline=!0,this.offlineCountdown=10,this._startOfflineCountdown())},this._isPinging=!1,this._handleShowToast=e=>{let t=++this.toastIdCounter,n={id:t,message:e.detail.message??(e.detail.i18nKey?this.i18nStore?.t(e.detail.i18nKey):void 0)??``,actionLabel:e.detail.actionLabel||``,actionFn:e.detail.actionFn,dismissFn:e.detail.dismissFn,timeout:e.detail.duration||Eo,show:!1};this.toasts=[...this.toasts,n],requestAnimationFrame(()=>{this.toasts=this.toasts.map(e=>e.id===t?{...e,show:!0}:e)})},this._handleBeforeUnload=e=>{if(this.activeComposers.some(e=>e.isSending))return e.preventDefault(),`You have a message currently sending. Are you sure you want to leave?`},this._handleUpdateAvailable=()=>{this._handleShowToast(new CustomEvent(`show-toast`,{detail:{i18nKey:`update.available`,actionLabel:this.i18nStore?.t(`update.reload`),actionFn:rt,duration:Do}}))},this.composerModule=null,this._handleComposeChange=()=>{let e=this.composeStore.getState().activeComposers;e.length>0&&this.ensureComposerLoaded(),this.activeComposers=e},this._handleSettingsChange=()=>{let e=this.settingsStore.getState();ya.setLogoutTime(e.autoLogout??0),this.i18nStore.setLanguage(e.language??`en`)},this.mailboxPageTemplate=n`<mailbox-page></mailbox-page>`,this.router=new lo(this.getRoutes(),()=>n`<div>404 — ${this.i18nStore.t(`general.notFound`)}</div>`,()=>this.requestUpdate())}static{this.styles=g`
========
    `}};A([h({context:S,subscribe:!0})],$.prototype,`i18nStore`,void 0),A([o({type:Array})],$.prototype,`attachments`,void 0),A([o({type:String})],$.prototype,`mailbox`,void 0),A([o({type:String})],$.prototype,`messageUid`,void 0),A([o({type:Number})],$.prototype,`activeIndex`,void 0),A([a()],$.prototype,`zoom`,void 0),A([a()],$.prototype,`rotation`,void 0),A([a()],$.prototype,`loadedText`,void 0),A([a()],$.prototype,`textLoading`,void 0),A([a()],$.prototype,`textError`,void 0),A([a()],$.prototype,`copied`,void 0),A([a()],$.prototype,`pdfUrl`,void 0),A([a()],$.prototype,`pdfLoading`,void 0),A([a()],$.prototype,`pdfError`,void 0),$=A([p(`alps-attachment-preview`)],$);var To=3e3,Eo=15e3,Do=3e3,Oo=1500,ko=class extends d{constructor(...e){super(...e),this.composeStore=new ii,this.settingsStore=new Oe,this.i18nStore=new xe,this.linkedAccountsStore=li,this.activeComposers=[],this.composerReady=!1,this.toasts=[],this.attachmentPreview=null,this.toastIdCounter=0,this.isOffline=!navigator.onLine,this.offlineCountdown=0,this.offlineInterval=null,this._handleOpenAttachmentPreview=e=>{let{attachments:t,mailbox:n,messageUid:r,index:i}=e.detail??{};!Array.isArray(t)||t.length===0||(this.attachmentPreview={attachments:t,mailbox:n,messageUid:r,index:i??0})},this._handlePluginsUpdated=()=>{this.requestUpdate()},this._handleGlobalDragOver=e=>{e.preventDefault()},this._handleGlobalDrop=e=>{e.preventDefault(),window.dispatchEvent(new CustomEvent(`alps-composer-drop`))},this._handleAuthError=()=>{sessionStorage.clear(),je(),window.dispatchEvent(new CustomEvent(`session-cleared`,{detail:{reason:`expired`}})),si(`sessionExpired`),window.location.hash=`#/login`},this._verifyConnectivity=async()=>{if(!navigator.onLine)return!1;try{let e=await fetch(`/site.webmanifest`,{method:`HEAD`,cache:`no-store`});return!(e.status===502||e.status===503||e.status===504)}catch{return!1}},this._handleOnlineEvent=async()=>{await this._verifyConnectivity()?(this.isOffline=!1,this._stopOfflineCountdown()):this._handleOfflineEvent()},this._verifyingNetworkError=!1,this._handleNetworkError=async()=>{if(!(this.isOffline||this._verifyingNetworkError)){this._verifyingNetworkError=!0;try{await this._verifyConnectivity()||this._handleOfflineEvent()}finally{this._verifyingNetworkError=!1}}},this._handleOfflineEvent=()=>{this.isOffline||(this.isOffline=!0,this.offlineCountdown=10,this._startOfflineCountdown())},this._isPinging=!1,this._handleShowToast=e=>{let t=++this.toastIdCounter,n={id:t,message:e.detail.message??(e.detail.i18nKey?this.i18nStore?.t(e.detail.i18nKey):void 0)??``,actionLabel:e.detail.actionLabel||``,actionFn:e.detail.actionFn,dismissFn:e.detail.dismissFn,timeout:e.detail.duration||To,show:!1};this.toasts=[...this.toasts,n],requestAnimationFrame(()=>{this.toasts=this.toasts.map(e=>e.id===t?{...e,show:!0}:e)})},this._handleBeforeUnload=e=>{if(this.activeComposers.some(e=>e.isSending))return e.preventDefault(),`You have a message currently sending. Are you sure you want to leave?`},this._handleUpdateAvailable=()=>{this._handleShowToast(new CustomEvent(`show-toast`,{detail:{i18nKey:`update.available`,actionLabel:this.i18nStore?.t(`update.reload`),actionFn:it,duration:Eo}}))},this.composerModule=null,this._handleComposeChange=()=>{let e=this.composeStore.getState().activeComposers;e.length>0&&this.ensureComposerLoaded(),this.activeComposers=e},this._handleSettingsChange=()=>{let e=this.settingsStore.getState();va.setLogoutTime(e.autoLogout??0),this.i18nStore.setLanguage(e.language??`en`)},this.mailboxPage=null,this.pluginPages=new Map,this._handleSessionCleared=()=>{this.mailboxPage=null,this.pluginPages.clear()},this.router=new co(this.getRoutes(),()=>n`<div>404 — ${this.i18nStore.t(`general.notFound`)}</div>`,()=>this.requestUpdate())}static{this.styles=g`
>>>>>>>> main:frontend/dist/assets/index-CCMQIZxV.js
...
>>>>>>>> main:frontend/dist/assets/index-CCMQIZxV.js
      ...
      ${this.isOffline?n`
        <ui-modal title=${this.i18nStore.t(`offline.title`)} .dismissible=${!1} width="400px">
          <div style="text-align: center; padding: 16px 0;">
            <div class="offline-icon">${k(`wifiSlash`)}</div>
      ...
      `:``}
    `}};A([i({context:oi})],Ao.prototype,`composeStore`,void 0),A([i({context:w})],Ao.prototype,`settingsStore`,void 0),A([i({context:C})],Ao.prototype,`i18nStore`,void 0),A([i({context:di})],Ao.prototype,`linkedAccountsStore`,void 0),A([a()],Ao.prototype,`activeComposers`,void 0),A([a()],Ao.prototype,`composerReady`,void 0),A([a()],Ao.prototype,`toasts`,void 0),A([a()],Ao.prototype,`attachmentPreview`,void 0),A([a()],Ao.prototype,`isOffline`,void 0),A([a()],Ao.prototype,`offlineCountdown`,void 0),Ao=A([p(`app-root`)],Ao);var jo=Object.assign({"../../plugins/caldav/frontend/index.ts":hr,"../../plugins/carddav/frontend/index.ts":Ua,"../../plugins/gpg/frontend/index.ts":Za,"../../plugins/managesieve/frontend/index.ts":oo,"../../plugins/password/frontend/index.ts":co});x.info(`Loaded ${Object.keys(jo).length} frontend plugins.`),Ze();export{v as C,x as S,A as _,oa as a,w as b,oi as c,Jr as d,Yr as f,Dn as g,L as h,la as i,$r as l,B as m,Sa as n,sa as o,Xr as p,xa as r,ni as s,ba as t,Kr as u,k as v,C as x,ke as y};