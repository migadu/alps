import{n as e,r as t}from"./rolldown-runtime-S-ySWqyJ.js";import{a as n,c as r,d as i,f as a,g as o,h as s,i as c,l,m as u,n as d,o as f,p,r as m,s as h,t as g,u as _}from"./lit-C59KtRpQ.js";import{n as ee,t as te}from"./vendor-SnGHSY2f.js";import{a as ne,c as re,i as ie,n as ae,o as oe,r as se,s as ce,t as le}from"./editor-Dqqk7UQI.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var v=new class{constructor(){this.navTabs=[],this.settingsTabs=[],this.routes=[],this.hooks=new Map}registerHook(e,t){this.hooks.has(e)||this.hooks.set(e,[]),this.hooks.get(e).push(t)}async invokeHookAsync(e,t){let n=this.hooks.get(e)||[];return await Promise.all(n.map(e=>e(t)))}invokeHook(e,t){(this.hooks.get(e)||[]).forEach(n=>{try{n(t)}catch(t){console.error(`Error in hook ${e}:`,t)}})}registerNavTab(e){this.navTabs.find(t=>t.id===e.id)||this.navTabs.push(e)}getNavTabs(){return this.navTabs}registerSettingsTab(e){this.settingsTabs.find(t=>t.id===e.id)||this.settingsTabs.push(e)}getSettingsTabs(){return this.settingsTabs}registerRoute(e){this.routes.find(t=>t.path===e.path)||this.routes.push(e)}getRoutes(){return this.routes}};async function y(e,t={},n=25e3){let r=new AbortController,i=setTimeout(()=>r.abort(),n);try{let n=await fetch(e,{...t,signal:r.signal});return(n.status===502||n.status===503||n.status===504)&&window.dispatchEvent(new CustomEvent(`network-error`)),n}catch(e){throw(e instanceof TypeError||e.name===`AbortError`)&&window.dispatchEvent(new CustomEvent(`network-error`)),e}finally{clearTimeout(i)}}var b=new class{async fetchContacts(e=``){let t=await y(e?`/contacts?query=${encodeURIComponent(e)}`:`/contacts`);if(!t.ok)throw Error(`Failed to fetch contacts: ${t.statusText}`);return t.json()}async fetchContact(e){let t=await y(`/contacts/${encodeURIComponent(e)}`);if(!t.ok)throw Error(`Failed to fetch contact: ${t.statusText}`);return t.json()}async createContact(e){let t=await y(`/contacts/create`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)});if(!t.ok)throw Error(`Failed to create contact: ${t.statusText}`);return t.json()}async updateContact(e,t){let n=await y(`/contacts/${encodeURIComponent(e)}/edit`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)});if(!n.ok)throw Error(`Failed to update contact: ${n.statusText}`);return n.json()}async deleteContact(e){let t=await y(`/contacts/${encodeURIComponent(e)}`,{method:`DELETE`});if(!t.ok)throw Error(`Failed to delete contact: ${t.statusText}`)}async bulkUpdateContacts(e){let t=e.map(e=>e.path?this.updateContact(e.path,e):Promise.resolve());await Promise.all(t)}async bulkDeleteContacts(e){let t=e.map(e=>this.deleteContact(e));await Promise.all(t)}},ue=`All Contacts`,de=`Favorites`,fe=e({default:()=>pe}),pe={contacts:{unnamedContact:`Unnamed Contact`,title:`Contacts`,allContacts:`All Contacts`,favorites:`Favorites`,addContact:`Add Contact`,createCategory:`Create Category`,categoryName:`Category Name`,renameCategory:`Rename Category`,deleteCategory:`Delete Category`,deleteCategoryConfirm:`Are you sure you want to delete the category '{category}'? This will remove it from all contacts. No contacts will be deleted.`,rename:`Rename`,delete:`Delete`,create:`Create`,add:`Add`,newCategory:`New Category`,refreshContacts:`Refresh Contacts`,sortZa:`Sort Z-A`,sortAz:`Sort A-Z`,filterStarred:`Filter Starred`,uncategorized:`Uncategorized`,addToCategory:`Add to Category`,deleteContact:`Delete Contact`,deleteContactConfirm:`Are you sure you want to delete this contact?`,editContact:`Edit Contact`,save:`Save`,cancel:`Cancel`,noContacts:`No contacts found`,selectContact:`Select a contact to view details`,selectedContacts:`{count} contacts selected`,clearSelection:`Clear selection`,selectAll:`Select All`,clearSearch:`Clear Search`,searchContacts:`Search contacts...`,details:`Details`,notes:`Notes`,name:`Name`,nickname:`Nickname`,organization:`Organization`,titleField:`Title`,email:`Email`,phone:`Phone`,address:`Address`,url:`URL`,birthday:`Birthday`,back:`Back`,toggleStar:`Toggle Star`}},me=e({default:()=>he}),he={settings:{categories:{filters:`Filters`}},managesieve:{title:`Filters`,description:`Add custom rules on how messages are processed and filed.`,tabs:{switchToRaw:`Raw Editor`},warningRawSwitchTitle:`Switch to Raw Mode`,warningRawSwitchConfirm:`Switch`,warningRawSwitch:`Switching to raw mode means the script will no longer be editable visually. Continue?`,toast:{saved:`Rules saved and activated.`,deactivated:`Rules deactivated.`,valid:`Script is valid!`,networkError:`Network error occurred.`},visual:{newRule:`New Rule`,noRules:`No rules defined.`,saveFilters:`Save`,deleteRule:`Delete Rule`,remove:`Remove`,add:`Add`,if:`IF`,all:`ALL`,any:`ANY`,ofTheFollowing:`of the following conditions match`,then:`THEN`,actions:{fileinto:`Move to folder`,discard:`Discard (Delete)`,redirect:`Redirect to email`,stop:`Stop evaluating rules`},fields:{subject:`Subject`,from:`From`,to:`To`,body:`Body`,size:`Size`,emailAddress:`Email Address`},operators:{contains:`Contains`,not_contains:`Does not contain`,is:`Is exactly`,not_is:`Is not exactly`,over:`Over`,under:`Under`}},raw:{validate:`Validate`,save:`Save`}}},ge=e({default:()=>_e}),_e={settings:{categories:{password:`Password`},password:{title:`Password`,changePassword:`Change Password`,changePasswordDesc:`Update your account password.`,oldPassword:`Current Password`,newPassword:`New Password`,confirmPassword:`Confirm New Password`,updatePassword:`Update Password`,fillAllFields:`Please fill in all fields.`,passwordMismatch:`New passwords do not match.`}}},ve={tags:{important:`Important`,work:`Work`,personal:`Personal`,todo:`To Do`,later:`Later`},settings:{title:`Settings`,categories:{general:`General`,identity:`Identity`,reading:`Reading & Composing`,appearance:`Appearance`,localization:`Localization`,accounts:`Linked Accounts`,accountsDesc:`Pre-authorized accounts for quick switching between.`,webauthn:`2FA / WebAuthn`},loading:`Loading...`,placeholderName:`Your Name`,placeholderReplyTo:`reply@example.com`,general:{checkMailInterval:`Check mail interval`,checkMailIntervalDesc:`How often to automatically check for new mail.`,autoLogout:`Auto-logout`,autoLogoutDesc:`Automatically log out after inactivity.`,desktopNotifications:`Enable Desktop Notifications`,soundNotifications:`Play sound notification on new messages`,everyMinute:`Every minute`,every5Minutes:`Every 5 minutes`,every15Minutes:`Every 15 minutes`,every30Minutes:`Every 30 minutes`,never:`Never`,minutes15:`15 minutes`,minutes30:`30 minutes`,hour1:`1 hour`,hours2:`2 hours`,hours6:`6 hours`},identity:{displayName:`Display Name`,displayNameDesc:`The name shown to recipients when you send an email.`,signature:`Signature`,signatureDesc:`Appended to the end of your sent messages.`,replyTo:`Reply-To Address`,replyToDesc:`Optional: specify a different address for replies.`,bccMyself:`Always BCC myself on outgoing mail`},reading:{messagesPerPage:`Messages per page`,preferredView:`Preferred View`,preferredViewDesc:`How to display messages that have both HTML and Plain Text.`,showRemoteContent:`Show Remote Content`,composeFormat:`Compose Format`,html:`HTML`,plainText:`Plain Text`,alwaysAsk:`Always ask`,alwaysLoad:`Always load`,richText:`Rich Text (HTML)`,markReadTimeout:`Mark as Read`,markReadImmediately:`Immediately`,markRead1s:`After 1 second`,markRead3s:`After 3 seconds`,markRead5s:`After 5 seconds`,markRead10s:`After 10 seconds`,markReadNever:`Never mark automatically`,messageSortCriteria:`Message Sort Criteria`,messageSortCriteriaDesc:`Choose whether to sort by the original received date or by folder filing date.`,sortUid:`Folder Filing Date`,sortDate:`Received Date`},appearance:{colorTheme:`Color Theme`,colorThemeDesc:`Select your preferred color palette.`,themeMode:`Theme Mode`,themeModeDesc:`Choose light, dark, or system auto.`,layoutMode:`Layout Mode`,layoutModeDesc:`Choose how you want your mailbox to be laid out.`,listDensity:`List Density`,listDensityDesc:`Adjust the spacing and compactness of the message list.`,light:`Light`,dark:`Dark`,systemAuto:`System Auto`,vertical:`Vertical (3 Panes)`,horizontal:`Horizontal (Top/Bottom)`,fullScreen:`Full Screen (Hide list when reading)`,loose:`Loose`,normal:`Normal`,compact:`Compact`,ultraCompact:`Ultra Compact`},localization:{language:`Language`,timeFormat:`Time Format`,dateFormat:`Date Format`,format12h:`12-hour (AM/PM)`,format24h:`24-hour`,english:`English`,german:`Deutsch`,italian:`Italiano`,spanish:`Español`,serbian:`Српски`,serbianLatin:`Srpski (Latinica)`,french:`Français`,portuguese:`Português`}},linkedAccounts:{description:`Connect another account to quickly switch between them without logging out.`,noAccounts:`No linked accounts.`,remove:`Remove`,addTitle:`Link Account`,linkAccount:`Link Account`,addedSuccess:`Account linked successfully.`,addError:`Failed to add account. Please check the credentials.`,removeConfirm:`Are you sure you want to remove this linked account?`,removedSuccess:`Account removed.`,removeError:`Failed to remove account.`,switchError:`Failed to switch account. The password might have changed.`},webauthn:{title:`Security Key Verification`,instruction:`Please use your security key to complete login.`,not_supported:`WebAuthn is not supported in your browser.`,requesting:`Requesting authentication...`,waiting_for_key:`Waiting for security key...`,verifying:`Verifying...`,success:`Verification successful, redirecting...`,verify_btn:`Verify Identity`,verifying_btn:`Verifying...`,back_to_login:`Back to Login`,key_name_placeholder:`Device name (e.g. YubiKey)`,name_key_title:`Name Security Key`,name_key_label:`Device Name`,add_key:`Add Security Key`,trust_linked:`Trust Linked Accounts`,trust_linked_desc:`If enabled, you can switch to this account from a linked account without providing a 2FA credential again.`,trust_linked_checkbox:`Allow switching to this account without 2FA`,confirm_remove:`Are you sure you want to remove this security key?`,errors:{begin_failed:`Failed to initiate authentication.`,invalid_options:`Invalid authentication options received.`,verification_failed:`Verification failed. Please try again.`,remove_failed:`Failed to remove the security key.`,general:`An error occurred.`},settings:{group_desc:`Secure your account with a hardware security key or biometrics.`,keys_title:`Security Keys`,added:`Added`,remove_btn:`Remove`}},print:{loading:`Loading print view...`},login:{subtitle:`Sign in to your webmail.`,emailPlaceholder:`Email Address`,passwordPlaceholder:`Password`,keepMeSignedIn:`Keep me signed in`,signIn:`Sign In`,tooManyAttempts:`Too many login attempts`,loginFailed:`Login failed. Please check your credentials.`,networkError:`Network error occurred. Please try again.`,pleaseWait:`Please wait`,wait:`Wait`},folderList:{compose:`Compose`,inbox:`Inbox`,drafts:`Drafts`,sent:`Sent`,archive:`Archive`,spam:`Spam`,junk:`Junk`,trash:`Trash`,title:`Folders`,rename:`Rename`,delete:`Delete`,createFolder:`Create Folder`,renameFolder:`Rename Folder`,deleteFolder:`Delete Folder`,deleteFolderConfirm:`Are you sure you want to delete "{folder}"? All messages inside will be permanently deleted.`,expandSidebar:`Expand sidebar`,collapseSidebar:`Collapse sidebar`,moveToTrash:`Move to Trash`,moveToTrashConfirm:`Are you sure you want to move "{folder}" to the Trash?`,createSubfolder:`Create subfolder`,createSubfolderUnder:`Create Subfolder under "{folder}"`},messageList:{selectAll:`Select all messages`,checkNew:`Check for new messages`,sortDesc:`Sort descending by date`,sortAsc:`Sort ascending by date`,filterStarred:`Filter by starred`,filterUnread:`Filter by unread`,noMessages:`No messages`,loading:`Loading...`,unknownSender:`Unknown Sender`,unknown:`Unknown`,noSubject:`(No Subject)`,hasAttachments:`Has attachments`,replied:`Replied`,forwarded:`Forwarded`,searchResultsFor:`Search results for:`,clearSearch:`Clear search`,totalMessagesIn:`{count} total messages in {folder}`,deleteAllNow:`Delete All Now`,emptyMailboxTitle:`Empty {folder}`,emptyMailboxConfirm:`Are you sure you want to permanently delete all {count} messages in {folder}? This action cannot be undone.`,emptyingMailbox:`Emptying mailbox...`,mailboxEmptied:`Mailbox emptied successfully.`,emptyMailboxFailed:`Failed to empty mailbox. Make sure it is Trash or Junk.`},composer:{attachmentsWait:`Please wait for attachments to finish uploading before sending.`,sending:`Message is being sent...`,undo:`Undo`,sendError:`Failed to send message: {error}`},messageComposer:{fontSize:`Font Size`,small:`Small`,normal:`Normal`,large:`Large`,huge:`Huge`,bold:`Bold`,italic:`Italic`,underline:`Underline`,textColor:`Text Color`,align:`Align`,left:`Left`,center:`Center`,right:`Right`,numberedList:`Numbered List`,bulletedList:`Bulleted List`,indentMore:`Indent More`,indentLess:`Indent Less`,moreFormatting:`More Formatting`,undo:`Undo`,redo:`Redo`,quote:`Quote`,strikethrough:`Strikethrough`,clearFormatting:`Clear Formatting`,goToLink:`Go to link:`,change:`Change`,remove:`Remove`,text:`Text`,link:`Link`,apply:`Apply`,writeMessage:`Write your message...`},floatingComposer:{discardDraftTitle:`Discard Draft?`,discardDraftMessage:`Are you sure you want to discard this draft? This action cannot be undone.`,discard:`Discard`,dropFiles:`Drop files here to attach`,newMessage:`New Message`,saving:`Saving...`,autosaved:`Autosaved`,restore:`Restore`,minimize:`Minimize`,expand:`Expand`,saveAndClose:`Save & close`,to:`To`,cc:`Cc`,bcc:`Bcc`,subject:`Subject`,toggleFormatting:`Toggle Formatting Options`,attachFiles:`Attach Files`,insertLink:`Insert Link`,insertEmoji:`Insert Emoji`,send:`Send`,linkUrl:`Link URL`,linkUrlPlaceholder:`https://example.com`,displayText:`Display Text`,displayTextPlaceholder:`My Website`,apply:`Apply`,uploadFailed:`Failed to upload attachment: {error}`,unknownError:`Unknown error`},messageReader:{tags:`Tags`,removeAllTags:`Remove all tags`,selectMessage:`Select a message to read`,messagesSelected:`messages selected`,back:`Back`,reply:`Reply`,replyAll:`Reply All`,forward:`Forward`,to:`To:`,cc:`Cc:`,undisclosed:`Undisclosed`,loadingMessage:`Loading message...`,remoteContentWarning:`This message contains remote content. For your privacy, it has been blocked.`,loadRemoteContent:`Load remote content`,isDraft:`This is a draft message.`,editDraft:`Edit Draft`,noRecipients:`(No Recipients)`,discardDraft:`Discard Draft`,noReadableText:`This message contains no readable text, only attachments.`,attachments:`Attachments`,downloadAllAttachments:`Download all attachments`,unknownAttachment:`Unknown attachment`,archive:`Archive`,reportSpam:`Report Spam`,notSpam:`Not Spam`,delete:`Delete`,deleteConfirmSingle:`Are you sure you want to permanently delete this message? This action cannot be undone.`,deleteConfirmMultiple:`Are you sure you want to permanently delete these messages? This action cannot be undone.`,markUnread:`Mark as unread`,markRead:`Mark as read`,star:`Star`,moveTo:`Copy/Move to...`,print:`Print`,showPlaintext:`Show plaintext`,showHtml:`Show HTML`,downloadMessage:`Download message`,showOriginal:`Show original`,verifiedSender:`Verified Sender`,unverifiedSender:`Unverified Sender`},originalMessage:{title:`Original Message`,loading:`Loading original message...`,errorMissingParams:`Missing mailbox or uid parameters`,errorFailedToFetch:`Failed to fetch original message`,messageId:`Message ID`,createdAt:`Created at`,from:`From`,to:`To`,subject:`Subject`,spf:`SPF`,dkim:`DKIM`,dmarc:`DMARC`,truncatedInfo:`Message is too large to display fully. Showing the first 64KB. Please use "Download Original" to view the entire message.`,downloadOriginal:`Download Original`,copyClipboard:`Copy to clipboard`,copiedTruncated:`Copied truncated content to clipboard.`,copied:`Copied to clipboard.`,copyFailed:`Failed to copy to clipboard.`,none:`NONE`,pass:`PASS`,fail:`FAIL`},folderSelector:{filter:`Filter folders...`,noResults:`No matching folders`,actionMove:`Move to`,actionCopy:`Copy to`},attachment:{remove:`Remove`},navigation:{messages:`Messages`,contacts:`Contacts`},userMenu:{settings:`Settings`,signOut:`Sign Out`,profileOptions:`Profile options`},pagination:{previousPage:`Previous page`,nextPage:`Next page`,of:`of`,zeroMessages:`0 messages`},toast:{messagePermanentlyDeleted:`Message permanently deleted`,draftDiscarded:`Draft discarded`,folderRenamed:`Folder renamed`,folderMovedToTrash:`Folder moved to Trash`,folderPermanentlyDeleted:`Folder permanently deleted`,undo:`Undo`,dismiss:`Dismiss`,messageMovedToArchive:`Message moved to Archive`,messagesMovedToArchive:`{count} messages moved to Archive`,messageMovedToSpam:`Message moved to Spam`,messagesMovedToSpam:`{count} messages moved to Spam`,messageMovedToInbox:`Message moved to Inbox`,messagesMovedToInbox:`{count} messages moved to Inbox`,messageMovedToTrash:`Message moved to Trash`,messagesMovedToTrash:`{count} messages moved to Trash`,messageMovedToFolder:`Message moved to {folder}`,messagesMovedToFolder:`{count} messages moved to {folder}`,messageCopiedToFolder:`Message copied to {folder}`,messagesCopiedToFolder:`{count} messages copied to {folder}`,draftsDiscarded:`{count} drafts discarded`,messagesPermanentlyDeleted:`{count} messages permanently deleted`},mailboxPage:{mailboxNotFound:`Mailbox not found`,newMessages:`New Messages`,newMessagesSingleBody:`You have 1 new message`,newMessagesMultiBody:`You have {count} new messages`,newMessagesInInbox:`New messages in Inbox`,newMessagesAvailable:`New messages available`,open:`Open`,refresh:`Refresh`,permanentlyDelete:`Permanently Delete?`,deletePermanently:`Delete Permanently`,undo:`Undo`},offline:{title:`Connection Lost`,description:`Network connectivity lost`,tryingAgain:`Trying again in {seconds} seconds...`},general:{cancel:`Cancel`,save:`Save`,optional:`Optional`}},x={debug:(...e)=>{},info:(...e)=>{console.info(`[INFO]`,...e)},warn:(...e)=>{console.warn(`[WARN]`,...e)},error:(...e)=>{console.error(`[ERROR]`,...e)}},ye=`modulepreload`,be=function(e){return`/`+e},xe={},S=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}r=o(t.map(t=>{if(t=be(t,n),t in xe)return;xe[t]=!0;let r=t.endsWith(`.css`),i=r?`[rel="stylesheet"]`:``;if(n)for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${t}"]${i}`))return;let o=document.createElement(`link`);if(o.rel=r?`stylesheet`:ye,r||(o.as=`script`),o.crossOrigin=``,o.href=t,a&&o.setAttribute(`nonce`,a),document.head.appendChild(o),r)return new Promise((e,n)=>{o.addEventListener(`load`,e),o.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})};function Se(e,t){if(typeof e!=`object`||!e)return t;if(typeof t!=`object`||!t)return e;let n={...e};return Object.keys(t).forEach(r=>{typeof t[r]==`object`&&t[r]!==null&&!Array.isArray(t[r])&&r in e?n[r]=Se(e[r],t[r]):n[r]=t[r]}),n}var Ce=Object.assign({"../../../plugins/carddav/frontend/i18n/en.ts":fe,"../../../plugins/managesieve/frontend/i18n/en.ts":me,"../../../plugins/password/frontend/i18n/en.ts":ge}),we={...ve};for(let e in Ce){let t=Ce[e],n=t.default||t.en||{};we=Se(we,n)}var Te=we,Ee=class extends EventTarget{constructor(){super(),this.language=`en`,this.dictionary=Te}async setLanguage(e){if(this.language!==e){this.language=e;try{if(e===`en`)this.dictionary=Te;else{let t={},n=Object.assign({"../i18n/de.ts":()=>S(()=>import(`./de-DgBQ0a-q.js`),[]),"../i18n/es.ts":()=>S(()=>import(`./es-Clo5QN4P.js`),[]),"../i18n/fr.ts":()=>S(()=>import(`./fr-BWykFXms.js`),[]),"../i18n/it.ts":()=>S(()=>import(`./it-BhwWP_u5.js`),[]),"../i18n/pt.ts":()=>S(()=>import(`./pt-B0VuO-tT.js`),[]),"../i18n/rs.ts":()=>S(()=>import(`./rs-CvwkQSlp.js`),[]),"../i18n/sr.ts":()=>S(()=>import(`./sr-HXbgtxAG.js`),[])})[`../i18n/${e}.ts`];if(n){let r=await n();t=r.default||r[e]}else throw Error(`Locale file not found for ${e}`);let r=Object.assign({"../../../plugins/carddav/frontend/i18n/de.ts":()=>S(()=>import(`./de-CidpNdb_.js`),[]),"../../../plugins/carddav/frontend/i18n/es.ts":()=>S(()=>import(`./es-D4OfLXXI.js`),[]),"../../../plugins/carddav/frontend/i18n/fr.ts":()=>S(()=>import(`./fr-qE-aVbxj.js`),[]),"../../../plugins/carddav/frontend/i18n/it.ts":()=>S(()=>import(`./it-CRayflmD.js`),[]),"../../../plugins/carddav/frontend/i18n/pt.ts":()=>S(()=>import(`./pt-B_uvE9Mp.js`),[]),"../../../plugins/carddav/frontend/i18n/rs.ts":()=>S(()=>import(`./rs-BeifriKw.js`),[]),"../../../plugins/carddav/frontend/i18n/sr.ts":()=>S(()=>import(`./sr-lLWqmHyv.js`),[]),"../../../plugins/managesieve/frontend/i18n/de.ts":()=>S(()=>import(`./de-DSWu1_ID.js`),[]),"../../../plugins/managesieve/frontend/i18n/es.ts":()=>S(()=>import(`./es-BhiBBKAI.js`),[]),"../../../plugins/managesieve/frontend/i18n/fr.ts":()=>S(()=>import(`./fr-ByQxQt47.js`),[]),"../../../plugins/managesieve/frontend/i18n/it.ts":()=>S(()=>import(`./it-DbrH29hW.js`),[]),"../../../plugins/managesieve/frontend/i18n/pt.ts":()=>S(()=>import(`./pt-Dpg5-Dop.js`),[]),"../../../plugins/managesieve/frontend/i18n/rs.ts":()=>S(()=>import(`./rs-EsW3R8ez.js`),[]),"../../../plugins/managesieve/frontend/i18n/sr.ts":()=>S(()=>import(`./sr-D8Vo5pZh.js`),[]),"../../../plugins/password/frontend/i18n/de.ts":()=>S(()=>import(`./de-CD8-BVff.js`),[]),"../../../plugins/password/frontend/i18n/es.ts":()=>S(()=>import(`./es-D3_5CpIu.js`),[]),"../../../plugins/password/frontend/i18n/fr.ts":()=>S(()=>import(`./fr-CkKwevKO.js`),[]),"../../../plugins/password/frontend/i18n/it.ts":()=>S(()=>import(`./it-s29zuCbt.js`),[]),"../../../plugins/password/frontend/i18n/pt.ts":()=>S(()=>import(`./pt-CaEUCGHK.js`),[]),"../../../plugins/password/frontend/i18n/rs.ts":()=>S(()=>import(`./rs-DxSxTVhX.js`),[]),"../../../plugins/password/frontend/i18n/sr.ts":()=>S(()=>import(`./sr-CYiO1P4Q.js`),[])}),i=[];for(let t in r)t.endsWith(`/${e}.ts`)&&i.push(r[t]());let a=await Promise.all(i);for(let n of a){let r=n.default||n[e]||{};t=Se(t,r)}this.dictionary=t}}catch(t){x.error(`Failed to load language module for ${e}`,t),this.dictionary=Te}this.dispatchEvent(new CustomEvent(`change`))}}getLanguage(){return this.language}t(e,t){let n=e.split(`.`),r=this.dictionary;for(let e of n){if(r==null)break;r=r[e]}if(typeof r!=`string`){let t=Te;for(let e of n){if(t==null)break;t=t[e]}r=typeof t==`string`?t:e}return typeof r==`string`&&t?r.replace(/\{(\w+)\}/g,(e,n)=>t[n]===void 0?e:String(t[n])):r}},C=r(`i18n-store`),De={"default-light":{id:`default-light`,name:`Default Light`,isDark:!1,colors:{"bg-primary":`#ffffff`,"bg-secondary":`#f9fafb`,"bg-tertiary":`#f3f4f6`,"bg-selected":`#eff6ff`,"bg-starred":`#2563eb0f`,"text-primary":`#111827`,"text-sender-read":`#202020`,"text-secondary":`#4b5563`,"text-muted":`#9ca3af`,"border-color":`#e5e7eb`,"accent-color":`#2563eb`,"accent-hover":`#1d4ed8`,"accent-light":`#dbeafe`,success:`#10b981`,warning:`#f59e0b`,error:`#ef4444`,"hover-color":`#f3f4f6`}},"default-dark":{id:`default-dark`,name:`Default Dark`,isDark:!0,colors:{"bg-primary":`#1f2937`,"bg-secondary":`#111827`,"bg-tertiary":`#374151`,"bg-selected":`#1e3a8a`,"bg-starred":`#3b82f615`,"text-primary":`#f9fafb`,"text-sender-read":`#e5e7eb`,"text-secondary":`#d1d5db`,"text-muted":`#9ca3af`,"border-color":`#374151`,"accent-color":`#3b82f6`,"accent-hover":`#60a5fa`,"accent-light":`#1e3a8a`,success:`#10b981`,warning:`#f59e0b`,error:`#ef4444`,"hover-color":`rgba(255, 255, 255, 0.1)`}},"nord-light":{id:`nord-light`,name:`Nord Light`,isDark:!1,colors:{"bg-primary":`#eceff4`,"bg-secondary":`#e5e9f0`,"bg-tertiary":`#d8dee9`,"bg-selected":`#81a1c133`,"bg-starred":`#5e81ac15`,"text-primary":`#2e3440`,"text-sender-read":`#3b4252`,"text-secondary":`#3b4252`,"text-muted":`#4c566a`,"border-color":`#d8dee9`,"accent-color":`#5e81ac`,"accent-hover":`#81a1c1`,"accent-light":`#81a1c133`,success:`#a3be8c`,warning:`#ebcb8b`,error:`#bf616a`,"hover-color":`rgba(0, 0, 0, 0.05)`}},"nord-dark":{id:`nord-dark`,name:`Nord Dark`,isDark:!0,colors:{"bg-primary":`#2e3440`,"bg-secondary":`#3b4252`,"bg-tertiary":`#434c5e`,"bg-selected":`#81a1c133`,"bg-starred":`#88c0d015`,"text-primary":`#eceff4`,"text-sender-read":`#e5e9f0`,"text-secondary":`#e5e9f0`,"text-muted":`#d8dee9`,"border-color":`#434c5e`,"accent-color":`#88c0d0`,"accent-hover":`#81a1c1`,"accent-light":`#81a1c133`,success:`#a3be8c`,warning:`#ebcb8b`,error:`#bf616a`,"hover-color":`rgba(255, 255, 255, 0.1)`}},"ocean-light":{id:`ocean-light`,name:`Ocean Light`,isDark:!1,colors:{"bg-primary":`#f8fafc`,"bg-secondary":`#f1f5f9`,"bg-tertiary":`#e2e8f0`,"bg-selected":`#e0f2fe`,"bg-starred":`#0ea5e915`,"text-primary":`#0f172a`,"text-sender-read":`#1e293b`,"text-secondary":`#334155`,"text-muted":`#64748b`,"border-color":`#cbd5e1`,"accent-color":`#0ea5e9`,"accent-hover":`#0284c7`,"accent-light":`#e0f2fe`,success:`#10b981`,warning:`#f59e0b`,error:`#ef4444`,"hover-color":`rgba(0, 0, 0, 0.05)`}},"ocean-dark":{id:`ocean-dark`,name:`Ocean Dark`,isDark:!0,colors:{"bg-primary":`#0f172a`,"bg-secondary":`#1e293b`,"bg-tertiary":`#334155`,"bg-selected":`#0c4a6e`,"bg-starred":`#38bdf815`,"text-primary":`#f8fafc`,"text-sender-read":`#e2e8f0`,"text-secondary":`#cbd5e1`,"text-muted":`#94a3b8`,"border-color":`#334155`,"accent-color":`#38bdf8`,"accent-hover":`#0ea5e9`,"accent-light":`#0c4a6e`,success:`#10b981`,warning:`#f59e0b`,error:`#ef4444`,"hover-color":`rgba(255, 255, 255, 0.1)`}}},Oe={themeMode:`auto`,colorFamily:`default`,layoutMode:`vertical`,densityMode:`compact`,sidebarCollapsed:!1,checkMailInterval:5,autoLogout:30,desktopNotifications:!1,soundNotifications:!0,name:``,signature:``,replyTo:``,bccMyself:!1,messagesPerPage:50,preferredView:`html`,markReadTimeout:3,showRemoteContent:`ask`,composeFormat:`html`,undoTimeout:0,language:`en`,hourFormat:`24`,dateFormat:`YYYY-MM-DD`,sortOrder:`desc`,messageSortCriteria:`date`,maxAttachmentMiB:32},ke=class extends EventTarget{constructor(){super(),this.state=this.loadSettings(),this.applyTheme(),window.matchMedia(`(prefers-color-scheme: dark)`).addEventListener(`change`,()=>{this.state.themeMode===`auto`&&this.applyTheme()}),window.addEventListener(`session-cleared`,()=>{this.state=this.loadSettings(),this.applyTheme(),this.notify()}),window.addEventListener(`user-logged-in`,()=>{this._fetchBackendSettings()}),this._fetchBackendSettings()}loadSettings(){let e=localStorage.getItem(`alps_settings`);if(e)try{let t=JSON.parse(e);return{...Oe,...t}}catch(e){x.error(`Failed to parse settings`,e)}return{...Oe}}saveSettings(){localStorage.setItem(`alps_settings`,JSON.stringify(this.state))}notify(){this.dispatchEvent(new CustomEvent(`change`))}getState(){return this.state}async updateSettings(e){this.state={...this.state,...e},this.saveSettings(),(e.themeMode!==void 0||e.colorFamily!==void 0)&&this.applyTheme(),this.notify();let t={...e};if(delete t.loginUsername,Object.keys(t).length>0)return this._saveBackendSettings(this.state)}async _fetchBackendSettings(){let e=document.cookie.split(`;`).some(e=>e.trim().startsWith(`alps_logged_in=1`)),t=document.cookie.split(`;`).some(e=>e.trim().startsWith(`alps_has_login_token=1`));if(!e&&!t){window.location.hash.startsWith(`#/login`)||window.dispatchEvent(new CustomEvent(`auth-error`));return}try{let e=await fetch(`/settings`);if(e.status===401){window.dispatchEvent(new CustomEvent(`auth-error`));return}if(e.ok){let t=await e.json(),n={};if(t.MaxAttachmentMiB!==void 0&&(n.maxAttachmentMiB=t.MaxAttachmentMiB),t&&t.Settings){let e=t.Settings;if(e.ui){let t=e.ui;t.themeMode&&(n.themeMode=t.themeMode),t.colorFamily&&(n.colorFamily=t.colorFamily),t.layoutMode&&(n.layoutMode=t.layoutMode),t.densityMode&&(n.densityMode=t.densityMode),t.sidebarCollapsed!==void 0&&(n.sidebarCollapsed=t.sidebarCollapsed)}e.check_mail_interval!==void 0&&e.check_mail_interval!==0&&(n.checkMailInterval=e.check_mail_interval),e.auto_logout!==void 0&&(n.autoLogout=e.auto_logout),e.desktop_notifications!==void 0&&(n.desktopNotifications=e.desktop_notifications),e.sound_notifications!==void 0&&(n.soundNotifications=e.sound_notifications),e.from!==void 0&&(n.name=e.from),e.signature!==void 0&&(n.signature=e.signature),e.reply_to!==void 0&&(n.replyTo=e.reply_to),e.bcc_myself!==void 0&&(n.bccMyself=e.bcc_myself),e.messages_per_page!==void 0&&e.messages_per_page!==0&&(n.messagesPerPage=e.messages_per_page),e.preferred_view!==void 0&&e.preferred_view!==``&&(n.preferredView=e.preferred_view),e.mark_read_timeout!==void 0&&(n.markReadTimeout=e.mark_read_timeout),e.show_remote_content!==void 0&&e.show_remote_content!==``&&(n.showRemoteContent=e.show_remote_content),e.compose_format!==void 0&&e.compose_format!==``&&(n.composeFormat=e.compose_format),e.undo_timeout!==void 0&&(n.undoTimeout=e.undo_timeout),e.language!==void 0&&e.language!==``&&(n.language=e.language),e.hour_format!==void 0&&e.hour_format!==``&&(n.hourFormat=e.hour_format),e.date_format!==void 0&&e.date_format!==``&&(n.dateFormat=e.date_format),e.sort_order!==void 0&&e.sort_order!==``&&(n.sortOrder=e.sort_order),e.message_sort_criteria!==void 0&&e.message_sort_criteria!==``&&(n.messageSortCriteria=e.message_sort_criteria),Object.keys(n).length>0&&(this.state={...this.state,...n},this.saveSettings(),this.applyTheme(),this.notify())}}}catch(e){x.error(`Failed to fetch backend settings`,e)}}async _saveBackendSettings(e){try{(await fetch(`/settings`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify({ui:{themeMode:e.themeMode,colorFamily:e.colorFamily,layoutMode:e.layoutMode,densityMode:e.densityMode,sidebarCollapsed:e.sidebarCollapsed},check_mail_interval:Number(e.checkMailInterval)||0,auto_logout:Number(e.autoLogout)||0,desktop_notifications:!!e.desktopNotifications,sound_notifications:!!e.soundNotifications,from:e.name,signature:e.signature,reply_to:e.replyTo,bcc_myself:!!e.bccMyself,messages_per_page:Number(e.messagesPerPage)||50,preferred_view:e.preferredView,mark_read_timeout:Number(e.markReadTimeout)||0,show_remote_content:e.showRemoteContent,compose_format:e.composeFormat,undo_timeout:Number(e.undoTimeout)||0,language:e.language,hour_format:e.hourFormat,date_format:e.dateFormat,sort_order:e.sortOrder,message_sort_criteria:e.messageSortCriteria})})).status===401&&window.dispatchEvent(new CustomEvent(`auth-error`))}catch(e){x.error(`Failed to save backend settings`,e)}}applyTheme(){let e=!1;this.state.themeMode===`dark`?e=!0:this.state.themeMode===`auto`&&(e=window.matchMedia(`(prefers-color-scheme: dark)`).matches),e?document.body.classList.add(`theme-dark`):document.body.classList.remove(`theme-dark`);let t=De[`${this.state.colorFamily}-${e?`dark`:`light`}`]||De[`default-${e?`dark`:`light`}`];if(t)for(let[e,n]of Object.entries(t.colors))document.documentElement.style.setProperty(`--${e}`,n)}},w=r(`settings-store`);function Ae(){let e=localStorage.getItem(`alps_settings`);if(e)try{let t=JSON.parse(e),n={};t.themeMode&&(n.themeMode=t.themeMode),t.colorFamily&&(n.colorFamily=t.colorFamily),t.language&&(n.language=t.language),t.layoutMode&&(n.layoutMode=t.layoutMode),t.densityMode&&(n.densityMode=t.densityMode),localStorage.setItem(`alps_settings`,JSON.stringify(n))}catch{localStorage.removeItem(`alps_settings`)}}var T=`INBOX`,je=`Drafts`,Me=`Sent`,Ne=`Archive`,Pe=`Archives`,Fe=`Spam`,Ie=`Junk`,Le=`Trash`;function E(e){return s`
  ...
  `}getInitials(e){if(!e)return`U`;let t=e.trim().split(/[\s.@]+/);return t.length>=2?(t[0][0]+t[1][0]).toUpperCase():e.substring(0,2).toUpperCase()}render(){let e=this.settingsStore?.getState()?.loginUsername||``,t=this.settingsStore?.getState()?.name||``,r=!1;(e&&this.email&&this.email.toLowerCase()===e.toLowerCase()||t&&this.name&&this.name.toLowerCase()===t.toLowerCase()||e&&this.name&&this.name.toLowerCase()===e.toLowerCase())&&(r=!0);let i=r?t||e:this.email||this.name,a=r&&(t||e)||this.name,o=Math.round(this.size/2.3);return s`
      <div class="avatar" style="${n({width:`${this.size}px`,height:`${this.size}px`,fontSize:`${o}px`,backgroundColor:Re(i)})}">
        ${this.src&&!this.imageError?s`<img src="${this.src}" alt="${this.name}" @error="${()=>this.imageError=!0}" />`:this.getInitials(a)}
      </div>
    `}};j([f({context:w})],dt.prototype,`settingsStore`,void 0),j([i({type:String})],dt.prototype,`name`,void 0),j([i({type:String})],dt.prototype,`email`,void 0),j([i({type:String})],dt.prototype,`src`,void 0),j([i({type:Number})],dt.prototype,`size`,void 0),j([_()],dt.prototype,`imageError`,void 0),dt=j([a(`alps-avatar`)],dt);var ft=o`
  .dropdown-header {
...
`,pt=class extends p{constructor(...e){super(...e),this.align=`right`,this.position=`bottom`,this.openState=!1,this._handleDialogClick=e=>{this.openState&&e.target===e.currentTarget&&(e.stopPropagation(),e.preventDefault(),this.close())},this._handleDialogClose=()=>{this.openState&&this.close()},this._handleDialogKeydown=e=>{if(this.openState){if(e.key===`ArrowDown`||e.key===`ArrowUp`){e.preventDefault();let t=this._getFocusableElements();if(t.length===0)return;let n=this._getActiveElement(),r=t.findIndex(e=>e===n);r=e.key===`ArrowDown`?r===-1?0:(r+1)%t.length:r===-1?t.length-1:(r-1+t.length)%t.length,t[r].focus()}else if(e.key===`Enter`||e.key===` `){let t=this._getActiveElement();t&&typeof t.click==`function`&&(e.preventDefault(),t.click())}}},this._handleResize=()=>{this.openState&&this._updatePosition()}}static{this.styles=o`
  ...
  `}open(){this.openState=!0,this.dispatchEvent(new CustomEvent(`popup-open`,{bubbles:!0,composed:!0}))}close(){this.openState=!1,this.dispatchEvent(new CustomEvent(`popup-close`,{bubbles:!0,composed:!0}))}toggle(e){this.openState?this.close():this.open()}_getActiveElement(){let e=document.activeElement;for(;e?.shadowRoot&&e.shadowRoot.activeElement;)e=e.shadowRoot.activeElement;return e}_getFocusableElements(){let e=this.shadowRoot?.querySelector(`slot:not([name])`);if(!e)return[];let t=e.assignedElements({flatten:!0}),n=[],r=`button:not([disabled]), a[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])`;return t.forEach(e=>{if(e instanceof HTMLElement){e.matches(r)&&n.push(e);let t=Array.from(e.querySelectorAll(r));n.push(...t)}}),n}updated(e){if(super.updated(e),e.has(`openState`)){let e=this.shadowRoot?.querySelector(`.popup-dialog`);if(this.openState)e&&!e.open&&e.showModal(),this._updatePosition();else if(e&&e.open){e.close();let t=this.shadowRoot?.querySelector(`slot[name="trigger"]`);t&&t.assignedElements({flatten:!0}).forEach(e=>{e instanceof HTMLElement&&e.blur()})}}}_updatePosition(){let e=this.shadowRoot?.querySelector(`.trigger`),t=this.shadowRoot?.querySelector(`.popup-content`);if(!e||!t)return;let n=e.getBoundingClientRect(),r=t.getBoundingClientRect(),i=this.position,a=this.align;this.position===`bottom`?n.bottom+8+r.height>window.innerHeight&&n.top-8-r.height>=0&&(i=`top`):n.top-8-r.height<0&&n.bottom+8+r.height<=window.innerHeight&&(i=`bottom`),this.align===`right`?n.right-r.width<0&&n.left+r.width<=window.innerWidth&&(a=`left`):n.left+r.width>window.innerWidth&&n.right-r.width>=0&&(a=`right`),i===`bottom`?(t.style.top=`${n.bottom+8}px`,t.style.bottom=`auto`):(t.style.bottom=`${window.innerHeight-n.top+8}px`,t.style.top=`auto`),a===`right`?(t.style.right=`${window.innerWidth-n.right}px`,t.style.left=`auto`):(t.style.left=`${n.left}px`,t.style.right=`auto`),t.classList.remove(`position-top`,`position-bottom`,`align-left`,`align-right`),t.classList.add(`position-${i}`,`align-${a}`)}connectedCallback(){super.connectedCallback(),window.addEventListener(`resize`,this._handleResize,{passive:!0})}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener(`resize`,this._handleResize)}render(){return s`
    ...
    `}};j([i({type:String})],pt.prototype,`align`,void 0),j([i({type:String})],pt.prototype,`position`,void 0),j([i({type:Boolean,reflect:!0,attribute:`open`})],pt.prototype,`openState`,void 0),pt=j([a(`alps-popup`)],pt);var mt=class extends p{constructor(...e){super(...e),this.icon=``,this.title=``,this.disabled=!1,this.active=!1,this.spinning=!1}static{this.styles=o`
    :host {
      display: inline-flex;
      line-height: 0;
    }
  ...
  `}_handleAnimationIteration(){this.dispatchEvent(new Event(`animationiteration`,{bubbles:!0,composed:!0}))}render(){return s`
    ...
    `}};j([i({type:String})],mt.prototype,`icon`,void 0),j([i({type:String})],mt.prototype,`title`,void 0),j([i({type:Boolean})],mt.prototype,`disabled`,void 0),j([i({type:Boolean,reflect:!0})],mt.prototype,`active`,void 0),j([i({type:Boolean})],mt.prototype,`spinning`,void 0),mt=j([a(`alps-icon-btn`)],mt);var ht=class extends p{constructor(...e){super(...e),this.username=``,this.isMobile=!1,this.currentTab=`messages`,this._handleStoreChange=()=>{this.requestUpdate()}}static{this.styles=[ft,o`
    :host {
      display: block;
      position: relative;
    }
  ...
  `]}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.i18nStore?.addEventListener(`change`,this._handleStoreChange),this.settingsStore?.addEventListener(`change`,this._handleStoreChange),this.linkedAccountsStore?.addEventListener(`change`,this._handleStoreChange),this.linkedAccountsStore&&!this.linkedAccountsStore.isInitialized()&&this.linkedAccountsStore.fetchAccounts()})}disconnectedCallback(){super.disconnectedCallback(),this.i18nStore?.removeEventListener(`change`,this._handleStoreChange),this.settingsStore?.removeEventListener(`change`,this._handleStoreChange),this.linkedAccountsStore?.removeEventListener(`change`,this._handleStoreChange)}_closePopup(){let e=this.shadowRoot?.querySelector(`alps-popup`);e&&e.close()}_handleSettings(){this._closePopup(),this.dispatchEvent(new CustomEvent(`open-settings`,{bubbles:!0,composed:!0}))}_handleSignOut(){this._closePopup(),this.dispatchEvent(new CustomEvent(`sign-out`,{bubbles:!0,composed:!0}))}_handleTabChange(e){this._closePopup(),e===`messages`&&(window.location.hash=`#/`),this.dispatchEvent(new CustomEvent(`change-tab`,{detail:{tab:e},bubbles:!0,composed:!0}))}async _handleSwitchAccount(e){this._closePopup();let t=document.createElement(`div`);document.body.appendChild(t),u(s`
    ...
    `}};j([i({type:String})],ht.prototype,`username`,void 0),j([i({type:Boolean})],ht.prototype,`isMobile`,void 0),j([i({type:String})],ht.prototype,`currentTab`,void 0),j([f({context:C})],ht.prototype,`i18nStore`,void 0),j([f({context:w})],ht.prototype,`settingsStore`,void 0),j([f({context:ut})],ht.prototype,`linkedAccountsStore`,void 0),ht=j([a(`user-profile-menu`)],ht);var gt=class extends p{constructor(...e){super(...e),this.username=``,this.currentTab=``,this.isMobile=!1,this.scrolled=!1,this._handleStoreChange=()=>{this.requestUpdate()}}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.i18nStore?.addEventListener(`change`,this._handleStoreChange)})}disconnectedCallback(){super.disconnectedCallback(),this.i18nStore?.removeEventListener(`change`,this._handleStoreChange)}static{this.styles=o`
    :host {
      display: block;
      position: relative;
      width: 100%;
  ...
  `}handleSettings(){window.location.hash=`/settings`}async handleSignOut(){try{this.composeStore&&await this.composeStore.saveAllDirtyDrafts(),await fetch(`/session`,{method:`DELETE`}),Ge.clear(),Ae(),window.dispatchEvent(new CustomEvent(`session-cleared`)),window.location.hash=`#/login`}catch(e){x.error(`Failed to sign out`,e)}}render(){return s`
    ...
    `}};j([i({type:String})],gt.prototype,`username`,void 0),j([i({type:String})],gt.prototype,`currentTab`,void 0),j([i({type:Boolean,reflect:!0})],gt.prototype,`isMobile`,void 0),j([i({type:Boolean,reflect:!0})],gt.prototype,`scrolled`,void 0),j([f({context:C})],gt.prototype,`i18nStore`,void 0),j([f({context:ct})],gt.prototype,`composeStore`,void 0),gt=j([a(`alps-header`)],gt);var M=class extends p{constructor(...e){super(...e),this.type=`text`,this.value=``,this.placeholder=``,this.required=!1,this.autocomplete=``,this.inputId=``,this.icon=``,this.clearable=!1,this.autofocus=!1,this.showPassword=!1}static{this.styles=o`
    :host {
      display: block;
      width: 100%;
      position: relative;
  ...
  `}handleTabClick(e){this.currentTab=e,this.dispatchEvent(new CustomEvent(`change-tab`,{detail:{tab:e}})),e===`messages`?window.location.hash.startsWith(`#/mailbox/`)||(window.location.hash=`#/`):window.location.hash=`#/`+e}render(){return s`
      ...
      >
        ...
        <alps-input 
          ...
          .placeholder=${this.currentTab===`contacts`?this.i18nStore?.t(`contacts.title`)||`Contacts`:this.currentMailbox?Ve(this.currentMailbox,this.i18nStore):this.i18nStore?.t(`search.placeholder`)}
    ...
    `}};j([i({type:String})],N.prototype,`username`,void 0),j([i({type:String})],N.prototype,`currentTab`,void 0),j([i({type:Boolean})],N.prototype,`isMobile`,void 0),j([i({type:String})],N.prototype,`currentMailbox`,void 0),j([i({type:String})],N.prototype,`searchQuery`,void 0),j([i({type:Boolean})],N.prototype,`scrolled`,void 0),j([f({context:C})],N.prototype,`i18nStore`,void 0),N=j([a(`app-header`)],N);var P=class extends p{constructor(...e){super(...e),this.variant=`normal`,this.icon=``,this.disabled=!1,this.spinning=!1,this.type=`button`,this.title=``,this.fullWidth=!1,this.handleClick=e=>{if(this.disabled||this.spinning){e.preventDefault(),e.stopPropagation();return}if(this.type===`submit`){let t=this.closest(`form`);t&&(e.preventDefault(),t.requestSubmit())}else if(this.type===`reset`){let t=this.closest(`form`);t&&(e.preventDefault(),t.reset())}}}connectedCallback(){super.connectedCallback(),this.addEventListener(`click`,this.handleClick)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`click`,this.handleClick)}static{this.styles=o`
    :host {
      display: inline-flex;
    }
  ...
  `}render(){return s`
    ...
    `}};j([i({type:String,reflect:!0})],P.prototype,`variant`,void 0),j([i({type:String})],P.prototype,`icon`,void 0),j([i({type:Boolean,reflect:!0})],P.prototype,`disabled`,void 0),j([i({type:Boolean,reflect:!0})],P.prototype,`spinning`,void 0),j([i({type:String})],P.prototype,`type`,void 0),j([i({type:String})],P.prototype,`title`,void 0),j([i({type:Boolean,attribute:`full-width`,reflect:!0})],P.prototype,`fullWidth`,void 0),P=j([a(`alps-button`)],P);var F=class extends p{constructor(...e){super(...e),this.isMobile=!1,this.isOpen=!1,this.collapsed=!1,this.suppressHover=!1,this.isHovered=!1,this.width=250,this.hideFooterDivider=!1,this.isDragging=!1}static{this.styles=o`
    :host {
      display: block;
      position: relative;
      height: 100%;
  ...
  `}startResize(e){if(this.isMobile||this.collapsed)return;e.preventDefault(),this.isDragging=!0,this.dispatchEvent(new CustomEvent(`drag-start`));let t=e.clientX,n=this.width,r=e=>{let r=n+(e.clientX-t);this.dispatchEvent(new CustomEvent(`sidebar-resize`,{detail:{newWidth:r,clientX:e.clientX}}))},i=()=>{this.isDragging=!1,window.removeEventListener(`mousemove`,r),window.removeEventListener(`mouseup`,i),this.dispatchEvent(new CustomEvent(`drag-end`))};window.addEventListener(`mousemove`,r),window.addEventListener(`mouseup`,i)}render(){return s`
    ...
    `}};j([f({context:C})],F.prototype,`i18nStore`,void 0),j([i({type:Boolean})],F.prototype,`isMobile`,void 0),j([i({type:Boolean})],F.prototype,`isOpen`,void 0),j([i({type:Boolean,reflect:!0})],F.prototype,`collapsed`,void 0),j([i({type:Boolean,reflect:!0})],F.prototype,`suppressHover`,void 0),j([i({type:Boolean,reflect:!0})],F.prototype,`isHovered`,void 0),j([i({type:Number})],F.prototype,`width`,void 0),j([i({type:Boolean})],F.prototype,`hideFooterDivider`,void 0),j([_()],F.prototype,`isDragging`,void 0),F=j([a(`alps-sidebar`)],F);var _t=o`
  .btn-cancel {
    background: transparent;
    border: none;
    color: var(--text-muted, #6b7280);
...
`,vt=class extends p{constructor(...e){super(...e),this.title=``,this.isDanger=!1,this.dismissible=!1,this.width=`400px`,this._handleDialogClose=()=>{this.dispatchEvent(new CustomEvent(`cancel`,{bubbles:!0,composed:!0}))}}static{this.styles=o`
    .modal-dialog {
      position: fixed;
      inset: 0;
      margin: 0;
  ...
  `}firstUpdated(){let e=this.shadowRoot?.querySelector(`.modal-dialog`);e&&!e.open&&e.showModal()}_handleOverlayClick(e){this.dismissible?e.target===e.currentTarget&&(e.stopPropagation(),this.dispatchEvent(new CustomEvent(`cancel`,{bubbles:!0,composed:!0}))):e.stopPropagation()}render(){return s`
    ...
    `}};j([i({type:String})],vt.prototype,`title`,void 0),j([i({type:Boolean})],vt.prototype,`isDanger`,void 0),j([i({type:Boolean})],vt.prototype,`dismissible`,void 0),j([i({type:String})],vt.prototype,`width`,void 0),vt=j([a(`ui-modal`)],vt);var yt=class extends p{constructor(...e){super(...e),this.title=`Prompt`,this.fields=[],this.confirmText=`Apply`,this.cancelText=`Cancel`,this.values={}}static{this.styles=[_t,o`
      .field-group {
        margin-bottom: 16px;
      }
    ...
    `}};j([i({type:String})],yt.prototype,`title`,void 0),j([i({type:Array})],yt.prototype,`fields`,void 0),j([i({type:String})],yt.prototype,`confirmText`,void 0),j([i({type:String})],yt.prototype,`cancelText`,void 0),j([_()],yt.prototype,`values`,void 0),yt=j([a(`ui-prompt`)],yt);var bt=class extends p{constructor(...e){super(...e),this.text=``,this.fullHeight=!1}static{this.styles=o`
    :host {
      display: inline-flex;
      align-items: center;
      justify-content: center;
  ...
  `}render(){return s`
    ...
    `}};j([i({type:String})],bt.prototype,`text`,void 0),j([i({type:Boolean,attribute:`full-height`})],bt.prototype,`fullHeight`,void 0),bt=j([a(`alps-loader`)],bt);var xt=class extends p{constructor(...e){super(...e),this.hidden=!1}static{this.styles=o`
    :host {
      position: absolute;
      inset: 0;
      background: var(--bg-primary, #ffffff);
  ...
  `}render(){return s`<alps-loader></alps-loader>`}};j([i({type:Boolean,reflect:!0})],xt.prototype,`hidden`,void 0),xt=j([a(`alps-initial-loader`)],xt);var St=class extends p{constructor(...e){super(...e),this.collapsed=!1,this.icon=`plus`,this.text=``,this.disabled=!1,this.title=``}static{this.styles=o`
    :host {
      display: block;
      width: 100%;
    }
  ...
  `}render(){return s`
    ...
    `}};j([i({type:Boolean})],St.prototype,`collapsed`,void 0),j([i({type:String})],St.prototype,`icon`,void 0),j([i({type:String})],St.prototype,`text`,void 0),j([i({type:Boolean})],St.prototype,`disabled`,void 0),j([i({type:String})],St.prototype,`title`,void 0),St=j([a(`alps-create-button`)],St);var I=class extends p{constructor(...e){super(...e),this.contacts=[],this.uniqueCategories=[],this.selectedCategory=``,this.filterQuery=``,this.sidebarCollapsed=!1,this.isSidebarHovered=!1,this.suppressSidebarHover=!1,this.isMobile=!1,this.activeKebabMenu=null,this.sidebarScrolled=!1}static{this.styles=[ft,o`
    :host {
      display: flex;
      flex-direction: column;
      flex: 1;
  ...
  `}render(){return s`
    ...
    `}};j([i({type:String})],wt.prototype,`name`,void 0),j([i({type:String})],wt.prototype,`color`,void 0),wt=j([a(`alps-tag`)],wt);var Tt=class extends p{constructor(...e){super(...e),this.currentPage=0,this.totalItems=0,this.itemsPerPage=50,this._handleStoreChange=()=>{this.requestUpdate()}}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.i18nStore?.addEventListener(`change`,this._handleStoreChange)})}disconnectedCallback(){super.disconnectedCallback(),this.i18nStore?.removeEventListener(`change`,this._handleStoreChange)}static{this.styles=o`
    :host {
      display: block;
    }
  ...
  `}changePage(e){let t=this.currentPage+e;t>=0&&t<Math.ceil(this.totalItems/this.itemsPerPage)&&this.dispatchEvent(new CustomEvent(`change-page`,{detail:{page:t},bubbles:!0,composed:!0}))}render(){let e=this.currentPage*this.itemsPerPage+1,t=Math.min((this.currentPage+1)*this.itemsPerPage,this.totalItems);return s`
    ...
    `}};j([i({type:Number})],Tt.prototype,`currentPage`,void 0),j([i({type:Number})],Tt.prototype,`totalItems`,void 0),j([i({type:Number})],Tt.prototype,`itemsPerPage`,void 0),j([f({context:C})],Tt.prototype,`i18nStore`,void 0),Tt=j([a(`alps-pagination`)],Tt);var Et=class extends p{constructor(...e){super(...e),this.scrolled=!1}static{this.styles=o`
    :host {
      display: flex;
      align-items: center;
      height: 57px;
  ...
  `}render(){return s`<slot></slot>`}};j([i({type:Boolean,reflect:!0})],Et.prototype,`scrolled`,void 0),Et=j([a(`alps-toolbar`)],Et);var Dt=class extends p{constructor(...e){super(...e),this.variant=`info`}static{this.styles=o`
    :host {
      display: block;
      position: sticky;
      top: 0;
  ...
  `}render(){return s`
    ...
    `}};j([i({type:String,reflect:!0})],Dt.prototype,`variant`,void 0),Dt=j([a(`alps-banner`)],Dt);var Ot=class extends p{constructor(...e){super(...e),this.title=`Confirm`,this.message=`Are you sure?`,this.confirmText=`Confirm`,this.cancelText=`Cancel`,this.isDanger=!1,this.dismissible=!1}static{this.styles=[_t]}_handleCancel(e){e.stopPropagation(),this.dispatchEvent(new CustomEvent(`cancel`,{bubbles:!0,composed:!0}))}_handleSecondary(e){e.stopPropagation(),this.dispatchEvent(new CustomEvent(`secondary`,{bubbles:!0,composed:!0}))}_handleConfirm(e){e.stopPropagation(),this.dispatchEvent(new CustomEvent(`confirm`,{bubbles:!0,composed:!0}))}render(){return s`
      <ui-modal 
        .title=${this.title}
        ...
        <alps-toolbar class="list-header" ?scrolled=${this.isScrolled}>
          ...
          ${this.sidebarCollapsed?s`
            <div class="current-mailbox-label">
              ${Ve(this.currentMailbox,this.i18nStore)}
            </div>
            <div class="spacer"></div>
          `:``}
          <alps-pagination 
  ...
  `]}formatRevision(e){if(!e)return``;let t=e;t.length===16&&t.indexOf(`-`)===-1&&(t=`${t.slice(0,4)}-${t.slice(4,6)}-${t.slice(6,8)}T${t.slice(9,11)}:${t.slice(11,13)}:${t.slice(13,16)}`);let n=this.settingsStore?.getState()?.dateFormat||`YYYY-MM-DD`,r=String(this.settingsStore?.getState()?.hourFormat||`12`);return ze(new Date(t),n,r)}handleKeyDown(e){let t=this.getFilteredContacts();if(t.length!==0){if(e.key===`ArrowDown`)e.preventDefault(),this.focusedIndex=Math.min(t.length-1,this.focusedIndex+1),this.scrollToFocused();else if(e.key===`ArrowUp`)e.preventDefault(),this.focusedIndex=Math.max(0,this.focusedIndex-1),this.scrollToFocused();else if(e.key===`Enter`)e.preventDefault(),this.focusedIndex>=0&&this.focusedIndex<t.length&&this.dispatchEvent(new CustomEvent(`select-contact`,{detail:{contact:t[this.focusedIndex]}}));else if(e.key===` `&&(e.preventDefault(),this.focusedIndex>=0&&this.focusedIndex<t.length)){let n=t[this.focusedIndex];n.isTemporary||this.dispatchEvent(new CustomEvent(`toggle-selection`,{detail:{path:n.path,event:e}})),this.focusedIndex=Math.min(t.length-1,this.focusedIndex+1),this.scrollToFocused()}}}scrollToFocused(){this.updateComplete.then(()=>{let e=this.renderRoot.querySelector(`.contact-item.focused`);e&&e.scrollIntoView({block:`nearest`})})}handleListScroll(e){let t=e.target.scrollTop>0;this.listScrolled!==t&&(this.listScrolled=t,this.dispatchEvent(new CustomEvent(`list-scrolled`,{detail:{scrolled:t}})))}render(){return s`
    ...
    `}};j([f({context:C})],R.prototype,`i18nStore`,void 0),j([f({context:w})],R.prototype,`settingsStore`,void 0),j([i({type:Array})],R.prototype,`contacts`,void 0),j([i({type:String})],R.prototype,`selectedCategory`,void 0),j([i({type:String})],R.prototype,`filterQuery`,void 0),j([i({type:String})],R.prototype,`sortOrder`,void 0),j([i({type:Boolean})],R.prototype,`showOnlyStarred`,void 0),j([i({type:Boolean})],R.prototype,`isMobile`,void 0),j([i({type:String})],R.prototype,`densityMode`,void 0),j([i({type:Object})],R.prototype,`selectedContacts`,void 0),j([i({type:Object})],R.prototype,`selectedContact`,void 0),j([i({type:Boolean})],R.prototype,`isSpinning`,void 0),j([i({type:Boolean})],R.prototype,`loading`,void 0),j([i({type:Boolean})],R.prototype,`listScrolled`,void 0),j([_()],R.prototype,`focusedIndex`,void 0),R=j([a(`alps-contacts-list`)],R);var z=class extends p{constructor(...e){super(...e),this.mailboxes=[],this.currentMailbox=``,this.expandedFolders=new Set,this.layoutMode=`vertical`,this.syncing=!1,this.collapsed=!1,this.isScrolled=!1,this.showCreatePrompt=!1,this.showRenamePrompt=!1,this.mailboxToRename=``,this.showDeleteConfirm=!1,this.showMoveToTrashConfirm=!1,this.mailboxToDelete=``,this.parentForNewFolder=``,this.activeKebabMenu=null,this._handleStoreChange=()=>{this.requestUpdate()},this.handleScroll=e=>{let t=e.target;this.isScrolled=t.scrollTop>0}}willUpdate(e){super.willUpdate(e)}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.composeStore&&this.composeStore.addEventListener(`change`,this._handleStoreChange),this.i18nStore&&this.i18nStore.addEventListener(`change`,this._handleStoreChange)})}disconnectedCallback(){super.disconnectedCallback(),this.composeStore&&this.composeStore.removeEventListener(`change`,this._handleStoreChange),this.i18nStore?.removeEventListener(`change`,this._handleStoreChange)}static{this.styles=[ft,o`
    :host {
      display: flex;
      flex-direction: column;
      flex: 1;
  ...
  `]}toggleFolder(e,t){e&&e.stopPropagation(),this.dispatchEvent(new CustomEvent(`toggle-folder`,{detail:{folderName:t}}))}selectMailbox(e){this.dispatchEvent(new CustomEvent(`select-mailbox`,{detail:{name:e}}))}triggerCreateFolder(){this.parentForNewFolder=``,this.showCreatePrompt=!0}handleCreateSubmit(e){let t=e.detail.name;if(t){if(this.parentForNewFolder){let e=this.mailboxes.find(e=>(e.Name||e.Mailbox)===this.parentForNewFolder),n=`.`;if(e){let t=e.Delimiter||e.Delim;n=typeof t==`number`?String.fromCharCode(t):t||`.`}t=`${this.parentForNewFolder}${n}${t}`,this.dispatchEvent(new CustomEvent(`expand-folder`,{detail:{folderName:this.parentForNewFolder}}))}Ct.createMailbox(t)}this.showCreatePrompt=!1,this.parentForNewFolder=``}async handleRenameSubmit(e){let t=e.detail.name;if(t&&this.mailboxToRename){let e=this.mailboxToRename;this.showRenamePrompt=!1,this.mailboxToRename=``,await Ct.renameMailbox(e,t)&&(this.currentMailbox===e&&this.selectMailbox(t),this.dispatchEvent(new CustomEvent(`toast`,{detail:{message:this.i18nStore?.t(`toast.folderRenamed`),actionLabel:this.i18nStore?.t(`toast.undo`),actionFn:async()=>{await Ct.renameMailbox(t,e),this.currentMailbox===t&&this.selectMailbox(e)},duration:5e3},bubbles:!0,composed:!0})))}else this.showRenamePrompt=!1,this.mailboxToRename=``}async handleDeleteConfirm(){this.mailboxToDelete&&await Ct.deleteMailbox(this.mailboxToDelete)&&(this.currentMailbox.startsWith(this.mailboxToDelete)&&this.selectMailbox(T),this.dispatchEvent(new CustomEvent(`toast`,{detail:{message:this.i18nStore?.t(`toast.folderPermanentlyDeleted`),duration:3e3},bubbles:!0,composed:!0}))),this.showDeleteConfirm=!1,this.mailboxToDelete=``}async handleMoveToTrashConfirm(){if(this.mailboxToDelete){let e=this.mailboxes.find(e=>(e.Name||e.Mailbox)===this.mailboxToDelete),t=`.`;if(e){let n=e.Delimiter||e.Delim;t=typeof n==`number`?String.fromCharCode(n):n||`.`}let n=this.mailboxToDelete.split(t),r=n[n.length-1],i=`Trash${t}${r}`;if(await Ct.renameMailbox(this.mailboxToDelete,i)){this.currentMailbox.startsWith(this.mailboxToDelete)&&this.selectMailbox(T);let e=this.mailboxToDelete;this.dispatchEvent(new CustomEvent(`toast`,{detail:{message:this.i18nStore?.t(`toast.folderMovedToTrash`),actionLabel:this.i18nStore?.t(`toast.undo`),actionFn:async()=>{await Ct.renameMailbox(i,e)},duration:5e3},bubbles:!0,composed:!0}))}}this.showMoveToTrashConfirm=!1,this.mailboxToDelete=``}render(){let e=[T,je,Me,Ne,Pe,Fe,Ie,Le],t={[T]:{icon:`tray`,colorClass:`icon-inbox`,label:this.i18nStore?.t(`folderList.inbox`)},[je]:{icon:`fileText`,colorClass:`icon-drafts`,label:this.i18nStore?.t(`folderList.drafts`)},[Me]:{icon:`paperPlaneTilt`,colorClass:`icon-sent`,label:this.i18nStore?.t(`folderList.sent`)},[Ne]:{icon:`archiveBox`,colorClass:`icon-archive`,label:this.i18nStore?.t(`folderList.archive`)},[Pe]:{icon:`archiveBox`,colorClass:`icon-archive`,label:this.i18nStore?.t(`folderList.archive`)},[Fe]:{icon:`warningDiamond`,colorClass:`icon-spam`,label:this.i18nStore?.t(`folderList.spam`)},[Ie]:{icon:`warningDiamond`,colorClass:`icon-spam`,label:this.i18nStore?.t(`folderList.junk`)},[Le]:{icon:`trash`,colorClass:`icon-trash`,label:this.i18nStore?.t(`folderList.trash`)}},n={};this.mailboxes.forEach(e=>{let t=e.Name||e.Mailbox||``,r=e.Delimiter||e.Delim,i=typeof r==`number`?String.fromCharCode(r):r||`.`,a=t.split(i),o=n,s=``;for(let t=0;t<a.length;t++){let n=a[t];s=t===0?n:s+i+n,o[n]||(o[n]={name:n,fullName:s,children:{}}),t===a.length-1&&(o[n].mb=e),o=o[n].children}});let r=[],i=[];Object.values(n).forEach(t=>{e.includes(t.name)?r.push(t):i.push(t)}),r.sort((t,n)=>e.indexOf(t.name)-e.indexOf(n.name)),i.sort((e,t)=>e.name.localeCompare(t.name));let a=(n,r=0)=>n.map(n=>{let i=Object.keys(n.children).length>0,o=this.expandedFolders.has(n.fullName),c=this.currentMailbox===n.fullName,l=E(`folder`),u=`icon-default`,d=n.name;r===0&&t[n.name]&&(l=E(t[n.name].icon),u=t[n.name].colorClass,d=t[n.name].label);let f=n.mb?.Unseen||0,p=(n.mb?.Attrs||[]).some(e=>typeof e==`string`&&e.toLowerCase()===`\\noselect`),m=e=>{p?i&&this.toggleFolder(e,n.fullName):this.selectMailbox(n.fullName)},h=r>0||!e.includes(n.name);return s`
            ...
            ${h?s`
              <div class="folder-actions ${this.activeKebabMenu===n.fullName?`popup-open`:``}" @click=${e=>e.stopPropagation()}>
                ...
                >
                  ...
                  <button class="dropdown-item" @click=${e=>{let t=e.target.closest(`alps-popup`);t&&t.close(),n.mb?.Subscribed?Ct.unsubscribeMailbox(n.fullName):Ct.subscribeMailbox(n.fullName)}}>
      ...
      ${this.showDeleteConfirm?s`
        ...
        ></ui-confirm>
      `:``}
    `}};j([f({context:ct})],z.prototype,`composeStore`,void 0),j([f({context:C})],z.prototype,`i18nStore`,void 0),j([i({type:Array})],z.prototype,`mailboxes`,void 0),j([i({type:String})],z.prototype,`currentMailbox`,void 0),j([i({type:Object})],z.prototype,`expandedFolders`,void 0),j([i({type:String})],z.prototype,`layoutMode`,void 0),j([i({type:Boolean})],z.prototype,`syncing`,void 0),j([i({type:Boolean,reflect:!0})],z.prototype,`collapsed`,void 0),j([_()],z.prototype,`isScrolled`,void 0),j([_()],z.prototype,`showCreatePrompt`,void 0),j([_()],z.prototype,`showRenamePrompt`,void 0),j([_()],z.prototype,`mailboxToRename`,void 0),j([_()],z.prototype,`showDeleteConfirm`,void 0),j([_()],z.prototype,`showMoveToTrashConfirm`,void 0),j([_()],z.prototype,`mailboxToDelete`,void 0),j([_()],z.prototype,`parentForNewFolder`,void 0),j([_()],z.prototype,`activeKebabMenu`,void 0),z=j([a(`alps-folder-list`)],z);var kt=class extends p{constructor(...e){super(...e),this.name=``,this.address=``}static{this.styles=o`
    :host {
      display: inline;
    }
  ...
  `}handleClick(){this.composeStore.openComposer({to:[this.address]})}render(){let e=this.name;return e===this.address&&(e=``),e?s`
      ...
      `}};j([f({context:ct})],kt.prototype,`composeStore`,void 0),j([i({type:String})],kt.prototype,`name`,void 0),j([i({type:String})],kt.prototype,`address`,void 0),kt=j([a(`alps-recipient-pill`)],kt);var At=class extends p{constructor(...e){super(...e),this.attachment=null,this.downloadUrl=``,this.fallbackName=`Unknown attachment`,this.removable=!1,this.compact=!1}static{this.styles=o`
    .attachment-chip {
      display: inline-flex;
      align-items: center;
      width: 100%;
  ...
  `}_handleRemove(e){e.preventDefault(),e.stopPropagation(),this.dispatchEvent(new CustomEvent(`remove-attachment`,{bubbles:!0,composed:!0,detail:{attachment:this.attachment}}))}render(){if(!this.attachment)return s``;let e=this.attachment.Filename||this.attachment.filename||this.attachment.name||this.fallbackName,t=this.attachment.Size||this.attachment.size||0,n=this.attachment.uploading,r=this.attachment.progress||0,i=s`
      ...
      <span class="attachment-size">${n?`${r}% of ${He(t)}`:He(t)}</span>
      ${this.removable?s`
  ...
  `}render(){return!this.attachments||this.attachments.length===0?s``:s`
    ...
    `}};j([f({context:C})],jt.prototype,`i18nStore`,void 0),j([i({type:Array})],jt.prototype,`attachments`,void 0),j([i({type:String})],jt.prototype,`mailbox`,void 0),j([i({type:String})],jt.prototype,`messageUid`,void 0),j([i({type:Boolean})],jt.prototype,`removable`,void 0),j([i({type:Boolean,reflect:!0})],jt.prototype,`composerMode`,void 0),j([_()],jt.prototype,`attachmentsExpanded`,void 0),jt=j([a(`alps-attachment-list`)],jt);var B=class extends p{constructor(...e){super(...e),this.mailboxes=[],this.currentMailbox=``,this.noActionBox=!1,this.noSearchBox=!1,this.filterQuery=``,this.isMove=!0}static{this.styles=o`
    :host {
      display: inline-block;
    }
...
`),_=``;return _=i&&r?e===`forward`?`<br><br><div class="gmail_quote"><div dir="ltr" class="gmail_attr">---------- Forwarded message ---------<br>From: ${m} &lt;${p}&gt;<br>Date: ${d}<br>Subject: ${s}<br>To: ${It(t?.Envelope?.To).join(`, `)}<br></div><br>${r}</div>`:`<br><br><div class="gmail_quote"><div dir="ltr" class="gmail_attr">On ${d}, ${m} wrote:<br></div><blockquote class="gmail_quote" style="margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);padding-left:1ex">${r}</blockquote></div>`:`<br><br><div class="gmail_quote"><div dir="ltr" class="gmail_attr">${h.replace(/\n/g,`<br>`)}<br></div><blockquote class="gmail_quote" style="margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);padding-left:1ex">${n.replace(/\n/g,`<br>`)}</blockquote></div>`,{subject:c,to:l,cc:u,quotedText:g,quotedHtml:_}}var V=class extends p{constructor(...e){super(...e),this.localPreferredView=null,this.hasHtml=!1,this.hasText=!1,this.mailbox=T,this.message=null,this.selectedUids=new Set,this.allSelectedStarred=!1,this.allSelectedUnread=!1,this.commonTags=[],this.bulkProcessing=!1,this.layoutMode=`vertical`,this.mailboxes=[],this.content=``,this.mimeType=``,this.loading=!1,this.hasRemoteResources=!1,this.allowRemoteResources=!1,this.attachments=[],this.rawMessageHtml=``,this.isScrolled=!1,this.handleScroll=e=>{let t=e.target;this.isScrolled=t.scrollTop>0}}_closePopup(){let e=this.shadowRoot?.querySelectorAll(`alps-popup`);e&&e.forEach(e=>e.close())}async _handleAction(e,t){if(e===`reply`||e===`replyAll`||e===`forward`){if(!this.message)return;this._closePopup();let t=``;if(this.mimeType===`text/plain`)t=this.content;else{try{let e=await y(`/mailboxes/${encodeURIComponent(this.mailbox)}/messages/${this.message.UID}?view=text`);if(e.ok){let n=await e.json();n.Part&&n.RawText&&(t=n.RawText)}}catch(e){x.error(`Failed to fetch text body for quote`,e)}if(!t&&this.rawMessageHtml){let e=document.createElement(`div`);e.innerHTML=this.rawMessageHtml,t=e.innerText||``}}let n=this.settingsStore?.getState()?.dateFormat||`YYYY-MM-DD`,r=String(this.settingsStore?.getState()?.hourFormat||`12`),{subject:i,to:a,cc:o,quotedText:s,quotedHtml:c}=Lt(e,this.message,t,this.rawMessageHtml,this.hasHtml,n,r),l=e===`forward`?this.attachments.map(e=>({name:e.Filename||`attachment`,size:e.Size||0,type:e.MIMEType||`application/octet-stream`,partPath:e.Path?e.Path.join(`.`):void 0})):[],u=e===`reply`||e===`replyAll`?this.message.Envelope?.MessageId:void 0;this.composeStore.openComposer({subject:i,to:a,cc:o,text:s,html:c,format:this.settingsStore?.getState()?.composeFormat||`html`,attachments:l,inReplyTo:u});return}if(e===`showPlaintext`){this.localPreferredView=`text`,this.message&&this.fetchMessageBody(this.message),this._closePopup();return}if(e===`showHtml`){this.localPreferredView=`html`,this.message&&this.fetchMessageBody(this.message),this._closePopup();return}if(e===`print`){let e=this.allowRemoteResources?`&remote=1`:``;window.open(`#/print?mailbox=`+encodeURIComponent(this.mailbox)+`&uid=`+this.message.UID+e,`_blank`),this._closePopup();return}this._closePopup(),this.dispatchEvent(new CustomEvent(`action`,{detail:{action:e,folder:t}}))}_handleTag(e){this._closePopup();let t=this.selectedUids.size>1&&!this.message?this.commonTags?.some(t=>t.toLowerCase()===e.toLowerCase()):this.message?.Flags?.some(t=>t.toLowerCase()===e.toLowerCase());this.dispatchEvent(new CustomEvent(`action`,{detail:{action:t?`removeTag`:`addTag`,folder:e}}))}_handleRemoveAllTags(){this._closePopup(),this.dispatchEvent(new CustomEvent(`action`,{detail:{action:`removeTag`,tags:[`$label1`,`$label2`,`$label3`,`$label4`,`$label5`]}}))}static{this.styles=[ft,o`
  ...
  `]}willUpdate(e){let t=e.has(`message`),n=e.has(`mailbox`);if(t||n){let t=e.get(`message`),n=e.has(`mailbox`)?e.get(`mailbox`):this.mailbox;this.message?!t||t.UID!==this.message.UID||n!==this.mailbox?(this.localPreferredView=null,this.fetchMessageBody(this.message,this.message._isAutosaveUpdate)):this.message._isAutosaveUpdate&&t&&this.message!==t&&this.fetchMessageBody(this.message,!0):(this.localPreferredView=null,this.content=``,this.mimeType=``,this.rawMessageHtml=``,this.loading=!1,this.allowRemoteResources=!1,this.hasRemoteResources=!1,this.hasHtml=!1,this.hasText=!1)}}loadRemoteResources(){this.allowRemoteResources=!0,this.rawMessageHtml&&(this.content=Ft(this.rawMessageHtml,{mailbox:this.mailbox,messageUid:this.message?.UID,allowRemoteResources:this.allowRemoteResources,messageStructure:this.message?.BodyStructure,onRemoteResourceBlocked:()=>{this.hasRemoteResources=!0}}))}async fetchMessageBody(e,t=!1){t||(this.content=``,this.mimeType=``,this.rawMessageHtml=``,this.loading=!0,this.allowRemoteResources=this.settingsStore?.getState().showRemoteContent===`always`,this.hasRemoteResources=!1);let n=this.localPreferredView||this.settingsStore?.getState()?.preferredView||`html`;try{let t=Ge.get(this.mailbox,e.UID.toString(),n);if(t){this.attachments=t.Attachments||[],this.hasHtml=t.HasHTML||!1,this.hasText=t.HasText||!1,t.Message&&(this.message={...this.message,...t.Message,...e}),t.Part&&(this.mimeType=t.Part.MIMEType||t.Part.MimeType||`text/plain`,t.RawHtml===void 0?t.RawText!==void 0&&(this.content=t.RawText):(this.rawMessageHtml=t.RawHtml,this.content=Ft(this.rawMessageHtml,{mailbox:this.mailbox,messageUid:this.message?.UID,allowRemoteResources:this.allowRemoteResources,messageStructure:this.message?.BodyStructure,onRemoteResourceBlocked:()=>{this.hasRemoteResources=!0}}))),this.loading=!1;return}let r=await y(`/mailboxes/${encodeURIComponent(this.mailbox)}/messages/${e.UID}?view=${n}`);if(r.status===401){window.location.hash=`/login`;return}if(!r.ok)throw Error(`Failed to fetch metadata`);let i=await r.json();this.attachments=i.Attachments||[],this.hasHtml=!!i.HasHTML,this.hasText=!!i.HasText,i.Message&&(this.message={...this.message,...i.Message});let a,o,s=i.Part;if(s){this.mimeType=s.MIMEType||s.MimeType||`text/plain`;let t=Array.isArray(s.Path)?s.Path.join(`.`):s.Path,n=await y(`/mailboxes/${encodeURIComponent(this.mailbox)}/messages/${e.UID}/raw?part=${t}`);if(n.status===401){window.location.hash=`/login`;return}n.ok&&(this.mimeType.toLowerCase()===`text/html`?(a=await n.text(),this.rawMessageHtml=a,this.content=Ft(this.rawMessageHtml,{mailbox:this.mailbox,messageUid:this.message?.UID,allowRemoteResources:this.allowRemoteResources,messageStructure:this.message?.BodyStructure,onRemoteResourceBlocked:()=>{this.hasRemoteResources=!0}})):(o=await n.text(),this.content=o))}Ge.set(this.mailbox,e.UID.toString(),n,{Message:i.Message,Part:i.Part,Attachments:i.Attachments,RawHtml:a,RawText:o,HasHTML:this.hasHtml,HasText:this.hasText})}catch(e){x.error(`Failed to fetch message:`,e),this.content=`Error loading message.`}finally{this.loading=!1}}onIframeLoad(e){let t=e.target;if(!t.contentDocument||!t.contentDocument.body)return;t.style.height=`0px`,t.style.width=`100%`,t.contentDocument.addEventListener(`dragover`,e=>e.preventDefault()),t.contentDocument.addEventListener(`drop`,e=>e.preventDefault()),t._ro&&t._ro.disconnect();let n=0,r=new ResizeObserver(e=>{let r=0,i=0;for(let a of e)a.target===t.parentElement?n=a.contentRect.width:t.contentDocument&&a.target===t.contentDocument.body&&(a.borderBoxSize&&a.borderBoxSize.length>0?(r=a.borderBoxSize[0].blockSize,i=a.borderBoxSize[0].inlineSize):(r=a.contentRect.height+48,i=a.contentRect.width+48));if(r>0){let e=parseFloat(t.style.height)||0;Math.abs(e-r)>2&&(t.style.height=`${Math.ceil(r)}px`)}if(n>0&&i>n){let e=parseFloat(t.style.width)||0;Math.abs(e-i)>2&&(t.style.width=`${Math.ceil(i)}px`)}});r.observe(t.contentDocument.body),t.parentElement&&r.observe(t.parentElement),t._ro=r}async _handleEditDraft(){if(!this.message)return;let e=``;if(this.mimeType===`text/plain`)e=this.content;else{try{let t=await y(`/mailboxes/${encodeURIComponent(this.mailbox)}/messages/${this.message.UID}?view=text`);if(t.ok){let n=await t.json();n.Part&&n.RawText&&(e=n.RawText)}}catch(e){x.error(`Failed to fetch text body for draft`,e)}if(!e){let t=document.createElement(`div`);t.innerHTML=this.rawMessageHtml,e=t.innerText||``}}let t=this.attachments.map(e=>({name:e.Filename||`attachment`,size:e.Size||0,type:e.MIMEType||`application/octet-stream`,partPath:e.Path?e.Path.join(`.`):void 0})),n=e=>e?e.map(e=>e.Name?`${e.Name} <${e.Mailbox}@${e.Host}>`:`${e.Mailbox}@${e.Host}`):[];this.composeStore.openComposer({draftUid:this.message.UID.toString(),draftMailbox:this.mailbox,subject:this.message.Envelope?.Subject||``,to:n(this.message.Envelope?.To),cc:n(this.message.Envelope?.Cc),bcc:n(this.message.Envelope?.Bcc),text:e,html:this.rawMessageHtml,format:this.settingsStore?.getState()?.composeFormat||`html`,attachments:t})}render(){let e=this.selectedUids&&this.selectedUids.size>0;if(!this.message&&!e)return s`
        ...
        <alps-popup align="left" class="tags-popup">
          ...
          ${[`$label1`,`$label2`,`$label3`,`$label4`,`$label5`].map(t=>s`
              <button class="dropdown-item ${(e?this.commonTags?.some(e=>e.toLowerCase()===t.toLowerCase()):this.message?.Flags?.some(e=>e.toLowerCase()===t.toLowerCase()))?`active`:``}" @click=${()=>this._handleTag(t)}>
                <span style="display:inline-block;width:12px;height:12px;border-radius:50%;background:${rt(t)};margin-right:12px;opacity:0.9;"></span>
                <span class="item-text">${nt(t,this.i18nStore)}</span>
              </button>
            `)}
          <div class="dropdown-divider"></div>
        ...
        <div class="reader-body" @scroll=${this.handleScroll}>
          ...
          <div class="reader-subject">
            ...
            <div class="mobile-date-container">
              ...
              ${n.RFC822Size?s`<div class="reader-size mobile-size">${He(n.RFC822Size)}</div>`:``}
            </div>
          ...
          <div class="reader-meta">
            <div class="reader-sender-block">
              ...
              <div class="desktop-date-container">
                ...
                ${n.RFC822Size?s`<div class="reader-size desktop-only">${He(n.RFC822Size)}</div>`:``}
              </div>
            </div>
    ...
    .layout-vertical alps-sidebar.desktop-sidebar { width: var(--sidebar-width, ${zt}px); flex-shrink: 0; }
    ...
    .layout-horizontal alps-sidebar.desktop-sidebar { width: var(--sidebar-width, ${zt}px); flex-shrink: 0; }
    ...
    .layout-full alps-sidebar.desktop-sidebar { width: var(--sidebar-width, ${zt}px); flex-shrink: 0; }
    ...
    `}showGlobalToast(e,t=``,n,r=3e3){window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:e,actionLabel:t,actionFn:n,duration:r}}))}get effectiveListWidth(){let e=this.sidebarCollapsed&&!this.isMobile?Ht:this.sidebarWidth;return Math.max(Wt,this.resizerPositionX-e)}get allSelectedStarred(){if(this.selectedUids.size===0)return!1;for(let e of this.selectedUids){let t=this.messages.find(t=>String(t.UID)===e);if(!t||!t.Flags?.includes(`\\Flagged`))return!1}return!0}get commonSelectedTags(){return this.selectedUids.size===0?[]:[`$label1`,`$label2`,`$label3`,`$label4`,`$label5`].filter(e=>{for(let t of this.selectedUids){let n=this.messages.find(e=>String(e.UID)===t);if(!n||!n.Flags?.some(t=>t.toLowerCase()===e.toLowerCase()))return!1}return!0})}get allSelectedUnread(){if(this.selectedUids.size===0)return!1;for(let e of this.selectedUids){let t=this.messages.find(t=>String(t.UID)===e);if(t&&t.Flags?.includes(`\\Seen`))return!1}return!0}connectedCallback(){super.connectedCallback(),this.extractMailboxFromHash(),window.addEventListener(`hashchange`,this.handleHashChange),document.addEventListener(`click`,this.unlockAudio),document.addEventListener(`keydown`,this.unlockAudio),this._mql.addEventListener(`change`,this._handleMediaQuery),this._handleMediaQuery(this._mql),this.settingsStore.addEventListener(`change`,this._handleSettingsChange),this._syncSettings(),D.addEventListener(`sync-start`,this.handleSyncStart),D.addEventListener(`sync-success`,this.handleSyncSuccess),D.addEventListener(`sync-error`,this.handleSyncError),D.addEventListener(`mailbox-not-found`,this.handleMailboxNotFound),window.addEventListener(`draft-autosaved`,this.handleDraftAutosaved),D.fetch(this.currentMailbox,this.currentPage,this.filterQuery,!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener(`hashchange`,this.handleHashChange),this._mql.removeEventListener(`change`,this._handleMediaQuery),document.removeEventListener(`click`,this.unlockAudio),document.removeEventListener(`keydown`,this.unlockAudio),this.settingsStore.removeEventListener(`change`,this._handleSettingsChange),this.i18nStore?.removeEventListener(`change`,this._handleI18nChange),D.removeEventListener(`sync-start`,this.handleSyncStart),D.removeEventListener(`sync-success`,this.handleSyncSuccess),D.removeEventListener(`sync-error`,this.handleSyncError),D.removeEventListener(`mailbox-not-found`,this.handleMailboxNotFound),window.removeEventListener(`draft-autosaved`,this.handleDraftAutosaved),D.stop()}_syncSettings(){let e=this.settingsStore.getState();this.layoutMode=e.layoutMode,this.densityMode=e.densityMode,this.sortOrder=e.sortOrder||`desc`,this.sidebarCollapsed!==e.sidebarCollapsed&&(this.sidebarCollapsed=e.sidebarCollapsed),e.messagesPerPage&&e.messagesPerPage>0&&(this.messagesPerPage=e.messagesPerPage),e.checkMailInterval!==void 0&&D.start(e.checkMailInterval)}openFolderPrompt(){let e=this.shadowRoot?.querySelector(`alps-folder-list`);e&&typeof e.triggerCreateFolder==`function`&&e.triggerCreateFolder()}updateUrl(e,t,n,r=this.filterQuery){let i=`#/mailbox/${encodeURIComponent(e)}`,a=new URLSearchParams;t>0&&a.set(`p`,t.toString()),n&&a.set(`uid`,n),r&&a.set(`q`,r);let o=a.toString();o&&(i+=`?`+o),window.location.hash=i}extractMailboxFromHash(){let e=window.location.hash;if(e.startsWith(`#/mailbox/`)){let t=e.substring(10),n=t.indexOf(`?`),r=``;n!==-1&&(r=t.substring(n+1),t=t.substring(0,n));let i=t.split(`/`);this.currentMailbox=decodeURIComponent(i[0]);let a=new URLSearchParams(r);i.length>1&&i[1]?this.targetUid=i[1]:this.targetUid=a.get(`uid`)||null;let o=a.get(`p`);o?this.currentPage=parseInt(o,10)||0:this.currentPage=0,this.filterQuery=a.get(`q`)||``}else this.currentMailbox=T,this.targetUid=null,this.currentPage=0}async applyTargetUid(){if(!this.targetUid){this.markReadTimer&&=(clearTimeout(this.markReadTimer),null),this.selectedMessage=null;return}let e=this.targetUid,t=this.messages.find(t=>String(t.UID)===e);if(!t&&this.messages.length>0)try{let n=await y(`/mailboxes/${encodeURIComponent(this.currentMailbox)}/messages/${e}`);if(n.ok){let e=await n.json();e.Message&&(t=e.Message)}}catch(e){x.error(`Failed to fetch shifted message:`,e)}this.targetUid===e&&(t?this.selectedMessage?.UID!==t.UID&&(this.selectedMessage=t,this.layoutMode===`full`&&this.expandedFolders.clear(),this._scheduleMarkAsRead(t)):this.messages.length>0&&(this.selectedMessage=null,this.updateUrl(this.currentMailbox,this.currentPage,null)))}async selectMessage(e){this.updateUrl(this.currentMailbox,this.currentPage,e.UID)}_scheduleMarkAsRead(e){if(this.markReadTimer&&=(clearTimeout(this.markReadTimer),null),e.Flags?.includes(`\\Seen`))return;let t=this.settingsStore?.getState().markReadTimeout??0;t<0||(t===0?this._doMarkAsRead(e):this.markReadTimer=setTimeout(()=>{this._doMarkAsRead(e)},t*1e3))}updateLocalMessageFlags(e,t,n){let r=!1,i=[...this.messages];for(let a=0;a<i.length;a++){let o=i[a];if(e.includes(String(o.UID))){let e=o.Flags&&o.Flags.includes(t);n===`add`&&!e?(i[a]={...o,Flags:[...o.Flags||[],t]},r=!0):n===`remove`&&e&&(i[a]={...o,Flags:o.Flags.filter(e=>e!==t)},r=!0)}}if(r&&(this.messages=i,this.selectedMessage&&e.includes(String(this.selectedMessage.UID)))){let e=this.selectedMessage.Flags&&this.selectedMessage.Flags.includes(t);n===`add`&&!e?this.selectedMessage.Flags=[...this.selectedMessage.Flags||[],t]:n===`remove`&&e&&(this.selectedMessage.Flags=this.selectedMessage.Flags.filter(e=>e!==t)),this.selectedMessage={...this.selectedMessage}}}async _handleListToggleStar(e){let t=e.detail.message,n=t.Flags&&t.Flags.includes(`\\Flagged`),r=n?`remove`:`add`;this.updateLocalMessageFlags([String(t.UID)],k,r);try{await A.setFlag(this.currentMailbox,[String(t.UID)],[`\\Flagged`],r)||this.updateLocalMessageFlags([String(t.UID)],k,n?`add`:`remove`)}catch{this.updateLocalMessageFlags([String(t.UID)],k,n?`add`:`remove`)}}async _doMarkAsRead(e){if(this.selectedMessage?.UID===e.UID)this.selectedMessage=await A.markAsRead(this.currentMailbox,e),this.updateLocalMessageFlags([String(this.selectedMessage.UID)],O,`add`);else{let t=await A.markAsRead(this.currentMailbox,e);t&&t.UID&&this.updateLocalMessageFlags([String(t.UID)],O,`add`)}}async _handleReaderAction(e){let t=e.detail.action,n=this.selectedUids&&this.selectedUids.size>0,r=n?Array.from(this.selectedUids):[];if(!(!n&&!this.selectedMessage?.UID)){n&&(this.bulkProcessing=!0);try{let i=this.selectedMessage,a=this.currentMailbox;if(t===`star`)if(n){let e=this.allSelectedStarred?`remove`:`add`;await A.setFlag(this.currentMailbox,r,[k],e),this.updateLocalMessageFlags(r,k,e)}else this.selectedMessage=await A.toggleStar(this.currentMailbox,this.selectedMessage),this.updateLocalMessageFlags([String(this.selectedMessage.UID)],k,this.selectedMessage.Flags?.includes(`\\Flagged`)?`add`:`remove`);else if(t===`addTag`||t===`removeTag`){let a=e.detail.tags||(e.detail.folder?[e.detail.folder]:[]);if(!a||a.length===0)return;let o=t===`addTag`?`add`:`remove`;if(n){await A.setFlag(this.currentMailbox,r,a,o);for(let e of a)this.updateLocalMessageFlags(r,e,o)}else{await A.setFlag(this.currentMailbox,[String(i.UID)],a,o);for(let e of a)this.updateLocalMessageFlags([String(i.UID)],e,o)}this.requestUpdate()}else if(t===`markUnread`)if(n){let e=this.allSelectedUnread?`add`:`remove`;await A.setFlag(this.currentMailbox,r,[O],e),this.updateLocalMessageFlags(r,O,e)}else !i?.Flags||!i.Flags.includes(`\\Seen`)?(this.selectedMessage=await A.markAsRead(this.currentMailbox,i),this.updateLocalMessageFlags([String(this.selectedMessage.UID)],O,`add`)):await A.markAsUnread(this.currentMailbox,i)&&(this.updateLocalMessageFlags([String(i.UID)],O,`remove`),this.selectedMessage=null,this.updateUrl(this.currentMailbox,this.currentPage,null));else if(t===`delete`||t===`archive`||t===`reportSpam`||t===`notSpam`){let e=this.currentMailbox.toLowerCase()===Le.toLowerCase(),o=this.currentMailbox.toLowerCase()===je.toLowerCase(),s=this.currentMailbox.toLowerCase()===`junk`||this.currentMailbox.toLowerCase()===`spam`,c={success:!1},l=Le;if(t===`archive`&&(l=Ne),t===`reportSpam`&&(l=Ie),t===`notSpam`&&(l=T),t===`delete`&&(e||o||s)){this.pendingDeleteDetails={isBulk:n,uidsArray:r,currentMsgUid:i?.UID,isTrash:e,isDrafts:o,isSpam:s},this.showDeleteConfirm=!0;return}else c=n?await A.moveMessages(this.currentMailbox,r,l):await A.moveMessages(this.currentMailbox,[String(i.UID)],l);if(c.success){n?(this.selectedUids=new Set,this.selectedMessage=null,this.updateUrl(this.currentMailbox,this.currentPage,null),this.requestUpdate()):(this.selectedMessage=null,this.updateUrl(this.currentMailbox,this.currentPage,null));let e=``,o;if(e=t===`archive`?n?this.i18nStore?.t(`toast.messagesMovedToArchive`,{count:r.length}):this.i18nStore?.t(`toast.messageMovedToArchive`):t===`reportSpam`?n?this.i18nStore?.t(`toast.messagesMovedToSpam`,{count:r.length}):this.i18nStore?.t(`toast.messageMovedToSpam`):t===`notSpam`?n?this.i18nStore?.t(`toast.messagesMovedToInbox`,{count:r.length}):this.i18nStore?.t(`toast.messageMovedToInbox`):n?this.i18nStore?.t(`toast.messagesMovedToTrash`,{count:r.length}):this.i18nStore?.t(`toast.messageMovedToTrash`),n&&c.uidMapping){let e=Object.values(c.uidMapping);o=async()=>{try{let t=await A.moveMessages(l,e,a);if(t.success&&this.currentMailbox===a&&t.uidMapping){let e=new Set(this.selectedUids);Object.values(t.uidMapping).forEach(t=>e.add(t)),this.selectedUids=e,this.requestUpdate()}}catch(e){x.error(`Undo failed`,e)}}}else if(!n&&c.uidMapping?.[String(i.UID)]){let e={UID:c.uidMapping[String(i.UID)]};o=async()=>{try{let t=await A.moveMessages(l,[String(e.UID)],a);if(t.success){let n=this.currentMailbox===a?this.currentPage:0;t.uidMapping?.[String(e.UID)]?this.updateUrl(a,n,t.uidMapping[String(e.UID)]):this.updateUrl(a,n,null)}}catch(e){x.error(`Undo failed`,e)}}}this.showGlobalToast(e,o?this.i18nStore?.t(`mailboxPage.undo`):``,o,Rt)}}else if(t===`moveTo`||t===`copyTo`){let o=e.detail.folder;if(!o)return;let s=t===`moveTo`,c={success:!1};if(c=s?n?await A.moveMessages(this.currentMailbox,r,o):await A.moveMessages(this.currentMailbox,[String(i.UID)],o):n?await A.copyMessages(this.currentMailbox,r,o):await A.copyMessages(this.currentMailbox,[String(i.UID)],o),c.success){s&&(n?(this.selectedUids=new Set,this.selectedMessage=null,this.updateUrl(this.currentMailbox,this.currentPage,null),this.requestUpdate()):(this.selectedMessage=null,this.updateUrl(this.currentMailbox,this.currentPage,null)));let e=s?n?this.i18nStore?.t(`toast.messagesMovedToFolder`,{count:r.length,folder:o}):this.i18nStore?.t(`toast.messageMovedToFolder`,{folder:o}):n?this.i18nStore?.t(`toast.messagesCopiedToFolder`,{count:r.length,folder:o}):this.i18nStore?.t(`toast.messageCopiedToFolder`,{folder:o}),t;if(n&&s&&c.uidMapping){let e=Object.values(c.uidMapping);t=async()=>{try{let t=await A.moveMessages(o,e,a);if(t.success&&this.currentMailbox===a&&t.uidMapping){let e=new Set(this.selectedUids);Object.values(t.uidMapping).forEach(t=>e.add(t)),this.selectedUids=e,this.requestUpdate()}}catch(e){x.error(`Undo failed`,e)}}}else if(!n&&s&&c.uidMapping?.[String(i.UID)]){let e={UID:c.uidMapping[String(i.UID)]};t=async()=>{try{let t=await A.moveMessages(o,[String(e.UID)],a);if(t.success){let n=this.currentMailbox===a?this.currentPage:0;t.uidMapping?.[String(e.UID)]?this.updateUrl(a,n,t.uidMapping[String(e.UID)]):this.updateUrl(a,n,null)}}catch(e){x.error(`Undo failed`,e)}}}this.showGlobalToast(e,t?this.i18nStore?.t(`mailboxPage.undo`):``,t,Rt)}}else if(t===`downloadMessage`&&!n){let e=i.UID,t=`/mailboxes/${encodeURIComponent(this.currentMailbox)}/messages/${e}/raw`,n=document.createElement(`a`);n.href=t,n.download=``,document.body.appendChild(n),n.click(),document.body.removeChild(n)}else if(t===`showOriginal`&&!n){let e=`#/original?mailbox=${encodeURIComponent(this.currentMailbox)}&uid=${i.UID}`;window.open(e,`_blank`)}}finally{n&&(this.bulkProcessing=!1)}}}async _confirmDelete(){this.showDeleteConfirm=!1;let e=this.pendingDeleteDetails;if(this.pendingDeleteDetails=null,!e)return;let{isBulk:t,uidsArray:n,currentMsgUid:r,isDrafts:i}=e;t&&(this.bulkProcessing=!0);try{let e=!1;if(e=t?await A.deleteMessages(this.currentMailbox,n):await A.deleteMessages(this.currentMailbox,[String(r)]),e){t?(this.selectedUids=new Set,this.selectedMessage=null,this.updateUrl(this.currentMailbox,this.currentPage,null),this.requestUpdate()):(this.selectedMessage=null,this.updateUrl(this.currentMailbox,this.currentPage,null));let e=``;e=i?t?this.i18nStore?.t(`toast.draftsDiscarded`,{count:n.length}):this.i18nStore?.t(`toast.draftDiscarded`):t?this.i18nStore?.t(`toast.messagesPermanentlyDeleted`,{count:n.length}):this.i18nStore?.t(`toast.messagePermanentlyDeleted`),this.showGlobalToast(e,``,void 0,Rt)}}finally{t&&(this.bulkProcessing=!1)}}_cancelDelete(){this.showDeleteConfirm=!1,this.pendingDeleteDetails=null}toggleFolder(e,t){t&&(t.stopPropagation(),t.preventDefault());let n=new Set(this.expandedFolders);n.has(e)?n.delete(e):n.add(e),this.expandedFolders=n}render(){let e=this.isMobile?`full`:this.layoutMode,t=e===`full`&&this.selectedMessage!==null;return s`
      ...
      <div class="app-container layout-${e} ${t?`reading`:``} ${this.isPaneDragging||this.isSidebarDragging?`dragging`:``} ${this.sidebarCollapsed&&!this.isMobile?`collapsed`:``} ${this.isMobile?`mobile-view`:``} ${this.suppressSidebarHover?`suppress-sidebar-hover`:``}" style="${!this.sidebarCollapsed&&!this.isMobile?`--sidebar-width: ${this.sidebarWidth}px;`:``}">
        <alps-sidebar 
          ...
          @sidebar-resize=${e=>{let t=e.detail.newWidth;t<Ut?(this.sidebarCollapsed||this.settingsStore.updateSettings({sidebarCollapsed:!0}),this.sidebarWidth=zt):(this.sidebarCollapsed&&this.settingsStore.updateSettings({sidebarCollapsed:!1}),this.sidebarWidth=Math.min(Math.max(t,Bt),Vt),this.resizerPositionX=Math.max(this.resizerPositionX,this.sidebarWidth+Wt))}}
  ...
  `]}updated(e){if(super.updated(e),e.has(`densityMode`)){let e=this.settingsStore?.getState().densityMode||`normal`;this.dataset.density=e;let t=this.shadowRoot?.querySelector(`.contact-list-pane`);t&&(t.classList.remove(`density-loose`,`density-normal`,`density-compact`,`density-ultra-compact`),t.classList.add(`density-${e}`))}e.has(`loading`)&&this.loading&&(this.isSpinning=!0)}handleSpinIteration(){this.loading||(this.isSpinning=!1)}connectedCallback(){super.connectedCallback(),this.showInitialLoader=!0,this.classList.add(`density-compact`);let e=localStorage.getItem(`contacts_categories_cache`);if(e)try{this.addedCategories=JSON.parse(e)}catch{}this.fetchContacts(),window.addEventListener(`resize`,this._handleWindowResize),window.addEventListener(`hashchange`,this._handleHashChange),this.settingsStore&&(this.settingsStore.addEventListener(`change`,this._handleSettingsChange),this._handleSettingsChange()),setTimeout(()=>this._handleHashChange(),0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener(`resize`,this._handleWindowResize),window.removeEventListener(`hashchange`,this._handleHashChange),this.settingsStore&&this.settingsStore.removeEventListener(`change`,this._handleSettingsChange)}get uniqueCategories(){let e=new Set(this.addedCategories);for(let t of this.contacts)if(t.categories)for(let n of t.categories)e.add(n);return Array.from(e).sort((e,t)=>e.localeCompare(t))}get username(){return this.settingsStore?.getState().loginUsername||``}async fetchContacts(){this.loading=!0;try{let e=await b.fetchContacts(this.filterQuery);this.contacts=e.contacts||[],this._handleHashChange()}catch(e){console.error(`Failed to fetch contacts`,e)}finally{this.loading=!1,this.showInitialLoader&&setTimeout(()=>{this.showInitialLoader=!1},100)}}async selectContact(e,t=!0){if(e.isTemporary){this.selectedContact=e,this.isEditing=!0;return}if(t){let t=this.selectedCategory?encodeURIComponent(this.selectedCategory):`all`,n=e.uid?.replace(/^urn:uuid:/,``)||e.path;window.location.hash=`/contacts/${t}/${encodeURIComponent(n)}`;return}if(this.selectedContacts.size>0&&(this.selectedContacts=new Set),this.selectedContact?.path!==e.path){this.selectedContact={...e},this.isEditing=!1;try{let t=await b.fetchContact(e.path);this.selectedContact?.path===t.path&&(this.selectedContact=t)}catch(e){console.error(`Failed to fetch contact details`,e)}}}get allSelectedStarred(){if(this.selectedContacts.size===0)return!1;for(let e of this.selectedContacts){let t=this.contacts.find(t=>t.path===e);if(!t||!t.categories?.includes(`Favorites`))return!1}return!0}async handleToggleStar(e,t){if(e.stopPropagation(),t.isTemporary)return;let n=t.categories?[...t.categories]:[],r=n.includes(de);r?n=n.filter(e=>e!==de):n.push(de),this.contacts=this.contacts.map(e=>e.path===t.path?{...e,categories:n}:e);try{let e={name:t.name||``,email:t.email||``,phone:t.phone||``,organization:t.organization||``,address:t.address||``,birthday:t.birthday||``,note:t.note||``,url:t.url||``,nickname:t.nickname||``,categories:n};await b.updateContact(t.path,e),this.selectedContact?.path===t.path&&(this.selectedContact={...this.selectedContact,categories:n})}catch(e){console.error(`Failed to toggle star:`,e),r?t.categories.push(de):t.categories=t.categories.filter(e=>e!==de),this.requestUpdate()}}handleSelectAll(e){let t=e;if(t.detail?t.detail.checked:e.target.checked){let e=this.contacts.filter(e=>!(this.selectedCategory&&(!e.categories||!e.categories.includes(this.selectedCategory))));this.selectedContacts=new Set(e.map(e=>e.path))}else this.selectedContacts=new Set}handleSelectContact(e,t){e.stopPropagation();let n=new Set(this.selectedContacts);n.has(t)?n.delete(t):n.add(t),this.selectedContacts=n}handleCreateCategorySubmit(e){let t=e.detail.name?.trim();t&&(this.addedCategories.includes(t)||(this.addedCategories=[...this.addedCategories,t],localStorage.setItem(`contacts_categories_cache`,JSON.stringify(this.addedCategories)))),this.showCreatePrompt=!1}handleCreateNew(){this.selectedContacts=new Set;let e={name:this.i18nStore?.t(`contacts.unnamedContact`),categories:this.selectedCategory?[this.selectedCategory]:[],isTemporary:!0};this.contacts=this.contacts.filter(e=>!e.isTemporary),this.contacts=[e,...this.contacts],this.selectedContact=e,this.isEditing=!0}async handleRenameCategorySubmit(e){let t=e.detail.name?.trim();if(!t||!this.categoryToRename||t===this.categoryToRename){this.categoryToRename=null;return}let n=this.categoryToRename;this.categoryToRename=null,this.addedCategories.includes(n)&&(this.addedCategories=this.addedCategories.map(e=>e===n?t:e),localStorage.setItem(`contacts_categories_cache`,JSON.stringify(this.addedCategories))),this.selectedCategory===n&&(this.selectedCategory=t,window.location.hash=`/contacts/${encodeURIComponent(t)}`);let r=this.contacts.filter(e=>e.categories?.includes(n));if(r.length>0){this.saving=!0;try{let e=r.map(e=>{let r=e.categories.map(e=>e===n?t:e);return{...e,categories:r}});await b.bulkUpdateContacts(e),this.fetchContacts()}catch(e){console.error(`Error renaming category`,e)}finally{this.saving=!1}}}async handleDeleteCategorySubmit(){if(!this.categoryToDelete)return;let e=this.categoryToDelete;this.categoryToDelete=null,this.addedCategories.includes(e)&&(this.addedCategories=this.addedCategories.filter(t=>t!==e),localStorage.setItem(`contacts_categories_cache`,JSON.stringify(this.addedCategories))),this.selectedCategory===e&&(this.selectedCategory=``,window.location.hash=`/contacts/all`);let t=this.contacts.filter(t=>t.categories?.includes(e));if(t.length>0){this.saving=!0;try{let n=t.map(t=>{let n=t.categories.filter(t=>t!==e);return{...t,categories:n}});await b.bulkUpdateContacts(n),this.fetchContacts()}catch(e){console.error(`Error deleting category`,e)}finally{this.saving=!1}}}handleEdit(){this.isEditing=!0}handleCancelEdit(){this.isEditing=!1,this.selectedContact?.isTemporary&&(this.selectedContact=null,this.contacts=this.contacts.filter(e=>!e.isTemporary),this.selectedCategory||(window.location.hash=`/contacts/all`))}async handleSave(e){this.saving=!0;try{e.categories&&typeof e.categories==`string`?e.categories=e.categories.split(`,`).map(e=>e.trim()).filter(e=>e):e.categories=[];let t;t=this.selectedContact&&!this.selectedContact.isTemporary?await b.updateContact(this.selectedContact.path,e):await b.createContact(e);let n={...e,path:t.path||(this.selectedContact&&!this.selectedContact.isTemporary?this.selectedContact.path:``)},r=this.contacts.findIndex(e=>this.selectedContact&&(e.path===this.selectedContact.path||e.isTemporary&&this.selectedContact.isTemporary));r>-1?(this.contacts[r]={...this.contacts[r],...n},delete this.contacts[r].isTemporary,this.contacts=[...this.contacts]):this.contacts=[n,...this.contacts],this.selectedContact={...this.selectedContact,...n},delete this.selectedContact.isTemporary}catch(e){console.error(`Error saving contact`,e)}finally{this.saving=!1}}handleSaveEvent(e){this.handleSave(e.detail)}async handleToggleStarEvent(){let e=this.selectedContacts.size>1?Array.from(this.selectedContacts):[this.selectedContact?.path].filter(Boolean);if(e.length===0)return;let t=e.length>1?this.allSelectedStarred:this.contacts.find(t=>t.path===e[0])?.categories?.includes(`Favorites`)||!1;this.saving=!0;try{let n=e.map(e=>{let n=this.contacts.findIndex(t=>t.path===e);if(n===-1)return;let r=this.contacts[n],i=r.categories?[...r.categories]:[];return t?i=i.filter(e=>e!==de):i.includes(`Favorites`)||i.push(de),this.contacts[n]={...r,categories:i},this.selectedContact?.path===e&&(this.selectedContact={...this.selectedContact,categories:i}),{...r,categories:i}}).filter(Boolean);this.contacts=[...this.contacts],await b.bulkUpdateContacts(n)}catch(e){console.error(`Error toggling star`,e)}finally{this.saving=!1}}handleDelete(){this.showDeleteConfirm=!0}async confirmDelete(){this.showDeleteConfirm=!1,this.saving=!0;try{let e=this.selectedContacts.size>1?Array.from(this.selectedContacts):[this.selectedContact?.path].filter(Boolean);await b.bulkDeleteContacts(e),this.selectedContact=null,this.selectedContacts.size>1&&(this.selectedContacts=new Set),this.isEditing=!1,this.fetchContacts()}catch(e){console.error(`Error deleting contacts`,e),alert(`Failed to delete one or more contacts`)}finally{this.saving=!1}}async handleUpdateCategories(e){let t=e.detail.category;typeof t==`string`&&(t=t.trim()),t&&!this.addedCategories.includes(t)&&(this.addedCategories=[...this.addedCategories,t],localStorage.setItem(`contacts_categories_cache`,JSON.stringify(this.addedCategories)));let n=this.selectedContacts.size>1?Array.from(this.selectedContacts):[this.selectedContact?.path].filter(Boolean);if(n.length!==0){this.saving=!0;try{let e=n.map(e=>{let n=this.contacts.findIndex(t=>t.path===e);if(n===-1)return;let r=this.contacts[n],i=r.categories?[...r.categories]:[];return t===``?i=[]:i.includes(t)?i=i.filter(e=>e!==t):i.push(t),this.contacts[n]={...r,categories:i},this.selectedContact?.path===e&&(this.selectedContact={...this.selectedContact,categories:i}),{...r,categories:i}}).filter(Boolean);if(await b.bulkUpdateContacts(e),this.contacts=[...this.contacts],this.selectedContact&&this.selectedContacts.size<=1&&this.selectedCategory!==``&&!this.selectedContact.categories?.includes(this.selectedCategory)){let e=this.selectedContact.uid?.replace(/^urn:uuid:/,``)||this.selectedContact.path;e&&(window.location.hash=`#/contacts/all/${encodeURIComponent(e)}`)}this.selectedCategory!==``&&this.selectedCategory!==`All Contacts`&&this.fetchContacts()}catch(e){console.error(`Error updating categories`,e)}finally{this.saving=!1}}}render(){return s`
      ...
      ${this.categoryToDelete===null?``:s`
        ...
        ></ui-confirm>
      `}
    `}};j([f({context:C})],U.prototype,`i18nStore`,void 0),j([f({context:w})],U.prototype,`settingsStore`,void 0),j([_()],U.prototype,`contacts`,void 0),j([_()],U.prototype,`sortOrder`,void 0),j([_()],U.prototype,`showOnlyStarred`,void 0),j([_()],U.prototype,`loading`,void 0),j([_()],U.prototype,`isSpinning`,void 0),j([_()],U.prototype,`showInitialLoader`,void 0),j([_()],U.prototype,`selectedContact`,void 0),j([_()],U.prototype,`filterQuery`,void 0),j([_()],U.prototype,`isEditing`,void 0),j([_()],U.prototype,`saving`,void 0),j([_()],U.prototype,`selectedCategory`,void 0),j([_()],U.prototype,`showCreatePrompt`,void 0),j([_()],U.prototype,`showDeleteConfirm`,void 0),j([_()],U.prototype,`addedCategories`,void 0),j([_()],U.prototype,`sidebarWidth`,void 0),j([_()],U.prototype,`listWidth`,void 0),j([_()],U.prototype,`sidebarCollapsed`,void 0),j([_()],U.prototype,`isSidebarHovered`,void 0),j([_()],U.prototype,`isMobile`,void 0),j([_()],U.prototype,`mobileSidebarOpen`,void 0),j([_()],U.prototype,`suppressSidebarHover`,void 0),j([_()],U.prototype,`isSidebarDragging`,void 0),j([_()],U.prototype,`isPaneDragging`,void 0),j([_()],U.prototype,`densityMode`,void 0),j([_()],U.prototype,`selectedContacts`,void 0),j([_()],U.prototype,`listScrolled`,void 0),j([_()],U.prototype,`categoryToRename`,void 0),j([_()],U.prototype,`categoryToDelete`,void 0),U=j([a(`contacts-page`)],U);var W=class extends p{constructor(...e){super(...e),this.contact=null,this.isEditing=!1,this.saving=!1,this.uniqueCategories=[],this.isMobile=!1,this.selectedCount=0,this.allSelectedStarred=!1,this.scrolled=!1,this.editForm={},this.isDirty=!1,this.newCategoryName=``,this.saveTimeout=null}handleAddCategory(){let e=this.newCategoryName.trim();if(e){this.dispatchEvent(new CustomEvent(`update-categories`,{detail:{category:e},bubbles:!0,composed:!0})),this.newCategoryName=``;let t=this.shadowRoot?.querySelector(`alps-popup`);t&&t.close()}}static{this.styles=[ft,o`
    :host {
      display: flex;
      flex-direction: column;
      height: 100%;
...
`)&&(t+=` `),m(t)}handleScroll(e){let t=e.target,n=this.shadowRoot?.querySelector(`.highlight-layer`);n&&(n.scrollTop=t.scrollTop,n.scrollLeft=t.scrollLeft)}handleInput(e){let t=e.target;this.script=t.value,this.dispatchEvent(new CustomEvent(`script-changed`,{detail:{script:this.script}}))}async validate(){this.isValidating=!0;try{await Qt.validateScript(this.script),window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:this.i18nStore.t(`managesieve.toast.valid`),timeout:3e3}}))}catch(e){window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:e.message||this.i18nStore.t(`managesieve.toast.networkError`),timeout:5e3,type:`error`}}))}finally{this.isValidating=!1}}async save(){this.isSaving=!0;try{await Qt.saveScript(this.script,`PUT`),this.initialScript=this.script,this.isDirty=!1;let e=this.script.trim()===``?`managesieve.toast.deactivated`:`managesieve.toast.saved`;window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:this.i18nStore.t(e),timeout:3e3}}))}catch(e){window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:e.message||this.i18nStore.t(`managesieve.toast.networkError`),timeout:5e3,type:`error`}}))}finally{this.isSaving=!1}}render(){return s`
		...
		`}};j([_()],$t.prototype,`isDirty`,void 0),j([f({context:C})],$t.prototype,`i18nStore`,void 0),j([i({type:String})],$t.prototype,`script`,void 0),j([_()],$t.prototype,`isValidating`,void 0),j([_()],$t.prototype,`isSaving`,void 0),$t=j([a(`alps-raw-editor`)],$t);var en=class extends p{constructor(...e){super(...e),this.value=``,this.options=[]}static{this.styles=o`
		:host {
			display: block;
			position: relative;
		}
	...
	`}addRule(){this.state={...this.state,rules:[...this.state.rules,{id:Math.random().toString(36).substring(7),matchType:`all`,conditions:[{field:`Subject`,operator:`contains`,value:``}],actions:[{type:`fileinto`,value:this.folders[0]||`INBOX`}]}]},this.notifyChange()}deleteRule(e){let t=[...this.state.rules];t.splice(e,1),this.state={...this.state,rules:t},this.notifyChange()}updateRule(e,t){let n=[...this.state.rules];n[e]={...n[e],...t},this.state={...this.state,rules:n},this.notifyChange()}addCondition(e,t){let n=this.state.rules[e],r={field:`Subject`,operator:`contains`,value:``},i=[...n.conditions];t===void 0?i.push(r):i.splice(t,0,r),this.updateRule(e,{conditions:i})}deleteCondition(e,t){let n=[...this.state.rules[e].conditions];n.splice(t,1),this.updateRule(e,{conditions:n})}updateCondition(e,t,n){let r=[...this.state.rules[e].conditions],i=r[t];n.field&&n.field!==i.field&&(n.field===`Size`?i.operator!==`over`&&i.operator!==`under`&&(n.operator=`over`):(i.operator===`over`||i.operator===`under`)&&(n.operator=`contains`)),r[t]={...i,...n},this.updateRule(e,{conditions:r})}addAction(e,t){let n=this.state.rules[e],r={type:`fileinto`,value:this.folders[0]||`INBOX`},i=[...n.actions];t===void 0?i.push(r):i.splice(t,0,r),this.updateRule(e,{actions:i})}deleteAction(e,t){let n=[...this.state.rules[e].actions];n.splice(t,1),this.updateRule(e,{actions:n})}updateAction(e,t,n){let r=[...this.state.rules[e].actions];r[t]={...r[t],...n},this.updateRule(e,{actions:r})}notifyChange(){this.dispatchEvent(new CustomEvent(`state-changed`,{detail:{state:this.state}}))}save(){this.dispatchEvent(new CustomEvent(`save-requested`))}render(){return s`
		...
		`}};j([i({type:Boolean})],tn.prototype,`isSaving`,void 0),j([_()],tn.prototype,`initialSnapshot`,void 0),j([f({context:C,subscribe:!0})],tn.prototype,`i18nStore`,void 0),j([i({type:Object})],tn.prototype,`state`,void 0),j([i({type:Array})],tn.prototype,`folders`,void 0),tn=j([a(`alps-visual-editor`)],tn);var G=class extends p{constructor(...e){super(...e),this.mode=`visual`,this.script=``,this.visualState={rules:[]},this.folders=[],this.isLoading=!0,this.isSaving=!1,this.showSwitchRawConfirm=!1}static{this.styles=o`
		.container {
			display: flex;
			flex-direction: column;
			gap: 20px;
	...
	`}connectedCallback(){super.connectedCallback(),this.fetchScript(),this.fetchFolders()}async fetchScript(){try{let e=await Qt.fetchScript();if(this.script=e.content||``,this.script.trim()===``)this.mode=`visual`,this.visualState={rules:[]};else{let e=Xt.extractVisualState(this.script);e?(this.visualState=e,this.mode=`visual`):this.mode=`raw`}}catch(e){console.error(`Failed to fetch Sieve script`,e),this.visualState={rules:[]},this.mode=`visual`}finally{this.isLoading=!1}}async fetchFolders(){try{let e=await Qt.fetchFolders();e&&e.Mailboxes&&(this.folders=e.Mailboxes.map(e=>e.Name||e.Mailbox).filter(Boolean))}catch(e){console.error(`Failed to fetch folders`,e)}}handleVisualStateChange(e){this.visualState=e.detail.state}handleRawScriptChange(e){this.script=e.detail.script}switchToRaw(){this.showSwitchRawConfirm=!0}confirmSwitchToRaw(){this.script=Xt.compile(this.visualState),this.mode=`raw`,this.showSwitchRawConfirm=!1}async saveVisual(){this.isSaving=!0;try{let e=Xt.compile(this.visualState);this.script=e,await Qt.saveScript(e,`PUT`);let t=e.trim()===``?`managesieve.toast.deactivated`:`managesieve.toast.saved`;window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:this.i18nStore.t(t),timeout:3e3}}));let n=this.shadowRoot?.querySelector(`alps-visual-editor`);n&&n.markClean&&n.markClean()}catch(e){window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:e.message||this.i18nStore.t(`managesieve.toast.networkError`),timeout:5e3,type:`error`}}))}finally{this.isSaving=!1}}render(){return s`
			...
			${this.showSwitchRawConfirm?s`
				...
				></ui-confirm>
			`:``}
		`}};j([f({context:C,subscribe:!0})],G.prototype,`i18nStore`,void 0),j([_()],G.prototype,`mode`,void 0),j([_()],G.prototype,`script`,void 0),j([_()],G.prototype,`visualState`,void 0),j([_()],G.prototype,`folders`,void 0),j([_()],G.prototype,`isLoading`,void 0),j([_()],G.prototype,`isSaving`,void 0),j([_()],G.prototype,`showSwitchRawConfirm`,void 0),G=j([a(`alps-managesieve-page`)],G);var nn=e({});v.registerSettingsTab({id:`managesieve`,labelKey:`settings.categories.filters`,icon:`sieve`,component:`alps-managesieve-page`});var rn=class extends p{constructor(...e){super(...e),this.passwordForm={old:``,new:``,confirm:``},this.isSubmitting=!1}static{this.styles=o`
		input[type="password"] {
			width: 100%;
			box-sizing: border-box;
	...
	`}};j([f({context:C})],rn.prototype,`i18nStore`,void 0),j([_()],rn.prototype,`passwordForm`,void 0),j([_()],rn.prototype,`isSubmitting`,void 0),rn=j([a(`alps-password-settings`)],rn);var an=e({});v.registerSettingsTab({id:`password`,labelKey:`settings.categories.password`,icon:`password`,component:`alps-password-settings`});var on=class{constructor(e,t,n){this.routes=e,this.fallback=t,this.currentPath=this.getHashPath(),window.addEventListener(`hashchange`,()=>{this.currentPath=this.getHashPath(),n()})}getHashPath(){let e=window.location.hash;return!e||e===`#`?`/`:e.substring(1).split(`?`)[0]}navigate(e){window.location.hash=e}render(){if(this.routes[this.currentPath])return this.routes[this.currentPath]();for(let e in this.routes)if(e.endsWith(`/*`)&&this.currentPath.startsWith(e.replace(`/*`,``)))return this.routes[e]();return this.fallback()}},sn=class extends p{constructor(...e){super(...e),this.icon=``,this.title=``,this.subtitle=``}static{this.styles=o`
    :host {
      display: flex;
      justify-content: center;
      align-items: center;
  ...
  `}render(){return s`
    ...
    `}};j([i({type:String})],sn.prototype,`icon`,void 0),j([i({type:String})],sn.prototype,`title`,void 0),j([i({type:String})],sn.prototype,`subtitle`,void 0),sn=j([a(`alps-auth-card`)],sn);var K=class extends p{constructor(...e){super(...e),this.username=``,this.password=``,this.rememberMe=!1,this.error=``,this.isSubmitting=!1,this.retryAfter=0,this.isRateLimited=!1,this._handleI18nChange=()=>{this.requestUpdate()}}static{this.styles=o`
    .form-group {
      margin-bottom: 16px;
      position: relative;
    }
  ...
  `}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.i18nStore?.addEventListener(`change`,this._handleI18nChange)}),this.composeStore&&this.composeStore.clearAllComposers()}disconnectedCallback(){super.disconnectedCallback(),this.i18nStore?.removeEventListener(`change`,this._handleI18nChange),this.retryCountdownInterval&&clearInterval(this.retryCountdownInterval)}startRetryCountdown(e){this.retryAfter=e,this.isRateLimited=!0,this.retryCountdownInterval&&clearInterval(this.retryCountdownInterval),this.retryCountdownInterval=setInterval(()=>{this.retryAfter--,this.retryAfter<=0&&(this.isRateLimited=!1,this.retryCountdownInterval&&=(clearInterval(this.retryCountdownInterval),void 0))},1e3)}formatRetryTime(e){if(e<60)return`${e} second${e===1?``:`s`}`;let t=Math.ceil(e/60);return`${t} minute${t===1?``:`s`}`}async handleSubmit(e){if(e.preventDefault(),this.isSubmitting)return;let t=this.shadowRoot?.querySelector(`form`);if(t&&!t.checkValidity()){t.reportValidity();return}this.error=``,this.isSubmitting=!0;try{await new Promise(e=>setTimeout(e,600));let e={username:this.username,password:this.password,"remember-me":this.rememberMe?`on`:``},t=await fetch(`/session`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json();t.ok?n.requires_2fa?(window.location.hash=`/login/webauthn`,this.isSubmitting=!1):(window.dispatchEvent(new CustomEvent(`user-logged-in`)),window.location.hash=`/mailbox/INBOX`):(t.status===429&&n.retry_after?(this.error=n.error||this.i18nStore?.t(`login.tooManyAttempts`),this.startRetryCountdown(n.retry_after)):(this.error=n.error||this.i18nStore?.t(`login.loginFailed`),this.isRateLimited=!1),this.isSubmitting=!1)}catch{this.error=this.i18nStore?.t(`login.networkError`),this.isSubmitting=!1,this.isRateLimited=!1}}render(){return s`
    ...
    `}};j([f({context:C})],K.prototype,`i18nStore`,void 0),j([_()],K.prototype,`username`,void 0),j([_()],K.prototype,`password`,void 0),j([_()],K.prototype,`rememberMe`,void 0),j([_()],K.prototype,`error`,void 0),j([_()],K.prototype,`isSubmitting`,void 0),j([_()],K.prototype,`retryAfter`,void 0),j([_()],K.prototype,`isRateLimited`,void 0),j([f({context:ct,subscribe:!0})],K.prototype,`composeStore`,void 0),K=j([a(`login-page`)],K);var cn=class extends p{constructor(...e){super(...e),this.active=!1,this.icon=``}static{this.styles=o`
    :host {
      display: flex;
      align-items: center;
      padding: 8px 16px;
  ...
  `}render(){return s`
    ...
    `}};j([i({type:Boolean,reflect:!0})],cn.prototype,`active`,void 0),j([i({type:String})],cn.prototype,`icon`,void 0),cn=j([a(`alps-category-item`)],cn);var q=class extends p{constructor(...e){super(...e),this.newUsername=``,this.newPassword=``,this.newDisplayName=``,this.isSubmitting=!1,this.error=``,this.showAddForm=!1,this._handleStoreChange=()=>{this.requestUpdate()}}static{this.styles=o`
        :host {
            display: block;
        }
    ...
    `}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.i18nStore?.addEventListener(`change`,this._handleStoreChange),this.linkedAccountsStore?.addEventListener(`change`,this._handleStoreChange),this.linkedAccountsStore&&!this.linkedAccountsStore.isInitialized()&&this.linkedAccountsStore.fetchAccounts()})}disconnectedCallback(){super.disconnectedCallback(),this.i18nStore?.removeEventListener(`change`,this._handleStoreChange),this.linkedAccountsStore?.removeEventListener(`change`,this._handleStoreChange)}async handleAdd(e){if(e.preventDefault(),!(!this.newUsername||!this.newPassword)){this.isSubmitting=!0,this.error=``;try{await this.linkedAccountsStore.addAccount(this.newUsername,this.newPassword,this.newDisplayName),this.newUsername=``,this.newPassword=``,this.newDisplayName=``,this.showAddForm=!1,window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:this.i18nStore?.t(`linkedAccounts.addedSuccess`)}}))}catch(e){this.error=e.message||this.i18nStore?.t(`linkedAccounts.addError`)}finally{this.isSubmitting=!1}}}async handleRemove(e){if(confirm(this.i18nStore?.t(`linkedAccounts.removeConfirm`)))try{await this.linkedAccountsStore.removeAccount(e),window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:this.i18nStore?.t(`linkedAccounts.removedSuccess`)}}))}catch(e){window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:e.message||this.i18nStore?.t(`linkedAccounts.removeError`)}}))}}render(){let e=this.linkedAccountsStore?.getAccounts()||[],t=this.linkedAccountsStore?.isLoading();return s`
            <alps-setting-group 
                ...
                ${this.showAddForm?``:s`
                    <alps-button variant="normal" style="margin-top: 16px;" @click=${()=>this.showAddForm=!0}>
            ...
            `:``}
        `}};j([f({context:C})],q.prototype,`i18nStore`,void 0),j([f({context:ut})],q.prototype,`linkedAccountsStore`,void 0),j([_()],q.prototype,`newUsername`,void 0),j([_()],q.prototype,`newPassword`,void 0),j([_()],q.prototype,`newDisplayName`,void 0),j([_()],q.prototype,`isSubmitting`,void 0),j([_()],q.prototype,`error`,void 0),j([_()],q.prototype,`showAddForm`,void 0),q=j([a(`settings-accounts`)],q);function ln(e){if(!e)throw Error(`base64url is null or undefined`);let t=e.replace(/-/g,`+`).replace(/_/g,`/`),n=atob(t),r=new Uint8Array(n.length);for(let e=0;e<n.length;e++)r[e]=n.charCodeAt(e);return r.buffer}function un(e){let t=new Uint8Array(e),n=``;for(let e=0;e<t.byteLength;e++)n+=String.fromCharCode(t[e]);return btoa(n).replace(/\+/g,`-`).replace(/\//g,`_`).replace(/=/g,``)}async function dn(e){e.publicKey.challenge=ln(e.publicKey.challenge),e.publicKey.user.id=ln(e.publicKey.user.id),e.publicKey.excludeCredentials&&(e.publicKey.excludeCredentials=e.publicKey.excludeCredentials.map(e=>({...e,id:ln(e.id)})));let t=await navigator.credentials.create(e);if(!t)throw Error(`Credential creation failed or was cancelled.`);let n=t.response,r=n.getTransports?n.getTransports():[];return{id:t.id,rawId:un(t.rawId),type:t.type,response:{attestationObject:un(n.attestationObject),clientDataJSON:un(n.clientDataJSON)},transports:r}}async function fn(e){e.publicKey.challenge=ln(e.publicKey.challenge),e.publicKey.allowCredentials&&(e.publicKey.allowCredentials=e.publicKey.allowCredentials.map(e=>({...e,id:ln(e.id)})));let t=await navigator.credentials.get(e);if(!t)throw Error(`Assertion failed or was cancelled.`);let n=t.response;return{id:t.id,rawId:un(t.rawId),type:t.type,response:{authenticatorData:un(n.authenticatorData),clientDataJSON:un(n.clientDataJSON),signature:un(n.signature),userHandle:n.userHandle?un(n.userHandle):null}}}function pn(){return window.PublicKeyCredential!==void 0&&navigator.credentials!==void 0}var mn=class extends p{constructor(...e){super(...e),this.data=null,this.error=``,this.loading=!0,this.adding=!1,this.showNamePrompt=!1,this.pendingCredential=null}static{this.styles=o`
        :host { display: block; }
        .setting-row {
            display: flex;
            justify-content: space-between;
    ...
    `}connectedCallback(){super.connectedCallback(),this.fetchData()}async fetchData(){try{this.loading=!0;let e=await fetch(`/settings/2fa`);if(!e.ok)throw Error(`Failed to fetch settings`);this.data=await e.json()}catch(e){this.error=e.message}finally{this.loading=!1}}async handleTrustToggle(e){let t=e.target;await fetch(`/settings/2fa/trust-linked-accounts`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({trust:t.checked})}),this.fetchData()}async addCredential(){this.adding=!0,this.error=``;try{let e=await fetch(`/settings/2fa/begin`,{method:`POST`});if(!e.ok)throw Error(await e.text());let t=await dn(await e.json());this.pendingCredential=t,this.showNamePrompt=!0,this.adding=!1}catch(e){e.name===`NotAllowedError`||e.message&&e.message.includes(`not allowed`)?this.error=``:this.error=e.message,this.adding=!1}}async _handlePromptSubmit(e){let t=e.detail.keyName||`Security Key`;this.showNamePrompt=!1;let n={...this.pendingCredential,name:t};this.adding=!0,this.error=``;try{let e=await fetch(`/settings/2fa/finish`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(n)});if(!e.ok)throw Error(await e.text());this.fetchData()}catch(e){this.error=e.message}finally{this.adding=!1,this.pendingCredential=null}}_handlePromptCancel(){this.showNamePrompt=!1,this.pendingCredential=null}async removeCredential(e){if(confirm(this.i18nStore?.t(`webauthn.confirm_remove`)))try{this.error=``;let t=await fetch(`/settings/2fa/credential/${encodeURIComponent(e)}/delete`,{method:`POST`});if(!t.ok)throw Error(await t.text());this.fetchData()}catch(e){this.error=e.message||this.i18nStore?.t(`webauthn.errors.remove_failed`)}}render(){return this.loading?s`<div>Loading...</div>`:s`
            ...
            `:``}
        `}};j([f({context:C})],mn.prototype,`i18nStore`,void 0),j([_()],mn.prototype,`data`,void 0),j([_()],mn.prototype,`error`,void 0),j([_()],mn.prototype,`loading`,void 0),j([_()],mn.prototype,`adding`,void 0),j([_()],mn.prototype,`showNamePrompt`,void 0),j([_()],mn.prototype,`pendingCredential`,void 0),mn=j([a(`alps-webauthn-settings`)],mn);var J=class extends p{constructor(...e){super(...e),this.category=`general`,this.isMobile=window.innerWidth<=768,this.mobileSidebarOpen=!1,this.username=``,this.isScrolled=!1,this.enabledPlugins=[],this.sidebarWidth=250,this.sidebarCollapsed=!1,this.isSidebarDragging=!1,this.isSidebarHovered=!1,this.hoverTimeout=null,this.suppressSidebarHover=!1,this._handleResize=()=>{this.isMobile=window.innerWidth<=768,this.isMobile||(this.mobileSidebarOpen=!1)},this._handleScroll=e=>{let t=e.target;this.isScrolled=t.scrollTop>0},this._handleSettingsChange=()=>{this._syncState()},this._handleI18nChange=()=>{this.requestUpdate()}}static{this.styles=o`
    :host {
      display: flex;
      flex-direction: column;
      height: 100vh;
  ...
  `}connectedCallback(){super.connectedCallback(),this.allowRemoteResources=this.settingsStore.getState().showRemoteContent===`always`,this.extractParams(),this.mailbox&&this.uid?this.fetchMessage():(this.error=`Missing mailbox or uid parameters`,this.loading=!1)}extractParams(){let e=window.location.hash,t=e.indexOf(`?`);if(t!==-1){let n=new URLSearchParams(e.substring(t+1));this.mailbox=n.get(`mailbox`)||``,this.uid=n.get(`uid`)||``,n.get(`remote`)===`1`&&(this.allowRemoteResources=!0)}}async fetchMessage(){try{this.loading=!0;let e=Ge.get(this.mailbox,this.uid);if(e&&e.Part){this.message=e.Message,this.mimeType=e.Part.MIMEType||e.Part.MimeType||`text/plain`,e.RawHtml===void 0?e.RawText!==void 0&&(this.content=e.RawText):(this.rawMessageHtml=e.RawHtml,this.hasRemoteResources=!1,this.content=Ft(this.rawMessageHtml,{mailbox:this.mailbox,messageUid:this.uid,allowRemoteResources:this.allowRemoteResources,messageStructure:this.message.BodyStructure,onRemoteResourceBlocked:()=>{this.hasRemoteResources=!0}})),this.loading=!1;return}let t=await y(`/mailboxes/${encodeURIComponent(this.mailbox)}/messages/${this.uid}`);if(!t.ok){if(t.status===401){window.location.hash=`#/login`;return}throw Error(`Failed to fetch message metadata`)}this.message=await t.json(),await this.fetchMessageBody()}catch(e){this.error=e.message}finally{this.loading=!1}}findDisplayPart(e,t){if(!e)return null;if(e.MIMEType&&e.MIMEType.toLowerCase().startsWith(`multipart/`)){if(e.MIMEType.toLowerCase()===`multipart/alternative`){let n=null,r=null;for(let t of e.Children||[])t.MIMEType?.toLowerCase()===`text/plain`&&(n=t),t.MIMEType?.toLowerCase()===`text/html`&&(r=t);return t===`html`?r||n||e.Children[0]:n||r||e.Children[0]}for(let n of e.Children||[]){let e=this.findDisplayPart(n,t);if(e)return e}}return e.MIMEType?.toLowerCase()===`text/html`||e.MIMEType?.toLowerCase()===`text/plain`?e:null}findPartPath(e,t,n=``){if(!e)return null;if(e===t)return n||`1`;if(e.Children&&Array.isArray(e.Children))for(let r=0;r<e.Children.length;r++){let i=n?`${n}.${r+1}`:`${r+1}`,a=this.findPartPath(e.Children[r],t,i);if(a)return a}return null}async fetchMessageBody(){if(!this.message||!this.message.BodyStructure)return;let e=`1`,t=this.findDisplayPart(this.message.BodyStructure,`html`);if(t?(e=this.findPartPath(this.message.BodyStructure,t)||`1`,this.mimeType=t.MIMEType||`text/plain`):(this.mimeType=this.message.BodyStructure.MIMEType||`text/plain`,this.mimeType.toLowerCase()===`text/plain`||this.mimeType.toLowerCase()===`text/html`?e=`1`:this.mimeType=`multipart/mixed`),this.mimeType.toLowerCase().startsWith(`multipart/`)){this.content=``;return}let n=await y(`/mailboxes/${encodeURIComponent(this.mailbox)}/messages/${this.uid}/raw?part=${e}`);if(!n.ok)throw Error(`Failed to fetch message body`);this.mimeType.toLowerCase()===`text/html`?(this.rawMessageHtml=await n.text(),this.hasRemoteResources=!1,this.content=Ft(this.rawMessageHtml,{mailbox:this.mailbox,messageUid:this.uid,allowRemoteResources:this.allowRemoteResources,messageStructure:this.message.BodyStructure,onRemoteResourceBlocked:()=>{this.hasRemoteResources=!0}})):this.content=await n.text()}loadRemoteResources(){this.allowRemoteResources=!0,this.rawMessageHtml&&(this.content=Ft(this.rawMessageHtml,{mailbox:this.mailbox,messageUid:this.uid,allowRemoteResources:this.allowRemoteResources,messageStructure:this.message?.BodyStructure,onRemoteResourceBlocked:()=>{this.hasRemoteResources=!0}}))}updated(e){e.has(`content`)&&this.content&&setTimeout(()=>{window.print()},500)}render(){if(this.loading)return s`
      ...
      `;let e=this.message;if(!e)return s``;let t=e.Envelope?.Subject||this.i18nStore?.t(`messageList.noSubject`),n=e.Envelope?.From?.[0]||{},r=n.Mailbox&&n.Host?`${n.Mailbox}@${n.Host}`:``,i=n.Name||r||this.i18nStore?.t(`messageList.unknownSender`),a=this.settingsStore?.getState()?.dateFormat||`YYYY-MM-DD`,o=String(this.settingsStore?.getState()?.hourFormat||`12`),c=e.Envelope?.Date?Be(e.Envelope.Date,a,o):``,l=e.Envelope?.To&&e.Envelope.To.length>0?e.Envelope.To.map(e=>e.Name?`${e.Name} &lt;${e.Mailbox}@${e.Host}&gt;`:`${e.Mailbox}@${e.Host}`).join(`, `):this.i18nStore?.t(`messageReader.undisclosed`),u=s``;if(e.Envelope?.Cc&&e.Envelope.Cc.length>0){let t=e.Envelope.Cc.map(e=>e.Name?`${e.Name} &lt;${e.Mailbox}@${e.Host}&gt;`:`${e.Mailbox}@${e.Host}`).join(`, `);u=s`<div class="print-cc"><strong>${this.i18nStore?.t(`messageReader.cc`)}</strong> ${t}</div>`}let d;return d=this.mimeType?.toLowerCase()===`text/html`?s`<div .innerHTML=${this.content}></div>`:this.mimeType?.toLowerCase().startsWith(`multipart/`)?s`<div style="font-style: italic; color: #666;">${this.i18nStore?.t(`messageReader.noReadableText`)}</div>`:s`<pre style="white-space: pre-wrap; font-family: inherit; margin: 0;">${this.content}</pre>`,s`
      ${this.hasRemoteResources&&!this.allowRemoteResources?s`
        <alps-banner>
          <span>${this.i18nStore.t(`messageReader.remoteContentWarning`)}</span>
    ...
    `}};j([f({context:w})],X.prototype,`settingsStore`,void 0),j([f({context:C})],X.prototype,`i18nStore`,void 0),j([_()],X.prototype,`loading`,void 0),j([_()],X.prototype,`error`,void 0),j([_()],X.prototype,`mailbox`,void 0),j([_()],X.prototype,`uid`,void 0),j([_()],X.prototype,`message`,void 0),j([_()],X.prototype,`content`,void 0),j([_()],X.prototype,`rawMessageHtml`,void 0),j([_()],X.prototype,`mimeType`,void 0),j([_()],X.prototype,`hasRemoteResources`,void 0),j([_()],X.prototype,`allowRemoteResources`,void 0),X=j([a(`print-page`)],X);var gn=class extends p{constructor(...e){super(...e),this.statusMessage=``,this.statusType=`info`,this.isLoading=!1,this.isSuccess=!1,this._handleI18nChange=()=>{this.requestUpdate()}}static{this.styles=o`
    .status {
      margin-bottom: 24px;
      padding: 8px 12px;
      border-radius: var(--radius-md, 6px);
  ...
  `}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.i18nStore?.addEventListener(`change`,this._handleI18nChange)}),pn()?setTimeout(()=>{this._handleVerify()},300):(this.statusMessage=this.i18nStore?.t(`webauthn.not_supported`),this.statusType=`error`)}disconnectedCallback(){super.disconnectedCallback(),this.i18nStore?.removeEventListener(`change`,this._handleI18nChange)}async _handleVerify(){this.isLoading=!0,this.statusMessage=this.i18nStore?.t(`webauthn.requesting`),this.statusType=`info`;try{let e=await fetch(`/webauthn/verify/begin`,{method:`POST`});if(!e.ok)throw Error(this.i18nStore?.t(`webauthn.errors.begin_failed`));let t=await e.json();if(!t||!t.publicKey)throw Error(this.i18nStore?.t(`webauthn.errors.invalid_options`));this.statusMessage=this.i18nStore?.t(`webauthn.waiting_for_key`);let n=await fn(t);if(this.statusMessage=this.i18nStore?.t(`webauthn.verifying`),(await(await fetch(`/webauthn/verify/finish`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(n)})).json()).success)this.statusMessage=this.i18nStore?.t(`webauthn.success`),this.statusType=`success`,this.isSuccess=!0,setTimeout(()=>{window.location.hash=`#/`,Ae(),sessionStorage.clear(),window.location.reload()},1e3);else throw Error(this.i18nStore?.t(`webauthn.errors.verification_failed`))}catch(e){this.statusMessage=e.message||this.i18nStore?.t(`webauthn.errors.general`),this.statusType=`error`}finally{this.isLoading=!1}}render(){return s`
      <alps-auth-card
        icon="fingerprint"
      ...
      >
        ...
        <alps-button 
          ...
          ?disabled=${this.isLoading||this.isSuccess||!pn()}
...
`).map(e=>`<p>${e}</p>`).join(``):this.text),onUpdate:({editor:e})=>{this.htmlText=e.getHTML(),this.text=e.getText(),this.dispatchEvent(new CustomEvent(`text-changed`,{detail:{text:this.text,html:this.htmlText},bubbles:!0,composed:!0}))},onTransaction:({editor:e})=>{!e.isActive(`link`)&&this.bubbleMenuState===`edit`&&(this.bubbleMenuState=`view`),this.requestUpdate()}}),this.editor.setEditable(!this.isSending),this.requestUpdate())}clear(){this.replyInputRef.value&&(this.replyInputRef.value.value=``),this.text=``,this.htmlText=``,this.editor&&!this.editor.isDestroyed&&this.editor.commands.clearContent(),this.attachments=[],this.dispatchEvent(new CustomEvent(`text-changed`,{detail:{text:``,html:``},bubbles:!0,composed:!0}))}insertFormatting(e,t=``){if(this.format===`html`&&this.editor&&!this.editor.isDestroyed){e===`**`?this.editor.chain().focus().toggleBold().run():e===`*`&&this.editor.chain().focus().toggleItalic().run();return}let n=this.replyInputRef.value;if(!n)return;let r=n.selectionStart,i=n.selectionEnd,a=n.value,o=a.substring(r,i);if(o.startsWith(e)&&o.endsWith(t)&&o.length>=e.length+t.length){let a=o.substring(e.length,o.length-t.length);n.setRangeText(a,r,i,`select`)}else r>=e.length&&a.substring(r-e.length,r)===e&&i+t.length<=a.length&&a.substring(i,i+t.length)===t?n.setRangeText(o,r-e.length,i+t.length,`select`):(n.setRangeText(e+o+t,r,i,`select`),r===i&&(n.selectionStart=r+e.length,n.selectionEnd=r+e.length));this.text=n.value,this.editor&&!this.editor.isDestroyed&&(this.htmlText=this.editor.getHTML()),this.dispatchEvent(new CustomEvent(`text-changed`,{detail:{text:this.text,html:this.htmlText},bubbles:!0,composed:!0})),n.focus()}insertEmoji(e){if(this.format===`html`&&this.editor&&!this.editor.isDestroyed)this.editor.chain().focus().insertContent(e).run();else{let t=this.replyInputRef.value;if(!t)return;let n=t.selectionStart,r=t.selectionEnd;t.setRangeText(e,n,r,`end`),this.text=t.value,this.editor&&!this.editor.isDestroyed&&(this.htmlText=this.editor.getHTML()),this.dispatchEvent(new CustomEvent(`text-changed`,{detail:{text:this.text,html:this.htmlText},bubbles:!0,composed:!0})),t.focus()}}_handleInput(e){this.text=e.target.value,this.dispatchEvent(new CustomEvent(`text-changed`,{detail:{text:this.text,html:this.htmlText},bubbles:!0,composed:!0}))}static{this.styles=[ft,o`
  ...
  `}render(){if(this.instance.closing)return s`<style>:host { display: none !important; }</style>`;let e=((this.instance.to?.length||0)>0||(this.instance.cc?.length||0)>0||(this.instance.bcc?.length||0)>0)&&(this.instance.text?.trim().length||0)>0,t,n;if(this.instance.minimized)t=24,n=24+this.minimizedIndex*40;else{let e=this.totalMinimized>0?276:0;if(t=24+e+this.openIndex*486,n=0,24+e+this.totalOpen*470>this.windowWidth&&this.totalOpen>1){let n=this.windowWidth-470-48-e,r=n>0?n/(this.totalOpen-1):32;t=24+e+this.openIndex*Math.min(r,470)}}let r,i,a,o,c=this.windowWidth<=768;return this.showDiscardConfirm?(this.style.zIndex=`30000`,c?(a=this.windowWidth,o=this.windowHeight,i=0,r=0,this.removeAttribute(`expanded`)):this.instance.expanded?(a=Math.min(this.windowWidth*.85,800),o=this.windowHeight*.8,i=(this.windowWidth-a)/2,r=(this.windowHeight-o)/2,this.setAttribute(`expanded`,``)):(a=this.instance.minimized?260:470,o=this.instance.minimized?40:500,i=this.windowWidth-t-a,r=this.windowHeight-n-o,this.removeAttribute(`expanded`))):c?(a=this.windowWidth,o=this.windowHeight,i=0,r=0,this.style.zIndex=`30000`,this.removeAttribute(`expanded`)):this.instance.expanded?(a=Math.min(this.windowWidth*.85,800),o=this.windowHeight*.8,i=(this.windowWidth-a)/2,r=(this.windowHeight-o)/2,this.style.zIndex=`30000`,this.setAttribute(`expanded`,``)):(a=this.instance.minimized?260:470,o=this.instance.minimized?40:500,i=this.windowWidth-t-a,r=this.windowHeight-n-o,this.style.zIndex=`${this.instance.zIndex||1e3}`,this.removeAttribute(`expanded`)),this.style.width=`${a}px`,this.style.height=`${o}px`,this.style.left=`${i}px`,this.style.top=`${r}px`,this.instance.minimized?this.setAttribute(`minimized`,``):this.removeAttribute(`minimized`),s`
    ...
    `}};j([f({context:ct})],Q.prototype,`composeStore`,void 0),j([f({context:C})],Q.prototype,`i18nStore`,void 0),j([f({context:w})],Q.prototype,`settingsStore`,void 0),j([i({type:Object})],Q.prototype,`instance`,void 0),j([i({type:Number})],Q.prototype,`index`,void 0),j([i({type:Number})],Q.prototype,`totalOpen`,void 0),j([i({type:Number})],Q.prototype,`totalMinimized`,void 0),j([i({type:Number})],Q.prototype,`openIndex`,void 0),j([i({type:Number})],Q.prototype,`minimizedIndex`,void 0),j([_()],Q.prototype,`showCc`,void 0),j([_()],Q.prototype,`showBcc`,void 0),j([_()],Q.prototype,`showDiscardConfirm`,void 0),j([_()],Q.prototype,`pendingDiscardType`,void 0),j([_()],Q.prototype,`windowWidth`,void 0),j([_()],Q.prototype,`windowHeight`,void 0),j([_()],Q.prototype,`isSaving`,void 0),j([_()],Q.prototype,`isDragOver`,void 0),j([_()],Q.prototype,`linkPromptFields`,void 0),Q=j([a(`alps-floating-composer`)],Q);var Dn=class extends p{constructor(...e){super(...e),this.show=!1,this.message=``,this.actionLabel=``,this.timeout=0,this._timer=null}updated(e){e.has(`show`)&&(this.show&&this.timeout>0?(this._timer&&clearTimeout(this._timer),this._timer=setTimeout(()=>{this.dismiss()},this.timeout)):!this.show&&this._timer&&(clearTimeout(this._timer),this._timer=null))}dismiss(){this.show=!1,this.dispatchEvent(new CustomEvent(`dismiss`)),this.onAction=void 0}handleAction(){this.onAction?this.onAction():this.dispatchEvent(new CustomEvent(`action`)),this.dismiss()}static{this.styles=o`
    :host {
      display: block;
  ...
  `}render(){return s`
    ...
    `}};j([f({context:C})],Dn.prototype,`i18nStore`,void 0),j([i({type:Boolean,reflect:!0})],Dn.prototype,`show`,void 0),j([i({type:String})],Dn.prototype,`message`,void 0),j([i({type:String})],Dn.prototype,`actionLabel`,void 0),j([i({type:Object})],Dn.prototype,`onAction`,void 0),j([i({type:Number})],Dn.prototype,`timeout`,void 0),Dn=j([a(`alps-toast`)],Dn);var On=new class{constructor(){this.events=[`mousedown`,`mousemove`,`keypress`,`scroll`,`touchstart`],this.logoutMinutes=0,this.lastActivity=Date.now(),this.lastPing=Date.now(),this.checkInterval=null,this.handleActivity=()=>{this.lastActivity=Date.now()}}setLogoutTime(e){let t=this.logoutMinutes>0;this.logoutMinutes=e;let n=this.logoutMinutes>0;n&&!t?(this.attachEvents(),this.startInterval()):!n&&t?(this.detachEvents(),this.clearInterval()):n&&t&&(this.lastActivity=Date.now())}attachEvents(){this.events.forEach(e=>document.addEventListener(e,this.handleActivity,{passive:!0})),this.lastActivity=Date.now()}detachEvents(){this.events.forEach(e=>document.removeEventListener(e,this.handleActivity))}startInterval(){this.clearInterval(),this.checkInterval=setInterval(()=>this.checkTimeout(),3e4)}clearInterval(){this.checkInterval&&=(clearInterval(this.checkInterval),null)}checkTimeout(){if(this.logoutMinutes<=0)return;if(window.location.hash===`#/login`||window.location.hash===``){this.lastActivity=Date.now();return}let e=Date.now()-this.lastActivity;e>=this.logoutMinutes*60*1e3?this.logout():e<300*1e3&&Date.now()-this.lastPing>300*1e3&&this.pingBackend()}async pingBackend(){this.lastPing=Date.now();try{await fetch(`/session`)}catch{}}async logout(){if(this.clearInterval(),this.detachEvents(),this.onBeforeLogout)try{await this.onBeforeLogout()}catch(e){x.error(`Failed to run onBeforeLogout hook`,e)}try{await fetch(`/session`,{method:`DELETE`}),Ge.clear(),Ae(),window.dispatchEvent(new CustomEvent(`session-cleared`)),window.location.hash=`#/login`,this.lastActivity=Date.now(),this.setLogoutTime(this.logoutMinutes)}catch(e){x.error(`Failed to auto sign out`,e)}}},kn=3e3,$=class extends p{constructor(...e){super(...e),this.composeStore=new st,this.settingsStore=new ke,this.i18nStore=new Ee,this.linkedAccountsStore=lt,this.activeComposers=[],this.toasts=[],this.toastIdCounter=0,this.isOffline=!navigator.onLine,this.offlineCountdown=0,this.offlineInterval=null,this._handleGlobalDragOver=e=>{e.preventDefault()},this._handleGlobalDrop=e=>{e.preventDefault(),window.dispatchEvent(new CustomEvent(`alps-composer-drop`))},this._handleAuthError=()=>{sessionStorage.clear(),Ae(),window.dispatchEvent(new CustomEvent(`session-cleared`)),window.location.hash=`#/login`},this._verifyConnectivity=async()=>{if(!navigator.onLine)return!1;try{let e=await fetch(`/site.webmanifest`,{method:`HEAD`,cache:`no-store`});return!(e.status===502||e.status===503||e.status===504)}catch{return!1}},this._handleOnlineEvent=async()=>{await this._verifyConnectivity()?(this.isOffline=!1,this._stopOfflineCountdown()):this._handleOfflineEvent()},this._handleOfflineEvent=()=>{this.isOffline||(this.isOffline=!0,this.offlineCountdown=10,this._startOfflineCountdown())},this._isPinging=!1,this._handleShowToast=e=>{let t=++this.toastIdCounter,n={id:t,message:e.detail.message,actionLabel:e.detail.actionLabel||``,actionFn:e.detail.actionFn,timeout:e.detail.duration||kn,show:!1};this.toasts=[...this.toasts,n],requestAnimationFrame(()=>{this.toasts=this.toasts.map(e=>e.id===t?{...e,show:!0}:e)})},this._handleBeforeUnload=e=>{if(this.activeComposers.some(e=>e.isSending))return e.preventDefault(),`You have a message currently sending. Are you sure you want to leave?`},this._handleComposeChange=()=>{this.activeComposers=this.composeStore.getState().activeComposers},this._handleSettingsChange=()=>{let e=this.settingsStore.getState();On.setLogoutTime(e.autoLogout||0),this.i18nStore.setLanguage(e.language||`en`)},this.mailboxPageTemplate=s`<mailbox-page></mailbox-page>`,this.router=new on(this.getRoutes(),()=>s`<div>404 Not Found</div>`,()=>this.requestUpdate())}static{this.styles=o`
    :host {
      display: block;
      height: 100vh;
      width: 100vw;
  ...
  `}connectedCallback(){super.connectedCallback(),!(document.cookie.split(`;`).some(e=>e.trim().startsWith(`alps_logged_in=1`))||document.cookie.split(`;`).some(e=>e.trim().startsWith(`alps_has_login_token=1`)))&&!window.location.hash.startsWith(`#/login`)&&(window.location.hash=`#/login`),this.composeStore.addEventListener(`change`,this._handleComposeChange),this.settingsStore.addEventListener(`change`,this._handleSettingsChange),this.activeComposers=this.composeStore.getState().activeComposers,On.setLogoutTime(this.settingsStore.getState().autoLogout||0),On.onBeforeLogout=async()=>{await this.composeStore.saveAllDirtyDrafts()},this.i18nStore.setLanguage(this.settingsStore.getState().language||`en`),window.addEventListener(`auth-error`,this._handleAuthError),window.addEventListener(`show-toast`,this._handleShowToast),window.addEventListener(`beforeunload`,this._handleBeforeUnload),window.addEventListener(`online`,this._handleOnlineEvent),window.addEventListener(`offline`,this._handleOfflineEvent),window.addEventListener(`network-error`,this._handleOfflineEvent),window.addEventListener(`dragover`,this._handleGlobalDragOver),window.addEventListener(`drop`,this._handleGlobalDrop),this.isOffline&&this._handleOfflineEvent()}disconnectedCallback(){super.disconnectedCallback(),this.composeStore.removeEventListener(`change`,this._handleComposeChange),this.settingsStore.removeEventListener(`change`,this._handleSettingsChange),window.removeEventListener(`auth-error`,this._handleAuthError),window.removeEventListener(`show-toast`,this._handleShowToast),window.removeEventListener(`beforeunload`,this._handleBeforeUnload),window.removeEventListener(`online`,this._handleOnlineEvent),window.removeEventListener(`offline`,this._handleOfflineEvent),window.removeEventListener(`network-error`,this._handleOfflineEvent),window.removeEventListener(`dragover`,this._handleGlobalDragOver),window.removeEventListener(`drop`,this._handleGlobalDrop),this._stopOfflineCountdown()}_startOfflineCountdown(){this._stopOfflineCountdown(),this.offlineInterval=window.setInterval(async()=>{if(this.offlineCountdown>1)this.offlineCountdown--;else{if(this.offlineCountdown=10,this._isPinging)return;this._isPinging=!0;try{await this._verifyConnectivity()&&(this.isOffline=!1,this._stopOfflineCountdown())}finally{this._isPinging=!1}}},1e3)}_stopOfflineCountdown(){this.offlineInterval!==null&&(clearInterval(this.offlineInterval),this.offlineInterval=null)}_handleDismissToast(e){this.toasts=this.toasts.map(t=>t.id===e?{...t,show:!1}:t),setTimeout(()=>{this.toasts=this.toasts.filter(t=>t.id!==e)},300)}getRoutes(){let e={"/":()=>this.mailboxPageTemplate,"/login":()=>s`<login-page></login-page>`,"/mailbox/*":()=>this.mailboxPageTemplate,"/settings":()=>s`<settings-page category="general"></settings-page>`,"/settings/*":()=>{let e=window.location.hash.match(/^#\/settings\/?(.*)$/);return s`<settings-page .category=${e&&e[1]?e[1].split(`?`)[0]:`general`}></settings-page>`},"/original":()=>s`<original-message-page></original-message-page>`,"/print":()=>s`<print-page></print-page>`,"/login/webauthn":()=>s`<login-webauthn-page></login-webauthn-page>`};return v.getRoutes().forEach(t=>{let n=null;e[t.path]=()=>(n||=document.createElement(t.component),n)}),e}render(){let e=this.activeComposers.filter(e=>!e.minimized).length,t=this.activeComposers.filter(e=>e.minimized).length,n=0,r=0;return s`
      ...
      `:``}
    `}};j([h({context:ct})],$.prototype,`composeStore`,void 0),j([h({context:w})],$.prototype,`settingsStore`,void 0),j([h({context:C})],$.prototype,`i18nStore`,void 0),j([h({context:ut})],$.prototype,`linkedAccountsStore`,void 0),j([_()],$.prototype,`activeComposers`,void 0),j([_()],$.prototype,`toasts`,void 0),j([_()],$.prototype,`isOffline`,void 0),j([_()],$.prototype,`offlineCountdown`,void 0),$=j([a(`app-root`)],$);var An=Object.assign({"../../plugins/carddav/frontend/index.ts":Yt,"../../plugins/managesieve/frontend/index.ts":nn,"../../plugins/password/frontend/index.ts":an});x.info(`Loaded ${Object.keys(An).length} frontend plugins.`);