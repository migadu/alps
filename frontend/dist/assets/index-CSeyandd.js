...
`,Tt=class extends d{constructor(...e){super(...e),this.title=``,this.isDanger=!1,this.dismissible=!1,this.width=`400px`,this._handleEscape=e=>{this.dismissible||e.preventDefault()},this._handleDialogClose=()=>{this.dispatchEvent(new CustomEvent(`cancel`,{bubbles:!0,composed:!0}))}}static{this.styles=n`
  ...
  `}handleInput(e){let t=e.target;this.value=t.value,this.dispatchEvent(new Event(`input`,{bubbles:!0,composed:!0})),this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))}togglePassword(){this.showPassword=!this.showPassword}handleClear(){this.value=``,this.dispatchEvent(new Event(`input`,{bubbles:!0,composed:!0})),this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0})),this.dispatchEvent(new Event(`clear`,{bubbles:!0,composed:!0}))}handleKeyDown(e){if(e.key===`Enter`){let t=this.closest(`form`);t&&(e.preventDefault(),t.requestSubmit())}}checkValidity(){let e=this.shadowRoot?.querySelector(`input`);return e?e.checkValidity():!0}reportValidity(){let e=this.shadowRoot?.querySelector(`input`);return e?e.reportValidity():!0}focus(){let e=this.shadowRoot?.querySelector(`input`);e&&e.focus()}connectedCallback(){super.connectedCallback(),this.i18nStore?.addEventListener(`change`,this._handleI18nChange)}disconnectedCallback(){super.disconnectedCallback(),this.i18nStore?.removeEventListener(`change`,this._handleI18nChange)}render(){let e=this.type===`password`,t=e&&this.showPassword?`text`:this.type,n=this.icon||(this.type===`email`?`at`:``);return s`
    ...
    `}getMonthGrid(){let e=new Date(this.year,this.month,1).getDay();e===0&&(e=7);let t=1-(e-1),n=new Date(this.year,this.month+1,0).getDate(),r=Math.ceil((n+(e-1))/7)*7,i=[];for(let e=0;e<r;e++)i.push(new Date(this.year,this.month,t+e));return i}hasEventsForDate(e){if(!this.events||this.events.length===0)return!1;let t=new Date(e);t.setHours(0,0,0,0);let n=new Date(e);return n.setHours(23,59,59,999),this.events.some(e=>{if(Ue(e)){let n=e.start.split(`T`)[0],r=e.end.split(`T`)[0],i=new Date(n+`T00:00:00`),a=new Date(r+`T00:00:00`);return i<=t&&a>t}else{let r=new Date(e.start),i=new Date(e.end);return i.getTime()===t.getTime()&&r.getTime()<i.getTime()?!1:r<=n&&i>=t}})}handleDateClick(e){this.dispatchEvent(new CustomEvent(`date-selected`,{detail:{date:e},bubbles:!0,composed:!0}))}render(){let e=this.getMonthGrid(),t=Array.from({length:7},(e,t)=>{let n=new Date(2021,10,t+1);return this.i18nStore?.t(`calendar.daysNarrow.${n.getDay()}`)}),n=new Date;n.setHours(0,0,0,0);let r=this.i18nStore?.t(`calendar.months.${this.month}`);return s`
        ...
        `}};k([g({context:C})],Dt.prototype,`i18nStore`,void 0),k([o({type:Number})],Dt.prototype,`year`,void 0),k([o({type:Number})],Dt.prototype,`month`,void 0),k([o({type:Array})],Dt.prototype,`events`,void 0),k([o({type:Boolean})],Dt.prototype,`showTitle`,void 0),k([o({type:Object})],Dt.prototype,`currentDate`,void 0),Dt=k([m(`calendar-mini-month`)],Dt);var Ot=n`
  .dropdown-header {
...
`,kt=class extends d{constructor(...e){super(...e),this.align=`right`,this.position=`bottom`,this.triggerOn=`click`,this.openState=!1,this._handleDialogClick=e=>{this.openState&&e.target===e.currentTarget&&(e.stopPropagation(),e.preventDefault(),this.close())},this._handleDialogClose=()=>{this.openState&&this.close()},this._handleDialogKeydown=e=>{if(this.openState){if(e.key===`ArrowDown`||e.key===`ArrowUp`){e.preventDefault();let t=this._getFocusableElements();if(t.length===0)return;let n=this._getActiveElement(),r=t.findIndex(e=>e===n);r=e.key===`ArrowDown`?r===-1?0:(r+1)%t.length:r===-1?t.length-1:(r-1+t.length)%t.length,t[r].focus()}else if(e.key===`Enter`||e.key===` `){let t=this._getActiveElement();t&&typeof t.click==`function`&&(e.preventDefault(),t.click())}}},this._closeTimeout=null,this._handleMouseEnter=()=>{this.triggerOn===`hover`&&(this._closeTimeout&&=(clearTimeout(this._closeTimeout),null),this.open())},this._handleMouseLeave=()=>{this.triggerOn===`hover`&&(this._closeTimeout&&clearTimeout(this._closeTimeout),this._closeTimeout=setTimeout(()=>{this.close(),this._closeTimeout=null},300))},this._handleResize=()=>{this.openState&&this._updatePosition()}}static{this.styles=n`
  ...
  `}open(){this.openState=!0,this.dispatchEvent(new CustomEvent(`popup-open`,{bubbles:!0,composed:!0}))}close(){this.openState=!1,this.dispatchEvent(new CustomEvent(`popup-close`,{bubbles:!0,composed:!0}))}toggle(e){if(this.triggerOn===`hover`){e.stopPropagation();return}this.openState?this.close():this.open()}_getActiveElement(){let e=document.activeElement;for(;e?.shadowRoot&&e.shadowRoot.activeElement;)e=e.shadowRoot.activeElement;return e}_getFocusableElements(){let e=this.shadowRoot?.querySelector(`slot:not([name])`);if(!e)return[];let t=e.assignedElements({flatten:!0}),n=[],r=`button:not([disabled]), a[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])`;return t.forEach(e=>{if(e instanceof HTMLElement){e.matches(r)&&n.push(e);let t=Array.from(e.querySelectorAll(r));n.push(...t)}}),n}updated(e){if(super.updated(e),e.has(`openState`)){let e=this.shadowRoot?.querySelector(`.popup-dialog`);if(this.openState)e&&!e.open&&(this.triggerOn===`hover`?e.show():e.showModal()),this._updatePosition();else if(e&&e.open){e.close();let t=this.shadowRoot?.querySelector(`slot[name="trigger"]`);t&&t.assignedElements({flatten:!0}).forEach(e=>{e instanceof HTMLElement&&e.blur()})}}}_updatePosition(){let e=this.shadowRoot?.querySelector(`.trigger`),t=this.shadowRoot?.querySelector(`.popup-content`);if(!e||!t)return;let n=e.getBoundingClientRect(),r=t.getBoundingClientRect(),i=this.position,a=this.align;if(t.style.top=``,t.style.bottom=``,t.style.left=``,t.style.right=``,t.style.removeProperty(`--arrow-right`),t.style.removeProperty(`--arrow-left`),t.style.removeProperty(`--arrow-top`),t.style.removeProperty(`--arrow-bottom`),this.position===`left`||this.position===`right`){this.position===`right`?n.right+6+r.width>window.innerWidth&&n.left-6-r.width>=0&&(i=`left`):n.left-6-r.width<0&&n.right+6+r.width<=window.innerWidth&&(i=`right`),this.align===`top`?n.top+r.height>window.innerHeight&&n.bottom-r.height>=0&&(a=`bottom`):n.bottom-r.height<0&&n.top+r.height<=window.innerHeight&&(a=`top`),i===`right`?(t.style.left=`${n.right+6}px`,t.style.right=`auto`):(t.style.right=`${window.innerWidth-n.left+6}px`,t.style.left=`auto`);let e=n.top+n.height/2;if(a===`top`){let i=n.top-4;i+r.height>window.innerHeight&&(i=window.innerHeight-r.height-8),i=Math.max(8,i),t.style.top=`${i}px`,t.style.bottom=`auto`;let a=e-i-6;t.style.setProperty(`--arrow-top`,`${Math.max(10,Math.min(r.height-20,a))}px`)}else{let i=window.innerHeight-n.bottom-4;i+r.height>window.innerHeight&&(i=window.innerHeight-r.height-8),i=Math.max(8,i),t.style.bottom=`${i}px`,t.style.top=`auto`;let a=e-(window.innerHeight-i-r.height)-6;t.style.setProperty(`--arrow-top`,`${Math.max(10,Math.min(r.height-20,a))}px`)}}else if(this.position===`bottom`?n.bottom+8+r.height>window.innerHeight&&n.top-8-r.height>=0&&(i=`top`):n.top-8-r.height<0&&n.bottom+8+r.height<=window.innerHeight&&(i=`bottom`),this.align===`right`?n.right-r.width<0&&n.left+r.width<=window.innerWidth&&(a=`left`):n.left+r.width>window.innerWidth&&n.right-r.width>=0&&(a=`right`),i===`bottom`?(t.style.top=`${n.bottom+8}px`,t.style.bottom=`auto`):(t.style.bottom=`${window.innerHeight-n.top+8}px`,t.style.top=`auto`),a===`right`){let e=window.innerWidth-n.right;e+r.width>window.innerWidth&&(e=window.innerWidth-r.width-8),e=Math.max(8,e),t.style.right=`${e}px`,t.style.left=`auto`;let i=n.left+n.width/2,a=window.innerWidth-e-i-6;t.style.setProperty(`--arrow-right`,`${Math.max(10,Math.min(r.width-20,a))}px`)}else{let e=n.left;e+r.width>window.innerWidth&&(e=window.innerWidth-r.width-8),e=Math.max(8,e),t.style.left=`${e}px`,t.style.right=`auto`;let i=n.left+n.width/2-e-6;t.style.setProperty(`--arrow-left`,`${Math.max(10,Math.min(r.width-20,i))}px`)}t.classList.remove(`position-top`,`position-bottom`,`position-left`,`position-right`,`align-left`,`align-right`,`align-top`,`align-bottom`),t.classList.add(`position-${i}`,`align-${a}`)}connectedCallback(){super.connectedCallback(),window.addEventListener(`resize`,this._handleResize,{passive:!0}),this.addEventListener(`mouseenter`,this._handleMouseEnter),this.addEventListener(`mouseleave`,this._handleMouseLeave)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener(`resize`,this._handleResize),this.removeEventListener(`mouseenter`,this._handleMouseEnter),this.removeEventListener(`mouseleave`,this._handleMouseLeave),this._closeTimeout&&=(clearTimeout(this._closeTimeout),null);let e=this.shadowRoot?.querySelector(`.popup-dialog`);e?.open&&e.close(),this.openState=!1}render(){return s`
    ...
    `}};k([o({type:String})],kt.prototype,`align`,void 0),k([o({type:String})],kt.prototype,`position`,void 0),k([o({type:String,reflect:!0})],kt.prototype,`triggerOn`,void 0),k([o({type:Boolean,reflect:!0,attribute:`open`})],kt.prototype,`openState`,void 0),kt=k([m(`alps-popup`)],kt);var At=class extends d{static{this.styles=n`
        :host {
            display: block;
            padding: 12px;
            min-width: 280px;
    ...
    `}formatEventDate(e){let t=e.start,n=Ue(e),r;return r=n?new Date(t.split(`T`)[0]+`T00:00:00`):new Date(t),`${this.i18nStore?.t(`calendar.days.${r.getDay()}`)}, ${this.i18nStore?.t(`calendar.monthsShort.${r.getMonth()}`)} ${r.getDate()}, ${r.getFullYear()}`}formatEventTimeRange(e){let t=new Date(e.start),n=new Date(e.end);if(Ue(e))return this.i18nStore?.t(`calendar.allDay`);let r={hour:`numeric`,minute:`2-digit`};return t.toDateString()===n.toDateString()?`${t.toLocaleTimeString(void 0,r)} - ${n.toLocaleTimeString(void 0,r)}`:`${t.toLocaleTimeString(void 0,r)} - ${this.i18nStore?.t(`calendar.monthsShort.${n.getMonth()}`)} ${n.getDate()} ${n.toLocaleTimeString(void 0,r)}`}handleEdit(e){e.stopPropagation();let t=this.closest(`alps-popup`);t&&t.close(),setTimeout(()=>{this.dispatchEvent(new CustomEvent(`edit-event`,{detail:{event:this.event},bubbles:!0,composed:!0}))},10)}handleDelete(e){e.stopPropagation();let t=this.closest(`alps-popup`);t&&t.close(),setTimeout(()=>{this.dispatchEvent(new CustomEvent(`delete-event`,{detail:{event:this.event},bubbles:!0,composed:!0}))},10)}render(){if(!this.event)return s``;let e=this.event;return s`
        ...
        `}};k([g({context:C})],At.prototype,`i18nStore`,void 0),k([o({type:Object})],At.prototype,`event`,void 0),At=k([m(`calendar-event-preview`)],At);var jt=class extends d{constructor(...e){super(...e),this.days=[],this.events=[],this.scrolled=!1}static{this.styles=n`
        :host {
            display: flex;
            flex-direction: column;
            height: 100%;
    ...
    `}getEventsForDate(e,t){return this.events?this.events.filter(n=>{let r=Ue(n);if(t!==r)return!1;let i=new Date(e);i.setHours(0,0,0,0);let a=new Date(e);if(a.setHours(23,59,59,999),r){let e=n.start.split(`T`)[0],t=n.end.split(`T`)[0],r=new Date(e+`T00:00:00`),a=new Date(t+`T00:00:00`);return r<=i&&a>i}else{let e=new Date(n.start),t=new Date(n.end);return t.getTime()===i.getTime()&&e.getTime()<t.getTime()?!1:e<=a&&t>=i}}):[]}handleColumnClick(e,t){let n=e.currentTarget.getBoundingClientRect(),r=e.clientY-n.top,i=Math.floor(r/48),a=new Date(t);a.setHours(i,0,0,0),this.dispatchEvent(new CustomEvent(`create-event`,{detail:{date:a,allDay:!1},bubbles:!0,composed:!0}))}handleAllDayCellClick(e){let t=new Date(e);t.setHours(0,0,0,0),this.dispatchEvent(new CustomEvent(`create-event`,{detail:{date:t,allDay:!0},bubbles:!0,composed:!0}))}handleScroll(e){let t=e.target;this.scrolled=t.scrollTop>0}render(){let e=Array.from({length:24},(e,t)=>t),t=new Date;return t.setHours(0,0,0,0),s`
        ...
        `}};k([g({context:C})],jt.prototype,`i18nStore`,void 0),k([o({type:Array})],jt.prototype,`days`,void 0),k([o({type:Array})],jt.prototype,`events`,void 0),k([a()],jt.prototype,`scrolled`,void 0),jt=k([m(`calendar-time-grid`)],jt);var Mt=class extends d{constructor(...e){super(...e),this.events=[]}static{this.styles=n`
        :host {
            display: flex;
            height: 100%;
            width: 100%;
    ...
    `}render(){return s`
            <calendar-time-grid 
                ...
                .events=${this.events}
            ></calendar-time-grid>
        `}};k([o({type:Object})],Mt.prototype,`date`,void 0),k([o({type:Array})],Mt.prototype,`events`,void 0),Mt=k([m(`calendar-day-view`)],Mt);var Nt=class extends d{constructor(...e){super(...e),this.events=[]}static{this.styles=n`
        :host {
            display: flex;
            height: 100%;
            width: 100%;
    ...
    `}getWeekDays(){let e=[],t=Ge(this.date);for(let n=0;n<7;n++)e.push(new Date(t)),t.setDate(t.getDate()+1);return e}render(){return s`
            <calendar-time-grid 
                ...
                .events=${this.events}
            ></calendar-time-grid>
        `}};k([o({type:Object})],Nt.prototype,`date`,void 0),k([o({type:Array})],Nt.prototype,`events`,void 0),Nt=k([m(`calendar-week-view`)],Nt);var Pt=class extends d{constructor(...e){super(...e),this.events=[]}static{this.styles=n`
        :host {
            display: flex;
            flex-direction: column;
            height: 100%;
    ...
    `}getMonthGrid(){let e=this.date.getFullYear(),t=this.date.getMonth(),n=new Date(e,t,1).getDay();n===0&&(n=7);let r=1-(n-1),i=new Date(e,t+1,0).getDate(),a=Math.ceil((i+(n-1))/7)*7,o=[];for(let n=0;n<a;n++)o.push(new Date(e,t,r+n));return o}getEventsForDate(e,t){return this.events?this.events.filter(n=>{let r=Ue(n);if(t!==r)return!1;let i=new Date(e);i.setHours(0,0,0,0);let a=new Date(e);if(a.setHours(23,59,59,999),r){let e=n.start.split(`T`)[0],t=n.end.split(`T`)[0],r=new Date(e+`T00:00:00`),a=new Date(t+`T00:00:00`);return r<=i&&a>i}else{let e=new Date(n.start),t=new Date(n.end);return t.getTime()===i.getTime()&&e.getTime()<t.getTime()?!1:e<=a&&t>=i}}):[]}handleCellClick(e){this.dispatchEvent(new CustomEvent(`create-event`,{detail:{date:e,allDay:!0},bubbles:!0,composed:!0}))}render(){let e=this.getMonthGrid(),t=Array.from({length:7},(e,t)=>{let n=new Date(2021,10,t+1);return this.i18nStore?.t(`calendar.daysShort.${n.getDay()}`)}),n=new Date;return n.setHours(0,0,0,0),s`
        ...
        `}};k([g({context:C})],Pt.prototype,`i18nStore`,void 0),k([o({type:Object})],Pt.prototype,`date`,void 0),k([o({type:Array})],Pt.prototype,`events`,void 0),Pt=k([m(`calendar-month-view`)],Pt);var Ft=class extends d{constructor(...e){super(...e),this.events=[]}static{this.styles=n`
        :host {
            display: flex;
            height: 100%;
            width: 100%;
    ...
    `}render(){return s`
        ...
        `}};k([o({type:Number})],Ft.prototype,`year`,void 0),k([o({type:Array})],Ft.prototype,`events`,void 0),Ft=k([m(`calendar-year-view`)],Ft);var It=class extends d{constructor(...e){super(...e),this.events=[]}static{this.styles=n`
        :host {
            display: flex;
            flex-direction: column;
            width: 100%;
    ...
    `}render(){return this.events.length===0?s`
        ...
        `}};k([g({context:C})],It.prototype,`i18nStore`,void 0),k([o({type:Array})],It.prototype,`events`,void 0),It=k([m(`calendar-list-view`)],It);var Lt=class extends d{constructor(...e){super(...e),this.selectedDate=new Date,this.events=[],this.viewDate=new Date}static{this.styles=n`
        :host {
            display: flex;
            flex-direction: column;
            width: 100%;
    ...
    `}updated(e){e.has(`selectedDate`)&&this.selectedDate&&(this.viewDate=new Date(this.selectedDate))}changeMonth(e){let t=new Date(this.viewDate);t.setMonth(t.getMonth()+e),this.viewDate=t}render(){let e=this.viewDate.getFullYear(),t=this.viewDate.getMonth();return s`
        ...
        `}};k([g({context:C})],Lt.prototype,`i18nStore`,void 0),k([o({type:Object})],Lt.prototype,`selectedDate`,void 0),k([o({type:Array})],Lt.prototype,`events`,void 0),k([a()],Lt.prototype,`viewDate`,void 0),Lt=k([m(`alps-sidebar-calendar`)],Lt);var Rt=class extends d{constructor(...e){super(...e),this._handleI18nChange=()=>this.requestUpdate(),this.label=`Today`}static{this.styles=n`
        :host {
            display: inline-flex;
        }
    ...
    `}handlePrevious(){this.dispatchEvent(new CustomEvent(`previous`,{bubbles:!0,composed:!0}))}handleNext(){this.dispatchEvent(new CustomEvent(`next`,{bubbles:!0,composed:!0}))}handleCenter(){this.dispatchEvent(new CustomEvent(`center`,{bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this.i18nStore?.addEventListener(`change`,this._handleI18nChange)}disconnectedCallback(){super.disconnectedCallback(),this.i18nStore?.removeEventListener(`change`,this._handleI18nChange)}render(){return s`
        ...
        `}};k([g({context:C})],Rt.prototype,`i18nStore`,void 0),k([o({type:String})],Rt.prototype,`label`,void 0),Rt=k([m(`alps-nav-buttons`)],Rt);var zt=class extends d{constructor(...e){super(...e),this.title=`Prompt`,this.fields=[],this.confirmText=`Apply`,this.cancelText=`Cancel`,this.busy=!1,this.values={},this.submitted=!1}static{this.styles=[wt,n`
      .field-group {
        margin-bottom: 16px;
      }
    ...
    `}};k([o({type:String})],zt.prototype,`title`,void 0),k([o({type:Array})],zt.prototype,`fields`,void 0),k([o({type:String})],zt.prototype,`confirmText`,void 0),k([o({type:String})],zt.prototype,`cancelText`,void 0),k([o({type:Boolean})],zt.prototype,`busy`,void 0),k([a()],zt.prototype,`values`,void 0),k([a()],zt.prototype,`submitted`,void 0),zt=k([m(`ui-prompt`)],zt);var Bt=class extends d{constructor(...e){super(...e),this.title=`Confirm`,this.message=`Are you sure?`,this.confirmText=`Confirm`,this.cancelText=`Cancel`,this.isDanger=!1,this.dismissible=!1}static{this.styles=[wt]}_handleCancel(e){e.stopPropagation(),this.dispatchEvent(new CustomEvent(`cancel`,{bubbles:!0,composed:!0}))}_handleSecondary(e){e.stopPropagation(),this.dispatchEvent(new CustomEvent(`secondary`,{bubbles:!0,composed:!0}))}_handleConfirm(e){e.stopPropagation(),this.dispatchEvent(new CustomEvent(`confirm`,{bubbles:!0,composed:!0}))}render(){return s`
      <ui-modal 
        .title=${this.title}
    ...
    `]}async connectedCallback(){super.connectedCallback(),window.addEventListener(`resize`,this.handleResize),window.addEventListener(`hashchange`,this.handleHashChange),this.settingsStore&&(this.settingsStore.addEventListener(`change`,this._handleSettingsChange),this._handleSettingsChange()),this.parseHash(),await this.fetchData()}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener(`resize`,this.handleResize),window.removeEventListener(`hashchange`,this.handleHashChange),this.settingsStore&&this.settingsStore.removeEventListener(`change`,this._handleSettingsChange),this.syncIntervalTimer&&=(clearInterval(this.syncIntervalTimer),null)}reportFailure(e){window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:this.i18nStore?.t(e),duration:5e3}}))}parseHash(){let e=window.location.hash;if(!e.startsWith(`#/calendar`))return!1;let[t,n]=e.substring(1).split(`?`),r=t.split(`/`),i=!1;if(r.length>=3){let e=r[2];[`day`,`week`,`month`,`year`].includes(e)&&this.viewMode!==e&&(this.viewMode=e,i=!0)}if(r.length>=4){let e=r[3],t=new Date(this.currentDate);if(this.viewMode===`year`){let n=parseInt(e,10);isNaN(n)||t.setFullYear(n)}else if(this.viewMode===`month`){let[n,r]=e.split(`-`);n&&r&&(t=new Date(parseInt(n,10),parseInt(r,10)-1,1))}else{let[n,r,i]=e.split(`-`);n&&r&&i&&(t=new Date(parseInt(n,10),parseInt(r,10)-1,parseInt(i,10)))}(t.getFullYear()!==this.currentDate.getFullYear()||t.getMonth()!==this.currentDate.getMonth()||t.getDate()!==this.currentDate.getDate())&&(this.currentDate=t,i=!0)}let a=``;return n&&(a=new URLSearchParams(`?`+n).get(`q`)||``),this.searchQuery!==a&&(this.searchQuery=a,i=!0),t===`/calendar`||t===`/calendar/`?(this.navigate(this.viewMode,this.currentDate,this.searchQuery),!1):i}navigate(e,t,n=``){let r=t.getFullYear(),i=String(t.getMonth()+1).padStart(2,`0`),a=String(t.getDate()).padStart(2,`0`),o=`#/calendar/${e}`;e===`year`?o+=`/${r}`:e===`month`?o+=`/${r}-${i}`:o+=`/${r}-${i}-${a}`,n&&(o+=`?q=${encodeURIComponent(n)}`),window.location.hash===o?this.fetchData():window.location.hash=o}handleSidebarMouseEnter(){this.sidebarCollapsed&&!this.isSidebarDragging&&(clearTimeout(this.hoverTimeout),this.hoverTimeout=setTimeout(()=>{this.isSidebarHovered=!0,this.suppressSidebarHover=!1},300))}handleSidebarMouseLeave(){this.sidebarCollapsed&&(clearTimeout(this.hoverTimeout),this.isSidebarHovered=!1)}async fetchData(){this.loading=!0,this.isSpinning=!0,this.error=``;try{let e=await Ke.fetchCalendars(),t,n,r=this.currentDate.getFullYear(),i=this.currentDate.getMonth();this.viewMode===`year`?(t=new Date(r,0,1),n=new Date(r,11,31)):this.viewMode===`month`?(t=new Date(r,i,1),n=new Date(r,i+1,0),t.setDate(t.getDate()-14),n.setDate(n.getDate()+14)):this.viewMode===`week`?(t=Ge(this.currentDate),n=new Date(t),n.setDate(t.getDate()+7)):(t=new Date(this.currentDate),t.setHours(0,0,0,0),n=new Date(this.currentDate),n.setHours(23,59,59,999));let a=(await Ke.fetchEvents(t,n,this.searchQuery)).events||[],o=[];for(let e of a)if(e.rrule)try{let r=new Date(e.start),i=new Date(e.end).getTime()-r.getTime(),a=v.parseString(e.rrule);a.dtstart=r;let s=new v(a).between(t,n,!0);for(let t of s)o.push({...e,start:t.toISOString(),end:new Date(t.getTime()+i).toISOString()})}catch(t){console.error(`Failed to parse rrule for event`,e.uid,t),o.push(e)}else o.push(e);this.events=o.map(e=>({...e,color:e.color||He(e.calendarPath||e.path)})),this.calendars=e.calendars.map(e=>({...e,color:e.color||He(e.path)})),this.activeCalendars.size===0&&this.calendars.length>0&&(this.activeCalendars=new Set(this.calendars.map(e=>e.path)))}catch(e){console.error(e),this.error=`Failed to load calendar data.`}finally{this.loading=!1}}changeDate(e,t){let n=new Date(this.currentDate),r=t||this.viewMode;r===`year`?n.setFullYear(n.getFullYear()+e):r===`month`?n.setMonth(n.getMonth()+e):r===`week`?n.setDate(n.getDate()+e*7):n.setDate(n.getDate()+e),this.navigate(r,n)}openCreateModal(e,t){this.selectedEvent=void 0,this.initialDate=e,this.initialAllDay=t,this.modalOpen=!0}openEditModal(e){this.selectedEvent=e,this.initialDate=void 0,this.initialAllDay=void 0,this.modalOpen=!0}handleModalClose(){this.modalOpen=!1,this.selectedEvent=void 0,this.initialDate=void 0,this.initialAllDay=void 0}async handleModalSaved(){this.modalOpen=!1,this.selectedEvent=void 0,this.initialDate=void 0,this.initialAllDay=void 0,await this.fetchData()}viewShows(e){let t=this.currentDate;if(this.viewMode===`year`)return e.getFullYear()===t.getFullYear();if(this.viewMode===`month`)return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth();if(this.viewMode===`week`){let n=Ge(t),r=new Date(n);return r.setDate(n.getDate()+7),e>=n&&e<r}return e.toDateString()===t.toDateString()}dayForViewSwitch(e){if(e===`day`||e===`week`){let e=new Date;if(this.viewShows(e))return e}return this.currentDate}setViewMode(e){this.navigate(e,this.dayForViewSwitch(e))}handleDateSelected(e){this.navigate(`day`,e)}handleAddCalendar(){this.promptFields=[{id:`name`,label:this.i18nStore?.t(`calendar.calendarName`),autofocus:!0}],this.promptMode=`add`,this.promptOpen=!0}handleRenameCalendar(e){this.promptFields=[{id:`name`,label:this.i18nStore?.t(`calendar.calendarName`),value:e.name,autofocus:!0}],this.promptMode=`rename`,this.promptTarget=e,this.promptOpen=!0}handleDeleteCalendar(e){this.calendarToDelete=e}async _executeDeleteCalendar(){if(!this.calendarToDelete)return;let e=this.calendarToDelete;this.calendarToDelete=null;try{await Ke.deleteCalendar(e.path),this.calendars=this.calendars.filter(t=>t.path!==e.path),this.activeCalendars.has(e.path)&&(this.activeCalendars.delete(e.path),await this.fetchData())}catch(e){console.error(`Failed to delete calendar`,e),this.reportFailure(`calendar.deleteCalendarFailed`)}}async _executeDeleteEvent(){if(!this.eventToDelete)return;let e=this.eventToDelete;this.eventToDelete=null;try{await Ke.deleteEvent(e.path),await this.fetchData()}catch(e){console.error(`Failed to delete event`,e),this.reportFailure(`calendar.deleteEventFailed`)}}toggleCalendar(e){let t=new Set(this.activeCalendars);t.has(e)?t.delete(e):t.add(e),this.activeCalendars=t}async handlePromptSubmit(e){this.promptOpen=!1;let t=e.detail.name;if(t)try{this.promptMode===`add`?await Ke.createCalendar(t):this.promptMode===`rename`&&this.promptTarget&&await Ke.renameCalendar(this.promptTarget.path,t),await this.fetchData()}catch(e){console.error(`Failed to save calendar`,e),this.reportFailure(`calendar.saveCalendarFailed`)}}handlePromptCancel(){this.promptOpen=!1}get username(){return this.settingsStore?.getState().loginUsername||``}render(){let e=this.i18nStore?.t(`calendar.months.${this.currentDate.getMonth()}`),t=this.currentDate.getFullYear(),n=``;n=this.searchQuery?this.i18nStore?.t(`calendar.searchResults`):this.viewMode===`year`?t.toString():this.viewMode===`day`?`${this.currentDate.getDate()} ${e}`:e;let r=this.events.filter(e=>this.activeCalendars.has(e.calendarPath));return s`
            ...
            <div class="app-container ${this.sidebarCollapsed&&!this.isMobile?`collapsed`:``} ${this.isSidebarDragging?`dragging`:``}" style="${!this.sidebarCollapsed&&!this.isMobile?`--sidebar-width: ${this.sidebarWidth}px;`:``}">
                <div class="layout">
                    <alps-sidebar 
                        ...
                        @sidebar-resize=${e=>{let t=e.detail.newWidth;t<Wt?(this.sidebarCollapsed||(this.sidebarCollapsed=!0,this.settingsStore&&this.settingsStore.updateSettings({sidebarCollapsed:!0})),this.sidebarWidth=Vt):(this.sidebarCollapsed&&(this.sidebarCollapsed=!1,this.settingsStore&&this.settingsStore.updateSettings({sidebarCollapsed:!1})),this.sidebarWidth=Math.min(Math.max(t,Ht),Ut))}}
            ...
            ${this.eventToDelete?s`
                ...
                ></ui-confirm>
            `:``}
        `}};k([g({context:C})],N.prototype,`i18nStore`,void 0),k([g({context:w})],N.prototype,`settingsStore`,void 0),k([a()],N.prototype,`calendars`,void 0),k([a()],N.prototype,`events`,void 0),k([a()],N.prototype,`currentDate`,void 0),k([a()],N.prototype,`viewMode`,void 0),k([a()],N.prototype,`loading`,void 0),k([a()],N.prototype,`isSpinning`,void 0),k([a()],N.prototype,`error`,void 0),k([a()],N.prototype,`modalOpen`,void 0),k([a()],N.prototype,`selectedEvent`,void 0),k([a()],N.prototype,`initialDate`,void 0),k([a()],N.prototype,`initialAllDay`,void 0),k([a()],N.prototype,`activeCalendars`,void 0),k([a()],N.prototype,`searchQuery`,void 0),k([a()],N.prototype,`sidebarWidth`,void 0),k([a()],N.prototype,`sidebarCollapsed`,void 0),k([a()],N.prototype,`isSidebarHovered`,void 0),k([a()],N.prototype,`isMobile`,void 0),k([a()],N.prototype,`mobileSidebarOpen`,void 0),k([a()],N.prototype,`promptOpen`,void 0),k([a()],N.prototype,`promptFields`,void 0),k([a()],N.prototype,`promptMode`,void 0),k([a()],N.prototype,`promptTarget`,void 0),k([a()],N.prototype,`calendarToDelete`,void 0),k([a()],N.prototype,`eventToDelete`,void 0),k([a()],N.prototype,`activeKebabMenu`,void 0),k([a()],N.prototype,`suppressSidebarHover`,void 0),k([a()],N.prototype,`isSidebarDragging`,void 0),N=k([m(`calendar-page`)],N);var Gt=e({});b.registerRoute({path:`/calendar/*`,component:`calendar-page`,pluginId:`caldav`}),b.registerNavTab({id:`calendar`,pluginId:`caldav`,labelKey:`navigation.calendar`,icon:`calendar`,order:20});function Kt(e){let t=0;for(let n of e)n.status===`rejected`&&(t+=1,console.error(`Bulk contact operation failed for one item`,n.reason));return{total:e.length,failed:t}}var P=new class{async fetchContacts(e=``){let t=await T(e?`/contacts?query=${encodeURIComponent(e)}`:`/contacts`);if(!t.ok)throw Error(`Failed to fetch contacts: ${t.statusText}`);return t.json()}async fetchContact(e){let t=await T(`/contacts/${Le(e)}`);if(!t.ok)throw Error(`Failed to fetch contact: ${t.statusText}`);return t.json()}async createContact(e){let t=await T(`/contacts/create`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)});if(!t.ok)throw Error(`Failed to create contact: ${t.statusText}`);return t.json()}async updateContact(e,t){let n=await T(`/contacts/${Le(e)}/edit`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)});if(!n.ok)throw Error(`Failed to update contact: ${n.statusText}`);return n.json()}async deleteContact(e){let t=await T(`/contacts/${Le(e)}`,{method:`DELETE`});if(!t.ok)throw Error(`Failed to delete contact: ${t.statusText}`)}async bulkUpdateContacts(e){let t=e.filter(e=>e.path);return Kt(await Promise.allSettled(t.map(e=>this.updateContact(e.path,e))))}async bulkDeleteContacts(e){return Kt(await Promise.allSettled(e.map(e=>this.deleteContact(e))))}},qt=`All Contacts`,Jt=`Favorites`,Yt=`alps_msg_`,Xt=1800*1e3,Zt={get(e,t,n=`html`){try{let r=`${Yt}${e}_${t}_${n}`,i=sessionStorage.getItem(r);if(!i)return null;let a=JSON.parse(i);return Date.now()-a.timestamp>Xt?(sessionStorage.removeItem(r),null):a}catch(e){return x.error(`Failed to read message cache`,e),null}},set(e,t,n,r){try{let i=`${Yt}${e}_${t}_${n}`,a={...r,timestamp:Date.now()},o=JSON.stringify(a);if(o.length>2*1024*1024){console.warn(`Message ${t} is too large to cache (${Math.round(o.length/1024)}KB)`);return}sessionStorage.setItem(i,o)}catch(i){if(i instanceof DOMException&&(i.name===`QuotaExceededError`||i.code===22)){console.warn(`Session storage quota exceeded, clearing cache and retrying...`),this.clear();try{let i=`${Yt}${e}_${t}_${n}`,a={...r,timestamp:Date.now()};sessionStorage.setItem(i,JSON.stringify(a))}catch(e){x.error(`Failed to write message cache even after clearing`,e)}}else x.error(`Failed to write message cache`,i)}},clear(){try{let e=[];for(let t=0;t<sessionStorage.length;t++){let n=sessionStorage.key(t);n&&n.startsWith(Yt)&&e.push(n)}e.forEach(e=>sessionStorage.removeItem(e))}catch(e){x.error(`Failed to clear message cache`,e)}}},F=new class extends EventTarget{constructor(...e){super(...e),this.interval=null,this.currentMailbox=E,this.currentPage=0,this.currentQuery=``,this.currentFetchId=0}setContext(e,t,n=``){this.currentMailbox=e,this.currentPage=t,this.currentQuery=n}start(e=5){if(this.stop(),e<=0)return;let t=e*60*1e3;this.interval=setInterval(()=>this.backgroundSync(),t)}stop(){this.interval&&=(clearInterval(this.interval),null)}mailboxRenamed(e,t){if(this.currentMailbox===e)this.currentMailbox=t;else if(this.currentMailbox.startsWith(e)){let n=this.currentMailbox.slice(e.length);/^[^A-Za-z0-9]/.test(n)&&(this.currentMailbox=t+n)}}mailboxDeleted(e){(this.currentMailbox===e||ot(this.currentMailbox,e))&&(this.currentMailbox=E,this.currentPage=0)}sync(){this.fetch(this.currentMailbox,this.currentPage,this.currentQuery,!0)}syncIfViewing(e){this.currentMailbox===e&&this.sync()}async fetch(e,t,n=``,r=!1){this.setContext(e,t,n);let i=++this.currentFetchId;this.dispatchEvent(new CustomEvent(`sync-start`,{detail:{background:!1}}));let a=Date.now();try{let o=`/mailboxes/${D(e)}?page=${t}`;n&&(o+=`&query=${encodeURIComponent(n)}`),r&&(o+=`&refresh=true`);let s=await T(o);if(this.currentFetchId!==i)return;if(s.status===401){window.dispatchEvent(new CustomEvent(`auth-error`));return}if(s.status===404){this.dispatchEvent(new CustomEvent(`mailbox-not-found`));return}let c=await s.json();if(this.currentFetchId!==i)return;let l=Date.now()-a;if(l<200&&await new Promise(e=>setTimeout(e,200-l)),this.currentFetchId!==i)return;this.dispatchEvent(new CustomEvent(`sync-success`,{detail:{data:c,background:!1}}))}catch(e){if(this.currentFetchId!==i)return;x.error(`Failed to fetch mailbox data`,e);let t=Date.now()-a;if(t<200&&await new Promise(e=>setTimeout(e,200-t)),this.currentFetchId!==i)return;this.dispatchEvent(new CustomEvent(`sync-error`,{detail:{error:e,background:!1}}))}}async backgroundSync(){let e=++this.currentFetchId,t=this.currentMailbox,n=this.currentPage,r=this.currentQuery;try{if(t!==`INBOX`&&await T(`/mailboxes/${E}/status`).catch(()=>{}),this.currentFetchId!==e||(await T(`/mailboxes/${D(t)}/status`),this.currentFetchId!==e))return;let i=`/mailboxes/${D(t)}?page=${n}`;r&&(i+=`&query=${encodeURIComponent(r)}`);let a=await T(i);if(this.currentFetchId!==e)return;if(a.status===401){window.dispatchEvent(new CustomEvent(`auth-error`));return}if(a.status===404){this.dispatchEvent(new CustomEvent(`mailbox-not-found`));return}let o=await a.json();if(this.currentFetchId!==e)return;this.dispatchEvent(new CustomEvent(`sync-success`,{detail:{data:o,background:!0}}))}catch(t){if(this.currentFetchId!==e)return;x.error(`Background sync failed`,t)}}},I=`\\Seen`,L=`\\Flagged`,Qt=`\\Answered`,$t=`\\Deleted`,en=`\\Draft`,tn=`$Forwarded`,nn=`$MDNSent`,rn=`Junk`,an=`NonJunk`,on=`NotJunk`,sn=`$Junk`,cn=`$NotJunk`,ln=`$Phishing`,un=`$SubmitPending`,dn=`$Submitted`;function fn(e,t){if(!e)return[];let n=new Set([I,L,Qt,$t,en,tn,nn,rn,an,on,sn,cn,ln,un,dn].map(e=>e.toLowerCase())),r=[];for(let i of e)i.startsWith(`\\`)||n.has(i.toLowerCase())||r.push({id:i,name:hn(i,t),color:gn(i)});return r.sort((e,t)=>{let n=e.id.toLowerCase().startsWith(`$label`),r=t.id.toLowerCase().startsWith(`$label`);return n&&!r?-1:!n&&r?1:e.id.localeCompare(t.id)})}var pn=new Set([tn,nn,un,dn].map(e=>e.toLowerCase()));function mn(e){return e?e.filter(e=>!e.startsWith(`\\`)&&!pn.has(e.toLowerCase())):[]}function hn(e,t){switch(e.toLowerCase()){case`$label1`:return t?.t(`tags.important`)||`Important`;case`$label2`:return t?.t(`tags.work`)||`Work`;case`$label3`:return t?.t(`tags.personal`)||`Personal`;case`$label4`:return t?.t(`tags.todo`)||`To Do`;case`$label5`:return t?.t(`tags.later`)||`Later`;default:return e}}function gn(e){switch(e.toLowerCase()){case`$label1`:return`#ef4444`;case`$label2`:return`#f97316`;case`$label3`:return`#22c55e`;case`$label4`:return`#3b82f6`;case`$label5`:return`#a855f7`;default:return _n(e)}}function _n(e){let t=0;for(let n=0;n<e.length;n++)t=e.charCodeAt(n)+((t<<5)-t);return`hsl(${Math.abs(t)%360}, 70%, 45%)`}function vn(e){let t=[];for(let n=0;n<e.length;n+=500)t.push(e.slice(n,n+500));return t}async function yn(e){try{return await e.json()??{}}catch{return{}}}var R=new class{isAuthError(e){return e.status===401?(window.dispatchEvent(new CustomEvent(`auth-error`)),!0):!1}async setFlag(e,t,n,r){if(!t||t.length===0)return{ok:!1,reason:`empty`};let i=0;try{for(let a of vn(t)){let t=await T(`/mailboxes/${D(e)}/messages/flag`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify({uids:a,flags:n,action:r})});if(this.isAuthError(t))return{ok:!1,reason:`auth`,applied:i};if(!t.ok){let e=await yn(t),n=e.error===`unsupported_flags`?`unsupported`:`failed`;return x.error(`Failed to set flag`,t.status,e),{ok:!1,reason:n,applied:i,rejected:e.rejected}}i+=a.length}return{ok:!0,applied:i}}catch(e){return x.error(`Failed to set flag`,e),{ok:!1,reason:`failed`,applied:i}}}async toggleStar(e,t){let n=t?.UID;if(!n)return t;let r=t.Flags?.includes(L),i=r?`remove`:`add`,{ok:a}=await this.setFlag(e,[String(n)],[L],i);if(a){let e={...t};return r?e.Flags=e.Flags.filter(e=>e!==L):e.Flags=[...e.Flags||[],L],e}return t}async markAsRead(e,t){let n=t?.UID;if(!n||t.Flags?.includes(`\\Seen`))return t;let{ok:r}=await this.setFlag(e,[String(n)],[I],`add`);if(r){let e={...t};return e.Flags=[...e.Flags||[],I],e}return t}async deleteMessagesResult(e,t){if(!t||t.length===0)return{ok:!1,reason:`empty`};let n=0;try{for(let r of vn(t)){let t=await T(`/mailboxes/${D(e)}/messages`,{method:`DELETE`,headers:{"Content-Type":`application/json`},body:JSON.stringify({uids:r})});if(this.isAuthError(t))return{ok:!1,reason:`auth`};if(!t.ok)return x.error(`Failed to delete messages`,t.status,await yn(t)),n>0&&F.sync(),{ok:!1,reason:`failed`};n+=r.length}return F.sync(),{ok:!0}}catch(e){return x.error(`Failed to delete messages`,e),n>0&&F.sync(),{ok:!1,reason:`failed`}}}async deleteMessages(e,t){return(await this.deleteMessagesResult(e,t)).ok}async moveMessages(e,t,n){if(!t||t.length===0)return{success:!1,reason:`empty`};let r=0,i={};try{for(let a of vn(t)){let t=await T(`/mailboxes/${D(e)}/messages/move`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify({uids:a,to:n})});if(this.isAuthError(t))return{success:!1,reason:`auth`};if(!t.ok)return x.error(`Failed to move messages`,t.status,await yn(t)),r>0&&F.sync(),{success:!1,reason:`failed`};let o=await yn(t);Object.assign(i,o.uidMapping??{}),r+=a.length}return F.sync(),{success:!0,uidMapping:i}}catch(e){return x.error(`Failed to move messages`,e),r>0&&F.sync(),{success:!1,reason:`failed`}}}async copyMessages(e,t,n){if(!t||t.length===0)return{success:!1,reason:`empty`};let r=0;try{for(let i of vn(t)){let t=await T(`/mailboxes/${D(e)}/messages/copy`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify({uids:i,to:n})});if(this.isAuthError(t))return{success:!1,reason:`auth`};if(!t.ok)return x.error(`Failed to copy messages`,t.status,await yn(t)),r>0&&F.sync(),{success:!1,reason:`failed`};r+=i.length}return F.sync(),{success:!0}}catch(e){return x.error(`Failed to copy messages`,e),r>0&&F.sync(),{success:!1,reason:`failed`}}}async markMessagesAsRead(e,t){if(!t||t.length===0)return!1;let{ok:n}=await this.setFlag(e,t,[I],`add`);return n}async markMessagesAsUnread(e,t){if(!t||t.length===0)return!1;let{ok:n}=await this.setFlag(e,t,[I],`remove`);return n}async saveDraft(e){try{let t=await T(`/messages`,{method:`POST`,body:e});if(t.status===401)return window.dispatchEvent(new CustomEvent(`auth-error`)),null;if(t.ok){let e=await t.json();return{uid:e.draft_uid,mailbox:e.draft_mailbox,size:e.draft_size,attachments:e.attachments}}return x.error(`Failed to save draft:`,t.status,await yn(t)),null}catch(e){return x.error(`Failed to save draft:`,e),null}}async sendDraft(e){try{let t=await T(`/messages`,{method:`POST`,body:e});if(t.status===401)return window.dispatchEvent(new CustomEvent(`auth-error`)),!1;if(t.ok)return F.sync(),!0;let n=await yn(t);throw Error(n.error||`Failed to send message (${t.status})`)}catch(e){throw x.error(`Failed to send message:`,e),e}}},bn=`Attachments exceed the maximum allowed size.`,xn=new Map;function Sn(){return globalThis.crypto?.randomUUID?.()??`${Date.now().toString(36)}-${Math.random().toString(36).slice(2)}`}function Cn(e){let t=xn.get(e);t&&(t.abort(),xn.delete(e))}function wn(e){for(let t of e)t.uploading&&t._tempId&&Cn(t._tempId)}async function Tn(e){try{await fetch(`/attachments/${e}`,{method:`DELETE`})}catch(e){x.error(`Failed to delete attachment from server:`,e)}}function En(e,t,n,r,i,a,o,s){let c=document.createElement(`input`);c.type=`file`,c.multiple=!0,c.onchange=c=>{let l=Array.from(c.target.files||[]);l.length!==0&&Dn(l,e,t,n,r,i,a,o,s)},c.click()}function Dn(e,t,n,r,i,a,o,s,c){let l=0;for(let t of e)l+=t.size;if(n>0&&r+l>n){window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:c||bn,duration:5e3}}));return}for(let n of e){let e=Sn();i(e,n);let r=new FormData;r.append(`attachments`,n);let c=new XMLHttpRequest;xn.set(e,c),c.open(`POST`,`/attachments?composer_id=${encodeURIComponent(t)}`,!0),c.upload.onprogress=t=>{t.lengthComputable&&a(e,Math.round(t.loaded/t.total*100))},c.onload=()=>{if(xn.delete(e),c.status>=200&&c.status<300)try{let t=JSON.parse(c.responseText),n=Array.isArray(t)?t:t.uuids||[];n.length>0?o(e,n):s(e,Error(`No UUID returned from server`))}catch(t){s(e,t)}else try{let t=JSON.parse(c.responseText);s(e,Error(t.error||`Unknown error`))}catch{s(e,Error(`Upload failed with status `+c.status))}},c.onerror=()=>{xn.delete(e),s(e,Error(`Network error during upload`))},c.onabort=()=>{xn.delete(e)},c.send(r)}}var On=e=>`alps_compose_drafts_${e}`,kn=`alps_compose_drafts`,An=e=>{let t=e.trim();if(t.endsWith(`>`)){let e=t.lastIndexOf(`<`);e!==-1&&(t=t.substring(e+1,t.length-1))}let n=t.toLowerCase();return n.startsWith(`noreply`)||n.startsWith(`no-reply`)||n.startsWith(`mailer-daemon`)},jn=e=>e&&e.filter(e=>!An(e)),Mn=class extends EventTarget{constructor(){super(),this.state={activeComposers:[]},this.saveTimeout=null,this.username=null,this.adoptSession=()=>{let e=Pe();if(e===this.username)return;let t=this.username===null?this.state.activeComposers:[];this.username=e;let n=e?this.loadDrafts(e):[];this.state.activeComposers=e?[...n,...t]:[],this.notify()},this.handleSessionCleared=e=>{this.saveTimeout!==null&&(window.clearTimeout(this.saveTimeout),this.saveTimeout=null);let t=e?.detail?.reason===`expired`;t&&this.saveDrafts();let n=this.username&&!t?On(this.username):null;this.username=null;for(let e of this.state.activeComposers)wn(e.attachments||[]);if(this.state.activeComposers=[],this.notify(),n)try{localStorage.removeItem(n)}catch(e){x.error(`Failed to clear compose drafts`,e)}};try{localStorage.removeItem(kn)}catch{}window.addEventListener(`session-cleared`,this.handleSessionCleared),window.addEventListener(`user-logged-in`,this.adoptSession),window.addEventListener(`alps-active-user-changed`,this.adoptSession),this.adoptSession()}loadDrafts(e){try{let t=localStorage.getItem(On(e));if(t)return JSON.parse(t).map(e=>{let t=e.isSending;return{...e,attachments:e.attachments?.filter(e=>!e.uploading&&e.uuid)||[],isSending:!1,minimized:t?!1:e.minimized}})}catch(e){x.error(`Failed to parse compose drafts from localStorage`,e)}return[]}saveDrafts(){if(this.username)try{localStorage.setItem(On(this.username),JSON.stringify(this.state.activeComposers))}catch(e){x.error(`Failed to save compose drafts to localStorage`,e)}}debouncedSaveDrafts(){this.saveTimeout!==null&&window.clearTimeout(this.saveTimeout),this.saveTimeout=window.setTimeout(()=>{this.saveDrafts(),this.saveTimeout=null},500)}notify(){this.dispatchEvent(new CustomEvent(`change`))}get stateCopy(){return{...this.state}}getComposer(e){return this.state.activeComposers.find(t=>t.id===e)}getState(){return this.state}openComposer(e){if(e?.draftUid){let t=this.state.activeComposers.find(t=>t.draftUid===e.draftUid);if(t){this.bringComposerToFront(t.id),t.minimized&&this.updateComposer(t.id,{minimized:!1});return}}let t=window.innerWidth<=768;if(t&&this.state.activeComposers.length>=1){let e=this.state.activeComposers[0].id;this.bringComposerToFront(e);return}if(!t&&this.state.activeComposers.length>=3)return;let n=`composer_`+Date.now()+`_`+Math.random().toString(36).substr(2,5),r=`html`,i=``,a=Fe();a.composeFormat===`text`&&(r=`text`),a.signature&&(i=a.signature);let o=e?.text||``,s=e?.html||``;if(i&&!e?.draftUid){let t=`-- \n${i}`,n=`<div class="alps-signature">-- <br>${i.replace(/\n/g,`<br>`)}</div>`;o=`\n\n${t}\n${o}`,s=s||e?.text?`<br><br>${n}${s}`:`<br><br>${n}`}let c={id:n,minimized:!1,expanded:!1,dirty:!1,subject:``,format:e?.format||r,attachments:[],zIndex:1e3+this.state.activeComposers.length,...e,to:jn(e?.to)||[],cc:jn(e?.cc)||[],bcc:jn(e?.bcc)||[],text:o,html:s,initialText:o,initialHtml:s};this.state={...this.state,activeComposers:[...this.state.activeComposers,c]},this.saveDrafts(),this.notify()}updateComposer(e,t){t.to&&=jn(t.to),t.cc&&=jn(t.cc),t.bcc&&=jn(t.bcc);let n=this.state.activeComposers.map(n=>{if(n.id!==e)return n;let r=!1;if(`subject`in t&&t.subject!==n.subject&&(r=!0),`to`in t&&JSON.stringify(t.to||[])!==JSON.stringify(n.to||[])&&(r=!0),`cc`in t&&JSON.stringify(t.cc||[])!==JSON.stringify(n.cc||[])&&(r=!0),`bcc`in t&&JSON.stringify(t.bcc||[])!==JSON.stringify(n.bcc||[])&&(r=!0),`attachments`in t&&t.attachments!==n.attachments&&(r=!0),!r&&!n.dirty){if(`text`in t||`html`in t){let e=`text`in t?t.text||``:n.text||``,i=n.initialText||``;e.trim()!==i.trim()&&(r=!0)}}else !r&&n.dirty;let i=`dirty`in t?t.dirty:r?!0:n.dirty;return{...n,...t,dirty:i}});this.state={...this.state,activeComposers:n},this.debouncedSaveDrafts(),this.notify()}closeComposer(e){this.state={...this.state,activeComposers:this.state.activeComposers.filter(t=>t.id!==e)},this.saveDrafts(),this.notify()}discardDraft(e){let t=this.state.activeComposers.find(t=>t.id===e);t&&t.draftUid&&t.draftMailbox&&R.deleteMessagesResult(t.draftMailbox,[String(t.draftUid)]).then(e=>{!e.ok&&e.reason!==`auth`&&this.reportDiscardFailed()}),this.closeComposer(e)}reportDiscardFailed(){window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{i18nKey:`composer.discardFailed`,duration:5e3}}))}clearAllComposers(){this.state={...this.state,activeComposers:[]},this.notify()}async saveAllDirtyDrafts(){let e=0,t=this.state.activeComposers.filter(e=>e.dirty);if(t.length>0)for(let n of t){let t=(n.to?.length||0)>0||(n.cc?.length||0)>0||(n.bcc?.length||0)>0,r=n.text?.trim()!==n.initialText?.trim()||(n.subject?.trim().length||0)>0;if(!t&&!r&&!(n.attachments&&n.attachments.length>0))continue;let i=new FormData,a=[...n.bcc||[]],o=``;{let e=Fe(),t=e.loginUsername;e.bccMyself&&t&&!a.includes(t)&&a.push(t),e.replyTo&&(o=e.replyTo)}i.append(`to`,(n.to||[]).join(`, `)),i.append(`cc`,(n.cc||[]).join(`, `)),i.append(`bcc`,a.join(`, `)),o&&i.append(`reply_to`,o),i.append(`subject`,(n.subject||``).trim()),i.append(`text`,n.text||``),n.html&&n.format===`html`&&i.append(`html`,n.html),i.append(`save_as_draft`,`1`);let s=n.attachments||[],c=s.map(e=>e.uuid).filter(Boolean).join(`,`);c&&i.append(`attachment-uuids`,c);let l=s.map(e=>e.partPath).filter(Boolean).join(`,`);l&&i.append(`prev_attachments`,l),n.draftMailbox&&i.append(`draft_mailbox`,n.draftMailbox),n.draftUid&&i.append(`draft_uid`,n.draftUid),await R.saveDraft(i)||e++}return this.state={...this.state,activeComposers:[]},this.saveDrafts(),this.notify(),{failed:e}}bringComposerToFront(e){let t=1e3;this.state.activeComposers.forEach(e=>{e.zIndex&&e.zIndex>t&&(t=e.zIndex)}),this.updateComposer(e,{zIndex:t+1})}},Nn=u(`compose-store`),Pn=`alps-login-notice`;function Fn(e){try{sessionStorage.setItem(Pn,e)}catch{}}function In(){try{let e=sessionStorage.getItem(Pn);return e&&sessionStorage.removeItem(Pn),e||null}catch{return null}}var Ln=new class extends EventTarget{constructor(){super(),this.accounts=[],this.loading=!1,this.initialized=!1}getAccounts(){return this.accounts}isLoading(){return this.loading}isInitialized(){return this.initialized}async fetchAccounts(){this.loading=!0,this.dispatchEvent(new Event(`change`));try{let e=await fetch(`/accounts`);if(e.ok){let t=await e.json();this.accounts=t.accounts||[],this.initialized=!0}else x.error(`Failed to fetch linked accounts`)}catch(e){x.error(`Error fetching linked accounts:`,e)}finally{this.loading=!1,this.dispatchEvent(new Event(`change`))}}async addAccount(e,t,n=``){let r=new URLSearchParams;r.append(`username`,e),r.append(`password`,t),r.append(`display_name`,n);let i=await fetch(`/accounts`,{method:`POST`,headers:{"Content-Type":`application/x-www-form-urlencoded`},body:r.toString()});if(!i.ok){let e=await i.json().catch(()=>({}));throw Error(e.error||`Failed to add linked account`)}await this.fetchAccounts()}async removeAccount(e){let t=await fetch(`/accounts/${encodeURIComponent(e)}`,{method:`DELETE`});if(!t.ok){let e=await t.json().catch(()=>({}));throw Error(e.error||`Failed to remove linked account`)}await this.fetchAccounts()}async switchAccount(e){let t=new URLSearchParams;t.append(`username`,e);let n=await fetch(`/accounts/switch`,{method:`POST`,headers:{"Content-Type":`application/x-www-form-urlencoded`},body:t.toString()});if(!n.ok){let e=await n.json().catch(()=>({}));throw Error(e.error||`Failed to switch account`)}return await n.json()}},Rn=u(`alps-linked-accounts`),zn=class extends d{constructor(...e){super(...e),this.name=``,this.email=``,this.src=``,this.size=40,this.imageError=!1,this._handleStoreChange=()=>{this.requestUpdate()}}willUpdate(e){e.has(`src`)&&(this.imageError=!1)}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.settingsStore?.addEventListener(`change`,this._handleStoreChange)})}disconnectedCallback(){super.disconnectedCallback(),this.settingsStore?.removeEventListener(`change`,this._handleStoreChange)}static{this.styles=n`
    :host {
      display: inline-block;
      flex-shrink: 0;
    }
  ...
  `}getInitials(e){if(!e)return`U`;let t=e.trim().split(/[\s.@]+/);return t.length>=2?(t[0][0]+t[1][0]).toUpperCase():e.substring(0,2).toUpperCase()}render(){let e=this.settingsStore?.getState()?.loginUsername||``,t=this.settingsStore?.getState()?.name||``,n=!1;(e&&this.email&&this.email.toLowerCase()===e.toLowerCase()||t&&this.name&&this.name.toLowerCase()===t.toLowerCase()||e&&this.name&&this.name.toLowerCase()===e.toLowerCase())&&(n=!0);let r=n?t||e:this.email||this.name,i=n&&(t||e)||this.name,a=Math.round(this.size/2.3);return s`
    ...
    `}};k([g({context:w})],zn.prototype,`settingsStore`,void 0),k([o({type:String})],zn.prototype,`name`,void 0),k([o({type:String})],zn.prototype,`email`,void 0),k([o({type:String})],zn.prototype,`src`,void 0),k([o({type:Number})],zn.prototype,`size`,void 0),k([a()],zn.prototype,`imageError`,void 0),zn=k([m(`alps-avatar`)],zn);var Bn=class extends d{constructor(...e){super(...e),this.username=``,this.isMobile=!1,this.currentTab=`messages`,this._handleStoreChange=()=>{this.requestUpdate()}}static{this.styles=[Ot,n`
    :host {
      display: block;
      position: relative;
    }
  ...
  `]}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.i18nStore?.addEventListener(`change`,this._handleStoreChange),this.settingsStore?.addEventListener(`change`,this._handleStoreChange),this.linkedAccountsStore?.addEventListener(`change`,this._handleStoreChange),window.addEventListener(`plugins-updated`,this._handleStoreChange),this.linkedAccountsStore&&!this.linkedAccountsStore.isInitialized()&&this.linkedAccountsStore.fetchAccounts()})}disconnectedCallback(){super.disconnectedCallback(),this.i18nStore?.removeEventListener(`change`,this._handleStoreChange),this.settingsStore?.removeEventListener(`change`,this._handleStoreChange),this.linkedAccountsStore?.removeEventListener(`change`,this._handleStoreChange),window.removeEventListener(`plugins-updated`,this._handleStoreChange)}_closePopup(){let e=this.shadowRoot?.querySelector(`alps-popup`);e&&e.close()}_handleSettings(){this._closePopup(),this.dispatchEvent(new CustomEvent(`open-settings`,{bubbles:!0,composed:!0}))}_handleSignOut(){this._closePopup(),this.dispatchEvent(new CustomEvent(`sign-out`,{bubbles:!0,composed:!0}))}_handleTabChange(e){this._closePopup(),e===`messages`?window.location.hash.startsWith(`#/mailbox/`)||(window.location.hash=`#/`):window.location.hash=`#/`+e,this.dispatchEvent(new CustomEvent(`change-tab`,{detail:{tab:e},bubbles:!0,composed:!0}))}async _handleSwitchAccount(e){this._closePopup();let t=document.createElement(`div`);document.body.appendChild(t),c(s`
    ...
    `}};k([o({type:String})],Bn.prototype,`username`,void 0),k([o({type:Boolean})],Bn.prototype,`isMobile`,void 0),k([o({type:String})],Bn.prototype,`currentTab`,void 0),k([g({context:C})],Bn.prototype,`i18nStore`,void 0),k([g({context:w})],Bn.prototype,`settingsStore`,void 0),k([g({context:Rn})],Bn.prototype,`linkedAccountsStore`,void 0),Bn=k([m(`user-profile-menu`)],Bn);var Vn=class extends d{constructor(...e){super(...e),this.username=``,this.currentTab=``,this.isMobile=!1,this.scrolled=!1,this._handleStoreChange=()=>{this.requestUpdate()}}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.i18nStore?.addEventListener(`change`,this._handleStoreChange)})}disconnectedCallback(){super.disconnectedCallback(),this.i18nStore?.removeEventListener(`change`,this._handleStoreChange)}static{this.styles=n`
    :host {
      display: block;
      position: relative;
      width: 100%;
  ...
  `}handleSettings(){window.location.hash=`/settings`}async handleSignOut(){let e=0;try{this.composeStore&&(e=(await this.composeStore.saveAllDirtyDrafts()).failed)}catch(e){x.error(`Could not save drafts before signing out`,e)}Fn(e>0?`signedOutDraftsLost`:`signedOut`);try{await fetch(`/session`,{method:`DELETE`})}catch(e){x.error(`Sign-out request failed; ending the session locally anyway`,e)}Zt.clear(),Ie(),window.dispatchEvent(new CustomEvent(`session-cleared`)),window.location.hash=`#/login`}render(){return s`
  ...
  `}handleTabClick(e){this.currentTab=e,this.dispatchEvent(new CustomEvent(`change-tab`,{detail:{tab:e}})),e===`messages`?window.location.hash.startsWith(`#/mailbox/`)||(window.location.hash=`#/`):window.location.hash=`#/`+e}render(){return s`
    ...
    `}};k([o({type:String})],Hn.prototype,`username`,void 0),k([o({type:String})],Hn.prototype,`currentTab`,void 0),k([o({type:Boolean})],Hn.prototype,`isMobile`,void 0),k([o({type:String})],Hn.prototype,`currentMailbox`,void 0),k([o({type:String})],Hn.prototype,`currentMailboxDelimiter`,void 0),k([o({type:String})],Hn.prototype,`searchQuery`,void 0),k([o({type:Boolean})],Hn.prototype,`scrolled`,void 0),k([g({context:C})],Hn.prototype,`i18nStore`,void 0),Hn=k([m(`app-header`)],Hn);var Un=class extends d{constructor(...e){super(...e),this.text=``,this.fullHeight=!1}static{this.styles=n`
    :host {
      display: inline-flex;
      align-items: center;
      justify-content: center;
  ...
  `}render(){return s`
    ...
    `}};k([o({type:String})],Un.prototype,`text`,void 0),k([o({type:Boolean,attribute:`full-height`})],Un.prototype,`fullHeight`,void 0),Un=k([m(`alps-loader`)],Un);var Wn=class extends d{constructor(...e){super(...e),this.hidden=!1}static{this.styles=n`
    :host {
      position: absolute;
      inset: 0;
      background: var(--bg-primary, #ffffff);
  ...
  `}render(){return s`<alps-loader></alps-loader>`}};k([o({type:Boolean,reflect:!0})],Wn.prototype,`hidden`,void 0),Wn=k([m(`alps-initial-loader`)],Wn);var z=class extends d{constructor(...e){super(...e),this.contacts=[],this.uniqueCategories=[],this.selectedCategory=``,this.filterQuery=``,this.sidebarCollapsed=!1,this.isSidebarHovered=!1,this.suppressSidebarHover=!1,this.isMobile=!1,this.activeKebabMenu=null,this.sidebarScrolled=!1}static{this.styles=[Ot,yt,n`
    :host {
      display: flex;
      flex-direction: column;
      flex: 1;
  ...
  `]}handleSidebarScroll(e){let t=e.target.scrollTop>0;this.sidebarScrolled!==t&&(this.sidebarScrolled=t)}render(){return s`
      <div class="sidebar-wrapper ${this.sidebarCollapsed&&!this.isMobile&&(!this.isSidebarHovered||this.suppressSidebarHover)?`collapsed`:``}">
        ...
        <div class="sidebar-content" @scroll=${this.handleSidebarScroll}>
          <div class="sidebar-scroll-content">
            ${[qt,Jt,...this.uniqueCategories.filter(e=>e!==Jt)].map(e=>{let t=e===`All Contacts`?this.contacts.length:this.contacts.filter(t=>t.categories&&t.categories.includes(e)).length,n=e===`All Contacts`||e===`Favorites`;return s`
  ...
  `}render(){return s`
    ...
    `}};k([o({type:String})],Kn.prototype,`name`,void 0),k([o({type:String})],Kn.prototype,`color`,void 0),Kn=k([m(`alps-tag`)],Kn);var qn=class extends d{constructor(...e){super(...e),this.currentPage=0,this.totalItems=0,this.itemsPerPage=50,this._handleStoreChange=()=>{this.requestUpdate()}}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.i18nStore?.addEventListener(`change`,this._handleStoreChange)})}disconnectedCallback(){super.disconnectedCallback(),this.i18nStore?.removeEventListener(`change`,this._handleStoreChange)}static{this.styles=n`
    :host {
      display: flex;
      flex: 1;
      min-width: 0;
  ...
  `}changePage(e){let t=this.currentPage+e;t>=0&&t<Math.ceil(this.totalItems/this.itemsPerPage)&&this.dispatchEvent(new CustomEvent(`change-page`,{detail:{page:t},bubbles:!0,composed:!0}))}render(){let e=this.currentPage*this.itemsPerPage+1,t=Math.min((this.currentPage+1)*this.itemsPerPage,this.totalItems);return s`
    ...
    `}};k([o({type:Number})],qn.prototype,`currentPage`,void 0),k([o({type:Number})],qn.prototype,`totalItems`,void 0),k([o({type:Number})],qn.prototype,`itemsPerPage`,void 0),k([g({context:C})],qn.prototype,`i18nStore`,void 0),qn=k([m(`alps-pagination`)],qn);var Jn=class extends d{constructor(...e){super(...e),this.variant=`info`}static{this.styles=n`
    :host {
      display: block;
      position: sticky;
      top: 0;
  ...
  `}render(){return s`
    ...
    `}};k([o({type:String,reflect:!0})],Jn.prototype,`variant`,void 0),Jn=k([m(`alps-banner`)],Jn);var B=class extends d{constructor(...e){super(...e),this.messages=[],this.currentMailbox=``,this.currentMailboxDelimiter=``,this.currentMailboxRole=``,this.loading=!1,this.selectedMessage=null,this.layoutMode=`vertical`,this.isMobile=!1,this.sidebarCollapsed=!1,this.currentPage=0,this.totalMessages=0,this.messagesPerPage=50,this.filterQuery=``,this.sortOrder=`desc`,this.densityMode=`compact`,this.selectedMessages=new Set,this.syncing=!1,this.isSpinning=!1,this.isScrolled=!1,this.isAtBottom=!1,this.focusedIndex=-1,this.showEmptyConfirm=!1,this.expandedThreads=new Set,this._shouldScrollToTop=!1,this._handleStoreChange=()=>{this.requestUpdate()},this.handleSyncStart=()=>{this.syncing=!0,this.isSpinning=!0},this.handleSyncEnd=()=>{this.syncing=!1},this.handleSpinIteration=()=>{this.syncing||(this.isSpinning=!1)},this.handleScroll=e=>{this.checkScrollState(e.target)}}static{this.styles=n`
    :host {
      display: flex;
      flex-direction: column;
      height: 100%;
            ...
            ${a?s`
              <div class="folder-actions ${this.activeKebabMenu===e.fullName?`popup-open`:``}" @click=${e=>e.stopPropagation()}>
                ...
                >
                  ...
                  <button class="dropdown-item" @click=${t=>{let n=t.target.closest(`alps-popup`);n&&n.close();let r=!e.mb?.Subscribed;Gn.setSubscribed(e.fullName,r).then(e=>{e.ok||e.reason===`auth`||(r?this.toast(this.i18nStore?.t(`toast.subscribeFailed`),`Could not subscribe`):this.toast(this.i18nStore?.t(`toast.unsubscribeFailed`),`Could not unsubscribe`))})}}>
  ...
  `}handleClick(){this.composeStore.openComposer({to:[this.address]})}render(){let e=this.name;return e===this.address&&(e=``),e?s`
      ...
      `}};k([g({context:Nn})],Yn.prototype,`composeStore`,void 0),k([o({type:String})],Yn.prototype,`name`,void 0),k([o({type:String})],Yn.prototype,`address`,void 0),Yn=k([m(`alps-recipient-pill`)],Yn);var Xn=class extends d{constructor(...e){super(...e),this.attachment=null,this.downloadUrl=``,this.fallbackName=`Unknown attachment`,this.removable=!1,this.compact=!1}static{this.styles=n`
    .attachment-chip {
      display: inline-flex;
      align-items: center;
      width: 100%;
  ...
  `}render(){return!this.attachments||this.attachments.length===0?s``:s`
    ...
    `}};k([g({context:C})],Zn.prototype,`i18nStore`,void 0),k([o({type:Array})],Zn.prototype,`attachments`,void 0),k([o({type:String})],Zn.prototype,`mailbox`,void 0),k([o({type:String})],Zn.prototype,`messageUid`,void 0),k([o({type:Boolean})],Zn.prototype,`removable`,void 0),k([o({type:Boolean,reflect:!0})],Zn.prototype,`composerMode`,void 0),k([a()],Zn.prototype,`attachmentsExpanded`,void 0),Zn=k([m(`alps-attachment-list`)],Zn);var U=class extends d{constructor(...e){super(...e),this.mailboxes=[],this.currentMailbox=``,this.noActionBox=!1,this.noSearchBox=!1,this.filterQuery=``,this.isMove=!0}static{this.styles=n`
    :host {
      display: inline-block;
    }
  ...
  `}_handleFilter(e){let t=e.target;this.filterQuery=t.value.toLowerCase()}_handleSelect(e){this.popup&&this.popup.close(),this.dispatchEvent(new CustomEvent(`folder-selected`,{detail:{folderName:e,isMove:this.isMove},bubbles:!0,composed:!0}))}_handlePopupToggle(){this.filterQuery=``,setTimeout(()=>{this.filterInput&&this.filterInput.focus()},50)}render(){let e=this.mailboxes.map(e=>e.Name||e.Mailbox||``).filter(e=>e!==``&&e!==this.currentMailbox).filter(e=>e.toLowerCase().includes(this.filterQuery));return s`
    ...
    `}};k([g({context:C})],U.prototype,`i18nStore`,void 0),k([o({type:Array})],U.prototype,`mailboxes`,void 0),k([o({type:String})],U.prototype,`currentMailbox`,void 0),k([o({type:Boolean})],U.prototype,`noActionBox`,void 0),k([o({type:Boolean})],U.prototype,`noSearchBox`,void 0),k([a()],U.prototype,`filterQuery`,void 0),k([a()],U.prototype,`isMove`,void 0),k([ee(`alps-popup`)],U.prototype,`popup`,void 0),k([ee(`input`)],U.prototype,`filterInput`,void 0),U=k([m(`alps-folder-selector-popup`)],U);var Qn=t(te(),1),$n=`data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7`;function er(e){let t=e.trim().toLowerCase();return t.startsWith(`http://`)||t.startsWith(`https://`)||t.startsWith(`//`)}var tr=()=>/url\(\s*(['"]?)((?:https?:)?\/\/[^'"\)]+)\1\s*\)/gi,nr=()=>/@import\s+(?:url\(\s*)?(['"]?)((?:https?:)?\/\/[^'"\)]+)\1\s*\)?\s*;?/gi;function rr(e){return`/proxy?url=${encodeURIComponent(e.trim())}`}function ir(e,t){return er(e)?(t.onRemoteResourceBlocked&&t.onRemoteResourceBlocked(),t.allowRemoteResources?rr(e):$n):null}function ar(e,t){let n=e.split(`,`).map(e=>e.trim()).filter(Boolean);if(n.length===0)return null;let r=!1,i=n.map(e=>{let n=e.search(/\s/),i=n===-1?e:e.slice(0,n),a=n===-1?``:e.slice(n);return er(i)?(r=!0,t.allowRemoteResources?`${rr(i)}${a}`:$n):e});return r?(t.onRemoteResourceBlocked&&t.onRemoteResourceBlocked(),t.allowRemoteResources?i.join(`, `):$n):null}function or(e,t,n=``){if(!e)return null;let r=t.replace(/^<|>$/g,``);if(e.ID&&e.ID.replace(/^<|>$/g,``)===r)return n||`1`;if(e.Children&&Array.isArray(e.Children))for(let r=0;r<e.Children.length;r++){let i=n?`${n}.${r+1}`:`${r+1}`,a=or(e.Children[r],t,i);if(a)return a}return null}function sr(e,t){if(!e)return e;try{let n=Qn.parse(e,{silent:!0});if(n&&n.stylesheet&&n.stylesheet.rules){let e=tr(),r=n=>n.replace(e,(e,n,r)=>{if(t.onRemoteResourceBlocked&&t.onRemoteResourceBlocked(),t.allowRemoteResources){let e=n||`"`;return`url(${e}${rr(r)}${e})`}else return`url(${$n})`}),i=n=>{for(let a=n.length-1;a>=0;a--){let o=n[a];if([`rule`,`font-face`,`page`,`keyframe`].includes(o.type)&&!o.declarations&&(o.declarations=[]),[`rule`,`page`].includes(o.type)&&!o.selectors&&(o.selectors=[]),o.type===`keyframe`&&!o.values&&(o.values=[]),o.type===`import`){let e=o;if(e.import&&e.import.match(/(?:https?:)?\/\//i)){t.onRemoteResourceBlocked&&t.onRemoteResourceBlocked(),n.splice(a,1);continue}}else if(o.type===`font-face`){let r=o;if(r.declarations){let i=!1;for(let n of r.declarations)n.type===`declaration`&&n.value?.match(e)&&(t.onRemoteResourceBlocked&&t.onRemoteResourceBlocked(),i=!0);if(i&&!t.allowRemoteResources){n.splice(a,1);continue}}}if(o.declarations)for(let t of o.declarations)t.type===`declaration`&&t.value&&t.value.match(e)&&(t.value=r(t.value));o.rules&&i(o.rules)}};return i(n.stylesheet.rules),Qn.stringify(n)}}catch(e){console.warn(`AST CSS parsing failed, falling back to regex sanitizer`,e)}let n=e,r=nr(),i=tr();return(n.match(r)||n.match(i))&&(t.onRemoteResourceBlocked&&t.onRemoteResourceBlocked(),n=n.replace(r,``),t.allowRemoteResources?n=n.replace(i,(e,t,n)=>`url(${t}${rr(n)}${t})`):(n=n.replace(/@font-face\s*\{[^{}]*\}/gi,e=>/url\(\s*['"]?(?:https?:)?\/\//i.test(e)?``:e),n=n.replace(i,`url(${$n})`))),n}function cr(e,t){let n=new DOMParser().parseFromString(e,`text/html`);n.querySelectorAll(`iframe, object, embed, frame, frameset, applet, meta[http-equiv]`).forEach(e=>e.remove()),n.querySelectorAll(`link`).forEach(e=>{(e.getAttribute(`rel`)||``).toLowerCase()!==`stylesheet`&&e.remove()});let r=n.createElement(`base`);r.target=`_blank`,n.head.prepend(r);let i=n.createElement(`meta`);i.httpEquiv=`Content-Security-Policy`,i.content=`default-src 'none'; img-src ${window.location.origin} data: blob: cid:; media-src ${window.location.origin} data: blob: cid:; style-src 'unsafe-inline'; font-src ${window.location.origin} data:; script-src 'none'; object-src 'none'; frame-src 'none'; child-src 'none'; form-action 'none'; base-uri 'none';`,n.head.prepend(i);let a=n.createElement(`style`);a.textContent=`
  ...
  `,n.head.prepend(a),n.querySelectorAll(`img`).forEach(e=>{let n=e.getAttribute(`src`);if(n)if(n.toLowerCase().startsWith(`cid:`)){let r=n.substring(4);if(t.messageStructure){let n=or(t.messageStructure,r);n&&(e.src=`/mailboxes/${D(t.mailbox)}/messages/${t.messageUid}/raw?part=${n}`)}}else er(n)&&(t.onRemoteResourceBlocked&&t.onRemoteResourceBlocked(),t.allowRemoteResources?e.src=rr(n):(e.setAttribute(`data-original-src`,n),e.src=$n,e.style.height=`0`,e.style.width=`0`))});for(let e of Array.from(n.querySelectorAll(`img[srcset], source[srcset], video[poster], source[src]`)))for(let n of[`srcset`,`poster`,`src`]){let r=e.getAttribute(n);if(!r||n===`src`&&e.tagName.toLowerCase()===`img`)continue;let i=n===`srcset`?ar(r,t):ir(r,t);i!==null&&e.setAttribute(n,i)}n.querySelectorAll(`link[rel="stylesheet"]`).forEach(e=>{let n=e.getAttribute(`href`);n&&er(n)&&(t.onRemoteResourceBlocked&&t.onRemoteResourceBlocked(),e.remove())}),n.querySelectorAll(`a[href]`).forEach(e=>{e.setAttribute(`rel`,`noopener noreferrer`)}),n.querySelectorAll(`style`).forEach(e=>{e.textContent&&=sr(e.textContent,t)});let o=tr();return n.querySelectorAll(`[style]`).forEach(e=>{let n=e.getAttribute(`style`);n&&n.match(o)&&(t.onRemoteResourceBlocked&&t.onRemoteResourceBlocked(),n=t.allowRemoteResources?n.replace(o,(e,t,n)=>{let r=t||`"`;return`url(${r}${rr(n)}${r})`}):n.replace(o,`url(${$n})`),e.setAttribute(`style`,n))}),n.documentElement.outerHTML}function lr(e){if(!e)return``;let t=new DOMParser().parseFromString(e,`text/html`);t.querySelectorAll(`script, style, link, iframe, object, embed, form, meta, base`).forEach(e=>e.remove());for(let e of Array.from(t.querySelectorAll(`*`))){for(let t of Array.from(e.attributes)){let n=t.name.toLowerCase();if(n.startsWith(`on`)){e.removeAttribute(t.name);continue}if(n===`href`||n===`src`||n===`srcset`||n===`action`){let n=t.value.toLowerCase().replace(/[^\x21-\x7e]/g,``);(n.startsWith(`javascript:`)||n.startsWith(`vbscript:`)||n.startsWith(`data:text/html`))&&e.removeAttribute(t.name)}}let t=e.getAttribute(`style`);t&&/url\s*\(/i.test(t)&&e.setAttribute(`style`,t.replace(/url\s*\([^)]*\)/gi,``))}return t.body.innerHTML}function ur(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}function dr(e){return e?e.map(e=>e.Name?`${e.Name} <${e.Mailbox}@${e.Host}>`:`${e.Mailbox}@${e.Host}`):[]}function fr(e,t,n,r,i,a=`YYYY-MM-DD`,o=`12`){let s=t?.Envelope?.Subject||``,c=s;c=e===`forward`?c.toLowerCase().startsWith(`fwd:`)?c:`Fwd: ${c}`:c.toLowerCase().startsWith(`re:`)?c:`Re: ${c}`;let l=[],u=[];if(e===`reply`||e===`replyAll`){let n=t?.Envelope?.ReplyTo,r=t?.Envelope?.From;if(l=[...dr(n&&n.length>0?n:r)],e===`replyAll`){let e=dr(t?.Envelope?.To)||[],n=dr(t?.Envelope?.Cc)||[],r=new Set([...l,...e]);l=Array.from(r),u=[...n]}}let d=t?.Envelope?.Date?dt(t.Envelope.Date,a,o):``,f=t?.Envelope?.From?.[0],p=f?.Mailbox&&f?.Host?`${f.Mailbox}@${f.Host}`:``,m=f?.Name||p||`Unknown Sender`,h=`On ${d}, ${m} wrote:`;e===`forward`&&(h=`---------- Forwarded message ---------\nFrom: ${m} <${p}>\nDate: ${d}\nSubject: ${s}\nTo: ${dr(t?.Envelope?.To).join(`, `)}\n`);let g=`\n\n${h}\n`+n.split(`
`).map(e=>`> ${e}`).join(`
`),_=ur(m),ee=ur(p),te=ur(s),v=ur(d),y=i&&r?lr(r):``,ne=``;return ne=y?e===`forward`?`<br><br><div class="gmail_quote"><div dir="ltr" class="gmail_attr">---------- Forwarded message ---------<br>From: ${_} &lt;${ee}&gt;<br>Date: ${v}<br>Subject: ${te}<br>To: ${ur(dr(t?.Envelope?.To).join(`, `))}<br></div><br>${y}</div>`:`<br><br><div class="gmail_quote"><div dir="ltr" class="gmail_attr">On ${v}, ${_} wrote:<br></div><blockquote class="gmail_quote" style="margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);padding-left:1ex">${y}</blockquote></div>`:`<br><br><div class="gmail_quote"><div dir="ltr" class="gmail_attr">${ur(h).replace(/\n/g,`<br>`)}<br></div><blockquote class="gmail_quote" style="margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);padding-left:1ex">${ur(n).replace(/\n/g,`<br>`)}</blockquote></div>`,{subject:c,to:l,cc:u,quotedText:g,quotedHtml:ne}}var pr=`alps_last_active`,mr=3e3;function hr(e){try{return window.localStorage.getItem(e)}catch{return null}}function gr(e,t){try{window.localStorage.setItem(e,t)}catch{}}function _r(e){try{window.localStorage.removeItem(e)}catch{}}var vr=new class{constructor(){this.events=[`mousedown`,`mousemove`,`keydown`,`scroll`,`touchstart`,`wheel`,`pointerdown`,`pointermove`,`click`,`input`,`focusin`],this.logoutMinutes=0,this.lastActivity=Date.now(),this.lastSync=0,this.lastPing=Date.now(),this.checkInterval=null,this.recordActivity=()=>{let e=Date.now();this.lastActivity=e,!(window.location.hash===`#/login`||window.location.hash===``)&&e-this.lastSync>=mr&&(this.lastSync=e,gr(pr,String(e)))},this.handleActivity=()=>{this.recordActivity()},this.handleStorage=e=>{if(e.key===pr&&e.newValue){let t=Number(e.newValue);Number.isFinite(t)&&t>this.lastActivity&&(this.lastActivity=t)}}}setLogoutTime(e){let t=this.logoutMinutes>0;this.logoutMinutes=e;let n=this.logoutMinutes>0;n&&!t?(this.attachEvents(),this.startInterval()):!n&&t?(this.detachEvents(),this.clearInterval()):n&&t&&this.recordActivity()}attachEvents(){this.lastSync=0,this.events.forEach(e=>{document.addEventListener(e,this.handleActivity,{capture:!0,passive:!0})}),window.addEventListener(`storage`,this.handleStorage),this.recordActivity()}detachEvents(){this.lastSync=0,this.events.forEach(e=>{document.removeEventListener(e,this.handleActivity,{capture:!0})}),window.removeEventListener(`storage`,this.handleStorage)}trackIframe(e){try{let t=e.contentDocument;if(!t)return;this.events.forEach(e=>{t.addEventListener(e,this.handleActivity,{capture:!0,passive:!0})})}catch{}}startInterval(){this.clearInterval(),this.checkInterval=setInterval(()=>this.checkTimeout(),3e4)}clearInterval(){this.checkInterval&&=(clearInterval(this.checkInterval),null)}checkTimeout(){if(this.logoutMinutes<=0)return;if(window.location.hash===`#/login`||window.location.hash===``){this.recordActivity();return}let e=this.lastActivity,t=Number(hr(pr));Number.isFinite(t)&&t>e&&(e=t,this.lastActivity=t);let n=Date.now()-e;n>=this.logoutMinutes*60*1e3?this.logout():n<300*1e3&&Date.now()-this.lastPing>300*1e3&&this.pingBackend()}async pingBackend(){this.lastPing=Date.now();try{await fetch(`/session`)}catch{}}rearm(){this.lastActivity=Date.now(),this.lastPing=Date.now(),this.lastSync=0,this.logoutMinutes>0&&(this.attachEvents(),this.startInterval())}async logout(){this.clearInterval(),this.detachEvents();let e=0;if(this.onBeforeLogout)try{e=(await this.onBeforeLogout())?.failed??0}catch(e){x.error(`Failed to run onBeforeLogout hook`,e)}try{_r(pr),Fn(e>0?`inactivitySignedOutDraftsLost`:`inactivitySignedOut`);try{await fetch(`/session`,{method:`DELETE`})}catch(e){x.error(`Sign-out request failed; ending the session locally anyway`,e)}Zt.clear(),Ie(),window.dispatchEvent(new CustomEvent(`session-cleared`)),window.location.hash=`#/login`}catch(e){x.error(`Failed to auto sign out`,e)}finally{this.rearm()}}};function yr(e,t){if(!e.contentDocument||!e.contentDocument.body)return;let n=e.contentDocument.getElementById(`dark-mode-override`);if(n&&n.remove(),t&&document.body.classList.contains(`theme-dark`)){let t=window.getComputedStyle(document.documentElement).getPropertyValue(`--bg-primary`).trim()||`#1f2937`,n=window.getComputedStyle(document.documentElement).getPropertyValue(`--text-primary`).trim()||`#f9fafb`,r=window.getComputedStyle(document.documentElement).getPropertyValue(`--accent-color`).trim()||`#3b82f6`,i=window.getComputedStyle(document.documentElement).getPropertyValue(`--border-color`).trim()||`#374151`,a=e.contentDocument.createElement(`style`);a.id=`dark-mode-override`,a.textContent=`
      html {
...
`).trim()}function Sr(e,t,n,r){if(!e)return n||r;let i=e;if(t?.toLowerCase()===`text/html`||e.trim().startsWith(`<`)||/<\/[a-zA-Z]+>/.test(e)||/<[a-zA-Z]+[^>]*>/.test(e))try{let t=new DOMParser().parseFromString(e,`text/html`);t.querySelectorAll(`style, script, head`).forEach(e=>e.remove());let n=e=>{if(e.nodeType===Node.TEXT_NODE)return e.textContent||``;if(e.nodeType===Node.ELEMENT_NODE){let t=e,r=t.tagName.toLowerCase();if(r===`br`)return` `;let i=``;for(let e=0;e<t.childNodes.length;e++)i+=n(t.childNodes[e]);return[`p`,`div`,`td`,`tr`,`th`,`li`,`h1`,`h2`,`h3`,`h4`,`h5`,`h6`,`section`,`article`,`blockquote`,`ol`,`ul`,`header`,`footer`].includes(r)?` `+i+` `:i}return``};i=n(t.body||t)}catch{i=e.replace(/<[^>]*>/g,` `)}else i=e.replace(/[\r\n\t]+/g,` `);let a=i.replace(/\s+/g,` `).trim();if(a){let e=a.substring(0,100);return a.length>100?e+`...`:e}else if(n)return n.replace(/[\r\n\t\s]+/g,` `).trim();else return r}var Cr=class extends d{static{this.styles=n`
  ...
  `]}updated(e){e.has(`message`)&&this.message&&setTimeout(()=>{let e=`thread-card-${this.message?.UID}`,t=this.shadowRoot?.getElementById(e);t&&t.scrollIntoView({behavior:`smooth`,block:`start`})},50)}willUpdate(e){let t=e.has(`message`),n=e.has(`mailbox`),r=e.has(`messages`);if(t||n){let t=e.get(`message`),n=e.has(`mailbox`)?e.get(`mailbox`):this.mailbox;this.message?!t||t.UID!==this.message.UID||n!==this.mailbox?(this.localPreferredView=null,this.fetchMessageBody(this.message,this.message._isAutosaveUpdate)):(t&&(t.HasBimiPotential&&!this.message.HasBimiPotential&&(this.message={...this.message,HasBimiPotential:!0}),t.HasBimiFailed&&!this.message.HasBimiFailed&&(this.message={...this.message,HasBimiFailed:!0})),this.resolveThread(this.message),this.message._isAutosaveUpdate&&t&&this.message!==t&&this.fetchMessageBody(this.message,!0)):(this.localPreferredView=null,this.content=``,this.mimeType=``,this.rawMessageHtml=``,this.loading=!1,this.allowRemoteResources=!1,this.hasRemoteResources=!1,this.hasHtml=!1,this.hasText=!1,this.activeBanners=[],this.threadItems=[])}else r&&this.message&&this.resolveThread(this.message)}loadRemoteResources(){if(this.allowRemoteResources=!0,this.message&&this.rawMessageHtml){this.hasRemoteResources=!1,this.content=cr(this.rawMessageHtml,{mailbox:this.mailbox,messageUid:this.message.UID,allowRemoteResources:this.allowRemoteResources,messageStructure:this.message.BodyStructure,onRemoteResourceBlocked:()=>{this.hasRemoteResources=!0}});let e=this.threadItems.find(e=>String(e.message?.UID)===String(this.message.UID));e&&(e.allowRemoteResources=!0,e.content=this.content,e.hasRemoteResources=this.hasRemoteResources,this.updateThreadItemReference(e))}}resolveThread(e){if(!e)return;let t=this.settingsStore?.getState()?.enableThreading??!0,n=[],r=null;if(t&&this.messages&&this.messages.length>0){let t=this.messages.find(t=>String(t.UID)===String(e.UID));if(t)r=t;else for(let t of this.messages)if(t.SubMessages&&t.SubMessages.find(t=>String(t.UID)===String(e.UID))){r=t;break}}r?(n=[r,...r.SubMessages||[]],n.sort((e,t)=>(e.Envelope?.Date?new Date(e.Envelope.Date).getTime():0)-(t.Envelope?.Date?new Date(t.Envelope.Date).getTime():0))):n=(t&&this.threadItems.length>1&&this.threadItems.some(t=>String(t.message?.UID)===String(e.UID))?this.threadItems.map(e=>e.message):null)??[e],this._isThread=t&&n.length>1;let i=this.getSentMailboxName(),a=this.threadItems||[];this.threadItems=n.map(t=>{let n=String(t.UID)===String(e.UID),r=a.find(e=>String(e.message?.UID)===String(t.UID));if(r){let e={...t,Flags:t.Flags||r.message.Flags||[]};return r.message.HasBimiPotential&&(e.HasBimiPotential=!0),r.message.HasBimiFailed&&(e.HasBimiFailed=!0),{...r,message:e}}return{message:t,content:``,mimeType:``,loading:!1,attachments:[],rawMessageHtml:``,hasHtml:!1,hasText:!1,activeBanners:[],allowRemoteResources:this.allowRemoteResources,hasRemoteResources:!1,isSent:(this.mailbox||``).toLowerCase()===i.toLowerCase()||(t.Mailbox||``).toLowerCase()===i.toLowerCase(),mailbox:t.Mailbox||this.mailbox,expanded:n}})}async fetchMessageBody(e,t=!1){e&&(e._isAutosaveUpdate=!1),this.message&&(this.message._isAutosaveUpdate=!1),t||(this.content=``,this.mimeType=``,this.rawMessageHtml=``,this.loading=!0,this.activeBanners=[],this.allowRemoteResources=this.settingsStore?.getState().showRemoteContent===`always`,this.hasRemoteResources=!1,this.threadItems=[]),this.resolveThread(e);let n=this.threadItems.find(t=>String(t.message?.UID)===String(e.UID))||this.threadItems[0];n&&(n.loading=!t,n.expanded=!0,this._deferPropertySync=!1,this.fetchItemBody(n).then(()=>{this.message?.UID!==e.UID||this.mailbox!==e.Mailbox||this.requestUpdate()}))}updateThreadItemReference(e){if(!e.message)return;let t=this.threadItems.findIndex(t=>String(t.message?.UID)===String(e.message?.UID));t!==-1&&(this.threadItems[t]={...e},this.threadItems=[...this.threadItems])}async fetchItemBody(e){if(!e.message)return;let t=e.message,n=e.mailbox,r=this.localPreferredView||this.settingsStore?.getState()?.preferredView||`html`;try{let i=Zt.get(n,t.UID.toString(),r);if(i){if(e.attachments=i.Attachments||[],e.hasHtml=i.HasHTML||!1,e.hasText=i.HasText||!1,i.Message&&(e.message={...t,...i.Message}),i.Part)if(e.mimeType=i.Part.MIMEType||i.Part.MimeType||`text/plain`,i.RawHtml===void 0){if(i.RawText!==void 0){e.content=i.RawText;let t={content:e.content,isHtml:!1,message:e.message,banners:[],i18nStore:this.i18nStore},r=await b.invokeHookAsync(`reader:content`,t);for(let t of r)t&&typeof t==`string`&&(e.content=t);e.activeBanners=t.banners||[],t.isHtml&&(e.mimeType=`text/html`,e.hasHtml=!0,e.content=cr(e.content,{mailbox:n,messageUid:e.message?.UID,allowRemoteResources:e.allowRemoteResources,messageStructure:e.message?.BodyStructure,onRemoteResourceBlocked:()=>{e.hasRemoteResources=!0,String(e.message.UID)===String(this.message?.UID)&&(this.hasRemoteResources=!0)}}))}}else{e.rawMessageHtml=i.RawHtml;let t={content:e.rawMessageHtml,isHtml:!0,message:e.message,banners:[],i18nStore:this.i18nStore},r=await b.invokeHookAsync(`reader:content`,t);for(let t of r)t&&typeof t==`string`&&(e.rawMessageHtml=t);e.activeBanners=t.banners||[],e.content=cr(e.rawMessageHtml,{mailbox:n,messageUid:e.message?.UID,allowRemoteResources:e.allowRemoteResources,messageStructure:e.message?.BodyStructure,onRemoteResourceBlocked:()=>{e.hasRemoteResources=!0,String(e.message.UID)===String(this.message?.UID)&&(this.hasRemoteResources=!0)}})}e.loading=!1,!this._deferPropertySync&&String(e.message.UID)===String(this.message?.UID)&&(this.content=e.content,this.mimeType=e.mimeType,this.rawMessageHtml=e.rawMessageHtml,this.attachments=e.attachments,this.hasHtml=e.hasHtml,this.hasText=e.hasText,this.activeBanners=e.activeBanners,this.allowRemoteResources=e.allowRemoteResources,this.hasRemoteResources=e.hasRemoteResources,this.loading=!1,this.message={...this.message,...e.message}),this.updateThreadItemReference(e);return}let a=await T(`/mailboxes/${D(n)}/messages/${t.UID}?view=${r}`);if(a.status===401){window.location.hash=`/login`;return}if(!a.ok)throw Error(`Failed to fetch metadata`);let o=await a.json();e.attachments=o.Attachments||[],e.hasHtml=!!o.HasHTML,e.hasText=!!o.HasText,o.Message&&(e.message={...e.message,...o.Message});let s,c,l=o.Part;if(l){e.mimeType=l.MIMEType||l.MimeType||`text/plain`;let r=Array.isArray(l.Path)?l.Path.join(`.`):l.Path,i=await T(`/mailboxes/${D(n)}/messages/${t.UID}/raw?part=${r}`);if(i.status===401){window.location.hash=`/login`;return}if(i.ok)if(e.mimeType.toLowerCase()===`text/html`){s=await i.text(),e.rawMessageHtml=s;let t={content:e.rawMessageHtml,isHtml:!0,message:e.message,banners:[],i18nStore:this.i18nStore},r=await b.invokeHookAsync(`reader:content`,t);for(let t of r)t&&typeof t==`string`&&(e.rawMessageHtml=t);e.activeBanners=t.banners||[],e.content=cr(e.rawMessageHtml,{mailbox:n,messageUid:e.message?.UID,allowRemoteResources:e.allowRemoteResources,messageStructure:e.message?.BodyStructure,onRemoteResourceBlocked:()=>{e.hasRemoteResources=!0,String(e.message.UID)===String(this.message?.UID)&&(this.hasRemoteResources=!0)}})}else{c=await i.text(),e.content=c;let t={content:e.content,isHtml:!1,message:e.message,banners:[],i18nStore:this.i18nStore},r=await b.invokeHookAsync(`reader:content`,t);for(let t of r)t&&typeof t==`string`&&(e.content=t);e.activeBanners=t.banners||[],t.isHtml&&(e.mimeType=`text/html`,e.hasHtml=!0,e.content=cr(e.content,{mailbox:n,messageUid:e.message?.UID,allowRemoteResources:e.allowRemoteResources,messageStructure:e.message?.BodyStructure,onRemoteResourceBlocked:()=>{e.hasRemoteResources=!0,String(e.message.UID)===String(this.message?.UID)&&(this.hasRemoteResources=!0)}}))}}Zt.set(n,t.UID.toString(),r,{Message:o.Message,Part:o.Part,Attachments:o.Attachments,RawHtml:s,RawText:c,HasHTML:e.hasHtml,HasText:e.hasText})}catch(t){x.error(`Failed to fetch message:`,t),e.content=`Error loading message.`}finally{e.loading=!1,!this._deferPropertySync&&String(e.message.UID)===String(this.message?.UID)&&(this.content=e.content,this.mimeType=e.mimeType,this.rawMessageHtml=e.rawMessageHtml,this.attachments=e.attachments,this.hasHtml=e.hasHtml,this.hasText=e.hasText,this.activeBanners=e.activeBanners,this.allowRemoteResources=e.allowRemoteResources,this.hasRemoteResources=e.hasRemoteResources,this.loading=!1,this.message={...this.message,...e.message}),this.updateThreadItemReference(e)}}getSentMailboxName(){if(this.mailboxes&&Array.isArray(this.mailboxes)){for(let e of this.mailboxes){let t=e.Name||e.Mailbox;if(t&&(e.Attrs||[]).some(e=>typeof e==`string`&&(e.toLowerCase()===`\\sent`||e.toLowerCase()===`\\\\sent`)))return t}let e=[`sent`,`sent messages`,`sent items`,`sent-mail`];for(let t of this.mailboxes){let n=t.Name||t.Mailbox;if(n&&e.includes(n.toLowerCase()))return n}}return Je}async toggleItemExpansion(e){e.expanded=!e.expanded,this.updateThreadItemReference(e),e.expanded&&!e.content&&!e.loading&&(e.loading=!0,this.updateThreadItemReference(e),await this.fetchItemBody(e))}loadRemoteResourcesForItem(e){e.allowRemoteResources=!0,e.message&&e.rawMessageHtml&&(e.hasRemoteResources=!1,e.content=cr(e.rawMessageHtml,{mailbox:e.mailbox,messageUid:e.message.UID,allowRemoteResources:e.allowRemoteResources,messageStructure:e.message.BodyStructure,onRemoteResourceBlocked:()=>{e.hasRemoteResources=!0}}),String(e.message.UID)===String(this.message?.UID)&&(this.content=e.content,this.allowRemoteResources=!0,this.hasRemoteResources=e.hasRemoteResources),this.updateThreadItemReference(e))}async toggleItemStar(e){if(!e.message)return;let t=e.message.Flags?.includes(L),n=t?`remove`:`add`;t?e.message.Flags=e.message.Flags.filter(e=>e!==L):e.message.Flags=[...e.message.Flags||[],L],this.updateThreadItemReference(e),this.dispatchEvent(new CustomEvent(`message-flags-changed`,{detail:{uid:String(e.message.UID),flag:L,action:n},bubbles:!0,composed:!0}));try{let{ok:r}=await R.setFlag(e.mailbox,[String(e.message.UID)],[L],n);r?String(e.message.UID)===String(this.message?.UID)&&(this.message.Flags=e.message.Flags,this.requestUpdate()):(t?e.message.Flags=[...e.message.Flags||[],L]:e.message.Flags=e.message.Flags.filter(e=>e!==L),this.updateThreadItemReference(e),this.dispatchEvent(new CustomEvent(`message-flags-changed`,{detail:{uid:String(e.message.UID),flag:L,action:t?`add`:`remove`},bubbles:!0,composed:!0})))}catch(n){x.error(`Failed to toggle star for thread item`,n),t?e.message.Flags=[...e.message.Flags||[],L]:e.message.Flags=e.message.Flags.filter(e=>e!==L),this.updateThreadItemReference(e),this.dispatchEvent(new CustomEvent(`message-flags-changed`,{detail:{uid:String(e.message.UID),flag:L,action:t?`add`:`remove`},bubbles:!0,composed:!0}))}}reportDeleteFailed(){window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:this.i18nStore?.t(`toast.messageDeleteFailed`),duration:5e3}}))}async deleteItem(e){if(e.message&&confirm(this.i18nStore?.t(`messageReader.deleteConfirmSingle`)||`Are you sure you want to permanently delete this message?`))try{let t=await R.deleteMessagesResult(e.mailbox,[String(e.message.UID)]);if(t.ok){let t=String(e.message.UID),n=this.threadItems.length>0&&String(this.threadItems[0].message?.UID)===t;this.threadItems=this.threadItems.filter(e=>String(e.message?.UID)!==t),this.requestUpdate(),n&&this.dispatchEvent(new CustomEvent(`action`,{detail:{action:`delete`}}))}else t.reason!==`auth`&&this.reportDeleteFailed()}catch(e){x.error(`Failed to delete thread item`,e),this.reportDeleteFailed()}}async _handleActionForItem(e,t){if(e===`reply`||e===`replyAll`||e===`forward`){let n=``;if(t.mimeType===`text/plain`)n=t.content;else{try{let e=await T(`/mailboxes/${D(t.mailbox)}/messages/${t.message.UID}?view=text`);if(e.ok){let t=await e.json();t.Part&&t.RawText&&(n=t.RawText)}}catch(e){x.error(`Failed to fetch text body for quote`,e)}!n&&t.rawMessageHtml&&(n=xr(t.rawMessageHtml))}let r=this.settingsStore?.getState()?.dateFormat||`YYYY-MM-DD`,i=String(this.settingsStore?.getState()?.hourFormat||`12`),{subject:a,to:o,cc:s,quotedText:c,quotedHtml:l}=fr(e,t.message,n,t.rawMessageHtml,t.hasHtml,r,i),u=e===`forward`?t.attachments.map(e=>({name:e.Filename||`attachment`,size:e.Size||0,type:e.MIMEType||`application/octet-stream`,partPath:e.Path?e.Path.join(`.`):void 0})):[],d=e===`reply`||e===`replyAll`?t.message.Envelope?.MessageID||t.message.Envelope?.MessageId:void 0;this.composeStore.openComposer({subject:a,to:o,cc:s,text:c,html:l,format:this.settingsStore?.getState()?.composeFormat||`html`,attachments:u,inReplyTo:d});return}if(e===`showPlaintext`){this.localPreferredView=`text`,this.fetchItemBody(t);return}if(e===`showHtml`){this.localPreferredView=`html`,this.fetchItemBody(t);return}if(e===`print`){let e=t.allowRemoteResources?`&remote=1`:``;window.open(`#/print?mailbox=`+encodeURIComponent(t.mailbox)+`&uid=`+t.message.UID+e,`_blank`);return}}applyThemeToIframe(e){yr(e,this.settingsStore?.getState()?.themeIframeContent??!1)}applyThemeToAllIframes(){let e=this.shadowRoot?.querySelectorAll(`iframe.reader-iframe`);e&&e.forEach(e=>this.applyThemeToIframe(e))}onIframeLoad(e){let t=e.target;br(t,this.settingsStore?.getState()?.themeIframeContent??!1)}async _handleEditDraft(e){let t=e&&!(e instanceof Event),n=t?e.message:this.message,r=t?e.mailbox:this.mailbox;if(!n)return;t&&e&&!e.content&&!e.loading&&(e.loading=!0,this.updateThreadItemReference(e),await this.fetchItemBody(e));let i=t&&e?e.content:this.content,a=t&&e?e.mimeType:this.mimeType,o=t&&e?e.rawMessageHtml:this.rawMessageHtml,s=t&&e?e.attachments:this.attachments,c=``;if(a===`text/plain`)c=i;else{try{let e=await T(`/mailboxes/${D(r)}/messages/${n.UID}?view=text`);if(e.ok){let t=await e.json();t.Part&&t.RawText&&(c=t.RawText)}}catch(e){x.error(`Failed to fetch text body for draft`,e)}c||=xr(o)}let l=(s||[]).map(e=>({name:e.Filename||`attachment`,size:e.Size||0,type:e.MIMEType||`application/octet-stream`,partPath:e.Path?e.Path.join(`.`):void 0})),u=e=>e?e.map(e=>e.Name?`${e.Name} <${e.Mailbox}@${e.Host}>`:`${e.Mailbox}@${e.Host}`):[];this.composeStore.openComposer({draftUid:n.UID.toString(),draftMailbox:r,subject:n.Envelope?.Subject||``,to:u(n.Envelope?.To),cc:u(n.Envelope?.Cc),bcc:u(n.Envelope?.Bcc),text:c,html:o,format:this.settingsStore?.getState()?.composeFormat||`html`,attachments:l})}renderThreadCard(e){return s`
        ...
        <alps-popup align="left" class="tags-popup">
          ...
          ${[`$label1`,`$label2`,`$label3`,`$label4`,`$label5`].map(t=>s`
              <button class="dropdown-item ${(e?this.commonTags?.some(e=>e.toLowerCase()===t.toLowerCase()):this.message?.Flags?.some(e=>e.toLowerCase()===t.toLowerCase()))?`active`:``}" @click=${()=>this._handleTag(t)}>
                <span style="display:inline-block;width:12px;height:12px;border-radius:50%;background:${gn(t)};margin-right:12px;opacity:0.9;"></span>
                <span class="item-text">${hn(t,this.i18nStore)}</span>
              </button>
            `)}
          ${o.length?s`
            <div class="dropdown-divider"></div>
            ${o.map(e=>s`
              <button class="dropdown-item active" title=${this.i18nStore?.t(`messageReader.removeTag`)} @click=${()=>this._handleTag(e)}>
                <span style="display:inline-block;width:12px;height:12px;border-radius:50%;background:${gn(e)};margin-right:12px;opacity:0.9;"></span>
                <span class="item-text">${hn(e,this.i18nStore)}</span>
                ${O(`x`)}
              </button>
            `)}
          `:``}
    ...
    .layout-vertical alps-sidebar.desktop-sidebar { width: var(--sidebar-width, ${Tr}px); flex-shrink: 0; }
    .layout-vertical .main-view { flex: 1; display: flex; flex-direction: row; min-width: 0; }
    .layout-vertical .message-list-pane { width: ${Ar}px; flex-shrink: 0; border-right: 1px solid var(--border-color); }
    .layout-vertical .message-reader-pane { flex: 1; min-width: 0; }

    /* Horizontal: Sidebar (250px) | [ Message List (50%) / Reader (50%) ] */
    .layout-horizontal alps-sidebar.desktop-sidebar { width: var(--sidebar-width, ${Tr}px); flex-shrink: 0; }
    ...
    .layout-full alps-sidebar.desktop-sidebar { width: var(--sidebar-width, ${Tr}px); flex-shrink: 0; }
    ...
    `}updateComputedMinWidth(){let e=Ar,t=this.shadowRoot?.querySelector(`.message-list-pane alps-message-list`);if(t){let n=t.shadowRoot?.querySelector(`.list-header`);if(n){let t=_t(n);e=Math.max(Ar,t+2)}}if(e!==this.computedMinListWidth){this.computedMinListWidth=e;let t=this.sidebarCollapsed&&!this.isMobile?Or:this.sidebarWidth;this.resizerPositionX-t<e&&(this.resizerPositionX=t+e)}}showGlobalToast(e,t=``,n,r=3e3){window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:e,actionLabel:t,actionFn:n,duration:r}}))}reportActionFailed(e,t){this.showGlobalToast(this.i18nStore?.t(e)||t,``,void 0,4e3)}reportFlagFailure(e){if(e.reason===`auth`)return;let t=e.reason===`unsupported`?`toast.tagNotSupported`:`toast.flagChangeFailed`,n=e.reason===`unsupported`?`That tag is not supported by this mail server`:`Could not update the messages`;this.showGlobalToast(this.i18nStore?.t(t)||n,``,void 0,4e3)}get canArchiveHere(){let e=rt(this.currentMailbox,this.mailboxes);return e!==`trash`&&e!==`drafts`&&e!==`archive`}get effectiveListWidth(){let e=this.sidebarCollapsed&&!this.isMobile?Or:this.sidebarWidth;return Math.max(this.computedMinListWidth,this.resizerPositionX-e)}get allSelectedStarred(){if(this.selectedUids.size===0)return!1;for(let e of this.selectedUids){let t=this.messages.find(t=>String(t.UID)===e);if(!t||!t.Flags?.includes(`\\Flagged`))return!1}return!0}get commonSelectedTags(){return this.selectedUids.size===0?[]:[`$label1`,`$label2`,`$label3`,`$label4`,`$label5`].filter(e=>{for(let t of this.selectedUids){let n=this.messages.find(e=>String(e.UID)===t);if(!n||!n.Flags?.some(t=>t.toLowerCase()===e.toLowerCase()))return!1}return!0})}get allSelectedUnread(){if(this.selectedUids.size===0)return!1;for(let e of this.selectedUids){let t=this.messages.find(t=>String(t.UID)===e);if(t&&t.Flags?.includes(`\\Seen`))return!1}return!0}connectedCallback(){super.connectedCallback(),this.extractMailboxFromHash(),window.addEventListener(`hashchange`,this.handleHashChange),document.addEventListener(`click`,this.unlockAudio),document.addEventListener(`keydown`,this.unlockAudio),this._mql.addEventListener(`change`,this._handleMediaQuery),this._handleMediaQuery(this._mql),this.settingsStore.addEventListener(`change`,this._handleSettingsChange),this._syncSettings(),F.addEventListener(`sync-start`,this.handleSyncStart),F.addEventListener(`sync-success`,this.handleSyncSuccess),F.addEventListener(`sync-error`,this.handleSyncError),F.addEventListener(`mailbox-not-found`,this.handleMailboxNotFound),window.addEventListener(`draft-autosaved`,this.handleDraftAutosaved),F.fetch(this.currentMailbox,this.currentPage,this.filterQuery,!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener(`hashchange`,this.handleHashChange),this._mql.removeEventListener(`change`,this._handleMediaQuery),document.removeEventListener(`click`,this.unlockAudio),document.removeEventListener(`keydown`,this.unlockAudio),this.settingsStore.removeEventListener(`change`,this._handleSettingsChange),this.i18nStore?.removeEventListener(`change`,this._handleI18nChange),F.removeEventListener(`sync-start`,this.handleSyncStart),F.removeEventListener(`sync-success`,this.handleSyncSuccess),F.removeEventListener(`sync-error`,this.handleSyncError),F.removeEventListener(`mailbox-not-found`,this.handleMailboxNotFound),window.removeEventListener(`draft-autosaved`,this.handleDraftAutosaved),F.stop()}updated(e){super.updated(e),(e.has(`sidebarCollapsed`)||e.has(`layoutMode`)||e.has(`currentMailbox`)||e.has(`isMobile`)||e.has(`mailboxes`))&&setTimeout(()=>this.updateComputedMinWidth(),0)}_syncSettings(){let e=this.settingsStore.getState();this.layoutMode=e.layoutMode,this.densityMode=e.densityMode,this.sortOrder=e.sortOrder||`desc`,this.sidebarCollapsed!==e.sidebarCollapsed&&(this.sidebarCollapsed=e.sidebarCollapsed),e.messagesPerPage&&e.messagesPerPage>0&&(this.messagesPerPage=e.messagesPerPage),e.checkMailInterval!==void 0&&F.start(e.checkMailInterval)}openFolderPrompt(){let e=this.shadowRoot?.querySelector(`alps-folder-list`);e&&typeof e.triggerCreateFolder==`function`&&e.triggerCreateFolder()}updateUrl(e,t,n,r=this.filterQuery){let i=`#/mailbox/${encodeURIComponent(e)}`,a=new URLSearchParams;t>0&&a.set(`p`,t.toString()),n&&a.set(`uid`,n),r&&a.set(`q`,r);let o=a.toString();o&&(i+=`?`+o),window.location.hash=i}extractMailboxFromHash(){let e=window.location.hash;if(e.startsWith(`#/mailbox/`)){let t=e.substring(10),n=t.indexOf(`?`),r=``;n!==-1&&(r=t.substring(n+1),t=t.substring(0,n));let i=t.split(`/`);this.currentMailbox=decodeURIComponent(i[0]);let a=new URLSearchParams(r);i.length>1&&i[1]?this.targetUid=i[1]:this.targetUid=a.get(`uid`)||null;let o=a.get(`p`);o?this.currentPage=parseInt(o,10)||0:this.currentPage=0,this.filterQuery=a.get(`q`)||``}else this.currentMailbox=E,this.targetUid=null,this.currentPage=0}async applyTargetUid(){if(!this.targetUid){this.markReadTimer&&=(clearTimeout(this.markReadTimer),null),this.selectedMessage=null;return}let e=this.targetUid,t=this.messages.find(t=>String(t.UID)===e);if(!t&&this.messages.length>0)try{let n=await T(`/mailboxes/${D(this.currentMailbox)}/messages/${e}`);if(n.ok){let e=await n.json();e.Message&&(t=e.Message)}}catch(e){x.error(`Failed to fetch shifted message:`,e)}this.targetUid===e&&(t?this.selectedMessage?.UID!==t.UID&&(this.selectedMessage=t,this.layoutMode===`full`&&this.expandedFolders.clear(),this._scheduleMarkAsRead(t)):this.messages.length>0&&(this.selectedMessage=null,this.updateUrl(this.currentMailbox,this.currentPage,null)))}async selectMessage(e){this.updateUrl(this.currentMailbox,this.currentPage,e.UID)}_scheduleMarkAsRead(e){if(this.markReadTimer&&=(clearTimeout(this.markReadTimer),null),e.Flags?.includes(`\\Seen`))return;let t=this.settingsStore?.getState().markReadTimeout??0;t<0||(t===0?this._doMarkAsRead(e):this.markReadTimer=setTimeout(()=>{this._doMarkAsRead(e)},t*1e3))}updateLocalMessageFlags(e,t,n){let r=!1,i=[...this.messages];for(let a=0;a<i.length;a++){let o=i[a];if(e.includes(String(o.UID))){let e=o.Flags&&o.Flags.includes(t);n===`add`&&!e?(i[a]={...o,Flags:[...o.Flags||[],t]},r=!0):n===`remove`&&e&&(i[a]={...o,Flags:o.Flags.filter(e=>e!==t)},r=!0)}}if(r){if(this.messages=i,this.selectedMessage&&e.includes(String(this.selectedMessage.UID))){let e=this.selectedMessage.Flags&&this.selectedMessage.Flags.includes(t);n===`add`&&!e?this.selectedMessage.Flags=[...this.selectedMessage.Flags||[],t]:n===`remove`&&e&&(this.selectedMessage.Flags=this.selectedMessage.Flags.filter(e=>e!==t)),this.selectedMessage={...this.selectedMessage}}window.dispatchEvent(new CustomEvent(`external-message-flags-changed`,{detail:{uids:e,flag:t,action:n}}))}}async _handleListToggleStar(e){let t=e.detail.message,n=t.Flags&&t.Flags.includes(`\\Flagged`),r=n?`remove`:`add`;this.updateLocalMessageFlags([String(t.UID)],L,r);try{let{ok:e}=await R.setFlag(this.currentMailbox,[String(t.UID)],[L],r);e||this.updateLocalMessageFlags([String(t.UID)],L,n?`add`:`remove`)}catch{this.updateLocalMessageFlags([String(t.UID)],L,n?`add`:`remove`)}}async _doMarkAsRead(e){let t=await R.markAsRead(this.currentMailbox,e);t?.Flags?.includes(`\\Seen`)&&(this.selectedMessage?.UID===e.UID&&(this.selectedMessage=t),this.updateLocalMessageFlags([String(t.UID)],I,`add`))}async _handleReaderAction(e){let t=e.detail.action,n=this.selectedUids&&this.selectedUids.size>0,r=n?Array.from(this.selectedUids):[];if(!(!n&&!this.selectedMessage?.UID)){n&&(this.bulkProcessing=!0);try{let i=this.selectedMessage,a=this.currentMailbox;if(t===`star`)if(n){let e=this.allSelectedStarred?`remove`:`add`,t=await R.setFlag(this.currentMailbox,r,[L],e);t.ok?this.updateLocalMessageFlags(r,L,e):this.reportFlagFailure(t)}else this.selectedMessage=await R.toggleStar(this.currentMailbox,this.selectedMessage),this.updateLocalMessageFlags([String(this.selectedMessage.UID)],L,this.selectedMessage.Flags?.includes(`\\Flagged`)?`add`:`remove`);else if(t===`addTag`||t===`removeTag`){let a=e.detail.tags||(e.detail.folder?[e.detail.folder]:[]);if(!a||a.length===0)return;let o=t===`addTag`?`add`:`remove`,s=n?r:[String(i.UID)],c=await R.setFlag(this.currentMailbox,s,a,o);if(c.ok)for(let e of a)this.updateLocalMessageFlags(s,e,o);else this.reportFlagFailure(c);this.requestUpdate()}else if(t===`markUnread`){if(n){let e=this.allSelectedUnread?`add`:`remove`,t=await R.setFlag(this.currentMailbox,r,[I],e);t.ok?this.updateLocalMessageFlags(r,I,e):this.reportFlagFailure(t)}else if(i?.UID){let e=!i.Flags||!i.Flags.includes(`\\Seen`),t=await R.setFlag(this.currentMailbox,[String(i.UID)],[I],e?`add`:`remove`);t.ok?e?(this.selectedMessage={...i,Flags:[...i.Flags||[],I]},this.updateLocalMessageFlags([String(i.UID)],I,`add`)):(this.updateLocalMessageFlags([String(i.UID)],I,`remove`),this.selectedMessage=null,this.updateUrl(this.currentMailbox,this.currentPage,null)):this.reportFlagFailure(t)}}else if(t===`delete`||t===`archive`||t===`reportSpam`||t===`notSpam`){let e=rt(this.currentMailbox,this.mailboxes),o=e===`trash`,s=e===`drafts`,c=e===`junk`,l={success:!1},u=it(`trash`,this.mailboxes,$e);if(t===`archive`&&(u=it(`archive`,this.mailboxes,Ye)),t===`reportSpam`&&(u=it(`junk`,this.mailboxes,Qe)),t===`notSpam`&&(u=E),t===`delete`&&(o||s||c)){this.pendingDeleteDetails={isBulk:n,uidsArray:r,currentMsgUid:i?.UID,isTrash:o,isDrafts:s,isSpam:c},this.showDeleteConfirm=!0;return}else l=n?await R.moveMessages(this.currentMailbox,r,u):await R.moveMessages(this.currentMailbox,[String(i.UID)],u);if(l.success){n?(this.selectedUids=new Set,this.selectedMessage=null,this.updateUrl(this.currentMailbox,this.currentPage,null),this.requestUpdate()):(this.selectedMessage=null,this.updateUrl(this.currentMailbox,this.currentPage,null));let e=``,o;if(e=t===`archive`?n?this.i18nStore?.t(`toast.messagesMovedToArchive`,{count:r.length}):this.i18nStore?.t(`toast.messageMovedToArchive`):t===`reportSpam`?n?this.i18nStore?.t(`toast.messagesMovedToSpam`,{count:r.length}):this.i18nStore?.t(`toast.messageMovedToSpam`):t===`notSpam`?n?this.i18nStore?.t(`toast.messagesMovedToInbox`,{count:r.length}):this.i18nStore?.t(`toast.messageMovedToInbox`):n?this.i18nStore?.t(`toast.messagesMovedToTrash`,{count:r.length}):this.i18nStore?.t(`toast.messageMovedToTrash`),n&&l.uidMapping){let e=Object.values(l.uidMapping);o=async()=>{try{let t=await R.moveMessages(u,e,a);if(t.success){if(this.currentMailbox===a&&t.uidMapping){let e=new Set(this.selectedUids);Object.values(t.uidMapping).forEach(t=>e.add(t)),this.selectedUids=e,this.requestUpdate()}}else t.reason!==`auth`&&this.reportActionFailed(`toast.undoFailed`,`Could not undo that`)}catch(e){x.error(`Undo failed`,e),this.reportActionFailed(`toast.undoFailed`,`Could not undo that`)}}}else if(!n&&l.uidMapping?.[String(i.UID)]){let e={UID:l.uidMapping[String(i.UID)]};o=async()=>{try{let t=await R.moveMessages(u,[String(e.UID)],a);if(t.success){let n=this.currentMailbox===a?this.currentPage:0;t.uidMapping?.[String(e.UID)]?this.updateUrl(a,n,t.uidMapping[String(e.UID)]):this.updateUrl(a,n,null)}else t.reason!==`auth`&&this.reportActionFailed(`toast.undoFailed`,`Could not undo that`)}catch(e){x.error(`Undo failed`,e),this.reportActionFailed(`toast.undoFailed`,`Could not undo that`)}}}this.showGlobalToast(e,o?this.i18nStore?.t(`mailboxPage.undo`):``,o,wr)}else l.reason!==`auth`&&this.reportActionFailed(`toast.moveFailed`,`Could not move that`)}else if(t===`moveTo`||t===`copyTo`){let o=e.detail.folder;if(!o)return;let s=t===`moveTo`,c={success:!1};if(c=s?n?await R.moveMessages(this.currentMailbox,r,o):await R.moveMessages(this.currentMailbox,[String(i.UID)],o):n?await R.copyMessages(this.currentMailbox,r,o):await R.copyMessages(this.currentMailbox,[String(i.UID)],o),c.success){s&&(n?(this.selectedUids=new Set,this.selectedMessage=null,this.updateUrl(this.currentMailbox,this.currentPage,null),this.requestUpdate()):(this.selectedMessage=null,this.updateUrl(this.currentMailbox,this.currentPage,null)));let e=s?n?this.i18nStore?.t(`toast.messagesMovedToFolder`,{count:r.length,folder:o}):this.i18nStore?.t(`toast.messageMovedToFolder`,{folder:o}):n?this.i18nStore?.t(`toast.messagesCopiedToFolder`,{count:r.length,folder:o}):this.i18nStore?.t(`toast.messageCopiedToFolder`,{folder:o}),t;if(n&&s&&c.uidMapping){let e=Object.values(c.uidMapping);t=async()=>{try{let t=await R.moveMessages(o,e,a);if(t.success){if(this.currentMailbox===a&&t.uidMapping){let e=new Set(this.selectedUids);Object.values(t.uidMapping).forEach(t=>e.add(t)),this.selectedUids=e,this.requestUpdate()}}else t.reason!==`auth`&&this.reportActionFailed(`toast.undoFailed`,`Could not undo that`)}catch(e){x.error(`Undo failed`,e),this.reportActionFailed(`toast.undoFailed`,`Could not undo that`)}}}else if(!n&&s&&c.uidMapping?.[String(i.UID)]){let e={UID:c.uidMapping[String(i.UID)]};t=async()=>{try{let t=await R.moveMessages(o,[String(e.UID)],a);if(t.success){let n=this.currentMailbox===a?this.currentPage:0;t.uidMapping?.[String(e.UID)]?this.updateUrl(a,n,t.uidMapping[String(e.UID)]):this.updateUrl(a,n,null)}else t.reason!==`auth`&&this.reportActionFailed(`toast.undoFailed`,`Could not undo that`)}catch(e){x.error(`Undo failed`,e),this.reportActionFailed(`toast.undoFailed`,`Could not undo that`)}}}this.showGlobalToast(e,t?this.i18nStore?.t(`mailboxPage.undo`):``,t,wr)}else c.reason!==`auth`&&(s?this.reportActionFailed(`toast.moveFailed`,`Could not move that`):this.reportActionFailed(`toast.copyFailed`,`Could not copy that`))}else if(t===`downloadMessage`&&!n){let e=i.UID,t=`/mailboxes/${D(this.currentMailbox)}/messages/${e}/raw`,n=document.createElement(`a`);n.href=t,n.download=``,document.body.appendChild(n),n.click(),document.body.removeChild(n)}else if(t===`showOriginal`&&!n){let e=`#/original?mailbox=${encodeURIComponent(this.currentMailbox)}&uid=${i.UID}`;window.open(e,`_blank`)}}finally{n&&(this.bulkProcessing=!1)}}}async _confirmDelete(){this.showDeleteConfirm=!1;let e=this.pendingDeleteDetails;if(this.pendingDeleteDetails=null,!e)return;let{isBulk:t,uidsArray:n,currentMsgUid:r,isDrafts:i}=e;t&&(this.bulkProcessing=!0);try{let e=await R.deleteMessagesResult(this.currentMailbox,t?n:[String(r)]);if(e.ok){t?(this.selectedUids=new Set,this.selectedMessage=null,this.updateUrl(this.currentMailbox,this.currentPage,null),this.requestUpdate()):(this.selectedMessage=null,this.updateUrl(this.currentMailbox,this.currentPage,null));let e=``;e=i?t?this.i18nStore?.t(`toast.draftsDiscarded`,{count:n.length}):this.i18nStore?.t(`toast.draftDiscarded`):t?this.i18nStore?.t(`toast.messagesPermanentlyDeleted`,{count:n.length}):this.i18nStore?.t(`toast.messagePermanentlyDeleted`),this.showGlobalToast(e,``,void 0,wr)}else e.reason!==`auth`&&this.reportActionFailed(`toast.messageDeleteFailed`,`The message could not be deleted`)}finally{t&&(this.bulkProcessing=!1)}}_cancelDelete(){this.showDeleteConfirm=!1,this.pendingDeleteDetails=null}toggleFolder(e,t){t&&(t.stopPropagation(),t.preventDefault());let n=new Set(this.expandedFolders);n.has(e)?n.delete(e):n.add(e),this.expandedFolders=n}render(){let e=this.isMobile?`full`:this.layoutMode,t=e===`full`&&this.selectedMessage!==null;return s`
      ...
      <div class="app-container layout-${e} ${t?`reading`:``} ${this.isPaneDragging||this.isSidebarDragging?`dragging`:``} ${this.sidebarCollapsed&&!this.isMobile?`collapsed`:``} ${this.isMobile?`mobile-view`:``} ${this.suppressSidebarHover?`suppress-sidebar-hover`:``}" style="${!this.sidebarCollapsed&&!this.isMobile?`--sidebar-width: ${this.sidebarWidth}px;`:``}">
        <alps-sidebar 
          ...
          .collapsed=${this.sidebarCollapsed&&!this.isMobile}
          .width=${this.sidebarWidth}
          @sidebar-resize=${e=>{let t=e.detail.newWidth;t<kr?(this.sidebarCollapsed||this.settingsStore.updateSettings({sidebarCollapsed:!0}),this.sidebarWidth=Tr):(this.sidebarCollapsed&&this.settingsStore.updateSettings({sidebarCollapsed:!1}),this.sidebarWidth=Math.min(Math.max(t,Er),Dr),this.resizerPositionX=Math.max(this.resizerPositionX,this.sidebarWidth+Ar))}}
          @drag-start=${()=>this.isSidebarDragging=!0}
          @drag-end=${()=>this.isSidebarDragging=!1}
  ...
  `}render(){return s`
    ...
    `}};k([o({type:String})],Ir.prototype,`label`,void 0),k([o({type:String})],Ir.prototype,`description`,void 0),Ir=k([m(`alps-setting-group`)],Ir);function Lr(e,t){return new Promise(n=>{let r=document.createElement(`ui-prompt`);r.title=t?.t(`gpg.passphraseRequired`),r.confirmText=t?.t(`gpg.unlock`),r.cancelText=t?.t(`general.cancel`);let i=t?.t(`gpg.passphrasePrompt`);e&&(i+=` (Error: ${e})`),r.fields=[{id:`passphrase`,label:i,type:`password`,placeholder:t?.t(`gpg.passphrase`),autofocus:!0}];let a=()=>{r.parentNode&&r.parentNode.removeChild(r)};r.addEventListener(`submit`,e=>{n(e.detail.passphrase),a()}),r.addEventListener(`cancel`,()=>{n(null),a()}),document.body.appendChild(r)})}var Rr=null;function zr(){Rr=null;try{sessionStorage.removeItem(`gpg_private_key`)}catch{}}async function Br(e,t){if(Rr)return Rr;let n=await T(`/gpg/keys`);if(!n.ok)throw Error(`Failed to fetch GPG keyring.`);let r=await n.json();if(!r.encrypted_private_key)throw Error(`No private key found on server. Please generate one in Settings.`);let i=await e.readPrivateKey({armoredKey:r.encrypted_private_key});if(i.isDecrypted())return Rr=i,Rr;{let n,r=await Lr(n,t);for(;r!==null;)try{return Rr=await e.decryptKey({privateKey:i,passphrase:r}),Rr}catch(e){n=`Incorrect passphrase: `+e.message,r=await Lr(n,t)}throw Error(`Passphrase prompt cancelled.`)}}async function Vr(e){let{instance:t,formData:n,composer:r}=e;if(!t.encryptGpg)return n;if(n.get(`attachment-uuids`)||n.get(`prev_attachments`)){let e=r?.i18nStore?.t(`gpg.attachmentsNotEncryptable`);return alert(e||`Attachments cannot be encrypted with inline PGP and would be sent unencrypted. Remove the attachments, or turn off encryption to send them.`),!1}try{let e=await S(()=>import(`./openpgp-DR5IM9o-.js`).then(e=>e.t),__vite__mapDeps([0,1])),i=t.to||[],a=t.cc||[],o=t.bcc||[],s=[...i,...a,...o];if(s.length===0)return n;let c=[],l=[],u=[],d=Fe();d.loginUsername&&u.push(d.loginUsername);for(let t of s){let n=t.includes(`<`)?t.split(`<`)[1].split(`>`)[0].trim():t.trim();if(u.includes(n))continue;let r=(await P.fetchContacts(n)).contacts||[],i=!1;for(let t of r)if(t.public_key){let n=await e.readKey({armoredKey:t.public_key});c.push(n),i=!0;break}i||l.push(t)}if(l.length>0){let e=r.i18nStore?.t(`gpg.missingPublicKeys`),t=l.join(`
`);return alert(e?e.replace(`{keys}`,t):`Cannot encrypt: Missing public keys for:\n${t}`),!1}let f=await Br(e,r.i18nStore),p=f.toPublic();c.push(p);let m=n.get(`text`)||``,h=n.get(`html`)||``,g=``;g=t.format===`html`&&h?h:m;let _=await e.createMessage({text:g}),ee=await e.encrypt({message:_,encryptionKeys:c,signingKeys:f,format:`armored`});return n.set(`text`,ee),n.set(`html`,``),n}catch(e){return alert(`GPG Encryption failed: `+e.message),!1}}async function Hr(e){if(typeof e.content==`string`&&e.content.includes(`-----BEGIN PGP MESSAGE-----`))try{let t=await S(()=>import(`./openpgp-DR5IM9o-.js`).then(e=>e.t),__vite__mapDeps([0,1])),n=e.content.indexOf(`-----BEGIN PGP MESSAGE-----`),r=e.content.indexOf(`-----END PGP MESSAGE-----`)+25;if(n===-1||r<=n)return e.content;let i=e.content.substring(n,r),a=await Br(t,e.i18nStore),o=await t.readMessage({armoredMessage:i}),{data:c}=await t.decrypt({message:o,decryptionKeys:a,format:`utf8`}),l=String(c);l.includes(`<html`)||l.includes(`<body`)||l.includes(`<p>`)||l.includes(`<div`)||l.includes(`<br`)||(l=l.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/\n/g,`<br/>`));let u=e.content.substring(0,n)+l+e.content.substring(r);return e.banners=e.banners||[],e.banners.push(s`
    ...
    `},`gpg`),b.registerHook(`composer:presend`,Vr,`gpg`),b.registerHook(`reader:content`,Hr,`gpg`);function Wr(e){return`"`+String(e??``).replace(/[\u0000-\u001f\u007f]/g,``).replace(/\\/g,`\\\\`).replace(/"/g,`\\"`)+`"`}function Gr(e){let t=new TextEncoder().encode(JSON.stringify(e)),n=``;for(let e of t)n+=String.fromCharCode(e);return btoa(n)}function Kr(e){let t=atob(e),n=Uint8Array.from(t,e=>e.charCodeAt(0));try{return new TextDecoder(`utf-8`,{fatal:!0}).decode(n)}catch{return t}}var qr=class{static extractVisualState(e){let t=e.match(/^# ALPS_VISUAL_STATE: (.*)$/m);if(!t)return null;try{return JSON.parse(Kr(t[1]))}catch{return null}}static compile(e){if(e.rules.length===0)return``;let t=new Set;for(let n of e.rules){for(let e of n.actions)e.type===`fileinto`&&(t.add(`fileinto`),t.add(`mailbox`));for(let e of n.conditions)e.field.toLowerCase()===`body`&&t.add(`body`)}let n=``;t.size>0&&(n+=`require [${Array.from(t).map(e=>`"${e}"`).join(`, `)}];\n\n`),n+=`# ALPS_VISUAL_STATE: ${Gr(e)}\n\n`;for(let t of e.rules){if(t.conditions.length===0||t.actions.length===0)continue;let e=t.conditions.map(e=>this.compileCondition(e)),r=``;r=e.length===1?`if ${e[0]}`:t.matchType===`all`?`if allof (${e.join(`, `)})`:`if anyof (${e.join(`, `)})`,n+=`${r} {\n`;for(let e of t.actions)n+=`  ${this.compileAction(e)}\n`;n+=`}

`}return n}static compileCondition(e){let t=e.field.toLowerCase();if(t===`size`){let t=String(e.value??``).trim();return/^\d+[KMG]?$/i.test(t)?`size :${e.operator} ${t}`:`size :${e.operator} 0`}if(t===`body`)return`body :text :${e.operator===`contains`?`contains`:`is`} ${Wr(e.value)}`;let n=``,r=``;return e.operator===`contains`?(n=``,r=`:contains`):e.operator===`not_contains`?(n=`not `,r=`:contains`):e.operator===`is`?(n=``,r=`:is`):e.operator===`not_is`&&(n=`not `,r=`:is`),`${n}header ${r} ${Wr(e.field)} ${Wr(e.value)}`}static compileAction(e){switch(e.type){case`fileinto`:return`fileinto :create ${Wr(e.value??``)};`;case`discard`:return`discard;`;case`redirect`:return`redirect ${Wr(e.value??``)};`;case`stop`:return`stop;`}return``}},Jr=new class{async fetchScript(){let e=await T(`/managesieve/script`);if(!e.ok)throw Error(`Failed to fetch script: ${e.statusText}`);return e.json()}async saveScript(e,t=`PUT`){let n=await T(`/managesieve/script`,{method:t,headers:{"Content-Type":`application/json`},body:JSON.stringify({content:e})});if(!n.ok){let e=await n.json().catch(()=>({}));throw Error(e.error||`Failed to save script`)}return n.json()}async validateScript(e){let t=await T(`/managesieve/validate`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({content:e})});if(!t.ok){let e=await t.json().catch(()=>({}));throw Error(e.error||`Validation failed`)}return t.json()}async fetchFolders(){let e=await T(`/mailboxes/INBOX`);if(!e.ok)throw Error(`Failed to fetch mailboxes: ${e.statusText}`);return e.json()}},Yr=class extends d{constructor(...e){super(...e),this.initialScript=null,this.isDirty=!1,this.script=``,this.isValidating=!1,this.isSaving=!1}static{this.styles=n`
		.editor-container {
			display: flex;
			flex-direction: column;
			gap: 16px;
...
`)&&(t+=` `),h(t)}handleScroll(e){let t=e.target,n=this.shadowRoot?.querySelector(`.highlight-layer`);n&&(n.scrollTop=t.scrollTop,n.scrollLeft=t.scrollLeft)}handleInput(e){let t=e.target;this.script=t.value,this.dispatchEvent(new CustomEvent(`script-changed`,{detail:{script:this.script}}))}async validate(){this.isValidating=!0;try{await Jr.validateScript(this.script),window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:this.i18nStore.t(`managesieve.toast.valid`),timeout:3e3}}))}catch(e){window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:e.message||this.i18nStore.t(`managesieve.toast.networkError`),timeout:5e3,type:`error`}}))}finally{this.isValidating=!1}}async save(){this.isSaving=!0;let e=this.script;try{await Jr.saveScript(e,`PUT`),this.initialScript=e,this.isDirty=this.script!==e;let t=e.trim()===``?`managesieve.toast.deactivated`:`managesieve.toast.saved`;window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:this.i18nStore.t(t),timeout:3e3}}))}catch(e){window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:e.message||this.i18nStore.t(`managesieve.toast.networkError`),timeout:5e3,type:`error`}}))}finally{this.isSaving=!1}}render(){return s`
		...
		`}};k([a()],Yr.prototype,`isDirty`,void 0),k([g({context:C})],Yr.prototype,`i18nStore`,void 0),k([o({type:String})],Yr.prototype,`script`,void 0),k([a()],Yr.prototype,`isValidating`,void 0),k([a()],Yr.prototype,`isSaving`,void 0),Yr=k([m(`alps-raw-editor`)],Yr);var Xr=class extends d{constructor(...e){super(...e),this.isSaving=!1,this.initialSnapshot=``,this.state={rules:[]},this.folders=[]}willUpdate(e){e.has(`state`)&&this.initialSnapshot===``&&(this.initialSnapshot=JSON.stringify(this.state))}get isDirty(){return this.initialSnapshot!==``&&this.initialSnapshot!==JSON.stringify(this.state)}markClean(e=JSON.stringify(this.state)){this.initialSnapshot=e,this.requestUpdate()}static{this.styles=n`
		.editor-container {
			display: flex;
			flex-direction: column;
			gap: 24px;
	...
	`}addRule(){this.state={...this.state,rules:[...this.state.rules,{id:Math.random().toString(36).substring(7),matchType:`all`,conditions:[{field:`Subject`,operator:`contains`,value:``}],actions:[{type:`fileinto`,value:this.folders[0]||`INBOX`}]}]},this.notifyChange()}deleteRule(e){let t=[...this.state.rules];t.splice(e,1),this.state={...this.state,rules:t},this.notifyChange()}updateRule(e,t){let n=[...this.state.rules];n[e]={...n[e],...t},this.state={...this.state,rules:n},this.notifyChange()}addCondition(e,t){let n=this.state.rules[e],r={field:`Subject`,operator:`contains`,value:``},i=[...n.conditions];t===void 0?i.push(r):i.splice(t,0,r),this.updateRule(e,{conditions:i})}deleteCondition(e,t){let n=[...this.state.rules[e].conditions];n.splice(t,1),this.updateRule(e,{conditions:n})}updateCondition(e,t,n){let r=[...this.state.rules[e].conditions],i=r[t];n.field&&n.field!==i.field&&(n.field===`Size`?i.operator!==`over`&&i.operator!==`under`&&(n.operator=`over`):(i.operator===`over`||i.operator===`under`)&&(n.operator=`contains`)),r[t]={...i,...n},this.updateRule(e,{conditions:r})}addAction(e,t){let n=this.state.rules[e],r={type:`fileinto`,value:this.folders[0]||`INBOX`},i=[...n.actions];t===void 0?i.push(r):i.splice(t,0,r),this.updateRule(e,{actions:i})}deleteAction(e,t){let n=[...this.state.rules[e].actions];n.splice(t,1),this.updateRule(e,{actions:n})}updateAction(e,t,n){let r=[...this.state.rules[e].actions];r[t]={...r[t],...n},this.updateRule(e,{actions:r})}notifyChange(){this.dispatchEvent(new CustomEvent(`state-changed`,{detail:{state:this.state}}))}save(){this.dispatchEvent(new CustomEvent(`save-requested`))}render(){return s`
		...
		`}};k([o({type:Boolean})],Xr.prototype,`isSaving`,void 0),k([a()],Xr.prototype,`initialSnapshot`,void 0),k([g({context:C,subscribe:!0})],Xr.prototype,`i18nStore`,void 0),k([o({type:Object})],Xr.prototype,`state`,void 0),k([o({type:Array})],Xr.prototype,`folders`,void 0),Xr=k([m(`alps-visual-editor`)],Xr);var Zr=class extends d{constructor(...e){super(...e),this.mode=`visual`,this.script=``,this.visualState={rules:[]},this.folders=[],this.isLoading=!0,this.isSaving=!1,this.showSwitchRawConfirm=!1}static{this.styles=n`
		.container {
			display: flex;
			flex-direction: column;
			gap: 20px;
	...
	`}connectedCallback(){super.connectedCallback(),this.fetchScript(),this.fetchFolders()}async fetchScript(){try{let e=await Jr.fetchScript();if(this.script=e.content||``,this.script.trim()===``)this.mode=`visual`,this.visualState={rules:[]};else{let e=qr.extractVisualState(this.script);e?(this.visualState=e,this.mode=`visual`):this.mode=`raw`}}catch(e){console.error(`Failed to fetch Sieve script`,e),this.visualState={rules:[]},this.mode=`visual`}finally{this.isLoading=!1}}async fetchFolders(){try{let e=await Jr.fetchFolders();e&&e.Mailboxes&&(this.folders=e.Mailboxes.map(e=>e.Name||e.Mailbox).filter(Boolean))}catch(e){console.error(`Failed to fetch folders`,e)}}handleVisualStateChange(e){this.visualState=e.detail.state}handleRawScriptChange(e){this.script=e.detail.script}switchToRaw(){this.showSwitchRawConfirm=!0}confirmSwitchToRaw(){this.script=qr.compile(this.visualState),this.mode=`raw`,this.showSwitchRawConfirm=!1}async saveVisual(){this.isSaving=!0;try{let e=qr.compile(this.visualState);this.script=e;let t=JSON.stringify(this.visualState);await Jr.saveScript(e,`PUT`);let n=e.trim()===``?`managesieve.toast.deactivated`:`managesieve.toast.saved`;window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:this.i18nStore.t(n),timeout:3e3}}));let r=this.shadowRoot?.querySelector(`alps-visual-editor`);r&&r.markClean&&r.markClean(t)}catch(e){window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:e.message||this.i18nStore.t(`managesieve.toast.networkError`),timeout:5e3,type:`error`}}))}finally{this.isSaving=!1}}render(){return s`
			...
			${this.showSwitchRawConfirm?s`
				...
				></ui-confirm>
			`:``}
		`}};k([g({context:C,subscribe:!0})],Zr.prototype,`i18nStore`,void 0),k([a()],Zr.prototype,`mode`,void 0),k([a()],Zr.prototype,`script`,void 0),k([a()],Zr.prototype,`visualState`,void 0),k([a()],Zr.prototype,`folders`,void 0),k([a()],Zr.prototype,`isLoading`,void 0),k([a()],Zr.prototype,`isSaving`,void 0),k([a()],Zr.prototype,`showSwitchRawConfirm`,void 0),Zr=k([m(`alps-managesieve-page`)],Zr);var Qr=e({});b.registerSettingsTab({id:`managesieve`,labelKey:`settings.categories.filters`,icon:`sieve`,component:`alps-managesieve-page`});var $r=class extends d{constructor(...e){super(...e),this.passwordForm={old:``,new:``,confirm:``},this.isSubmitting=!1}static{this.styles=n`
		input[type="password"] {
			width: 100%;
			box-sizing: border-box;
	...
	`}};k([g({context:C})],$r.prototype,`i18nStore`,void 0),k([a()],$r.prototype,`passwordForm`,void 0),k([a()],$r.prototype,`isSubmitting`,void 0),$r=k([m(`alps-password-settings`)],$r);var ei=e({});b.registerSettingsTab({id:`password`,labelKey:`settings.categories.password`,icon:`password`,component:`alps-password-settings`});var ti=class{get currentPath(){return this.getHashPath()}constructor(e,t,n){this.routes=e,this.fallback=t,window.addEventListener(`hashchange`,()=>n())}getHashPath(){let e=window.location.hash;return!e||e===`#`?`/`:e.substring(1).split(`?`)[0]}navigate(e){window.location.hash=e}render(){if(this.routes[this.currentPath])return this.routes[this.currentPath]();for(let e in this.routes)if(e.endsWith(`/*`)&&this.currentPath.startsWith(e.replace(`/*`,``)))return this.routes[e]();return this.fallback()}},ni=class extends d{constructor(...e){super(...e),this.icon=``,this.title=``,this.subtitle=``}static{this.styles=n`
    :host {
      display: flex;
      justify-content: center;
      align-items: center;
  ...
  `}render(){return s`
    ...
    `}};k([o({type:String})],ni.prototype,`icon`,void 0),k([o({type:String})],ni.prototype,`title`,void 0),k([o({type:String})],ni.prototype,`subtitle`,void 0),ni=k([m(`alps-auth-card`)],ni);var Y=class extends d{constructor(...e){super(...e),this.notice=null,this.username=``,this.password=``,this.rememberMe=!1,this.error=``,this.isSubmitting=!1,this.retryAfter=0,this.isRateLimited=!1,this._handleI18nChange=()=>{this.requestUpdate()}}static{this.styles=n`
    .form-group {
      margin-bottom: 16px;
      position: relative;
    }
  ...
  `}render(){return s`
    ...
    `}};k([o({type:Boolean,reflect:!0})],ri.prototype,`active`,void 0),k([o({type:String})],ri.prototype,`icon`,void 0),ri=k([m(`alps-category-item`)],ri);var ii=class extends d{constructor(...e){super(...e),this.newUsername=``,this.newPassword=``,this.newDisplayName=``,this.isSubmitting=!1,this.error=``,this.showAddForm=!1,this._handleStoreChange=()=>{this.requestUpdate()}}static{this.styles=n`
        :host {
            display: block;
        }
    ...
    `}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.i18nStore?.addEventListener(`change`,this._handleStoreChange),this.linkedAccountsStore?.addEventListener(`change`,this._handleStoreChange),this.linkedAccountsStore&&!this.linkedAccountsStore.isInitialized()&&this.linkedAccountsStore.fetchAccounts()})}disconnectedCallback(){super.disconnectedCallback(),this.i18nStore?.removeEventListener(`change`,this._handleStoreChange),this.linkedAccountsStore?.removeEventListener(`change`,this._handleStoreChange)}async handleAdd(e){if(e.preventDefault(),!(!this.newUsername||!this.newPassword)){this.isSubmitting=!0,this.error=``;try{await this.linkedAccountsStore.addAccount(this.newUsername,this.newPassword,this.newDisplayName),this.newUsername=``,this.newPassword=``,this.newDisplayName=``,this.showAddForm=!1,window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:this.i18nStore?.t(`linkedAccounts.addedSuccess`)}}))}catch(e){this.error=e.message||this.i18nStore?.t(`linkedAccounts.addError`)}finally{this.isSubmitting=!1}}}async handleRemove(e){if(confirm(this.i18nStore?.t(`linkedAccounts.removeConfirm`)))try{await this.linkedAccountsStore.removeAccount(e),window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:this.i18nStore?.t(`linkedAccounts.removedSuccess`)}}))}catch(e){window.dispatchEvent(new CustomEvent(`show-toast`,{detail:{message:e.message||this.i18nStore?.t(`linkedAccounts.removeError`)}}))}}render(){let e=this.linkedAccountsStore?.getAccounts()||[],t=this.linkedAccountsStore?.isLoading();return s`
            ...
            `:``}
        `}};k([g({context:C})],ii.prototype,`i18nStore`,void 0),k([g({context:Rn})],ii.prototype,`linkedAccountsStore`,void 0),k([a()],ii.prototype,`newUsername`,void 0),k([a()],ii.prototype,`newPassword`,void 0),k([a()],ii.prototype,`newDisplayName`,void 0),k([a()],ii.prototype,`isSubmitting`,void 0),k([a()],ii.prototype,`error`,void 0),k([a()],ii.prototype,`showAddForm`,void 0),ii=k([m(`settings-accounts`)],ii);function ai(e){if(!e)throw Error(`base64url is null or undefined`);let t=e.replace(/-/g,`+`).replace(/_/g,`/`),n=atob(t),r=new Uint8Array(n.length);for(let e=0;e<n.length;e++)r[e]=n.charCodeAt(e);return r.buffer}function oi(e){let t=new Uint8Array(e),n=``;for(let e=0;e<t.byteLength;e++)n+=String.fromCharCode(t[e]);return btoa(n).replace(/\+/g,`-`).replace(/\//g,`_`).replace(/=/g,``)}async function si(e){e.publicKey.challenge=ai(e.publicKey.challenge),e.publicKey.user.id=ai(e.publicKey.user.id),e.publicKey.excludeCredentials&&(e.publicKey.excludeCredentials=e.publicKey.excludeCredentials.map(e=>({...e,id:ai(e.id)})));let t=await navigator.credentials.create(e);if(!t)throw Error(`Credential creation failed or was cancelled.`);let n=t.response,r=n.getTransports?n.getTransports():[];return{id:t.id,rawId:oi(t.rawId),type:t.type,response:{attestationObject:oi(n.attestationObject),clientDataJSON:oi(n.clientDataJSON)},transports:r}}async function ci(e){e.publicKey.challenge=ai(e.publicKey.challenge),e.publicKey.allowCredentials&&(e.publicKey.allowCredentials=e.publicKey.allowCredentials.map(e=>({...e,id:ai(e.id)})));let t=await navigator.credentials.get(e);if(!t)throw Error(`Assertion failed or was cancelled.`);let n=t.response;return{id:t.id,rawId:oi(t.rawId),type:t.type,response:{authenticatorData:oi(n.authenticatorData),clientDataJSON:oi(n.clientDataJSON),signature:oi(n.signature),userHandle:n.userHandle?oi(n.userHandle):null}}}function li(){return window.PublicKeyCredential!==void 0&&navigator.credentials!==void 0}var ui=class extends d{constructor(...e){super(...e),this.data=null,this.error=``,this.loading=!0,this.adding=!1,this.showNamePrompt=!1,this.pendingCredential=null,this.pendingDeleteId=null}static{this.styles=n`
        :host { display: block; }
        .setting-row {
            display: flex;
            justify-content: space-between;
    ...
    `}connectedCallback(){super.connectedCallback(),this.fetchData()}async fetchData(){try{this.loading=!0;let e=await fetch(`/settings/2fa`);if(!e.ok)throw Error(`Failed to fetch settings`);this.data=await e.json()}catch(e){this.error=e.message}finally{this.loading=!1}}async handleTrustToggle(e){let t=e.target;await fetch(`/settings/2fa/trust-linked-accounts`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({trust:t.checked})}),this.fetchData()}async addCredential(){this.adding=!0,this.error=``;try{let e=await fetch(`/settings/2fa/begin`,{method:`POST`});if(!e.ok)throw Error(await e.text());let t=await si(await e.json());this.pendingCredential=t,this.showNamePrompt=!0,this.adding=!1}catch(e){e.name===`NotAllowedError`||e.message&&e.message.includes(`not allowed`)?this.error=``:this.error=this.i18nStore?.t(`webauthn.errors.register_failed`)||`There was an error registering your security key. Please try again.`,this.adding=!1}}async _handlePromptSubmit(e){let t=e.detail.keyName||`Security Key`;this.showNamePrompt=!1;let n={...this.pendingCredential,name:t};this.adding=!0,this.error=``;try{let e=await fetch(`/settings/2fa/finish`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(n)});if(!e.ok)throw Error(await e.text());this.fetchData()}catch{this.error=this.i18nStore?.t(`webauthn.errors.register_failed`)||`There was an error registering your security key. Please try again.`}finally{this.adding=!1,this.pendingCredential=null}}_handlePromptCancel(){this.showNamePrompt=!1,this.pendingCredential=null}removeCredential(e){this.pendingDeleteId=e}async executeRemoveCredential(){if(!this.pendingDeleteId)return;let e=this.pendingDeleteId;this.pendingDeleteId=null;try{this.error=``;let t=await fetch(`/settings/2fa/credential/${encodeURIComponent(e)}/delete`,{method:`POST`});if(!t.ok)throw Error(await t.text());this.fetchData()}catch(e){this.error=e.message||this.i18nStore?.t(`webauthn.errors.remove_failed`)}}render(){return this.loading?s`<div>${this.i18nStore?.t(`settings.loading`)}</div>`:s`
            ...
            `:``}
        `}};k([g({context:C})],ui.prototype,`i18nStore`,void 0),k([a()],ui.prototype,`data`,void 0),k([a()],ui.prototype,`error`,void 0),k([a()],ui.prototype,`loading`,void 0),k([a()],ui.prototype,`adding`,void 0),k([a()],ui.prototype,`showNamePrompt`,void 0),k([a()],ui.prototype,`pendingCredential`,void 0),k([a()],ui.prototype,`pendingDeleteId`,void 0),ui=k([m(`alps-webauthn-settings`)],ui);var X=class extends d{constructor(...e){super(...e),this.category=`general`,this.isMobile=window.innerWidth<=768,this.mobileSidebarOpen=!1,this.username=``,this.isScrolled=!1,this.sidebarWidth=250,this.sidebarCollapsed=!1,this.isSidebarDragging=!1,this.isSidebarHovered=!1,this.hoverTimeout=null,this.suppressSidebarHover=!1,this._handleResize=()=>{this.isMobile=window.innerWidth<=768,this.isMobile||(this.mobileSidebarOpen=!1)},this._handleScroll=e=>{let t=e.target;this.isScrolled=t.scrollTop>0},this._handleSettingsChange=()=>{this._syncState()},this._handleI18nChange=()=>{this.requestUpdate()}}static{this.styles=[yt,n`
    :host {
      display: flex;
      flex-direction: column;
      height: 100vh;
  ...
  `}connectedCallback(){super.connectedCallback(),this.extractParams(),this.mailbox&&this.uid?this.fetchOriginal():(this.error=this.i18nStore?.t(`originalMessage.errorMissingParams`),this.loading=!1),this.updateComplete.then(()=>{this.i18nStore?.addEventListener(`change`,this._handleStoreChange)})}disconnectedCallback(){super.disconnectedCallback(),this.i18nStore?.removeEventListener(`change`,this._handleStoreChange)}extractParams(){let e=window.location.hash,t=e.indexOf(`?`);if(t!==-1){let n=new URLSearchParams(e.substring(t+1));this.mailbox=n.get(`mailbox`)||``,this.uid=n.get(`uid`)||``}}async fetchOriginal(){try{this.loading=!0;let e=await T(`/mailboxes/${D(this.mailbox)}/messages/${this.uid}/raw?limit=${this.MAX_DISPLAY_SIZE}`);if(!e.ok){if(e.status===401){window.location.hash=`#/login`;return}throw Error(this.i18nStore?.t(`originalMessage.errorFailedToFetch`))}this.rawText=await e.text(),this.rawText.length>=this.MAX_DISPLAY_SIZE&&(this.isTruncated=!0),this.parsedHeaders=await di(this.rawText)}catch(e){this.error=e.message}finally{this.loading=!1}}copyToClipboard(){navigator.clipboard.writeText(this.rawText).then(()=>{alert(this.isTruncated?this.i18nStore?.t(`originalMessage.copiedTruncated`):this.i18nStore?.t(`originalMessage.copied`))}).catch(e=>{x.error(`Failed to copy: `,e),alert(this.i18nStore?.t(`originalMessage.copyFailed`))})}renderAuthStatus(e,t){e=e.toLowerCase();let n=s`<span class="auth-none">${this.i18nStore?.t(`originalMessage.none`)}</span>`;return e===`pass`?n=s`<span class="auth-pass">${this.i18nStore?.t(`originalMessage.pass`)}</span>`:e===`fail`&&(n=s`<span class="auth-fail">${this.i18nStore?.t(`originalMessage.fail`)}</span>`),s`
    ...
    `}};k([a()],fi.prototype,`rawText`,void 0),k([a()],fi.prototype,`parsedHeaders`,void 0),k([a()],fi.prototype,`loading`,void 0),k([a()],fi.prototype,`error`,void 0),k([a()],fi.prototype,`mailbox`,void 0),k([a()],fi.prototype,`uid`,void 0),k([a()],fi.prototype,`isTruncated`,void 0),k([g({context:C})],fi.prototype,`i18nStore`,void 0),fi=k([m(`original-message-page`)],fi);var Z=class extends d{constructor(...e){super(...e),this.loading=!0,this.error=``,this.mailbox=``,this.uid=``,this.message=null,this.content=``,this.rawMessageHtml=``,this.mimeType=`text/plain`,this.hasRemoteResources=!1,this.allowRemoteResources=!1,this.printTriggered=!1}static{this.styles=n`
    :host {
      display: block;
      min-height: 100vh;
      background: #fff;
  ...
  `}connectedCallback(){super.connectedCallback(),this.allowRemoteResources=this.settingsStore.getState().showRemoteContent===`always`,this.extractParams(),this.mailbox&&this.uid?this.fetchMessage():(this.error=`Missing mailbox or uid parameters`,this.loading=!1)}extractParams(){let e=window.location.hash,t=e.indexOf(`?`);if(t!==-1){let n=new URLSearchParams(e.substring(t+1));this.mailbox=n.get(`mailbox`)||``,this.uid=n.get(`uid`)||``,n.get(`remote`)===`1`&&(this.allowRemoteResources=!0)}}async fetchMessage(){try{this.loading=!0;let e=Zt.get(this.mailbox,this.uid);if(e&&e.Part){this.message=e.Message,this.mimeType=e.Part.MIMEType||e.Part.MimeType||`text/plain`,e.RawHtml===void 0?e.RawText!==void 0&&(this.content=e.RawText):(this.rawMessageHtml=e.RawHtml,this.hasRemoteResources=!1,this.content=cr(this.rawMessageHtml,{mailbox:this.mailbox,messageUid:this.uid,allowRemoteResources:this.allowRemoteResources,messageStructure:this.message.BodyStructure,onRemoteResourceBlocked:()=>{this.hasRemoteResources=!0}})),this.loading=!1;return}let t=await T(`/mailboxes/${D(this.mailbox)}/messages/${this.uid}`);if(!t.ok){if(t.status===401){window.location.hash=`#/login`;return}throw Error(`Failed to fetch message metadata`)}this.message=await t.json(),await this.fetchMessageBody()}catch(e){this.error=e.message}finally{this.loading=!1}}findDisplayPart(e,t){if(!e)return null;if(e.MIMEType&&e.MIMEType.toLowerCase().startsWith(`multipart/`)){if(e.MIMEType.toLowerCase()===`multipart/alternative`){let n=null,r=null;for(let t of e.Children||[])t.MIMEType?.toLowerCase()===`text/plain`&&(n=t),t.MIMEType?.toLowerCase()===`text/html`&&(r=t);return t===`html`?r||n||e.Children[0]:n||r||e.Children[0]}for(let n of e.Children||[]){let e=this.findDisplayPart(n,t);if(e)return e}}return e.MIMEType?.toLowerCase()===`text/html`||e.MIMEType?.toLowerCase()===`text/plain`?e:null}findPartPath(e,t,n=``){if(!e)return null;if(e===t)return n||`1`;if(e.Children&&Array.isArray(e.Children))for(let r=0;r<e.Children.length;r++){let i=n?`${n}.${r+1}`:`${r+1}`,a=this.findPartPath(e.Children[r],t,i);if(a)return a}return null}async fetchMessageBody(){if(!this.message||!this.message.BodyStructure)return;let e=`1`,t=this.findDisplayPart(this.message.BodyStructure,`html`);if(t?(e=this.findPartPath(this.message.BodyStructure,t)||`1`,this.mimeType=t.MIMEType||`text/plain`):(this.mimeType=this.message.BodyStructure.MIMEType||`text/plain`,this.mimeType.toLowerCase()===`text/plain`||this.mimeType.toLowerCase()===`text/html`?e=`1`:this.mimeType=`multipart/mixed`),this.mimeType.toLowerCase().startsWith(`multipart/`)){this.content=``;return}let n=await T(`/mailboxes/${D(this.mailbox)}/messages/${this.uid}/raw?part=${e}`);if(!n.ok)throw Error(`Failed to fetch message body`);this.mimeType.toLowerCase()===`text/html`?(this.rawMessageHtml=await n.text(),this.hasRemoteResources=!1,this.content=cr(this.rawMessageHtml,{mailbox:this.mailbox,messageUid:this.uid,allowRemoteResources:this.allowRemoteResources,messageStructure:this.message.BodyStructure,onRemoteResourceBlocked:()=>{this.hasRemoteResources=!0}})):this.content=await n.text()}loadRemoteResources(){this.allowRemoteResources=!0,this.printTriggered=!1,this.rawMessageHtml&&(this.content=cr(this.rawMessageHtml,{mailbox:this.mailbox,messageUid:this.uid,allowRemoteResources:this.allowRemoteResources,messageStructure:this.message?.BodyStructure,onRemoteResourceBlocked:()=>{this.hasRemoteResources=!0}}))}updated(e){e.has(`content`)&&this.content&&this.mimeType?.toLowerCase()!==`text/html`&&setTimeout(()=>{window.print()},500)}onPrintIframeLoad(e){let t=e.target;try{let e=t.contentDocument;e&&e.body&&(t.style.height=`${e.body.scrollHeight}px`)}catch{}this.printTriggered||(this.printTriggered=!0,setTimeout(()=>window.print(),300))}render(){if(this.loading)return s`
        <div class="loading-state">
          <alps-loader></alps-loader>
    ...
    `}};k([g({context:w})],Z.prototype,`settingsStore`,void 0),k([g({context:C})],Z.prototype,`i18nStore`,void 0),k([a()],Z.prototype,`loading`,void 0),k([a()],Z.prototype,`error`,void 0),k([a()],Z.prototype,`mailbox`,void 0),k([a()],Z.prototype,`uid`,void 0),k([a()],Z.prototype,`message`,void 0),k([a()],Z.prototype,`content`,void 0),k([a()],Z.prototype,`rawMessageHtml`,void 0),k([a()],Z.prototype,`mimeType`,void 0),k([a()],Z.prototype,`hasRemoteResources`,void 0),k([a()],Z.prototype,`allowRemoteResources`,void 0),Z=k([m(`print-page`)],Z);var pi=class extends d{constructor(...e){super(...e),this.statusMessage=``,this.statusType=`info`,this.isLoading=!1,this.isSuccess=!1,this._handleI18nChange=()=>{this.requestUpdate()}}static{this.styles=n`
    .status {
      margin-bottom: 24px;
      padding: 8px 12px;
      border-radius: var(--radius-md, 6px);
  ...
  `}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.i18nStore?.addEventListener(`change`,this._handleI18nChange)}),li()?setTimeout(()=>{this._handleVerify()},300):(this.statusMessage=this.i18nStore?.t(`webauthn.not_supported`),this.statusType=`error`)}disconnectedCallback(){super.disconnectedCallback(),this.i18nStore?.removeEventListener(`change`,this._handleI18nChange)}async _handleVerify(){this.isLoading=!0,this.statusMessage=this.i18nStore?.t(`webauthn.requesting`),this.statusType=`info`;try{let e=await fetch(`/webauthn/verify/begin`,{method:`POST`});if(!e.ok)throw Error(this.i18nStore?.t(`webauthn.errors.begin_failed`));let t=await e.json();if(!t||!t.publicKey)throw Error(this.i18nStore?.t(`webauthn.errors.invalid_options`));this.statusMessage=this.i18nStore?.t(`webauthn.waiting_for_key`);let n=await ci(t);if(this.statusMessage=this.i18nStore?.t(`webauthn.verifying`),(await(await fetch(`/webauthn/verify/finish`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(n)})).json()).success)this.statusMessage=this.i18nStore?.t(`webauthn.success`),this.statusType=`success`,this.isSuccess=!0,setTimeout(()=>{window.location.href=`/#/mailbox/INBOX`},1e3);else throw Error(this.i18nStore?.t(`webauthn.errors.verification_failed`))}catch(e){this.statusMessage=e.message||this.i18nStore?.t(`webauthn.errors.general`),this.statusType=`error`}finally{this.isLoading=!1}}render(){return s`
      ...
      >
        ...
        <alps-button 
          ...
          ?disabled=${this.isLoading||this.isSuccess||!li()}
...
`).map(e=>`<p>${e}</p>`).join(``):this.text),onUpdate:({editor:e})=>{this.format===`html`&&(this.htmlText=e.getHTML(),this.text=e.getText(),this.dispatchEvent(new CustomEvent(`text-changed`,{detail:{text:this.text,html:this.htmlText},bubbles:!0,composed:!0})))},onTransaction:({editor:e})=>{!e.isActive(`link`)&&this.bubbleMenuState===`edit`&&(this.bubbleMenuState=`view`),this.requestUpdate()}}),this.editor.setEditable(!this.isSending),this.requestUpdate())}clear(){this.replyInputRef.value&&(this.replyInputRef.value.value=``),this.text=``,this.htmlText=``,this.editor&&!this.editor.isDestroyed&&this.editor.commands.clearContent(),this.attachments=[],this.dispatchEvent(new CustomEvent(`text-changed`,{detail:{text:``,html:``},bubbles:!0,composed:!0}))}insertFormatting(e,t=``){if(this.format===`html`&&this.editor&&!this.editor.isDestroyed){e===`**`?this.editor.chain().focus().toggleBold().run():e===`*`&&this.editor.chain().focus().toggleItalic().run();return}let n=this.replyInputRef.value;if(!n)return;let r=n.selectionStart,i=n.selectionEnd,a=n.value,o=a.substring(r,i);if(o.startsWith(e)&&o.endsWith(t)&&o.length>=e.length+t.length){let a=o.substring(e.length,o.length-t.length);n.setRangeText(a,r,i,`select`)}else r>=e.length&&a.substring(r-e.length,r)===e&&i+t.length<=a.length&&a.substring(i,i+t.length)===t?n.setRangeText(o,r-e.length,i+t.length,`select`):(n.setRangeText(e+o+t,r,i,`select`),r===i&&(n.selectionStart=r+e.length,n.selectionEnd=r+e.length));this.text=n.value,this.editor&&!this.editor.isDestroyed&&(this.htmlText=this.editor.getHTML()),this.dispatchEvent(new CustomEvent(`text-changed`,{detail:{text:this.text,html:this.htmlText},bubbles:!0,composed:!0})),n.focus()}insertEmoji(e){if(this.format===`html`&&this.editor&&!this.editor.isDestroyed)this.editor.chain().focus().insertContent(e).run();else{let t=this.replyInputRef.value;if(!t)return;let n=t.selectionStart,r=t.selectionEnd;t.setRangeText(e,n,r,`end`),this.text=t.value,this.editor&&!this.editor.isDestroyed&&(this.htmlText=this.editor.getHTML()),this.dispatchEvent(new CustomEvent(`text-changed`,{detail:{text:this.text,html:this.htmlText},bubbles:!0,composed:!0})),t.focus()}}_handleInput(e){this.text=e.target.value,this.dispatchEvent(new CustomEvent(`text-changed`,{detail:{text:this.text,html:this.htmlText},bubbles:!0,composed:!0}))}static{this.styles=[Ot,n`
  ...
  `}render(){if(this.instance.closing)return s`<style>:host { display: none !important; }</style>`;let e=((this.instance.to?.length||0)>0||(this.instance.cc?.length||0)>0||(this.instance.bcc?.length||0)>0)&&(this.instance.text?.trim().length||0)>0,t,n;if(this.instance.minimized)t=24,n=24+this.minimizedIndex*40;else{let e=this.totalMinimized>0?276:0;if(t=24+e+this.openIndex*486,n=0,24+e+this.totalOpen*470>this.windowWidth&&this.totalOpen>1){let n=this.windowWidth-470-48-e,r=n>0?n/(this.totalOpen-1):32;t=24+e+this.openIndex*Math.min(r,470)}}let r,i,a,o,c=this.windowWidth<=768;return this.showDiscardConfirm?(this.style.zIndex=`30000`,c?(a=this.windowWidth,o=this.windowHeight,i=0,r=0,this.removeAttribute(`expanded`)):this.instance.expanded?(a=Math.min(this.windowWidth*.85,800),o=this.windowHeight*.8,i=(this.windowWidth-a)/2,r=(this.windowHeight-o)/2,this.setAttribute(`expanded`,``)):(a=this.instance.minimized?260:470,o=this.instance.minimized?40:500,i=this.windowWidth-t-a,r=this.windowHeight-n-o,this.removeAttribute(`expanded`))):c?(a=this.windowWidth,o=this.windowHeight,i=0,r=0,this.style.zIndex=`30000`,this.removeAttribute(`expanded`)):this.instance.expanded?(a=Math.min(this.windowWidth*.85,800),o=this.windowHeight*.8,i=(this.windowWidth-a)/2,r=(this.windowHeight-o)/2,this.style.zIndex=`30000`,this.setAttribute(`expanded`,``)):(a=this.instance.minimized?260:470,o=this.instance.minimized?40:500,i=this.windowWidth-t-a,r=this.windowHeight-n-o,this.style.zIndex=`${this.instance.zIndex||1e3}`,this.removeAttribute(`expanded`)),c?(this.style.width=`100%`,this.style.height=`100dvh`,this.style.left=`0`,this.style.top=`0`):(this.style.width=`${a}px`,this.style.height=`${o}px`,this.style.left=`${i}px`,this.style.top=`${r}px`),this.instance.minimized?this.setAttribute(`minimized`,``):this.removeAttribute(`minimized`),s`
    ...
    `}};k([g({context:Nn})],$.prototype,`composeStore`,void 0),k([g({context:C})],$.prototype,`i18nStore`,void 0),k([g({context:w})],$.prototype,`settingsStore`,void 0),k([o({type:Object})],$.prototype,`instance`,void 0),k([o({type:Number})],$.prototype,`index`,void 0),k([o({type:Number})],$.prototype,`totalOpen`,void 0),k([o({type:Number})],$.prototype,`totalMinimized`,void 0),k([o({type:Number})],$.prototype,`openIndex`,void 0),k([o({type:Number})],$.prototype,`minimizedIndex`,void 0),k([a()],$.prototype,`showCc`,void 0),k([a()],$.prototype,`showBcc`,void 0),k([a()],$.prototype,`showDiscardConfirm`,void 0),k([a()],$.prototype,`pendingDiscardType`,void 0),k([a()],$.prototype,`windowWidth`,void 0),k([a()],$.prototype,`windowHeight`,void 0),k([a()],$.prototype,`isSaving`,void 0),k([a()],$.prototype,`isDragOver`,void 0),k([a()],$.prototype,`linkPromptFields`,void 0),$=k([m(`alps-floating-composer`)],$);var yi=class extends d{constructor(...e){super(...e),this.show=!1,this.message=``,this.actionLabel=``,this.timeout=0,this._timer=null}updated(e){e.has(`show`)&&(this.show&&this.timeout>0?(this._timer&&clearTimeout(this._timer),this._timer=setTimeout(()=>{this.dismiss()},this.timeout)):!this.show&&this._timer&&(clearTimeout(this._timer),this._timer=null))}dismiss(){this.onDismiss&&this.onDismiss(),this.close()}close(){this.show=!1,this.dispatchEvent(new CustomEvent(`dismiss`)),this.onAction=void 0,this.onDismiss=void 0}handleAction(){this.onAction?this.onAction():this.dispatchEvent(new CustomEvent(`action`)),this.close()}static{this.styles=n`
    :host {
      display: block;
  ...
  `}connectedCallback(){super.connectedCallback();let e=document.cookie.split(`;`).some(e=>e.trim().startsWith(`alps_logged_in=1`))||document.cookie.split(`;`).some(e=>e.trim().startsWith(`alps_has_login_token=1`));!e&&!window.location.hash.startsWith(`#/login`)&&(window.location.hash=`#/login`),this.settingsStore.setI18n(this.i18nStore),this.composeStore.addEventListener(`change`,this._handleComposeChange),this.settingsStore.addEventListener(`change`,this._handleSettingsChange),this.activeComposers=this.composeStore.getState().activeComposers;let t=this.settingsStore.getState().autoLogout??0;vr.setLogoutTime(t),vr.onBeforeLogout=()=>this.composeStore.saveAllDirtyDrafts();let n=this.settingsStore.getState().language??`en`;this.i18nStore.setLanguage(n),window.addEventListener(`auth-error`,this._handleAuthError),window.addEventListener(`show-toast`,this._handleShowToast),window.addEventListener(`beforeunload`,this._handleBeforeUnload),window.addEventListener(`online`,this._handleOnlineEvent),window.addEventListener(`offline`,this._handleOfflineEvent),window.addEventListener(`network-error`,this._handleNetworkError),window.addEventListener(`dragover`,this._handleGlobalDragOver),window.addEventListener(`drop`,this._handleGlobalDrop),window.addEventListener(`plugins-updated`,this._handlePluginsUpdated),this.isOffline&&this._handleOfflineEvent(),e&&this._fetchSessionData()}async _fetchSessionData(){try{let e=await fetch(`/session`);if(e.ok){let t=await e.json();t.EnabledPlugins&&b.setEnabledPlugins(t.EnabledPlugins)}}catch(e){console.error(`Failed to fetch session data`,e)}}disconnectedCallback(){super.disconnectedCallback(),this.composeStore.removeEventListener(`change`,this._handleComposeChange),this.settingsStore.removeEventListener(`change`,this._handleSettingsChange),window.removeEventListener(`auth-error`,this._handleAuthError),window.removeEventListener(`show-toast`,this._handleShowToast),window.removeEventListener(`beforeunload`,this._handleBeforeUnload),window.removeEventListener(`online`,this._handleOnlineEvent),window.removeEventListener(`offline`,this._handleOfflineEvent),window.removeEventListener(`network-error`,this._handleNetworkError),window.removeEventListener(`dragover`,this._handleGlobalDragOver),window.removeEventListener(`drop`,this._handleGlobalDrop),window.removeEventListener(`plugins-updated`,this._handlePluginsUpdated),this._stopOfflineCountdown()}_startOfflineCountdown(){this._stopOfflineCountdown(),this.offlineInterval=window.setInterval(async()=>{if(this.offlineCountdown>1)this.offlineCountdown--;else{if(this.offlineCountdown=10,this._isPinging)return;this._isPinging=!0;try{await this._verifyConnectivity()&&(this.isOffline=!1,this._stopOfflineCountdown())}finally{this._isPinging=!1}}},1e3)}_stopOfflineCountdown(){this.offlineInterval!==null&&(clearInterval(this.offlineInterval),this.offlineInterval=null)}_handleDismissToast(e){this.toasts=this.toasts.map(t=>t.id===e?{...t,show:!1}:t),setTimeout(()=>{this.toasts=this.toasts.filter(t=>t.id!==e)},300)}getRoutes(){let e={"/":()=>this.mailboxPageTemplate,"/login":()=>s`<login-page></login-page>`,"/mailbox/*":()=>this.mailboxPageTemplate,"/settings":()=>s`<settings-page category="general"></settings-page>`,"/settings/*":()=>{let e=window.location.hash.match(/^#\/settings\/?(.*)$/);return s`<settings-page .category=${e&&e[1]?e[1].split(`?`)[0]:`general`}></settings-page>`},"/original":()=>s`<original-message-page></original-message-page>`,"/print":()=>s`<print-page></print-page>`,"/login/webauthn":()=>s`<login-webauthn-page></login-webauthn-page>`};return b.getRoutes().forEach(t=>{let n=null;e[t.path]=()=>(n||=document.createElement(t.component),n)}),e}render(){let e=this.activeComposers.filter(e=>!e.minimized).length,t=this.activeComposers.filter(e=>e.minimized).length,n=0,r=0;return s`
      ...
      `:``}
    `}};k([i({context:Nn})],xi.prototype,`composeStore`,void 0),k([i({context:w})],xi.prototype,`settingsStore`,void 0),k([i({context:C})],xi.prototype,`i18nStore`,void 0),k([i({context:Rn})],xi.prototype,`linkedAccountsStore`,void 0),k([a()],xi.prototype,`activeComposers`,void 0),k([a()],xi.prototype,`toasts`,void 0),k([a()],xi.prototype,`isOffline`,void 0),k([a()],xi.prototype,`offlineCountdown`,void 0),xi=k([m(`app-root`)],xi);var Si=Object.assign({"../../plugins/caldav/frontend/index.ts":Gt,"../../plugins/carddav/frontend/index.ts":Fr,"../../plugins/gpg/frontend/index.ts":Ur,"../../plugins/managesieve/frontend/index.ts":Qr,"../../plugins/password/frontend/index.ts":ei});x.info(`Loaded ${Object.keys(Si).length} frontend plugins.`);